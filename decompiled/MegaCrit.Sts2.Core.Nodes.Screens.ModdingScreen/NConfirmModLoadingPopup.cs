...
public class NConfirmModLoadingPopup : Control, IScreenContext
{
    ...
    public static NConfirmModLoadingPopup? Create()
    {
        ...
        return PreloadManager
            ...
            .Instantiate<NConfirmModLoadingPopup>(PackedScene.GenEditState.Disabled);
    }
    ...
    public override void _Ready()
    {
        ...
        _verticalPopup.SetText(
            new LocString("main_menu_ui", "MODDING_POPUP.title"),
            new LocString("main_menu_ui", "MODDING_POPUP.description")
        );
        _verticalPopup.InitYesButton(
            new LocString("main_menu_ui", "MODDING_POPUP.load_mods"),
            OnYesButtonPressed
        );
        _verticalPopup.InitNoButton(
            new LocString("main_menu_ui", "MODDING_POPUP.cancel"),
            OnNoButtonPressed
        );
    }
