...
public class DynamicVar : IConvertible
{
    ...
    {
        get { return _enchantedValue; }
        set { _enchantedValue = Math.Min(value, 999999999m); }
    }

    public decimal PreviewValue
    {
        get { return _previewValue; }
        set { _previewValue = Math.Min(value, 999999999m); }
    }
    ...
    public string ToHighlightedString(bool inverse)
    {
        ...
        return StsTextUtilities.HighlightChangeText(
            baseComparison: WasJustUpgraded
                ? 1
                : ((!inverse) ? value.CompareTo(value2) : value2.CompareTo(value)),
