...
public class NGridCardHolder : NCardHolder, IPoolable
{
    public new class MethodName : NCardHolder.MethodName
    {
        ...
        public static new readonly StringName OnCardReassigned = "OnCardReassigned";
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.EnsureCardLibraryStatsExists,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.SetIsPreviewingUpgrade,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NGridCardHolder>(
                Create(VariantUtils.ConvertTo<NCard>(in args[0]))
            );
            return true;
        }
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName._isPreviewingUpgrade,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName.CardLibraryStats,
            Variant.From<NCardLibraryStats>(CardLibraryStats)
        );
