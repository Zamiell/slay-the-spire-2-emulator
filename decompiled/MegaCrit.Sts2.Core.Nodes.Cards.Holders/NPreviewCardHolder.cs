...
public class NPreviewCardHolder : NCardHolder
{
    public new class MethodName : NCardHolder.MethodName
    {
        ...
        public static new readonly StringName CreateHoverTips = "CreateHoverTips";
    ...
    public new class PropertyName : NCardHolder.PropertyName
    {
        ...
        public static new readonly StringName SmallScale = "SmallScale";

        public static new readonly StringName IsShowingUpgradedCard = "IsShowingUpgradedCard";
    ...
    private static string ScenePath =>
        SceneHelper.GetScenePath("cards/holders/preview_card_holder");
    ...
    public static NPreviewCardHolder? Create(NCard card, bool showHoverTips, bool scaleOnHover)
    {
        ...
        NPreviewCardHolder nPreviewCardHolder = PreloadManager
            .Cache.GetScene(ScenePath)
            .Instantiate<NPreviewCardHolder>(PackedScene.GenEditState.Disabled);
    ...
    protected override void CreateHoverTips()
    {
        ...
        {
            NHoverTipSet
                .CreateAndShow(this, base.CardNode.Model.HoverTips)
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NPreviewCardHolder>(
                Create(
