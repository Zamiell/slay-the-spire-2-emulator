...
public abstract class NCardHolder : Control
{
    ...
    {
        add { backing_Pressed = (PressedEventHandler)Delegate.Combine(backing_Pressed, value); }
        remove { backing_Pressed = (PressedEventHandler)Delegate.Remove(backing_Pressed, value); }
    }
    ...
    public event AltPressedEventHandler AltPressed
    {
        add
        {
            backing_AltPressed = (AltPressedEventHandler)
                Delegate.Combine(backing_AltPressed, value);
        }
        remove
        {
    ...
    protected void ConnectSignals()
    {
        ...
        _hitbox.Connect(
            NClickableControl.SignalName.MousePressed,
    ...
    protected virtual void SetCard(NCard node)
    {
        ...
        {
            throw new InvalidOperationException(
                "Cannot set a card node on a holder that already has one."
            );
        }
        CardNode = node;
    ...
    protected virtual void CreateHoverTips()
    {
        ...
        {
            NHoverTipSet
                .CreateAndShow(this, CardNode.Model.HoverTips)
                ?.SetAlignmentForCardHolder(this);
        }
    }
    ...
    protected virtual void DoCardHoverEffects(bool isHovered)
    {
        ...
        else if (!isHovered)
        {
            ...
            _hoverTween
                .TweenProperty(this, "scale", SmallScale, 0.5)
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName.IsShowingUpgradedCard,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._currentPressedAction,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._currentPressedAction,
            Variant.From(in _currentPressedAction)
        );
    ...
    protected override void RestoreGodotObjectData(GodotSerializationInfo info)
    {
        ...
        if (
            info.TryGetSignalEventDelegate<AltPressedEventHandler>(
                SignalName.AltPressed,
                out var value9
            )
        )
        {
