...
public class NSelectedHandCardHolder : NCardHolder
{
    ...
    private static string ScenePath =>
        SceneHelper.GetScenePath("/cards/holders/selected_hand_card_holder");
    ...
    public static NSelectedHandCardHolder Create(NHandCardHolder originalHolder)
    {
        ...
        NSelectedHandCardHolder nSelectedHandCardHolder = PreloadManager
            .Cache.GetScene(ScenePath)
            .Instantiate<NSelectedHandCardHolder>(PackedScene.GenEditState.Disabled);
    ...
    public override void _Ready()
    {
        ...
        _tween = CreateTween();
        _tween
            .TweenProperty(base.CardNode, "position", base.Position, 0.15000000596046448)
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NSelectedHandCardHolder>(
