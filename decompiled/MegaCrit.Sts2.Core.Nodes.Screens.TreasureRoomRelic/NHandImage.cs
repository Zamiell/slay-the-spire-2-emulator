...
public class NHandImage : Control
{
    ...
    {
        NHandImage nHandImage = PreloadManager
            .Cache.GetScene(_scenePath)
            .Instantiate<NHandImage>(PackedScene.GenEditState.Disabled);
    ...
    public Tween DoFightMove(RelicPickingFightMove move, float duration)
    {
        ...
        tween
            ...
            .TweenProperty(
                _textureRect,
                "rotation",
                -(float)Math.PI / 10f + Rng.Chaotic.NextFloat(-0.05f, 0.05f),
                list2[0]
            )
        ...
        tween
            .Chain()
            .TweenProperty(_textureRect, "rotation", Rng.Chaotic.NextFloat(-0.02f, 0.02f), list2[1])
        ...
        tween
            .Chain()
            .TweenProperty(_textureRect, "rotation", Rng.Chaotic.NextFloat(-0.02f, 0.02f), list2[3])
            .SetTrans(Tween.TransitionType.Expo)
            .SetEase(Tween.EaseType.In);
        tween
            .Chain()
        ...
        tween
            .Chain()
            .TweenProperty(_textureRect, "rotation", Rng.Chaotic.NextFloat(-0.02f, 0.02f), list2[5])
            .SetTrans(Tween.TransitionType.Expo)
            .SetEase(Tween.EaseType.In);
        tween.TweenCallback(
            Callable.From(
    ...
    public void SetIsDown(bool isDown)
    {
        if (IsDown != isDown)
        {
            ...
            _downTween
                .TweenProperty(_textureRect, "scale", Vector2.One, 0.20000000298023224)
                .SetTrans(Tween.TransitionType.Expo)
                .SetEase(Tween.EaseType.Out);
        }
    }
    ...
    {
        CreateTween()
            .TweenProperty(this, "modulate", new Color(0.5f, 0.5f, 0.5f, 0.5f), duration * 0.333f)
            .SetDelay(duration * 0.667f);
    ...
    public async Task GrabRelic(NTreasureRoomRelicHolder holder)
    {
        ...
        tween
            .TweenProperty(
                ...
                holder.GlobalPosition
                    - _grabMarker.Position.Rotated(base.Rotation)
                    + holder.Size * 0.5f,
                0.5
            )
        ...
        tween = CreateTween();
        tween
            .TweenProperty(this, "global_position", _desiredPosition, 0.5)
            .SetTrans(Tween.TransitionType.Sine)
            .SetEase(Tween.EaseType.InOut);
        await tween.AwaitFinished(_cts.Token);
        _state = oldState;
    ...
    public override void _Process(double delta)
    {
        ...
        if (_state != State.GrabbingRelic)
        {
            ...
            float smoothTime = (
                (_state == State.Frozen) ? 0.25f : ((!LocalContext.IsMe(Player)) ? 0.07f : 0.01f)
            );
            Vector2 target = vector2.Lerp(_desiredPosition, _handAnimateInProgress);
            base.GlobalPosition = MathHelper.SmoothDamp(
                base.GlobalPosition,
                target,
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.SetFrozenForRelicAwards,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.SetTextureToFightMove,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.SetPointingPosition,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.SetAnimateInProgress,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<Tween>(
                DoFightMove(
                    VariantUtils.ConvertTo<RelicPickingFightMove>(in args[0]),
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Vector2,
                PropertyName._originalPosition,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName._handAnimateInProgress,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._handAnimateInProgress,
            Variant.From(in _handAnimateInProgress)
        );
    }
