...
{
    private static readonly IReadOnlyCollection<string> _options =
        new global::_003C_003Ez__ReadOnlyArray<string>(
            new string[5] { "logs", "saves", "root", "build-logs", "loc-override" }
        );
    ...
    public override CmdResult Process(Player? issuingPlayer, string[] args)
    {
        ...
        string text = args[0] switch
        {
            ...
            "saves" => ProjectSettings.GlobalizePath(
