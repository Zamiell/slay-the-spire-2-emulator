...
public class MultiplayerConsoleCmd : AbstractConsoleCmd
{
    ...
    public override string Description =>
        "Opens the multiplayer menu, or the test scene if test is the first argument";
    ...
    public override CmdResult Process(Player? issuingPlayer, string[] args)
    {
        ...
        {
            NMultiplayerTest currentScene = SceneHelper.Instantiate<NMultiplayerTest>(
                "debug/multiplayer_test"
            );
