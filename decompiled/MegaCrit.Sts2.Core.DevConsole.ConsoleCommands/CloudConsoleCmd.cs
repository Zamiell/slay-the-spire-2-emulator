...
public class CloudConsoleCmd : AbstractConsoleCmd
{
    ...
    public override string Description =>
        "Deletes all save files from Steam Cloud, if you are running on Steam";
    ...
    public override CmdResult Process(Player? issuingPlayer, string[] args)
    {
        ...
        if (!_confirmed)
        {
            ...
            return new CmdResult(
                success: false,
                "Run this command again to confirm you want to delete all your Steam cloud saves. The game will quit."
            );
        }
        DeleteCloudSaves();
