...
public class NDeckHistoryEntry : NButton
{
    ...
    private static string ScenePath =>
        SceneHelper.GetScenePath("screens/run_history_screen/deck_history_entry");
    ...
    {
        add { backing_Clicked = (ClickedEventHandler)Delegate.Combine(backing_Clicked, value); }
        remove { backing_Clicked = (ClickedEventHandler)Delegate.Remove(backing_Clicked, value); }
    }
    ...
    {
        NDeckHistoryEntry nDeckHistoryEntry = PreloadManager
            .Cache.GetScene(ScenePath)
            .Instantiate<NDeckHistoryEntry>(PackedScene.GenEditState.Disabled);
    ...
    protected override void OnFocus()
    {
        ...
        _scaleTween.TweenProperty(
            _labelContainer,
            "position:x",
            _labelContainer.Position.X + 8f,
            0.05
        );
    }
    ...
    protected override void OnUnfocus()
    {
        ...
        _scaleTween = CreateTween().SetParallel();
        _scaleTween
            .TweenProperty(_cardImage, "scale", Vector2.One, 0.5)
            .SetTrans(Tween.TransitionType.Expo)
            .SetEase(Tween.EaseType.Out);
        _scaleTween
            .TweenProperty(_labelContainer, "position:x", _labelContainer.Position.X - 8f, 0.5)
            .SetTrans(Tween.TransitionType.Expo)
            .SetEase(Tween.EaseType.Out);
    }
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._enchantmentImage,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
