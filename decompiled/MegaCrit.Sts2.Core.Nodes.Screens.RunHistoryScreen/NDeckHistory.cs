...
public class NDeckHistory : VBoxContainer
{
    ...
    private readonly LocString _cardCategories = new LocString(
        "run_history",
        "DECK_HISTORY.categories"
    );
    ...
    public void LoadDeck(Player player, IEnumerable<SerializableCard> cards)
    {
        ...
        StringBuilder.AppendInterpolatedStringHandler handler =
            new StringBuilder.AppendInterpolatedStringHandler(20, 1, stringBuilder2);
    ...
    private void PopulateCards(Player player, IEnumerable<SerializableCard> cards)
    {
        ...
        _allCards.Clear();
        foreach (IGrouping<SerializableCard, SerializableCard> item in from x in cards group x by x)
        {
