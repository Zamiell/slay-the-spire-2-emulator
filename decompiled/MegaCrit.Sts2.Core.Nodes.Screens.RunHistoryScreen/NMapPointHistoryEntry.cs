...
public class NMapPointHistoryEntry : NClickableControl
{
    ...
    private static string ScenePath =>
        SceneHelper.GetScenePath("screens/run_history_screen/map_point_history_entry");
    ...
    private static IEnumerable<string> GetAssetPaths()
    {
        ...
        foreach (
            EncounterModel encounter in ModelDb.AllEncounters.Where(
                (EncounterModel e) => e.RoomType == RoomType.Boss
            )
        )
        {
            string roomIconPath3 = ImageHelper.GetRoomIconPath(
                MapPointType.Boss,
                RoomType.Boss,
                encounter.Id
            );
            ...
            string roomIconOutlinePath3 = ImageHelper.GetRoomIconOutlinePath(
                MapPointType.Boss,
                RoomType.Boss,
                encounter.Id
            );
        ...
        {
            string roomIconPath4 = ImageHelper.GetRoomIconPath(
            ...
            string roomIconOutlinePath4 = ImageHelper.GetRoomIconOutlinePath(
                MapPointType.Ancient,
                RoomType.Event,
                ancient.Id
            );
    ...
    public override void _Ready()
    {
        ...
        string roomIconPath = ImageHelper.GetRoomIconPath(
            mapPointType,
            roomType,
            flag ? _entry.Rooms.First().ModelId : null
        );
    ...
    {
        NMapPointHistoryEntry nMapPointHistoryEntry = PreloadManager
            .Cache.GetScene(ScenePath)
            .Instantiate<NMapPointHistoryEntry>(PackedScene.GenEditState.Disabled);
    ...
    protected override void OnFocus()
    {
        ...
        NHoverTipSet tip = NHoverTipSet.CreateAndShowMapPointHistory(
            this,
            NMapPointHistoryHoverTip.Create(FloorNum, _player.Id, _entry)
        );
        Callable
            .From(
                delegate
    ...
    public void Highlight()
    {
        ...
        _hoverTween
            .TweenProperty(_texture, "scale", _baseScale * 1.5f, 0.05)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _hoverTween
            .TweenProperty(_texture, "rotation_degrees", 0f, 0.05)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _hoverTween
            .TweenProperty(_outline, "modulate", StsColors.halfTransparentWhite, 0.05)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
    }
    ...
    public void Unhighlight()
    {
        ...
        _hoverTween = CreateTween().SetParallel();
        _hoverTween
            .TweenProperty(_texture, "scale", _baseScale, 1.0)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _hoverTween
            .TweenProperty(_texture, "rotation_degrees", _baseAngle, 1.0)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _hoverTween
            .TweenProperty(_outline, "modulate", StsColors.quarterTransparentBlack, 1.0)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
    }
    ...
    public async Task AnimateIn(int index)
    {
        ...
        _animateInTween
            .TweenProperty(this, "scale", Vector2.One, _hurryUp ? 0.05 : 0.4)
            .SetEase(Tween.EaseType.Out)
    ...
    private async Task DoAnimateInEffects()
    {
        ...
        if (_runHistory.MapPointHistory.Last().Last() == _entry && !_runHistory.Win)
        {
            ...
            NDebugAudioManager.Instance?.Play(
                "STS_DeathStinger_v4_Short_SFX.mp3",
                0.75f * GetSfxVolume()
            );
            return;
        }
