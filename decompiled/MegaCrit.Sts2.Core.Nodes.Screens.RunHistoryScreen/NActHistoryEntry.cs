...
public class NActHistoryEntry : HBoxContainer
{
    ...
    private static string ScenePath =>
        SceneHelper.GetScenePath("screens/run_history_screen/act_history_entry");

    public static IEnumerable<string> AssetPaths =>
        new global::_003C_003Ez__ReadOnlySingleElementList<string>(ScenePath);

    public List<NMapPointHistoryEntry> Entries { get; private set; } =
        new List<NMapPointHistoryEntry>();
    ...
    public override void _Ready()
    {
        ...
        {
            NMapPointHistoryEntry nMapPointHistoryEntry = NMapPointHistoryEntry.Create(
                _runHistory,
                _entries[i],
                i + _baseFloorNum
            );
    ...
    )
    {
        ...
        NActHistoryEntry nActHistoryEntry = PreloadManager
            .Cache.GetScene(ScenePath)
            .Instantiate<NActHistoryEntry>(PackedScene.GenEditState.Disabled);
