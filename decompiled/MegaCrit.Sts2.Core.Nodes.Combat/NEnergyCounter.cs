...
public class NEnergyCounter : Control
{
    ...
    public static NEnergyCounter? Create(Player player)
    {
        ...
        NEnergyCounter nEnergyCounter = PreloadManager
            .Cache.GetScene(player.Character.EnergyCounterPath)
    ...
    private void OnHovered()
    {
        NHoverTipSet
            ...
            ?.SetGlobalPosition(base.GlobalPosition + new Vector2(-70f, -200f));
    }
    ...
    private void RefreshLabel()
    {
        ...
        _label.AddThemeColorOverride(
            ...
            (playerCombatState.Energy == 0) ? StsColors.red : StsColors.cream
        );
        _label.AddThemeColorOverride(
            ThemeConstants.Label.FontOutlineColor,
            (playerCombatState.Energy == 0) ? StsColors.unplayableEnergyCostOutline : OutlineColor
        );
        Material material = (
    ...
    public void AnimIn()
    {
        ...
        _animInTween
            .TweenProperty(this, "position", _showPosition, 0.6000000238418579)
    ...
    public void AnimOut()
    {
        ...
        _animOutTween
            .TweenProperty(this, "position", _hidePosition, 0.6000000238418579)
