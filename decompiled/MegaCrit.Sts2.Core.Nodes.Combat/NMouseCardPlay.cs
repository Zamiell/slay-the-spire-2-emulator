...
public class NMouseCardPlay : NCardPlay
{
    public new class MethodName : NCardPlay.MethodName
    {
        ...
        public static new readonly StringName Start = "Start";
        ...
        public static new readonly StringName OnCancelPlayCard = "OnCancelPlayCard";
    ...
    public override void _Input(InputEvent inputEvent)
    {
        ...
        if (
            inputEvent.IsActionPressed(_cancelShortcut)
            || inputEvent.IsActionPressed(MegaInput.releaseCard)
        )
        {
            CancelPlayCard();
    ...
    public override void _EnterTree()
    {
        if (NControllerManager.Instance != null)
        {
            NControllerManager.Instance.Connect(
                ...
                Callable.From(base.CancelPlayCard)
            );
            NControllerManager.Instance.Connect(
    ...
    private async Task TargetSelection(TargetMode targetMode)
    {
        if (base.Card != null)
        {
            ...
            if (
                (targetType == TargetType.AnyEnemy || targetType == TargetType.AnyAlly)
                    ? true
                    : false
            )
            {
    ...
    private async Task SingleCreatureTargeting(TargetMode targetMode, TargetType targetType)
    {
        ...
        try
        {
            instance.StartTargeting(
                ...
                base.CardNode,
                targetMode,
                () => IsCardInCancelZone() || _cancellationTokenSource.IsCancellationRequested,
                null
            );
        ...
        if (_signalsConnected)
        {
            ...
            if (NRun.Instance != null)
            {
                ...
                instance.Disconnect(
                    ...
                    _onCreatureHoverCallable
                );
                instance.Disconnect(
                    NTargetManager.SignalName.CreatureUnhovered,
                    _onCreatureUnhoverCallable
                );
            }
        }
    }
    ...
    private async Task MultiCreatureTargeting(TargetMode targetMode)
    {
        ...
        Func<bool> shouldFinishTargeting = (
            (targetMode == TargetMode.ReleaseMouseToTarget)
                ? ((Func<bool>)(() => !_isLeftMouseDown))
                : ((Func<bool>)(() => _isLeftMouseDown))
        );
        do
        {
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.DisconnectTargetingSignals,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NMouseCardPlay>(
                Create(
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName._hasLeftCardCancelZoneOnce,
                PropertyHint.None,
                "",
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName.PlayZoneThreshold,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName.CancelZoneThreshold,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName._dragStartYPosition,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                ...
                PropertyName._onCreatureHoverCallable,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Callable,
                PropertyName._onCreatureUnhoverCallable,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName._signalsConnected,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName._skipStartCardDrag,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._hasLeftCardCancelZoneOnce,
            Variant.From(in _hasLeftCardCancelZoneOnce)
        );
        ...
        info.AddProperty(
            PropertyName._onCreatureHoverCallable,
            Variant.From(in _onCreatureHoverCallable)
        );
        info.AddProperty(
            PropertyName._onCreatureUnhoverCallable,
            Variant.From(in _onCreatureUnhoverCallable)
        );
