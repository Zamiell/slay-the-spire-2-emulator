...
public class NCombatStartBanner : Control
{
    ...
    public static NCombatStartBanner? Create()
    {
        ...
        return PreloadManager
            ...
            .Instantiate<NCombatStartBanner>(PackedScene.GenEditState.Disabled);
    }
    ...
    private async Task AnimateVfx()
    {
        ...
        tween.Chain();
        tween
            .TweenProperty(_colorRect, "modulate:a", 0.5f, 0.75)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        tween
            .TweenProperty(_colorRect, "scale", Vector2.One, 0.75)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo)
            .From(Vector2.One * 1.2f);
        tween
            .TweenProperty(_label, "modulate:a", 1f, 1.2999999523162842)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        tween
            .TweenProperty(_label, "scale", Vector2.One, 0.75)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo)
            .From(Vector2.One * 2f);
        tween
            .TweenProperty(_label, "modulate:a", 0f, 1.0)
            .SetEase(Tween.EaseType.Out)
        ...
        if (await tween.AwaitFinished(this))
        {
            ...
            tween = CreateTween();
            tween
                .TweenProperty(_colorRect, "modulate:a", 0f, 1.0)
                .SetEase(Tween.EaseType.Out)
                .SetTrans(Tween.TransitionType.Cubic)
                .SetDelay(1.5);
