...
public class NStarCounter : Control
{
    ...
    public static IEnumerable<string> AssetPaths =>
        new global::_003C_003Ez__ReadOnlySingleElementList<string>(_starGainVfxPath);
    ...
    private void OnHovered()
    {
        NHoverTipSet
            ...
            ?.SetGlobalPosition(base.GlobalPosition + new Vector2(-34f, -300f));
    }
    ...
    public override void _Process(double delta)
    {
        if (_player != null)
        {
            ...
            {
                _rotationLayers.GetChild<Control>(i).RotationDegrees +=
                    (float)delta * num * (float)(i + 1);
            }
            _lerpingStarCount = MathHelper.SmoothDamp(
                _lerpingStarCount,
                _player.PlayerCombatState.Stars,
                ref _velocity,
                0.1f,
                (float)delta
            );
    ...
    private void UpdateStarCount(int oldCount, int newCount)
    {
        ...
        else if (newCount > oldCount)
        {
            ...
            Node2D node2D = PreloadManager
                .Cache.GetAsset<PackedScene>(_starGainVfxPath)
    ...
    private void SetStarCountText(int stars)
    {
        if (_displayedStarCount != stars)
        {
            ...
            _label.AddThemeColorOverride(
                ...
                (stars == 0) ? StsColors.red : StsColors.cream
            );
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.ConnectStarsChangedSignal,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName._lerpingStarCount,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Int,
                PropertyName._displayedStarCount,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName._isListeningToCombatState,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._isListeningToCombatState,
            Variant.From(in _isListeningToCombatState)
        );
    }
