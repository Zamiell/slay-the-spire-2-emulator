...
public abstract class NCombatCardPile : NButton
{
    public new class MethodName : NButton.MethodName
    {
        ...
        public static new readonly StringName ConnectSignals = "ConnectSignals";
    ...
    public virtual void Initialize(Player player)
    {
        ...
        {
            PileType.Draw => new HoverTip(
                new LocString("static_hover_tips", "DRAW_PILE.title"),
                new LocString("static_hover_tips", "DRAW_PILE.description")
            ),
            PileType.Discard => new HoverTip(
                new LocString("static_hover_tips", "DISCARD_PILE.title"),
                new LocString("static_hover_tips", "DISCARD_PILE.description")
            ),
            PileType.Exhaust => new HoverTip(
                new LocString("static_hover_tips", "EXHAUST_PILE.title"),
                new LocString("static_hover_tips", "EXHAUST_PILE.description")
            ),
    ...
    protected override void OnRelease()
    {
        ...
        _bumpTween
            .TweenProperty(_icon, "modulate", Colors.White, 0.5)
        ...
        if (_pile.IsEmpty)
        {
            ...
            NThoughtBubbleVfx child = NThoughtBubbleVfx.Create(
                _emptyPileMessage.GetFormattedText(),
                _localPlayer.Creature,
                2.0
            );
            NCombatRoom.Instance?.CombatVfxContainer.AddChildSafely(child);
        }
        else if (
            NCapstoneContainer.Instance?.CurrentCapstoneScreen is NCardPileScreen nCardPileScreen
            && nCardPileScreen.Pile == _pile
        )
        {
            NCapstoneContainer.Instance.Close();
        }
    ...
    protected override void OnPress()
    {
        ...
        _bumpTween = CreateTween().SetParallel();
        _bumpTween
            .TweenProperty(_icon, "scale", Vector2.One, 0.25)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Cubic);
        _bumpTween
            .TweenProperty(_icon, "modulate", _downColor, 0.25)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Cubic);
    }
    ...
    protected virtual void AddCard()
    {
        if (_pile != null)
        {
            ...
            _bumpTween
                .TweenProperty(_countLabel, "scale", Vector2.One, 0.5)
                .SetEase(Tween.EaseType.Out)
                .SetTrans(Tween.TransitionType.Expo);
        }
    }
    ...
    public virtual void AnimIn()
    {
        ...
        _positionTween
            .TweenProperty(this, "position", _showPosition, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
    }
    ...
    public void AnimOut()
    {
        ...
        _positionTween = CreateTween();
        _positionTween
            .TweenProperty(this, "position", _hidePosition, 0.5)
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.SetAnimInOutPositions,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
