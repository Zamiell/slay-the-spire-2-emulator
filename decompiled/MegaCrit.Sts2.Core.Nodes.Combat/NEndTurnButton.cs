...
public class NEndTurnButton : NButton
{
    ...
    public new class MethodName : NButton.MethodName
    {
        ...
        public static new readonly StringName OnRelease = "OnRelease";
        ...
        public static readonly StringName ShouldShowPlayableCardsFtue =
            "ShouldShowPlayableCardsFtue";

        public static new readonly StringName OnEnable = "OnEnable";

        public static new readonly StringName OnDisable = "OnDisable";
        ...
        public static new readonly StringName OnFocus = "OnFocus";

        public static readonly StringName HasPlayableCard = "HasPlayableCard";

        public static new readonly StringName OnUnfocus = "OnUnfocus";

        public static new readonly StringName OnPress = "OnPress";
    ...
    public new class PropertyName : NButton.PropertyName
    {
        ...
        public static new readonly StringName Hotkeys = "Hotkeys";
    ...
    private static readonly Vector2 _hidePosRatio =
        _showPosRatio + new Vector2(0f, 250f) / NGame.devResolution;
    ...
    public override void _Ready()
    {
        ...
        _hoverTip = new HoverTip(
            new LocString("static_hover_tips", "END_TURN.title"),
            new LocString("static_hover_tips", "END_TURN.description")
        );
    ...
    private void AfterPlayerEndedTurn(Player player, bool canBackOut)
    {
        ...
        if (LocalContext.IsMe(player))
        {
            ...
            if (
                ...
                && PlayerCanTakeAction(me)
                && canBackOut
            )
            {
                SetState(State.Enabled);
                _label.SetTextAutoSize(
                    new LocString("gameplay_ui", "UNDO_END_TURN_BUTTON").GetFormattedText()
                );
            }
            else
            {
    ...
    private void StartOrStopPulseVfx()
    {
        bool flag =
            !HasPlayableCard()
            && !CombatManager.Instance.IsPlayerReadyToEndTurn(LocalContext.GetMe(_combatState))
        ...
        if (_isShiny)
        {
            if (!flag)
            {
                ...
                _glowEnableTween
                    .TweenProperty(_glow, "modulate:a", 0f, 0.5)
                    .SetEase(Tween.EaseType.Out)
                    .SetTrans(Tween.TransitionType.Expo);
                _glowVfxTween?.Kill();
                _glowVfxTween = CreateTween();
                _glowVfxTween
                    .TweenProperty(_glowVfx, "modulate:a", 0f, 0.5)
                    .SetEase(Tween.EaseType.Out)
                    .SetTrans(Tween.TransitionType.Expo);
            }
        }
        else if (flag)
        {
            ...
            _glowEnableTween = CreateTween().SetParallel();
            _glowEnableTween
                .TweenProperty(_glow, "modulate:a", 0.75f, 0.8)
                .SetEase(Tween.EaseType.Out)
                .SetTrans(Tween.TransitionType.Back);
            _glowEnableTween
                .TweenProperty(_glow, "scale", Vector2.One * 0.5f, 0.8)
                .SetEase(Tween.EaseType.Out)
                .SetTrans(Tween.TransitionType.Back)
    ...
    private void GlowPulse()
    {
        ...
        _glowVfxTween
            .TweenProperty(_glowVfx, "scale", Vector2.One * 0.7f, 1.5)
            .From(Vector2.One * 0.5f)
            .SetEase(Tween.EaseType.Out)
        ...
        if (CanTurnBeEnded)
        {
            ...
            if (!CombatManager.Instance.IsPlayerReadyToEndTurn(me))
            {
                ...
                RunManager.Instance.ActionQueueSynchronizer.RequestEnqueue(
                    new EndPlayerTurnAction(me, turnNumber)
                );
            }
            else
            {
                SetState(State.Disabled);
                RunManager.Instance.ActionQueueSynchronizer.RequestEnqueue(
                    new UndoEndPlayerTurnAction(me, turnNumber)
                );
            }
        }
    }
    ...
    public void SecretEndTurnLogicViaFtue()
    {
        ...
        Player me = LocalContext.GetMe(_combatState);
        RunManager.Instance.ActionQueueSynchronizer.RequestEnqueue(
            new EndPlayerTurnAction(me, me.PlayerCombatState.TurnNumber)
        );
    }
    ...
    private bool ShouldShowPlayableCardsFtue()
    {
        ...
        else
        {
            ...
            {
                Log.Info(
                    $"Ended {3} turns without cards left to play. Good job! Disabling can_play_cards ftue."
                );
                SaveManager.Instance.MarkFtueAsComplete("can_play_cards_ftue");
            }
        }
    ...
    private void AnimOut()
    {
        ...
        _positionTween
            .TweenProperty(this, "position", HidePos, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
    }
    ...
    private void AnimIn()
    {
        ...
        _positionTween = CreateTween();
        _positionTween
            .TweenProperty(this, "position", ShowPos, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Back);
    }
    ...
    protected override void OnFocus()
    {
        ...
        if (!CombatManager.Instance.IsPlayerReadyToEndTurn(me))
        {
            ...
            NHoverTipSet
                .CreateAndShow(this, _hoverTip)
                ?.SetGlobalPosition(base.GlobalPosition + _hoverTipOffset);
        }
        else
        {
            _label.Modulate = StsColors.cream;
    ...
    protected override void OnUnfocus()
    {
        ...
        _hoverTween
            .TweenMethod(Callable.From<float>(UpdateShaderV), _hsv.GetShaderParameter(_v), 1f, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _hoverTween
            .TweenProperty(_visuals, "position", Vector2.Zero, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _hoverTween
            .TweenProperty(
                _label,
                "modulate",
                base.IsEnabled ? StsColors.cream : StsColors.gray,
                0.5
            )
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
    ...
    protected override void OnPress()
    {
        if (CanTurnBeEnded)
        {
            ...
            _hoverTween
                ...
                .SetTrans(Tween.TransitionType.Expo);
            _hoverTween
                .TweenProperty(_visuals, "position", new Vector2(0f, 8f), 0.5)
                .SetEase(Tween.EaseType.Out)
                .SetTrans(Tween.TransitionType.Cubic);
            _hoverTween
                .TweenProperty(_label, "modulate", Colors.DarkGray, 0.5)
                .SetEase(Tween.EaseType.Out)
                .SetTrans(Tween.TransitionType.Expo);
        }
    }
    ...
    public void RefreshEnabled()
    {
        bool flag =
            ...
            || NCombatRoom.Instance.Mode != CombatRoomMode.ActiveCombat
            || !ActiveScreenContext.Instance.IsCurrent(NCombatRoom.Instance)
            || NCombatRoom.Instance.Ui.Hand.IsInCardSelection;
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.StartOrStopPulseVfx,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.SecretEndTurnLogicViaFtue,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.ShouldShowPlayableCardsFtue,
                new PropertyInfo(
                    Variant.Type.Bool,
                    "",
                    PropertyHint.None,
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Int,
                PropertyName._endTurnWithNoPlayableCardsCount,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._endTurnWithNoPlayableCardsCount,
            Variant.From(in _endTurnWithNoPlayableCardsCount)
        );
    }
