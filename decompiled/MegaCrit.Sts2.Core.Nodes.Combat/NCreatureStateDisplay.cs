...
public class NCreatureStateDisplay : Control
{
    public new class MethodName : Control.MethodName
    {
        ...
        public static readonly StringName OnBlockTrackingCreatureBlockChanged =
            "OnBlockTrackingCreatureBlockChanged";
    }
    ...
    public void SetCreatureBounds(Control bounds)
    {
        ...
        _nameplateContainer.GlobalPosition = new Vector2(
            bounds.GlobalPosition.X,
            _nameplateContainer.GlobalPosition.Y
        );
        _nameplateContainer.Size = new Vector2(
            bounds.Size.X * bounds.Scale.X,
            _nameplateContainer.Size.Y
        );
    ...
    public void AnimateIn(HealthBarAnimMode mode)
    {
        ...
        _showHideTween
            .TweenProperty(
                ...
                "modulate:a",
                1f,
                (mode == HealthBarAnimMode.FromHidden) ? 0.15 : 1.0
            )
        ...
        _showHideTween
            .TweenProperty(
                ...
                "position",
                _originalPosition,
                (mode == HealthBarAnimMode.FromHidden) ? 0.15 : 0.5
            )
            .SetEase(Tween.EaseType.Out)
    ...
    public void AnimateOut()
    {
        ...
        _showHideTween = CreateTween().SetParallel();
        _showHideTween
            .TweenProperty(this, "modulate:a", 0f, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Sine);
        _showHideTween
            .TweenProperty(this, "position", _healthBarAnimOffset, 0.25)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Quad);
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnBlockTrackingCreatureBlockChanged,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._nameplateContainer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
