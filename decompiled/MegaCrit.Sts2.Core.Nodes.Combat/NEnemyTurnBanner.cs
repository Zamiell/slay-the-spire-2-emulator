...
public class NEnemyTurnBanner : Control
{
    ...
    public static NEnemyTurnBanner? Create()
    {
        ...
        return PreloadManager
            ...
            .Instantiate<NEnemyTurnBanner>(PackedScene.GenEditState.Disabled);
    }
    ...
    private async Task Display()
    {
        ...
        tween
            .TweenProperty(this, "modulate:a", 1f, 1.2999999523162842)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        tween.Chain();
        tween
            .TweenProperty(_label, "modulate", Colors.Red, 1.0)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo)
            .FromCurrent();
        tween
