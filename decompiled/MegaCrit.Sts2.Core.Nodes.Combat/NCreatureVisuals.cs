...
public class NCreatureVisuals : Node2D
{
    ...
    public override void _Ready()
    {
        ...
        if (IsSpineNode)
        {
            ...
            {
                GD.PushWarning(
                    $"Spine skeleton data failed to load for {base.Name}, disabling spine animation."
                );
                SpineBody = null;
            }
        }
    ...
    public void UpdatePhobiaMode(MonsterModel? model)
    {
        ...
        if (SpineBody != null)
        {
            ...
            if (skeleton != null)
            {
                model?.OnPhobiaModeToggled(
                    SaveManager.Instance.PrefsSave.PhobiaMode,
                    SpineBody,
                    skeleton
                );
            }
        ...
        if (!Mathf.IsEqualApprox(hue, 0f) && SpineBody != null)
        {
            ...
            if (normalMaterial == null)
            {
                Material material = (ShaderMaterial)
                    PreloadManager.Cache.GetMaterial("res://materials/vfx/hsv.tres");
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.IsPlayingHurtAnimation,
                new PropertyInfo(
                    Variant.Type.Bool,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.TryApplyLiquidOverlay,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName.IsUsingPhobiaModeBody,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName._liquidOverlayTimer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._savedNormalMaterial,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._currentLiquidOverlayMaterial,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._currentLiquidOverlayMaterial,
            Variant.From(in _currentLiquidOverlayMaterial)
        );
    }
