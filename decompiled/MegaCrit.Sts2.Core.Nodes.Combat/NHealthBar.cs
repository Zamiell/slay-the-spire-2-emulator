...
public class NHealthBar : Control
{
    ...
    public void UpdateLayoutForCreatureBounds(Control bounds)
    {
        ...
        HpBarContainer.GlobalPosition = new Vector2(
            bounds.GlobalPosition.X - valueOrDefault * 0.5f,
        ...
        _blockContainer.GlobalPosition = new Vector2(
            bounds.GlobalPosition.X - num,
            _blockContainer.GlobalPosition.Y
        );
        _originalBlockPosition = _blockContainer.Position;
    }
    ...
    private void SetHpBarContainerSizeWithOffsetsImmediately(Vector2 size)
    {
        if (!HpBarContainer.Size.IsEqualApprox(size))
        {
            ...
            _hpForeground.OffsetRight =
                GetFgWidth(_creature.CurrentHp, _expectedMaxFgWidth) - _expectedMaxFgWidth;
            _hpMiddleground.OffsetRight = _hpForeground.OffsetRight - 2f;
        }
    }
    ...
    private void RefreshMiddleground()
    {
        ...
        if (currentHp != _currentHpOnLastRefresh || maxHp != _maxHpOnLastRefresh)
        {
            ...
            float num = (
                _poisonForeground.Visible
                    ? _poisonForeground.OffsetRight
                    : _hpForeground.OffsetRight
            );
            ...
            _middlegroundTween
                .TweenProperty(_hpMiddleground, "offset_right", num - 2f, 1.0)
                .SetDelay(flag ? 0.0 : 1.0)
            ...
            if (blockTrackingCreature == null || blockTrackingCreature.Block <= 0)
            {
                if (_blockContainer.Visible)
                {
                    ...
                    if (nBlockBrokenVfx != null)
                    {
                        ...
                        nBlockBrokenVfx.GlobalPosition =
                            _blockContainer.GlobalPosition + _blockContainer.Size * 0.5f;
                    }
                }
    ...
    private void RefreshText()
    {
        if (_creature.CurrentHp <= 0)
        {
            ...
            _hpLabel.AddThemeColorOverride(
                ThemeConstants.Label.FontOutlineColor,
                _defaultFontOutlineColor
            );
            _hpLabel.SetTextAutoSize(_healthBarDead.GetRawText());
            return;
        }
        _doomForeground.Modulate = (
            _creature.HpDisplay.IsInfinite() ? Colors.Transparent : Colors.White
        );
    ...
    public void FadeOutHpLabel(float duration, float finalAlpha)
    {
        ...
        _hpLabelFadeTween
            .TweenProperty(_hpLabel, "modulate:a", finalAlpha, duration)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
    }
    ...
    public void AnimateInBlock(int oldBlock, int blockGain)
    {
        if (oldBlock == 0 && blockGain != 0)
        {
            ...
            if (SaveManager.Instance.PrefsSave.FastMode != FastModeType.Instant)
            {
                ...
                _blockTween
                    .TweenProperty(_blockContainer, "modulate:a", 1f, 0.5)
                    .SetEase(Tween.EaseType.Out)
                    .SetTrans(Tween.TransitionType.Sine);
                _blockTween
                    .TweenProperty(_blockContainer, "position", _originalBlockPosition, 0.5)
                    .SetEase(Tween.EaseType.Out)
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.DebugToggleVisibility,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.UpdateLayoutForCreatureBounds,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.UpdateWidthRelativeToReferenceValue,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.SetHpBarContainerSizeWithOffsets,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.SetHpBarContainerSizeWithOffsetsImmediately,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.RefreshMiddleground,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    )
    {
        ...
        {
            SetHpBarContainerSizeWithOffsetsImmediately(
                VariantUtils.ConvertTo<Vector2>(in args[0])
            );
            ret = default(godot_variant);
            return true;
        }
        ...
        if (method == MethodName.IsPoisonLethal && args.Count == 1)
        {
            ret = VariantUtils.CreateFrom<bool>(
                IsPoisonLethal(VariantUtils.ConvertTo<int>(in args[0]))
            );
            return true;
        }
        ...
        if (method == MethodName.GetFgWidth && args.Count == 1)
        {
            ret = VariantUtils.CreateFrom<float>(
                GetFgWidth(VariantUtils.ConvertTo<int>(in args[0]))
            );
            return true;
        }
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._hpForegroundContainer,
                PropertyHint.None,
                "",
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._poisonForeground,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._hpLabelFadeTween,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._middlegroundTween,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Vector2,
                PropertyName._originalBlockPosition,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Int,
                PropertyName._currentHpOnLastRefresh,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Int,
                PropertyName._maxHpOnLastRefresh,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName._expectedMaxFgWidth,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._hpForegroundContainer,
            Variant.From(in _hpForegroundContainer)
        );
        ...
        info.AddProperty(
            PropertyName._originalBlockPosition,
            Variant.From(in _originalBlockPosition)
        );
        info.AddProperty(
            PropertyName._currentHpOnLastRefresh,
            Variant.From(in _currentHpOnLastRefresh)
        );
