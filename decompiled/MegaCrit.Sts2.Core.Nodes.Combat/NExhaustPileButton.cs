...
public class NExhaustPileButton : NCombatCardPile
{
    public new class MethodName : NCombatCardPile.MethodName
    {
        ...
        public static new readonly StringName AddCard = "AddCard";

        public static new readonly StringName SetAnimInOutPositions = "SetAnimInOutPositions";

        public static new readonly StringName AnimIn = "AnimIn";
    }
    ...
    public new class PropertyName : NCombatCardPile.PropertyName
    {
        ...
        public static new readonly StringName Pile = "Pile";
    ...
    public override void _Ready()
    {
        ...
        GetTree()
            .Root.Connect(Viewport.SignalName.SizeChanged, Callable.From(SetAnimInOutPositions));
