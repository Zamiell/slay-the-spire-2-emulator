...
public class NCombatUi : Control
{
    ...
    private readonly Dictionary<NCard, Vector2> _originalPlayContainerCardPositions =
        new Dictionary<NCard, Vector2>();

    private readonly Dictionary<NCard, Vector2> _originalPlayContainerCardScales =
        new Dictionary<NCard, Vector2>();
    ...
    public override void _Ready()
    {
        ...
        MessyCardPreviewContainer = GetNode<NMessyCardPreviewContainer>(
    ...
    private async Task ShowRewards(CombatRoom room)
    {
        ...
        {
            if (
                removingCreatureNode != null
                && removingCreatureNode.HasSpineAnimation
                && removingCreatureNode.IsPlayingDeathAnimation
            )
            {
    ...
    private void OnPeekButtonToggled(NPeekButton peekButton)
    {
        ...
        if (peekButton.IsPeeking)
        {
            ...
            foreach (NCard playContainerCard in PlayContainerCards)
            {
                ...
                _playContainerPeekModeTween
                    .TweenProperty(playContainerCard, "global_position", globalPosition, 0.25)
                    .SetEase(Tween.EaseType.Out)
                    .SetTrans(Tween.TransitionType.Cubic);
                _playContainerPeekModeTween
                    .Parallel()
                    .TweenProperty(playContainerCard, "scale", vector, 0.25)
                    .SetEase(Tween.EaseType.Out)
                    .SetTrans(Tween.TransitionType.Cubic);
            }
        }
        else
        {
            ...
            foreach (NCard playContainerCard2 in PlayContainerCards)
            {
                Vector2 value;
                Vector2 vector2 = (
                    _originalPlayContainerCardPositions.TryGetValue(playContainerCard2, out value)
                        ? value
                        : (size * 0.5f)
                );
                Vector2 value2;
                Vector2 vector3 = (
                    _originalPlayContainerCardScales.TryGetValue(playContainerCard2, out value2)
                        ? value2
                        : Vector2.One
                );
                if (_playContainerPeekModeTween == null)
                ...
                _playContainerPeekModeTween
                    .TweenProperty(playContainerCard2, "position", vector2, 0.25)
                    .SetEase(Tween.EaseType.Out)
                    .SetTrans(Tween.TransitionType.Cubic);
                _playContainerPeekModeTween
                    .Parallel()
                    .TweenProperty(playContainerCard2, "scale", vector3, 0.25)
                    .SetEase(Tween.EaseType.Out)
                    .SetTrans(Tween.TransitionType.Cubic);
            }
    ...
    public override void _Input(InputEvent inputEvent)
    {
        if (inputEvent.IsActionReleased(DebugHotkey.hideIntents))
        {
            ...
            NGame.Instance.AddChildSafely(
                NFullscreenTextVfx.Create(IsDebugHidingIntent ? "Hide Intents" : "Show Intents")
            );
        ...
        if (inputEvent.IsActionReleased(DebugHotkey.hideCombatUi))
        {
            ...
            NGame.Instance.AddChildSafely(
                NFullscreenTextVfx.Create(_isDebugHidden ? "Hide Combat UI" : "Show Combat UI")
            );
            DebugHideCombatUi();
        }
        else if (inputEvent.IsActionReleased(DebugHotkey.hidePlayContainer))
        {
            ...
            NGame.Instance.AddChildSafely(
                NFullscreenTextVfx.Create(
                    IsDebugHidingPlayContainer ? "Hide Played Card" : "Show Played Card"
                )
            );
            DebugHideCombatUi();
        }
        else if (inputEvent.IsActionReleased(DebugHotkey.hideHand))
        {
            ...
            NGame.Instance.AddChildSafely(
                NFullscreenTextVfx.Create(
                    _isDebugHidingHand ? "Hide Hand Cards" : "Show Hand Cards"
                )
            );
            DebugHideCombatUi();
        }
        else if (inputEvent.IsActionReleased(DebugHotkey.hideHpBars))
        {
            ...
            NGame.Instance.AddChildSafely(
                NFullscreenTextVfx.Create(IsDebugHidingHpBar ? "Hide HP Bars" : "Show HP Bars")
            );
        ...
        else if (inputEvent.IsActionReleased(DebugHotkey.hideTextVfx))
        {
            ...
            NGame.Instance.AddChildSafely(
                NFullscreenTextVfx.Create(IsDebugHideTextVfx ? "Hide Text Vfx" : "Show Text Vfx")
            );
        }
        else if (inputEvent.IsActionReleased(DebugHotkey.hideTargetingUi))
        {
            ...
            NGame.Instance.AddChildSafely(
                NFullscreenTextVfx.Create(
                    IsDebugHideTargetingUi ? "Hide Targeting UI" : "Show Targeting UI"
                )
            );
        }
        else if (inputEvent.IsActionReleased(DebugHotkey.slowRewards))
        {
            ...
            NGame.Instance.AddChildSafely(
                NFullscreenTextVfx.Create(
                    _isDebugSlowRewards ? "Slow Rewards Screens" : "Normal Rewards Screen"
                )
            );
        }
        else if (inputEvent.IsActionReleased(DebugHotkey.hideMpTargeting))
        {
            ...
            NGame.Instance.AddChildSafely(
                NFullscreenTextVfx.Create(
                    IsDebugHideMpTargetingUi ? "Hide MP Targeting" : "Show MP Targeting"
                )
            );
        }
        else if (inputEvent.IsActionReleased(DebugHotkey.hideMpIntents))
        {
            ...
            NGame.Instance.AddChildSafely(
                NFullscreenTextVfx.Create(
                    IsDebugHideMpIntents ? "Hide MP Intents" : "Show MP Intents"
                )
            );
        }
    }
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnHandSelectModeEntered,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnHandSelectModeExited,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    )
    {
        ...
        {
            MessyCardPreviewContainer = VariantUtils.ConvertTo<NMessyCardPreviewContainer>(
                in value
            );
            return true;
        }
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName.EnergyCounterContainer,
                PropertyHint.None,
                "",
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._combatPilesContainer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName.CardPreviewContainer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName.MessyCardPreviewContainer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._playContainerPeekModeTween,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Int,
                PropertyName._originalHandChildIndex,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName.EnergyCounterContainer,
            Variant.From<Control>(EnergyCounterContainer)
        );
        ...
        info.AddProperty(
            PropertyName.CardPreviewContainer,
            Variant.From<Control>(CardPreviewContainer)
        );
        info.AddProperty(
            PropertyName.MessyCardPreviewContainer,
            Variant.From<NMessyCardPreviewContainer>(MessyCardPreviewContainer)
        );
        ...
        info.AddProperty(
            PropertyName._combatPilesContainer,
            Variant.From(in _combatPilesContainer)
        );
        info.AddProperty(
            PropertyName._playContainerPeekModeTween,
            Variant.From(in _playContainerPeekModeTween)
        );
        info.AddProperty(
            PropertyName._originalHandChildIndex,
            Variant.From(in _originalHandChildIndex)
        );
    }
