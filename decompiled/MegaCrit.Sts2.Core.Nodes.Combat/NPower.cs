...
public class NPower : Control
{
    ...
    public PowerModel Model
    {
        ...
        {
            return _model
                ?? throw new InvalidOperationException("Model was accessed before it was set.");
        }
        set
        {
            if (_model != null)
    ...
    {
        NPower nPower = PreloadManager
            .Cache.GetScene(ScenePath)
            .Instantiate<NPower>(PackedScene.GenEditState.Disabled);
        nPower.Model = power;
        return nPower;
    }
    ...
    public override void _Ready()
    {
        ...
        _animInTween
            .TweenProperty(_icon, "position:y", 0f, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Back)
            .From(-24f);
        _animInTween
            .TweenProperty(this, "modulate:a", 1f, 0.5)
            .SetEase(Tween.EaseType.Out)
    ...
    private void RefreshAmount()
    {
        if (_model != null)
        {
            ...
            _amountLabel.SetTextAutoSize(
                (Model.StackType == PowerStackType.Counter)
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.SubscribeToModelEvents,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.UnsubscribeFromModelEvents,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
