...
public sealed class SovereignBlade : CardModel
{
    ...
    {
        get { return _createdThroughForge; }
        set
        {
            AssertMutable();
        ...
        new global::_003C_003Ez__ReadOnlyArray<DynamicVar>(
            new DynamicVar[5]
            {
                ...
                new CalculatedBlockVar(ValueProp.Move).WithMultiplier(
                    (CardModel card, Creature? _) => GetOwnerParryAmount(card)
                ),
                new RepeatVar(1),
            }
        );
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        float delay = (
            (base.Owner.Character is Regent) ? 0.25f : base.Owner.Character.CastAnimDelay
        );
        AttackCommand attackCommand = DamageCmd
            ...
            attackCommand = attackCommand
                ...
                .BeforeDamage(
                    delegate
                    {
                        ...
                        NCreature nCreature = NCombatRoom.Instance?.GetCreatureNode(
                            hittableEnemies[0]
                        );
    ...
    )
    {
        ...
        if (
            (!CreatedThroughForge && oldPileType == PileType.None)
    ...
    public static NSovereignBladeVfx? GetVfxNode(Player player, CardModel card)
    {
        ...
        return (NCombatRoom.Instance?.GetCreatureNode(player.Creature))
            ...
            .FirstOrDefault((NSovereignBladeVfx b) => b.Card == originalCard);
    }
