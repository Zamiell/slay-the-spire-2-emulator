...
public sealed class NoEscape : CardModel
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars =>
        new global::_003C_003Ez__ReadOnlyArray<DynamicVar>(
            new DynamicVar[4]
            {
                ...
                new CalculatedVar("CalculatedDoom").WithMultiplier(
                    delegate(CardModel card, Creature? target)
                    {
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await PowerCmd.Apply<DoomPower>(
            choiceContext,
            cardPlay.Target,
            ((CalculatedVar)base.DynamicVars["CalculatedDoom"]).Calculate(cardPlay.Target),
            base.Owner.Creature,
            this
        );
    }
