...
public sealed class ConsumingShadow : CardModel
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars =>
        new global::_003C_003Ez__ReadOnlyArray<DynamicVar>(
            new DynamicVar[2] { new RepeatVar(2), new PowerVar<ConsumingShadowPower>(1m) }
        );
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await PowerCmd.Apply<ConsumingShadowPower>(
            choiceContext,
            base.Owner.Creature,
            base.DynamicVars["ConsumingShadowPower"].BaseValue,
            base.Owner.Creature,
            this
        );
    }
