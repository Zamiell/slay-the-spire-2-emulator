...
public sealed class SpoilsMap : CardModel
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars =>
        new global::_003C_003Ez__ReadOnlySingleElementList<DynamicVar>(new GoldVar(600));
    ...
    public override ActMap ModifyGeneratedMapLate(IRunState runState, ActMap map, int actIndex)
    {
        ...
        MapPoint mapPoint = map.GetAllMapPoints()
            .FirstOrDefault((MapPoint p) => p.PointType == MapPointType.Treasure);
        if (mapPoint != null)
        {
