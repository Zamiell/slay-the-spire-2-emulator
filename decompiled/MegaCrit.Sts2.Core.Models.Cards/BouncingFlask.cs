...
public sealed class BouncingFlask : CardModel
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars =>
        new global::_003C_003Ez__ReadOnlyArray<DynamicVar>(
            new DynamicVar[2] { new PowerVar<PoisonPower>(3m), new RepeatVar(3) }
        );
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        {
            Creature enemy = base.Owner.RunState.Rng.CombatTargets.NextItem(
            ...
            if (TestMode.IsOff)
            {
                ...
                {
                    lastPos = NCombatRoom
                        .Instance.GetCreatureNode(base.Owner.Creature)
                        .VfxSpawnPosition;
                }
                ...
                if (targetNode != null)
                {
                    ...
                    NGaseousImpactVfx child4 = NGaseousImpactVfx.Create(
