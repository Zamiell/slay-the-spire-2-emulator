...
public sealed class Synchronize : CardModel
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars =>
        new global::_003C_003Ez__ReadOnlyArray<DynamicVar>(
            new DynamicVar[3]
            {
                ...
                new CalculatedVar("CalculatedFocus").WithMultiplier(
                    (CardModel card, Creature? _) =>
                        (
                            from orb in card.Owner.PlayerCombatState.OrbQueue.Orbs
                            group orb by orb.Id
                        ).Count()
                ),
            }
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await PowerCmd.Apply<SynchronizePower>(
            choiceContext,
            base.Owner.Creature,
            ((CalculatedVar)base.DynamicVars["CalculatedFocus"]).Calculate(cardPlay.Target),
            base.Owner.Creature,
            this
        );
    }
