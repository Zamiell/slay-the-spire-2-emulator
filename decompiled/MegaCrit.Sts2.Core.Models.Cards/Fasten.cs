...
public sealed class Fasten : CardModel
{
        ...
        get
        {
            ...
            if (base.IsMutable && base.Owner != null)
            {
                cardModel = base
                    ...
                    .First((CardModel c) => c.Tags.Contains(CardTag.Defend));
            }
            if (cardModel == null)
            {
                cardModel = ModelDb.Card<DefendIronclad>();
            }
            return new global::_003C_003Ez__ReadOnlyArray<IHoverTip>(
                new IHoverTip[2]
                {
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        await PowerCmd.Apply<FastenPower>(
            choiceContext,
            base.Owner.Creature,
            base.DynamicVars["ExtraBlock"].BaseValue,
            base.Owner.Creature,
            this
        );
    }
