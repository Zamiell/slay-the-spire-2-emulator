...
public class NPotionLab : NSubmenu
{
    ...
    public static string[] AssetPaths =>
        new string[3] { _scenePath, NLabPotionHolder.scenePath, NLabPotionHolder.lockedIconPath };
    ...
    public static NPotionLab? Create()
    {
        ...
        return PreloadManager
            ...
            .Instantiate<NPotionLab>(PackedScene.GenEditState.Disabled);
    }
    ...
    private async Task LoadPotions()
    {
        ...
        HashSet<PotionModel> seenPotions = SaveManager
            .Instance.Progress.DiscoveredPotions.Select(ModelDb.GetByIdOrNull<PotionModel>)
            .OfType<PotionModel>()
            .ToHashSet();
        _common.LoadPotions(
            PotionRarity.Common,
            new LocString("potion_lab", "COMMON"),
            seenPotions,
            unlockState,
            allUnlockedPotions
        );
        _uncommon.LoadPotions(
            PotionRarity.Uncommon,
            new LocString("potion_lab", "UNCOMMON"),
            seenPotions,
            unlockState,
            allUnlockedPotions
        );
        _rare.LoadPotions(
            PotionRarity.Rare,
            new LocString("potion_lab", "RARE"),
            seenPotions,
            unlockState,
            allUnlockedPotions
        );
        _special.LoadPotions(
            PotionRarity.Event,
            new LocString("potion_lab", "SPECIAL"),
            seenPotions,
            unlockState,
            allUnlockedPotions,
            PotionRarity.Token
