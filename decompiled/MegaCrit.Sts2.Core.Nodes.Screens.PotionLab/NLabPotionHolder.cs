...
public class NLabPotionHolder : Control
{
    ...
    public static readonly string scenePath = SceneHelper.GetScenePath(
        "screens/potion_lab/lab_potion_holder"
    );
    ...
    private LocString UnknownHoverTipTitle =>
        new LocString("main_menu_ui", "POTION_LAB_COLLECTION.unknown.title");

    private LocString UnknownHoverTipDescription =>
        new LocString("main_menu_ui", "POTION_LAB_COLLECTION.unknown.description");
    ...
    private static LocString LockedHoverTipTitle =>
        new LocString("main_menu_ui", "POTION_LAB_COLLECTION.locked.title");

    private static LocString LockedHoverTipDescription =>
        new LocString("main_menu_ui", "POTION_LAB_COLLECTION.locked.description");
    ...
    {
        NLabPotionHolder nLabPotionHolder = PreloadManager
            .Cache.GetScene(scenePath)
            .Instantiate<NLabPotionHolder>(PackedScene.GenEditState.Disabled);
    ...
    public override void _Ready()
    {
        ...
        else
        {
            ...
            {
                PotionModel potionModel = allCharacterPotionPool.AllPotions.FirstOrDefault(
                    (PotionModel p) => p.Id == _model.Id
                );
                if (potionModel != null)
                {
    ...
    private void OnFocus()
    {
        ...
        NHoverTipSet nHoverTipSet = NHoverTipSet.CreateAndShow(
            this,
            hoverTips,
    ...
    private void OnUnfocus()
    {
        ...
        _hoverTween = CreateTween();
        _hoverTween
            .TweenProperty(_potionNode, "scale", Vector2.One, 0.5)
