...
public class NDecimillipedeSegmentDriver : Node2D
{
    ...
    public override void _Process(double delta)
    {
        ...
        Vector2 vector =
            new Vector2(_noise.GetNoise1D(num), _noise.GetNoise1D(num + 0.25f)) * _magnitude;
    ...
    public void AttackShake()
    {
        ...
        _attackTween
            .TweenProperty(this, "_decimillipedeStrikeOffset", Vector2.Left * 100f, 0.4)
            .SetEase(Tween.EaseType.InOut)
            .SetTrans(Tween.TransitionType.Sine);
        _attackTween
            .TweenProperty(
                this,
                "_decimillipedeStrikeOffset",
                Vector2.Right * 100f,
                0.10000000149011612
            )
            .SetEase(Tween.EaseType.InOut)
            .SetTrans(Tween.TransitionType.Sine);
        _attackTween
            .TweenProperty(this, "_decimillipedeStrikeOffset", Vector2.Zero, 0.75)
            .SetEase(Tween.EaseType.InOut)
            .SetTrans(Tween.TransitionType.Sine);
    }
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Vector2,
                PropertyName._decimillipedeStrikeOffset,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._decimillipedeStrikeOffset,
            Variant.From(in _decimillipedeStrikeOffset)
        );
