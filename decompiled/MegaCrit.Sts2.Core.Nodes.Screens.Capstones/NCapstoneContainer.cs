...
public class NCapstoneContainer : Control
{
    ...
    public event CapstoneClosedEventHandler CapstoneClosed
    {
        add
        {
            backing_CapstoneClosed = (CapstoneClosedEventHandler)
                Delegate.Combine(backing_CapstoneClosed, value);
        }
        remove
        {
            backing_CapstoneClosed = (CapstoneClosedEventHandler)
                Delegate.Remove(backing_CapstoneClosed, value);
        }
    }
    ...
    protected override void RestoreGodotObjectData(GodotSerializationInfo info)
    {
        ...
        if (
            info.TryGetSignalEventDelegate<CapstoneClosedEventHandler>(
                SignalName.CapstoneClosed,
                out var value4
            )
        )
        {
