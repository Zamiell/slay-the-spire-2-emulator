...
{
    private static readonly string _trialMerchantVfx = SceneHelper.GetScenePath(
        "vfx/events/trial_merchant_vfx"
    );

    private static readonly string _trialNobleVfx = SceneHelper.GetScenePath(
        "vfx/events/trial_noble_vfx"
    );

    private static readonly string _trialNondescriptVfx = SceneHelper.GetScenePath(
        "vfx/events/trial_nondescript_vfx"
    );
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars =>
        new global::_003C_003Ez__ReadOnlySingleElementList<DynamicVar>(
            new DynamicVar("EntrantNumber", -1m)
        );
            ...
            case 2:
                ...
                eventOptions = new EventOption[2]
                {
                    ...
                    new EventOption(
                        ...
                        HoverTipFactory
                            .FromCardWithCardHoverTips<Doubt>()
                            .Concat(
    ...
    private Task Reject()
    {
        EventOption[] eventOptions = new EventOption[2]
        {
            ...
            new EventOption(
                ...
                false,
                true
            ).ThatWillKillPlayerIf((Player _) => true),
        };
    ...
    private async Task NondescriptInnocent()
    {
        ...
        {
            await CardCmd.TransformToRandom(
                item,
    ...
    public override void CalculateVars()
    {
        ...
        {
            base.DynamicVars["EntrantNumber"].BaseValue =
