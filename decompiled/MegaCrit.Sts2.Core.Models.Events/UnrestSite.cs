...
public sealed class UnrestSite : EventModel
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars =>
        new global::_003C_003Ez__ReadOnlyArray<DynamicVar>(
            new DynamicVar[2] { new HealVar(0m), new DynamicVar("MaxHpLoss", 8m) }
        );

    public override bool IsAllowed(IRunState runState)
    {
        return runState.Players.All(
            (Player p) => (decimal)p.Creature.CurrentHp <= (decimal)p.Creature.MaxHp * 0.70m
        );
    }
    ...
    protected override IReadOnlyList<EventOption> GenerateInitialOptions()
    {
        return new global::_003C_003Ez__ReadOnlyArray<EventOption>(
            new EventOption[2]
            {
                ...
                ).ThatDecreasesMaxHp(base.DynamicVars["MaxHpLoss"].BaseValue),
            }
        );
    }
    ...
    private async Task Rest()
    {
        ...
        await CardPileCmd.AddCursesToDeck(
            new global::_003C_003Ez__ReadOnlySingleElementList<CardModel>(
    ...
    private async Task Kill()
    {
        await CreatureCmd.LoseMaxHp(
            ...
            base.Owner.Creature,
            base.DynamicVars["MaxHpLoss"].BaseValue,
            isFromCard: false
        );
