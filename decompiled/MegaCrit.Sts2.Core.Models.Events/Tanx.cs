...
public class Tanx : AncientEventModel
{
    ...
    public override IEnumerable<EventOption> AllPossibleOptions =>
        BaseOptionPool.Append(TriBoomerangOption);
        ...
        >
        {
            [AncientEventModel.CharKey<Ironclad>()] =
                new global::_003C_003Ez__ReadOnlyArray<AncientDialogue>(
                    ...
                    {
                        new AncientDialogue("event:/sfx/npcs/tanx/tanx_roar") { VisitIndex = 0 },
                        new AncientDialogue("event:/sfx/npcs/tanx/tanx_laugh") { VisitIndex = 1 },
                        new AncientDialogue(
            ...
            [AncientEventModel.CharKey<Necrobinder>()] =
                new global::_003C_003Ez__ReadOnlyArray<AncientDialogue>(
                    new AncientDialogue[3]
                    {
                        ...
                        new AncientDialogue("event:/sfx/npcs/tanx/tanx_roar") { VisitIndex = 1 },
                        new AncientDialogue(
                            "event:/sfx/npcs/tanx/tanx_roar",
                            "",
                            "event:/sfx/npcs/tanx/tanx_laugh"
    ...
    protected override IReadOnlyList<EventOption> GenerateInitialOptions()
    {
        ...
        if (
            base.Owner.Deck.Cards.Count(
                (CardModel c) => ModelDb.Enchantment<Instinct>().CanEnchant(c)
            ) >= 3
        )
        {
