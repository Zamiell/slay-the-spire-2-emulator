...
{
    private const string _cursedChoiceDoneDescriptionOverride =
        "NEOW.pages.DONE.CURSED.description";

    private const string _positiveChoiceDoneDescriptionOverride =
    ...
    private IEnumerable<EventOption> PositiveOptions =>
        new global::_003C_003Ez__ReadOnlyArray<EventOption>(
            new EventOption[14]
            {
    ...
    private EventOption LavaRockOption =>
        RelicOption<LavaRock>("INITIAL", "NEOW.pages.DONE.POSITIVE.description");

    private EventOption NeowsTalismanOption =>
        RelicOption<NeowsTalisman>("INITIAL", "NEOW.pages.DONE.POSITIVE.description");

    private EventOption NutritiousOysterOption =>
        RelicOption<NutritiousOyster>("INITIAL", "NEOW.pages.DONE.POSITIVE.description");
    ...
    private EventOption SmallCapsuleOption =>
        RelicOption<SmallCapsule>("INITIAL", "NEOW.pages.DONE.POSITIVE.description");

    private EventOption StoneHumidifierOption =>
        RelicOption<StoneHumidifier>("INITIAL", "NEOW.pages.DONE.POSITIVE.description");
    ...
    protected override AncientDialogueSet DefineDialogues()
    {
        ...
        >
        {
            [AncientEventModel.CharKey<Ironclad>()] =
                new global::_003C_003Ez__ReadOnlyArray<AncientDialogue>(
                    new AncientDialogue[3]
                    {
                        new AncientDialogue("event:/sfx/npcs/neow/neow_welcome") { VisitIndex = 0 },
                        new AncientDialogue("event:/sfx/npcs/neow/neow_curious") { VisitIndex = 1 },
                        new AncientDialogue(
            ...
            [AncientEventModel.CharKey<Silent>()] =
                new global::_003C_003Ez__ReadOnlyArray<AncientDialogue>(
                    new AncientDialogue[3]
                    {
                        new AncientDialogue("event:/sfx/npcs/neow/neow_curious") { VisitIndex = 0 },
                        new AncientDialogue("event:/sfx/npcs/neow/neow_sleepy") { VisitIndex = 1 },
            ...
            [AncientEventModel.CharKey<Defect>()] =
                new global::_003C_003Ez__ReadOnlyArray<AncientDialogue>(
                    new AncientDialogue[3]
                    {
                        new AncientDialogue("event:/sfx/npcs/neow/neow_curious") { VisitIndex = 0 },
            ...
            [AncientEventModel.CharKey<Necrobinder>()] =
                new global::_003C_003Ez__ReadOnlyArray<AncientDialogue>(
                    new AncientDialogue[3]
                    {
                        new AncientDialogue(
            ...
            [AncientEventModel.CharKey<Regent>()] =
                new global::_003C_003Ez__ReadOnlyArray<AncientDialogue>(
                    new AncientDialogue[3]
                    {
                        new AncientDialogue("", "event:/sfx/npcs/neow/neow_sleepy")
        ...
        ancientDialogueSet.AgnosticDialogues =
            new global::_003C_003Ez__ReadOnlyArray<AncientDialogue>(
                new AncientDialogue[5]
                {
