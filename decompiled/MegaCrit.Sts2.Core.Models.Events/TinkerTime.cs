...
public sealed class TinkerTime : EventModel
{
    ...
    {
        IEnumerable<EventOption> collection = new global::_003C_003Ez__ReadOnlyArray<EventOption>(
            new EventOption[3]
            {
                new EventOption(
                    this,
        ...
        SetEventState(
            L10NLookup("TINKER_TIME.pages.CHOOSE_CARD_TYPE.description"),
            collection.TakeRandom(2, base.Rng)
        );
    ...
    {
        List<RiderEffect> riders = (
            ChosenCardType switch
            {
                CardType.Attack => new global::_003C_003Ez__ReadOnlyArray<RiderEffect>(
                    new RiderEffect[3]
                    {
                        RiderEffect.Sapping,
                ...
                CardType.Skill => new global::_003C_003Ez__ReadOnlyArray<RiderEffect>(
                    new RiderEffect[3]
                    {
                ...
                CardType.Power => new global::_003C_003Ez__ReadOnlyArray<RiderEffect>(
                    new RiderEffect[3]
                    {
            ...
            .TakeRandom(2, base.Rng)
            .ToList();
        SetEventState(
            L10NLookup("TINKER_TIME.pages.CHOOSE_RIDER.description"),
            new global::_003C_003Ez__ReadOnlyArray<EventOption>(
                new EventOption[2]
                {
                    new EventOption(
                        this,
                        () => RiderChosen(riders[0]),
                        GetRiderLocKey(riders[0]),
                        GetRiderHoverTip(riders[0])
                    ),
                    new EventOption(
                        this,
                        () => RiderChosen(riders[1]),
                        GetRiderLocKey(riders[1]),
    ...
    private static string GetRiderLocKey(RiderEffect rider)
    {
        return rider switch
        {
            RiderEffect.None => throw new ArgumentOutOfRangeException(
                "rider",
                rider,
