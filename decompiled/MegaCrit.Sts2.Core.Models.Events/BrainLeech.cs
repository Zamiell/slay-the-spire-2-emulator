...
public sealed class BrainLeech : EventModel
{
    ...
    protected override IReadOnlyList<EventOption> GenerateInitialOptions()
    {
        return new global::_003C_003Ez__ReadOnlyArray<EventOption>(
            new EventOption[2]
            {
                ...
                new EventOption(this, Rip, "BRAIN_LEECH.pages.INITIAL.options.RIP").ThatDoesDamage(
                    base.DynamicVars["RipHpLoss"].BaseValue
                ),
            }
        );
    }
    ...
    private async Task Rip()
    {
        await CreatureCmd.Damage(
            ...
            base.Owner.Creature,
            (DamageVar)base.DynamicVars["RipHpLoss"],
            null,
            null
        );
    ...
    private async Task ShareKnowledge()
    {
        ...
        List<CardCreationResult> cards = CardFactory
            .CreateForReward(
                owner,
                base.DynamicVars["FromCardChoiceCount"].IntValue,
        ...
        CardSelectorPrefs cardSelectorPrefs = new CardSelectorPrefs(
            L10NLookup("BRAIN_LEECH.pages.SHARE_KNOWLEDGE.selectionScreenPrompt"),
            1
        );
