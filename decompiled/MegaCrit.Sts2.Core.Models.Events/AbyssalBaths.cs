...
public sealed class AbyssalBaths : EventModel
{
        ...
        return new global::_003C_003Ez__ReadOnlyArray<EventOption>(
            new EventOption[2]
            {
                new EventOption(
                    ...
                    (decimal)base.DynamicVars.Damage.IntValue - base.DynamicVars.MaxHp.BaseValue
                ),
    ...
    private async Task Immerse()
    {
        await OnImmerse();
        SetEventState(
            L10NLookup("ABYSSAL_BATHS.pages.IMMERSE.description"),
    ...
    private async Task Linger()
    {
        ...
        {
            SetEventState(
                L10NLookup("ABYSSAL_BATHS.pages.DEATH_WARNING.description"),
                new global::_003C_003Ez__ReadOnlyArray<EventOption>(
                    new EventOption[2]
                    {
                        new EventOption(
        ...
        SetEventState(
            L10NLookup($"ABYSSAL_BATHS.pages.LINGER{LingerCount}.description"),
            new global::_003C_003Ez__ReadOnlyArray<EventOption>(
                new EventOption[2]
                {
                    new EventOption(
