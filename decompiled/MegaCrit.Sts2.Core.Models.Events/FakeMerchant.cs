...
public sealed class FakeMerchant : EventModel
{
    ...
    protected override Task BeforeEventStarted(bool isPreFinished)
    {
        ...
        List<RelicModel> list = _inventoryRelics
            .ToList()
    ...
    public async Task FoulPotionThrown(FoulPotion potion)
    {
        ...
        foreach (Player player in base.Owner.RunState.Players)
        {
            ...
            FakeMerchant fakeMerchant = (FakeMerchant)
                RunManager.Instance.EventSynchronizer.GetEventForPlayer(player);
        ...
        EnterCombatWithoutExitingEvent<FakeMerchantEventEncounter>(
            list,
