...
public sealed class TheFutureOfPotions : EventModel
{
    ...
    private LocString ChoiceTitle =>
        new LocString("events", "THE_FUTURE_OF_POTIONS.pages.INITIAL.options.POTION.title");

    private LocString ChoiceDescription =>
        new LocString("events", "THE_FUTURE_OF_POTIONS.pages.INITIAL.options.POTION.description");
    ...
    public override IEnumerable<LocString> GameInfoOptions
    {
        get
        {
            ...
            LocString locString2 = list.First(
    ...
    protected override IReadOnlyList<EventOption> GenerateInitialOptions()
    {
        ...
        for (int i = 0; i < num; i++)
        {
            ...
            choiceDescription.Add(
                "Type",
                PotionToCardType[potion].ToLocString().GetFormattedText()
            );
            list.Add(
                new EventOption(
                    this,
