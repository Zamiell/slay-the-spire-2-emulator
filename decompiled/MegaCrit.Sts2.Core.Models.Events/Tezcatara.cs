...
public class Tezcatara : AncientEventModel
{
    public override IEnumerable<CharacterModel> AnyCharacterDialogueBlacklist =>
        new global::_003C_003Ez__ReadOnlySingleElementList<CharacterModel>(
    ...
    public override IEnumerable<EventOption> AllPossibleOptions
    {
        get
        {
            List<EventOption>[] obj = new List<EventOption>[4]
            {
                OptionPool1,
                OptionPool2,
                OptionPool3,
    ...
    protected override IReadOnlyList<EventOption> GenerateInitialOptions()
    {
        ...
        if (
            base.Owner.Deck.Cards.Any(
                (CardModel c) => c.Tags.Contains(CardTag.Strike) && c.Rarity == CardRarity.Basic
            )
        )
        {
        ...
        return new global::_003C_003Ez__ReadOnlyArray<EventOption>(
            new EventOption[3] { eventOption, eventOption2, eventOption3 }
        );
    }
}
