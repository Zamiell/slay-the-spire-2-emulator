...
public class Orobas : AncientEventModel
{
    ...
    private IEnumerable<EventOption> OptionPool3
    {
        get
        {
            ...
            {
                list.Add(
                    new EventOption(this, null, "OROBAS.pages.INITIAL.options.OPTION_POOL_3_LOCKED")
                );
            }
            return list;
        }
    ...
    protected override AncientDialogueSet DefineDialogues()
    {
        ...
        ancientDialogueSet.AgnosticDialogues =
            new global::_003C_003Ez__ReadOnlyArray<AncientDialogue>(
                new AncientDialogue[2] { new AncientDialogue(""), new AncientDialogue("") }
            );
    ...
    protected override IReadOnlyList<EventOption> GenerateInitialOptions()
    {
        ...
        CharacterModel characterModel = base.Rng.NextItem(
            base.Owner.UnlockState.Characters.Where((CharacterModel c) => c.Id != character.Id)
        );
