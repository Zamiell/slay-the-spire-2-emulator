...
public sealed class BattlewornDummy : EventModel
{
    ...
    protected override IReadOnlyList<EventOption> GenerateInitialOptions()
    {
        ...
        base.DynamicVars["Setting1Hp"].BaseValue = Creature.ScaleHpForMultiplayer(
            ModelDb.Monster<BattleFriendV1>().MinInitialHp,
            ModelDb.Encounter<BattlewornDummyEventEncounter>(),
            playerCount,
            actIndex
        );
        base.DynamicVars["Setting2Hp"].BaseValue = Creature.ScaleHpForMultiplayer(
            ModelDb.Monster<BattleFriendV2>().MinInitialHp,
            ModelDb.Encounter<BattlewornDummyEventEncounter>(),
            playerCount,
            actIndex
        );
        base.DynamicVars["Setting3Hp"].BaseValue = Creature.ScaleHpForMultiplayer(
    ...
    public override async Task Resume(AbstractRoom room)
    {
        ...
        BattlewornDummyEventEncounter battlewornDummyEventEncounter =
            (BattlewornDummyEventEncounter)combatRoom.Encounter;
    ...
    private void StartCombat(BattlewornDummyEventEncounter.DummySetting setting)
    {
        BattlewornDummyEventEncounter battlewornDummyEventEncounter =
            (BattlewornDummyEventEncounter)
                ModelDb.Encounter<BattlewornDummyEventEncounter>().ToMutable();
