...
internal class GameInfoUploaderSerializerContext : JsonSerializerContext, IJsonTypeInfoResolver
{
    ...
    private static readonly JsonEncodedText PropName_bot_keyword = JsonEncodedText.Encode(
        "bot_keyword"
    );
    ...
    private static readonly JsonEncodedText PropName_base_damage = JsonEncodedText.Encode(
        "base_damage"
    );

    private static readonly JsonEncodedText PropName_energy = JsonEncodedText.Encode("energy");

    private static readonly JsonEncodedText PropName_star_cost = JsonEncodedText.Encode(
        "star_cost"
    );

    private static readonly JsonEncodedText PropName_has_art = JsonEncodedText.Encode("has_art");

    private static readonly JsonEncodedText PropName_has_joke_art = JsonEncodedText.Encode(
        "has_joke_art"
    );
    ...
    public JsonTypeInfo<AncientChoiceInfo> AncientChoiceInfo =>
        _AncientChoiceInfo
        ?? (
            _AncientChoiceInfo =
                (JsonTypeInfo<AncientChoiceInfo>)base.Options.GetTypeInfo(typeof(AncientChoiceInfo))
        );

    public JsonTypeInfo<CardInfo> CardInfo =>
        _CardInfo
        ?? (_CardInfo = (JsonTypeInfo<CardInfo>)base.Options.GetTypeInfo(typeof(CardInfo)));

    public JsonTypeInfo<DailyMods> DailyMods =>
        _DailyMods
        ?? (_DailyMods = (JsonTypeInfo<DailyMods>)base.Options.GetTypeInfo(typeof(DailyMods)));

    public JsonTypeInfo<EnchantmentInfo> EnchantmentInfo =>
        _EnchantmentInfo
        ?? (
            _EnchantmentInfo =
                (JsonTypeInfo<EnchantmentInfo>)base.Options.GetTypeInfo(typeof(EnchantmentInfo))
        );

    public JsonTypeInfo<EncounterInfo> EncounterInfo =>
        _EncounterInfo
        ?? (
            _EncounterInfo =
                (JsonTypeInfo<EncounterInfo>)base.Options.GetTypeInfo(typeof(EncounterInfo))
        );

    public JsonTypeInfo<MegaCrit.Sts2.GameInfo.Objects.EventInfo> EventInfo =>
        _EventInfo
        ?? (
            _EventInfo =
                (JsonTypeInfo<MegaCrit.Sts2.GameInfo.Objects.EventInfo>)
                    base.Options.GetTypeInfo(typeof(MegaCrit.Sts2.GameInfo.Objects.EventInfo))
        );

    public JsonTypeInfo<IGameInfo> IGameInfo =>
        _IGameInfo
        ?? (_IGameInfo = (JsonTypeInfo<IGameInfo>)base.Options.GetTypeInfo(typeof(IGameInfo)));

    public JsonTypeInfo<Keywords> Keywords =>
        _Keywords
        ?? (_Keywords = (JsonTypeInfo<Keywords>)base.Options.GetTypeInfo(typeof(Keywords)));

    public JsonTypeInfo<NeowBonusInfo> NeowBonusInfo =>
        _NeowBonusInfo
        ?? (
            _NeowBonusInfo =
                (JsonTypeInfo<NeowBonusInfo>)base.Options.GetTypeInfo(typeof(NeowBonusInfo))
        );

    public JsonTypeInfo<PotionInfo> PotionInfo =>
        _PotionInfo
        ?? (_PotionInfo = (JsonTypeInfo<PotionInfo>)base.Options.GetTypeInfo(typeof(PotionInfo)));

    public JsonTypeInfo<RelicInfo> RelicInfo =>
        _RelicInfo
        ?? (_RelicInfo = (JsonTypeInfo<RelicInfo>)base.Options.GetTypeInfo(typeof(RelicInfo)));

    public JsonTypeInfo<List<IGameInfo>> ListIGameInfo =>
        _ListIGameInfo
        ?? (
            _ListIGameInfo =
                (JsonTypeInfo<List<IGameInfo>>)base.Options.GetTypeInfo(typeof(List<IGameInfo>))
        );
    ...
    public static GameInfoUploaderSerializerContext Default { get; } =
        new GameInfoUploaderSerializerContext(new JsonSerializerOptions(s_defaultOptions));
    ...
    private JsonTypeInfo<AncientChoiceInfo> Create_AncientChoiceInfo(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<AncientChoiceInfo> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<AncientChoiceInfo> jsonObjectInfoValues =
                new JsonObjectInfoValues<AncientChoiceInfo>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new AncientChoiceInfo
                {
                    Name = (string)args[0],
            ...
            jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) =>
                AncientChoiceInfoPropInit(options);
            jsonObjectInfoValues.ConstructorParameterMetadataInitializer =
                AncientChoiceInfoCtorParamInit;
            jsonObjectInfoValues.ConstructorAttributeProviderFactory = () =>
                typeof(AncientChoiceInfo).GetConstructor(
                    BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                    null,
                    Array.Empty<Type>(),
                    null
    ...
    private static JsonPropertyInfo[] AncientChoiceInfoPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(AncientChoiceInfo).GetProperty(
                "Name",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(string),
    ...
    private JsonTypeInfo<CardInfo> Create_CardInfo(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<CardInfo> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<CardInfo> jsonObjectInfoValues =
                new JsonObjectInfoValues<CardInfo>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new CardInfo
                {
    ...
    private JsonTypeInfo<DailyMods> Create_DailyMods(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<DailyMods> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<DailyMods> jsonObjectInfoValues =
                new JsonObjectInfoValues<DailyMods>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new DailyMods
                {
    ...
    private JsonTypeInfo<EnchantmentInfo> Create_EnchantmentInfo(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<EnchantmentInfo> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<EnchantmentInfo> jsonObjectInfoValues =
                new JsonObjectInfoValues<EnchantmentInfo>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new EnchantmentInfo
                {
            ...
            jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) =>
                EnchantmentInfoPropInit(options);
            jsonObjectInfoValues.ConstructorParameterMetadataInitializer =
                EnchantmentInfoCtorParamInit;
            jsonObjectInfoValues.ConstructorAttributeProviderFactory = () =>
                typeof(EnchantmentInfo).GetConstructor(
                    BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                    null,
                    Array.Empty<Type>(),
                    null
    ...
    private static JsonPropertyInfo[] EnchantmentInfoPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.JsonPropertyName = "name";
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(EnchantmentInfo).GetProperty(
                "Name",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(string),
    ...
    private JsonTypeInfo<EncounterInfo> Create_EncounterInfo(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<EncounterInfo> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<EncounterInfo> jsonObjectInfoValues =
                new JsonObjectInfoValues<EncounterInfo>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new EncounterInfo
                {
            ...
            jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) =>
                EncounterInfoPropInit(options);
            jsonObjectInfoValues.ConstructorParameterMetadataInitializer =
                EncounterInfoCtorParamInit;
            jsonObjectInfoValues.ConstructorAttributeProviderFactory = () =>
                typeof(EncounterInfo).GetConstructor(
                    BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                    null,
                    Array.Empty<Type>(),
                    null
    ...
    private static JsonPropertyInfo[] EncounterInfoPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.JsonPropertyName = "name";
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(EncounterInfo).GetProperty(
                "Name",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(string),
    ...
    private JsonTypeInfo<MegaCrit.Sts2.GameInfo.Objects.EventInfo> Create_EventInfo(
    ...
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<MegaCrit.Sts2.GameInfo.Objects.EventInfo> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<MegaCrit.Sts2.GameInfo.Objects.EventInfo> jsonObjectInfoValues =
                new JsonObjectInfoValues<MegaCrit.Sts2.GameInfo.Objects.EventInfo>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new MegaCrit.Sts2.GameInfo.Objects.EventInfo
                {
                    Name = (string)args[0],
                    BotKeyword = (string)args[1],
                    BotText = (string)args[2],
            ...
            jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) =>
                EventInfoPropInit(options);
            jsonObjectInfoValues.ConstructorParameterMetadataInitializer = EventInfoCtorParamInit;
            jsonObjectInfoValues.ConstructorAttributeProviderFactory = () =>
                typeof(MegaCrit.Sts2.GameInfo.Objects.EventInfo).GetConstructor(
                    BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                    null,
                    Array.Empty<Type>(),
                    null
            ...
            JsonObjectInfoValues<MegaCrit.Sts2.GameInfo.Objects.EventInfo> objectInfo =
    ...
    private static JsonPropertyInfo[] EventInfoPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((MegaCrit.Sts2.GameInfo.Objects.EventInfo)obj).Name;
        jsonPropertyInfoValues.Setter = delegate
        {
            throw new InvalidOperationException(
                "Setting init-only properties is not supported in source generation mode."
        ...
        jsonPropertyInfoValues.JsonPropertyName = "name";
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(MegaCrit.Sts2.GameInfo.Objects.EventInfo).GetProperty(
                "Name",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(string),
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((MegaCrit.Sts2.GameInfo.Objects.EventInfo)obj).BotKeyword;
        jsonPropertyInfoValues.Setter = delegate
        {
            throw new InvalidOperationException(
                "Setting init-only properties is not supported in source generation mode."
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((MegaCrit.Sts2.GameInfo.Objects.EventInfo)obj).BotText;
        jsonPropertyInfoValues.Setter = delegate
        {
            throw new InvalidOperationException(
                "Setting init-only properties is not supported in source generation mode."
        ...
        jsonPropertyInfoValues2.Getter = (object obj) =>
            ((MegaCrit.Sts2.GameInfo.Objects.EventInfo)obj).Id;
        jsonPropertyInfoValues2.Setter = delegate
        {
            throw new InvalidOperationException(
                "Setting init-only properties is not supported in source generation mode."
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((MegaCrit.Sts2.GameInfo.Objects.EventInfo)obj).Act;
        jsonPropertyInfoValues.Setter = delegate
        {
            throw new InvalidOperationException(
                "Setting init-only properties is not supported in source generation mode."
        ...
        array[4].IsGetNullable = false;
        array[4].IsSetNullable = false;
        JsonPropertyInfoValues<List<string>> jsonPropertyInfoValues3 =
        ...
        jsonPropertyInfoValues3.Getter = (object obj) =>
            ((MegaCrit.Sts2.GameInfo.Objects.EventInfo)obj).Options;
        jsonPropertyInfoValues3.Setter = delegate
        {
            throw new InvalidOperationException(
                "Setting init-only properties is not supported in source generation mode."
    ...
    private void EventInfoSerializeHandler(
        Utf8JsonWriter writer,
        MegaCrit.Sts2.GameInfo.Objects.EventInfo? value
    )
    {
        if (value == null)
        {
    ...
    private JsonTypeInfo<IGameInfo> Create_IGameInfo(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<IGameInfo> jsonTypeInfo
            )
        )
        {
    ...
    private JsonTypeInfo<Keywords> Create_Keywords(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<Keywords> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<Keywords> jsonObjectInfoValues =
                new JsonObjectInfoValues<Keywords>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new Keywords
                {
    ...
    private JsonTypeInfo<NeowBonusInfo> Create_NeowBonusInfo(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<NeowBonusInfo> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<NeowBonusInfo> jsonObjectInfoValues =
                new JsonObjectInfoValues<NeowBonusInfo>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new NeowBonusInfo
                {
            ...
            jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) =>
                NeowBonusInfoPropInit(options);
            jsonObjectInfoValues.ConstructorParameterMetadataInitializer =
                NeowBonusInfoCtorParamInit;
            jsonObjectInfoValues.ConstructorAttributeProviderFactory = () =>
                typeof(NeowBonusInfo).GetConstructor(
                    BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                    null,
                    Array.Empty<Type>(),
                    null
    ...
    private static JsonPropertyInfo[] NeowBonusInfoPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.JsonPropertyName = "name";
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(NeowBonusInfo).GetProperty(
                "Name",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(string),
    ...
    private JsonTypeInfo<PotionInfo> Create_PotionInfo(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<PotionInfo> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<PotionInfo> jsonObjectInfoValues =
                new JsonObjectInfoValues<PotionInfo>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new PotionInfo
                {
    ...
    private JsonTypeInfo<RelicInfo> Create_RelicInfo(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<RelicInfo> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<RelicInfo> jsonObjectInfoValues =
                new JsonObjectInfoValues<RelicInfo>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new RelicInfo
                {
    ...
    private JsonTypeInfo<List<IGameInfo>> Create_ListIGameInfo(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<IGameInfo>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<IGameInfo>> collectionInfo = new JsonCollectionInfoValues<
                List<IGameInfo>
            >
            {
            ...
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<List<IGameInfo>, IGameInfo>(
                options,
                collectionInfo
            );
            jsonTypeInfo.NumberHandling = null;
