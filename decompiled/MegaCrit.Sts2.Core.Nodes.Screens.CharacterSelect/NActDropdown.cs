...
public class NActDropdown : NDropdown
{
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.GetDropdownContainer,
                new PropertyInfo(
                    Variant.Type.Object,
                    "",
                    PropertyHint.None,
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Int,
                PropertyName._currentOptionIndex,
                PropertyHint.None,
                "",
