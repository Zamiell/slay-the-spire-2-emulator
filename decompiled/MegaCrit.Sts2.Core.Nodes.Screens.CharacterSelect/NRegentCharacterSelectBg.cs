...
public class NRegentCharacterSelectBg : Control
{
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._sphereGuardianHover,
                PropertyHint.None,
                "",
