...
public class NAscensionPanel : Control
{
    ...
    public event AscensionLevelChangedEventHandler AscensionLevelChanged
    {
        add
        {
            backing_AscensionLevelChanged = (AscensionLevelChangedEventHandler)
                Delegate.Combine(backing_AscensionLevelChanged, value);
        }
        remove
        {
            backing_AscensionLevelChanged = (AscensionLevelChangedEventHandler)
                Delegate.Remove(backing_AscensionLevelChanged, value);
        }
    }
    ...
    public override void _Ready()
    {
        ...
        _ascensionLevel = GetNode<MegaLabel>(
            "HBoxContainer/AscensionIconContainer/AscensionIcon/AscensionLevel"
        );
    ...
    public void Initialize(MultiplayerUiMode mode)
    {
        ...
        if (_mode == MultiplayerUiMode.Host)
        {
            ...
            SetAscensionLevel(
                Math.Min(_maxAscension, SaveManager.Instance.Progress.PreferredMultiplayerAscension)
            );
    ...
    public void AnimIn()
    {
        if (base.Visible)
        {
            ...
            _tween
                .TweenProperty(this, "position:y", base.Position.Y, 0.3)
                .From(base.Position.Y + 30f)
    ...
    private void UpdateControllerButton()
    {
        ...
        if ((uint)(mode - 1) <= 1u)
        {
            ...
            _leftTriggerIcon.Texture = NInputManager.Instance.GetHotkeyIcon(
                MegaInput.viewDeckAndTabLeft
            );
            _rightTriggerIcon.Texture = NInputManager.Instance.GetHotkeyIcon(
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.RefreshArrowVisibility,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.RefreshAscensionText,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._rightTriggerIcon,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddSignalEventDelegate(
            SignalName.AscensionLevelChanged,
            backing_AscensionLevelChanged
        );
    }
    ...
    protected override void RestoreGodotObjectData(GodotSerializationInfo info)
    {
        ...
        if (
            info.TryGetSignalEventDelegate<AscensionLevelChangedEventHandler>(
                SignalName.AscensionLevelChanged,
                out var value13
            )
        )
