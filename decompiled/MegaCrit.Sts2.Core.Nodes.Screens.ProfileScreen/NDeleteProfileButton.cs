...
public class NDeleteProfileButton : NButton
{
    ...
    private static readonly LocString _title = new LocString(
        "main_menu_ui",
        "PROFILE_SCREEN.DELETE_CONFIRM_POPUP.title"
    );

    private static readonly LocString _description = new LocString(
        "main_menu_ui",
        "PROFILE_SCREEN.DELETE_CONFIRM_POPUP.description"
    );

    private static readonly LocString _buttonMesssage = new LocString(
        "main_menu_ui",
        "PROFILE_SCREEN.DELETE_BUTTON.label"
    );
    ...
    public void Initialize(NProfileScreen profileScreen, int profileId)
    {
        ...
        bool visible =
            ...
            && FileAccess.FileExists(
                UserDataPathProvider.GetProfileScopedPath(profileId, "saves/progress.save")
            );
    ...
    private async Task ConfirmDeletion()
    {
        ...
        if (
            await nGenericPopup.WaitForConfirmation(
                ...
                new LocString("main_menu_ui", "PROFILE_SCREEN.DELETE_CONFIRM_POPUP.delete")
            )
        )
        {
