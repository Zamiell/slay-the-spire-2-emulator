...
public class NCreditsScreen : Control, IScreenContext
{
    ...
    public static NCreditsScreen? Create()
    {
        ...
        return PreloadManager
            .Cache.GetScene(_scenePath)
            .Instantiate<NCreditsScreen>(PackedScene.GenEditState.Disabled);
    }
    ...
    {
        GetNode<MegaLabel>("%MegaCritHeader").Text = new LocString(
            "credits",
            "MEGA_CRIT.header"
        ).GetRawText();
        GetNode<MegaRichTextLabel>("%CreatedByNames").Text = new LocString(
            "credits",
            "MEGA_CRIT.names"
        ).GetRawText();
        var (text, text2) = SplitTwoColumn(
            new LocString("credits", "MEGA_CRIT_TEAM.names").GetRawText()
        );
    ...
    {
        GetNode<MegaLabel>("%ComposerHeader").Text = new LocString(
            "credits",
            "COMPOSER.header"
        ).GetRawText();
        GetNode<MegaRichTextLabel>("%ComposerNames").Text = new LocString(
            "credits",
            "COMPOSER.names"
        ).GetRawText();
    }
    ...
    {
        GetNode<MegaLabel>("%AdditionalProgrammingHeader").Text = new LocString(
            "credits",
            "ADDITIONAL_PROGRAMMING.header"
        ).GetRawText();
        GetNode<MegaRichTextLabel>("%AdditionalProgrammingNames").Text = new LocString(
            "credits",
            "ADDITIONAL_PROGRAMMING.names"
        ).GetRawText();
    }

    private void InitAdditionalVfx()
    {
        GetNode<MegaLabel>("%AdditionalVfxHeader").Text = new LocString(
            "credits",
            "ADDITIONAL_VFX.header"
        ).GetRawText();
        GetNode<MegaRichTextLabel>("%AdditionalVfxNames").Text = new LocString(
            "credits",
            "ADDITIONAL_VFX.names"
        ).GetRawText();
    }

    private void InitMarketingSupport()
    {
        GetNode<MegaLabel>("%MarketingSupportHeader").Text = new LocString(
            "credits",
            "MARKETING_SUPPORT.header"
        ).GetRawText();
        GetNode<MegaRichTextLabel>("%MarketingSupportNames").Text = new LocString(
            "credits",
            "MARKETING_SUPPORT.names"
        ).GetRawText();
    }

    private void InitConsultants()
    {
        GetNode<MegaLabel>("%ConsultantsHeader").Text = new LocString(
            "credits",
            "CONSULTANTS.header"
        ).GetRawText();
        GetNode<MegaRichTextLabel>("%ConsultantsNames").Text = new LocString(
            "credits",
            "CONSULTANTS.names"
        ).GetRawText();
    }
    ...
    {
        GetNode<MegaLabel>("%VoicesHeader").Text = new LocString(
            "credits",
            "VOICES.header"
        ).GetRawText();
        var (text, text2) = SplitTwoColumnMultiRole(
            new LocString("credits", "VOICES.names").GetRawText()
        );
    ...
    {
        GetNode<MegaLabel>("%LocalizationHeader").Text = new LocString(
            "credits",
            "LOC.header"
        ).GetRawText();
        GetNode<MegaLabel>("%ptbHeader").Text = new LocString(
            "credits",
            "LOC_PTB.header"
        ).GetRawText();
        GetNode<MegaRichTextLabel>("%ptbNames").Text = new LocString(
            "credits",
            "LOC_PTB.names"
        ).GetRawText();
        GetNode<MegaLabel>("%zhsHeader").Text = new LocString(
            "credits",
            "LOC_ZHS.header"
        ).GetRawText();
        (string, string) tuple = SplitTwoColumn(
            new LocString("credits", "LOC_ZHS.names").GetRawText()
        );
        GetNode<MegaRichTextLabel>("%zhsRoles").Text = tuple.Item1;
        GetNode<MegaRichTextLabel>("%zhsNames").Text = tuple.Item2;
        GetNode<MegaLabel>("%fraHeader").Text = new LocString(
            "credits",
            "LOC_FRA.header"
        ).GetRawText();
        ...
        GetNode<MegaLabel>("%deuHeader").Text = new LocString(
            "credits",
            "LOC_DEU.header"
        ).GetRawText();
        GetNode<MegaRichTextLabel>("%deuNames").Text = new LocString(
            "credits",
            "LOC_DEU.names"
        ).GetRawText();
        GetNode<MegaLabel>("%itaHeader").Text = new LocString(
            "credits",
            "LOC_ITA.header"
        ).GetRawText();
        GetNode<MegaRichTextLabel>("%itaTeam").Text = new LocString(
            "credits",
            "LOC_ITA.team"
        ).GetRawText();
        ...
        GetNode<MegaLabel>("%jpnHeader").Text = new LocString(
            "credits",
            "LOC_JPN.header"
        ).GetRawText();
        GetNode<MegaRichTextLabel>("%jpnNames").Text = new LocString(
            "credits",
            "LOC_JPN.names"
        ).GetRawText();
        GetNode<MegaLabel>("%korHeader").Text = new LocString(
            "credits",
            "LOC_KOR.header"
        ).GetRawText();
        GetNode<MegaRichTextLabel>("%korNames").Text = new LocString(
            "credits",
            "LOC_KOR.names"
        ).GetRawText();
        GetNode<MegaLabel>("%polHeader").Text = new LocString(
            "credits",
            "LOC_POL.header"
        ).GetRawText();
        GetNode<MegaRichTextLabel>("%polNames").Text = new LocString(
            "credits",
            "LOC_POL.names"
        ).GetRawText();
        GetNode<MegaLabel>("%rusHeader").Text = new LocString(
            "credits",
            "LOC_RUS.header"
        ).GetRawText();
        ...
        GetNode<MegaLabel>("%spaHeader").Text = new LocString(
            "credits",
            "LOC_SPA.header"
        ).GetRawText();
        GetNode<MegaRichTextLabel>("%spaNames").Text = new LocString(
            "credits",
            "LOC_SPA.names"
        ).GetRawText();
        GetNode<MegaLabel>("%espHeader").Text = new LocString(
            "credits",
            "LOC_ESP.header"
        ).GetRawText();
        GetNode<MegaRichTextLabel>("%espTeam").Text = new LocString(
            "credits",
            "LOC_ESP.team"
        ).GetRawText();
        ...
        GetNode<MegaLabel>("%thaHeader").Text = new LocString(
            "credits",
            "LOC_THA.header"
        ).GetRawText();
        GetNode<MegaRichTextLabel>("%thaNames").Text = new LocString(
            "credits",
            "LOC_THA.names"
        ).GetRawText();
        GetNode<MegaLabel>("%turHeader").Text = new LocString(
            "credits",
            "LOC_TUR.header"
        ).GetRawText();
    ...
    {
        GetNode<MegaLabel>("%TwitchHeader").Text = new LocString(
            "credits",
            "TWITCH.header"
        ).GetRawText();
        (string, string) tuple = SplitTwoColumn(
            new LocString("credits", "TWITCH.names").GetRawText()
        );
    ...
    {
        GetNode<MegaLabel>("%ModdingSupportHeader").Text = new LocString(
            "credits",
            "MODDING_SUPPORT.header"
        ).GetRawText();
        GetNode<MegaRichTextLabel>("%ModdingSupportNames").Text = ShuffleOneColumn(
            new LocString("credits", "MODDING_SUPPORT.names").GetRawText()
        );
    }

    private void InitPlaytesters()
    {
        GetNode<MegaLabel>("%PlaytestersHeader").Text = new LocString(
            "credits",
            "PLAYTESTERS.header"
        ).GetRawText();
        (string, string, string) tuple = SplitThreeColumnPlaytesters(
            new LocString("credits", "PLAYTESTERS.names").GetRawText()
        );
    ...
    {
        GetNode<MegaLabel>("%TrailerHeader").Text = new LocString(
            "credits",
            "TRAILER.header"
        ).GetRawText();
        GetNode<MegaRichTextLabel>("%TrailerAnimationTeam").Text = new LocString(
            "credits",
            "TRAILER_ANIMATION.team"
        ).GetRawText();
        GetNode<MegaLabel>("%TrailerAnimationHeader").Text = new LocString(
            "credits",
            "TRAILER_ANIMATION.header"
        ).GetRawText();
        (string, string) tuple = SplitTwoColumn(
            new LocString("credits", "TRAILER_ANIMATION.names").GetRawText()
        );
        ...
        GetNode<MegaLabel>("%TrailerEditorHeader").Text = new LocString(
            "credits",
            "TRAILER_EDITOR.header"
        ).GetRawText();
    ...
    {
        GetNode<MegaRichTextLabel>("%ExitMessage").Text = new LocString(
            "credits",
            "EXIT_MESSAGE"
        ).GetRawText();
    }
    ...
    {
        if (
            inputEvent is InputEventMouseButton inputEventMouseButton
    ...
    public override void _Process(double delta)
    {
        ...
        _screenContents.Position = _screenContents.Position.Lerp(
            new Vector2(_screenContents.Position.X, _targetPosition),
            num * 20f
        );
    }
    ...
    private (string Roles, string Names) SplitTwoColumn(string input)
    {
        ...
        {
            string[] array3 = (
                from p in text.Split(new string[1] { "||" }, StringSplitOptions.RemoveEmptyEntries)
    ...
    private (string Column1, string Column2, string Column3) SplitThreeColumnPlaytesters(
        string input
    )
    {
        string[] array = (
            from p in input.Split(new string[1] { "||" }, StringSplitOptions.RemoveEmptyEntries)
            select p.Trim() into p
            where !string.IsNullOrWhiteSpace(p)
            select p
        ).ToArray();
    ...
    private static (string left, string right) SplitTwoColumnMultiRole(string input)
    {
        ...
        for (int i = 0; i < array.Length; i++)
        {
            ...
            if (array2.Length == 2)
            {
                ...
                List<string> list3 = (
                    from r in text.Split(new char[1] { ',' }, StringSplitOptions.RemoveEmptyEntries)
                    select r.Trim()
                ).ToList();
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.InitAdditionalProgramming,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.InitMarketingSupport,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.InitTwitchExtension,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    )
    {
        ...
        if (method == MethodName.ShuffleOneColumn && args.Count == 1)
        {
            ret = VariantUtils.CreateFrom<string>(
                ShuffleOneColumn(VariantUtils.ConvertTo<string>(in args[0]))
            );
            return true;
        }
