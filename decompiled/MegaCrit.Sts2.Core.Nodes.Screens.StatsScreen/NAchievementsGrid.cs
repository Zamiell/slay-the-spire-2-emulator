...
public class NAchievementsGrid : Control
{
    ...
    public static IEnumerable<string> AssetPaths =>
        from a in Enum.GetValues<Achievement>()
    ...
    public Control DefaultFocusedControl =>
        _achievementsContainer.GetChildren().OfType<NAchievementHolder>().First();
    ...
    {
        foreach (
            NAchievementHolder item in _achievementsContainer
                .GetChildren()
                .OfType<NAchievementHolder>()
        )
        {
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnAchievementsChanged,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._achievementsContainer,
                PropertyHint.None,
                "",
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._achievementsContainer,
            Variant.From(in _achievementsContainer)
        );
