...
public class NCharacterStats : Node
{
    ...
    private static readonly string _chainIconPath = ImageHelper.GetImagePath(
    ...
    public static string[] AssetPaths =>
        new string[4] { ScenePath, _playtimeIconPath, _winLossIconPath, _chainIconPath };

    private static string ScenePath =>
        SceneHelper.GetScenePath("screens/stats_screen/character_stats");

    public static NCharacterStats Create(CharacterStats characterStats)
    {
        NCharacterStats nCharacterStats = PreloadManager
            .Cache.GetScene(ScenePath)
            .Instantiate<NCharacterStats>(PackedScene.GenEditState.Disabled);
