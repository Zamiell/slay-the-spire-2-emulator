...
public class NStatsScreen : NSubmenu
{
    ...
    private static readonly string _scenePath = SceneHelper.GetScenePath(
        "screens/stats_screen/stats_screen"
    );
    ...
    public static NStatsScreen? Create()
    {
        ...
        return PreloadManager
            ...
            .Instantiate<NStatsScreen>(PackedScene.GenEditState.Disabled);
    }
    ...
    public override void _Ready()
    {
        ...
        _achievementsTab.SetLabel(
            new LocString("stats_screen", "TAB_ACHIEVEMENT.header").GetFormattedText()
        );
        _statsTab.Connect(
        ...
        GetNode<MegaLabel>("%OverallStatsHeader")
            .SetTextAutoSize(
                new LocString("main_menu_ui", "STATISTICS.OVERALL.title").GetFormattedText()
            );
        GetNode<MegaLabel>("%CharacterStatsHeader")
            .SetTextAutoSize(new LocString("main_menu_ui", "STATISTICS.title").GetFormattedText());
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.OpenAchievementsMenu,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
