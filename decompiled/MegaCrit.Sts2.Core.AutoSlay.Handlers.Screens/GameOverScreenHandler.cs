...
public class GameOverScreenHandler : IScreenHandler, IHandler
{
    ...
    public async Task HandleAsync(Rng random, CancellationToken ct)
    {
        ...
        NGameOverContinueButton continueButton = UiHelper.FindFirst<NGameOverContinueButton>(
            screen
        );
        ...
        await WaitHelper.Until(
            delegate
            {
                ...
                if (waitCycles % 20 == 0)
                {
                    ...
                    AutoSlayLog.Info(
                        $"Waiting for main menu button: found={value}, visible={value2}, enabled={value3}"
                    );
                ...
                return nReturnToMainMenuButton != null
                    && nReturnToMainMenuButton.Visible
                    && mainMenuButton.IsEnabled;
            },
            ct,
            TimeSpan.FromSeconds(90L),
