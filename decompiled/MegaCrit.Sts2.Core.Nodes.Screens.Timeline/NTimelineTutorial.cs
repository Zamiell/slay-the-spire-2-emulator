...
public class NTimelineTutorial : Control, IScreenContext
{
    ...
    public override void _Ready()
    {
        ...
        _text.Text =
            "[center]" + new LocString("timeline", "TUTORIAL_TEXT").GetRawText() + "[/center]";
        _acknowledgeButton = GetNode<NAcknowledgeButton>("%AcknowledgeButton");
        _acknowledgeButton.Connect(
            NClickableControl.SignalName.Released,
            Callable.From<NButton>(CloseTutorial)
        );
        AnimateTutorial();
    }
    ...
    private void AnimateTutorial()
    {
        ...
        _tween = CreateTween();
        _tween
            .TweenProperty(_text, "visible_ratio", 1f, 2.0)
        ...
        _tween
            .Parallel()
            .TweenProperty(_acknowledgeButton, "modulate:a", 1f, 0.3)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Cubic)
            .SetDelay(1.0);
        _tween
            .Parallel()
            .TweenProperty(_acknowledgeButton, "position:y", 920f, 0.3)
            .SetEase(Tween.EaseType.Out)
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._acknowledgeButton,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
