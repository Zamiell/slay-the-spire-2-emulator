...
public class NEpochInspectScreen : NClickableControl, IScreenContext
{
    ...
    private static readonly LocString _placeholderLoc = new LocString(
        "timeline",
        "PLACEHOLDER_PORTRAIT"
    );

    public static readonly string lockedImagePath = ImageHelper.GetImagePath(
        "packed/timeline/epoch_slot_locked.png"
    );
    ...
    public async Task Open(NEpochSlot slot, EpochModel epoch, bool wasRevealed)
    {
        ...
        _tween
            .TweenProperty(_mask, "offset_left", _maskOffsetX, 0.4)
            .SetTrans(Tween.TransitionType.Cubic)
            .SetEase(Tween.EaseType.Out);
        _tween
            .TweenProperty(_mask, "offset_top", _maskOffsetY, 0.4)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _tween
            .TweenProperty(_mask, "size", size, 0.4)
            .SetTrans(Tween.TransitionType.Cubic)
            .SetEase(Tween.EaseType.Out);
        ...
        _tween
            .TweenProperty(_prevChapterButton, "offset_left", _prevChapterButtonOffsetX, 0.25)
            .SetEase(Tween.EaseType.Out)
        ...
        _tween
            .TweenProperty(_nextChapterButton, "offset_left", _nextChapterButtonOffsetX, 0.25)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Back)
        ...
        _closeLabel.SetTextAutoSize(
            new LocString("timeline", "EPOCH_INSPECT.closeButton").GetRawText()
        );
        _fancyText.Text = epoch.Description;
        _textTween?.Kill();
        ...
        _buttonTween
            .TweenProperty(_closeButton, "modulate:a", 1f, 0.3)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Cubic)
            .SetDelay(0.1);
        _buttonTween
            .TweenProperty(_closeButton, "position:y", _closeButtonY - 180f, 0.3)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Back)
            .SetDelay(0.1);
    ...
    private void OpenViaPaginator(EpochModel epoch)
    {
        ...
        _textTween = CreateTween().SetParallel();
        _tween
            .TweenProperty(_mask, "offset_top", _maskOffsetY, 0.25)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _textTween.TweenProperty(_fancyText, "modulate:a", 1f, 0.5).SetDelay(0.1);
        _fancyText.VisibleRatio = 1f;
    ...
    public void Close()
    {
        ...
        _buttonTween = CreateTween().SetParallel();
        _buttonTween
            .TweenProperty(_closeButton, "scale", new Vector2(3f, 0.1f), 0.3)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _buttonTween
            .TweenProperty(_closeButton, "modulate:a", 0f, 0.25)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Cubic);
        _buttonTween.TweenProperty(this, "modulate", new Color(0f, 0f, 0f, 0f), 0.5);
        _buttonTween.TweenCallback(
            Callable.From(
                delegate
                {
                    base.Visible = false;
    ...
    public async Task UnlockAnimation(EpochModel epoch)
    {
        ...
        _closeLabel.SetTextAutoSize(
            new LocString("timeline", "EPOCH_INSPECT.continueButton").GetRawText()
        );
        ...
        _unlockTween
            .TweenProperty(_chains, "scale", Vector2.One * 0.98f, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo)
            .SetDelay(0.5);
        if (await _unlockTween.AwaitFinished(this))
        {
            ...
            _unlockTween
                .TweenMethod(
                    Callable.From<float>(UpdateShaderS),
                    _portraitHsv.GetShaderParameter(_s),
                    1f,
                    1.0
                )
                .SetEase(Tween.EaseType.Out)
            ...
            _unlockTween
                .TweenMethod(
                    ...
                    _portraitHsv.GetShaderParameter(_v),
                    1f,
                    1.0
                )
                .SetEase(Tween.EaseType.Out)
            ...
            _textTween
                .TweenProperty(
                    ...
                    "visible_ratio",
                    1f,
                    (double)_fancyText.GetTotalCharacterCount() * 0.015
                )
                .SetDelay(0.5);
            _buttonTween?.Kill();
            _buttonTween = CreateTween().SetParallel();
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.SpeedUpTextAnimation,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.RefreshChapterPaginators,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._placeholderLabel,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._nextChapterButton,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._prevChapterButton,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName._prevChapterButtonOffsetX,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName._nextChapterButtonOffsetX,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._prevChapterButtonOffsetX,
            Variant.From(in _prevChapterButtonOffsetX)
        );
        info.AddProperty(
            PropertyName._nextChapterButtonOffsetX,
            Variant.From(in _nextChapterButtonOffsetX)
        );
