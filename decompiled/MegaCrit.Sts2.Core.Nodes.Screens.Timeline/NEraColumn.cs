...
public class NEraColumn : Control
{
    ...
    {
        NEraColumn nEraColumn = PreloadManager
            .Cache.GetScene("res://scenes/timeline_screen/era_column.tscn")
            .Instantiate<NEraColumn>(PackedScene.GenEditState.Disabled);
    ...
    public async Task SpawnNameAndYear()
    {
        if (!_labelSpawned)
        {
            ...
            _name.SelfModulate = new Color(
                _name.SelfModulate.R,
                _name.SelfModulate.G,
                _name.SelfModulate.B,
                0f
            );
            ...
            _labelTween
                .TweenProperty(_name, "position:y", 28f, 1.0)
                .From(-36f)
                .SetEase(Tween.EaseType.Out)
                .SetTrans(Tween.TransitionType.Cubic);
            _labelTween.TweenProperty(_year, "modulate:a", 1f, 1.0).SetDelay(0.5);
            _labelTween
                .TweenProperty(_year, "position:y", 20f, 1.0)
                .SetDelay(0.5)
                .From(0f)
                .SetEase(Tween.EaseType.Out)
                .SetTrans(Tween.TransitionType.Cubic);
    ...
    public async Task SaveBeforeAnimationPosition()
    {
        ...
        tween
            .TweenProperty(this, "position", _targetPosition, 2.0)
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.SetPredictedPosition,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Vector2,
                PropertyName._predictedPosition,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
