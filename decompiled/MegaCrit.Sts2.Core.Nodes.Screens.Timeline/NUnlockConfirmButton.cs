...
public class NUnlockConfirmButton : NButton
{
    ...
    protected override string[] Hotkeys =>
        new string[2] { MegaInput.select, MegaInput.pauseAndBack };

    public override void _Ready()
    {
        ConnectSignals();
        GetNode<MegaLabel>("Label")
            .SetTextAutoSize(new LocString("timeline", "UNLOCK_CONFIRM").GetFormattedText());
        _tween = CreateTween();
    ...
    protected override void OnRelease()
    {
        ...
        _hoverTween = CreateTween().SetParallel();
        _hoverTween
            .TweenProperty(this, "scale", new Vector2(3f, 0.1f), 0.3)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _hoverTween
