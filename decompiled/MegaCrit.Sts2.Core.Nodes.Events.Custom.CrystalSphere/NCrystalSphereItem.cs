...
public class NCrystalSphereItem : Control
{
    ...
    public const string scenePath =
        "res://scenes/events/custom/crystal_sphere/crystal_sphere_item.tscn";
    ...
    public static NCrystalSphereItem? Create(CrystalSphereItem item)
    {
        ...
        NCrystalSphereItem nCrystalSphereItem = PreloadManager
            .Cache.GetScene("res://scenes/events/custom/crystal_sphere/crystal_sphere_item.tscn")
            .Instantiate<NCrystalSphereItem>(PackedScene.GenEditState.Disabled);
