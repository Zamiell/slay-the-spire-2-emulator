...
public class NCrystalSphereCell : NClickableControl
{
    ...
    private const string _scenePath =
        "res://scenes/events/custom/crystal_sphere/crystal_sphere_cell.tscn";
    ...
    public static NCrystalSphereCell? Create(CrystalSphereCell cell, NCrystalSphereMask mask)
    {
        ...
        NCrystalSphereCell nCrystalSphereCell = PreloadManager
            .Cache.GetScene("res://scenes/events/custom/crystal_sphere/crystal_sphere_cell.tscn")
            .Instantiate<NCrystalSphereCell>(PackedScene.GenEditState.Disabled);
    ...
    private void OnEntityHighlightUpdated()
    {
        ...
        fadeTween.TweenProperty(
            this,
            property,
            (entity != null && entity.IsHighlighted && entity.IsHidden)
                ? Colors.White
                : Colors.Transparent,
            0.15000000596046448
        );
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnEntityHighlightUpdated,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
