...
public class NCardTypeTickbox : NButton
{
    ...
    protected override void OnRelease()
    {
        ...
        _tween
            .TweenProperty(_image, "scale", _baseScale * _hoverScale, 0.25)
    ...
    protected override void OnFocus()
    {
        ...
        NHoverTipSet
            .CreateAndShow(this, new HoverTip(Loc))
            ?.SetGlobalPosition(new Vector2(310f, base.GlobalPosition.Y));
    }
    ...
    protected override void OnUnfocus()
    {
        ...
        _tween = CreateTween().SetParallel();
        _tween
            .TweenProperty(_image, "scale", _baseScale, 0.5)
            .SetEase(Tween.EaseType.Out)
    ...
    protected override void OnPress()
    {
        ...
        _tween = CreateTween().SetParallel();
        _tween
            .TweenProperty(_image, "scale", _baseScale * _pressDownScale, 0.25)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _tween
            .TweenMethod(
