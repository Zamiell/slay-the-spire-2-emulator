...
public sealed class NCardLibrary : NSubmenu
{
    ...
    private static readonly string _scenePath = SceneHelper.GetScenePath(
        "screens/card_library/card_library"
    );
    ...
    private readonly Dictionary<string, Func<CardModel, bool>> _specialSearchbarKeywords =
        new Dictionary<string, Func<CardModel, bool>>();

    private readonly Dictionary<CharacterModel, NCardPoolFilter> _cardPoolFilters =
        new Dictionary<CharacterModel, NCardPoolFilter>();
    ...
    private readonly Dictionary<NCardPoolFilter, Func<CardModel, bool>> _poolFilters =
        new Dictionary<NCardPoolFilter, Func<CardModel, bool>>();
    ...
    private readonly Dictionary<NCardTypeTickbox, Func<CardModel, bool>> _cardTypeFilters =
        new Dictionary<NCardTypeTickbox, Func<CardModel, bool>>();
    ...
    private readonly Dictionary<NCardRarityTickbox, Func<CardModel, bool>> _rarityFilters =
        new Dictionary<NCardRarityTickbox, Func<CardModel, bool>>();
    ...
    private readonly Dictionary<NCardCostTickbox, Func<CardModel, bool>> _costFilters =
        new Dictionary<NCardCostTickbox, Func<CardModel, bool>>();
    ...
    public static NCardLibrary? Create()
    {
        ...
        return PreloadManager
            ...
            .Instantiate<NCardLibrary>(PackedScene.GenEditState.Disabled);
    }
    ...
    public override void _Ready()
    {
        ...
        _grid.Connect(
            ...
            Callable.From<NCardHolder>(ShowCardDetail)
        );
        _grid.Connect(
        ...
        _searchBar.Connect(
            NSearchBar.SignalName.QueryChanged,
            Callable.From<string>(SearchBarQueryChanged)
        );
        _searchBar.Connect(
            NSearchBar.SignalName.QuerySubmitted,
            Callable.From<string>(SearchBarQuerySubmitted)
        );
        ...
        _typeSorter.Connect(
            ...
            Callable.From<NButton>(OnCardTypeSort)
        );
        ...
        _raritySorter.Connect(
            NClickableControl.SignalName.Released,
            Callable.From<NButton>(OnRaritySort)
        );
        ...
        _costSorter.Connect(
            NClickableControl.SignalName.Released,
            Callable.From<NButton>(OnCostSort)
        );
        ...
        _alphabetSorter.Connect(
            NClickableControl.SignalName.Released,
            Callable.From<NButton>(OnAlphabetSort)
        );
        ...
        _viewUpgrades.Connect(
            NTickbox.SignalName.Toggled,
            Callable.From<NTickbox>(ToggleShowUpgrades)
        );
        _viewMultiplayerCards.Connect(
            NTickbox.SignalName.Toggled,
            Callable.From<NTickbox>(ToggleFilterMultiplayerCards)
        );
        ...
        _viewMultiplayerCards.SetLabel(
            new LocString("card_library", "VIEW_MULTIPLAYER_CARDS").GetRawText()
        );
        ...
        for (int num = 0; num < values.Length; num++)
        {
            ...
            _specialSearchbarKeywords.Add(
                keyword.ToString().ToLowerInvariant(),
                (CardModel c) => c.Rarity == keyword
            );
        }
        _ironcladFilter.Connect(
    ...
    private void UpdateFilter(bool isTextInput = false)
    {
        ...
        {
            if (
                poolFilter2.Key.IsSelected
                && poolFilter2.Key != _miscPoolFilter
                && poolFilter2.Key != _ancientsFilter
            )
            {
                flag = false;
                break;
        ...
        if (!flag)
        {
            foreach (
                KeyValuePair<
                    NCardRarityTickbox,
                    Func<CardModel, bool>
                > rarityFilter in _rarityFilters
            )
            {
        ...
        foreach (
            KeyValuePair<NCardTypeTickbox, Func<CardModel, bool>> cardTypeFilter in _cardTypeFilters
        )
        {
        ...
        {
            multiplayerCardFilter = (CardModel c) =>
                c.MultiplayerConstraint != CardMultiplayerConstraint.MultiplayerOnly;
        }
        _filter = (CardModel c) =>
            activeCostFilter.Any((Func<CardModel, bool> filter) => filter(c))
            && activeRarityFilters.Any((Func<CardModel, bool> filter) => filter(c))
            && activeCardTypeFilter.Any((Func<CardModel, bool> filter) => filter(c))
            && poolFilter.Any((Func<CardModel, bool> filter) => filter(c))
            && TextFilter(c)
            && multiplayerCardFilter(c);
        ...
        bool TextFilter(CardModel card)
        {
            ...
            global::_003C_003Ey__InlineArray2<string> buffer =
                default(global::_003C_003Ey__InlineArray2<string>);
            global::_003CPrivateImplementationDetails_003E.InlineArrayElementRef<
                global::_003C_003Ey__InlineArray2<string>,
                string
            >(ref buffer, 0) = title;
            global::_003CPrivateImplementationDetails_003E.InlineArrayElementRef<
                global::_003C_003Ey__InlineArray2<string>,
                string
            >(ref buffer, 1) = NSearchBar.RemoveHtmlTags(text);
            string text2 = string.Join(
                " ",
                global::_003CPrivateImplementationDetails_003E.InlineArrayAsReadOnlySpan<
                    global::_003C_003Ey__InlineArray2<string>,
                    string
                >(in buffer, 2)
            );
    ...
    private void ShowCardDetail(NCardHolder holder)
    {
        if (SaveManager.Instance.Progress.DiscoveredCards.Contains(holder.CardModel.Id))
        {
            ...
            List<CardModel> list = _grid
                .VisibleCards.Where(
                    (CardModel c) => SaveManager.Instance.Progress.DiscoveredCards.Contains(c.Id)
                )
                .ToList();
            NGame
                .Instance.GetInspectCardScreen()
                .Open(list, list.IndexOf(holder.CardModel), _viewUpgrades.IsTicked);
        }
    }
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.ToggleFilterMultiplayerCards,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.UpdateCardPoolFilter,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.SearchBarQueryChanged,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.SearchBarQuerySubmitted,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._necrobinderFilter,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._viewMultiplayerCards,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._lastHoveredControl,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._viewMultiplayerCards,
            Variant.From(in _viewMultiplayerCards)
        );
