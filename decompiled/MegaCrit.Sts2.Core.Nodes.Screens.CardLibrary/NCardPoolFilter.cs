...
public class NCardPoolFilter : NButton
{
    ...
    private void OnToggle()
    {
        ...
        if (!_isSelected)
        {
            ...
            _tween
                .TweenProperty(_image, "scale", _disabledScale, 0.3)
        ...
        else
        {
            _tween = CreateTween().SetParallel();
            _tween
                .TweenProperty(_image, "scale", _enabledScale, 0.2)
                .SetEase(Tween.EaseType.Out)
    ...
    protected override void OnFocus()
    {
        ...
        _tween.TweenProperty(
            _image,
            "scale",
            (_isSelected ? _enabledScale : _disabledScale) * 1.2f,
            0.05
        );
        ...
        if (!_isSelected)
        {
            ...
            _tween
                .TweenProperty(
                    _image,
                    "scale",
                    (_isSelected ? _enabledScale : _disabledScale) * 0.8f,
                    0.3
                )
                .SetEase(Tween.EaseType.Out)
                .SetTrans(Tween.TransitionType.Expo);
