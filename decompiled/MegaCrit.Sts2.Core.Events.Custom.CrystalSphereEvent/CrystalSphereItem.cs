...
public abstract class CrystalSphereItem
{
    ...
    protected virtual string TexturePath =>
        ImageHelper.GetImagePath("events/crystal_sphere/" + GetType().Name.ToSnakeCase() + ".png");
    ...
    )
    {
        ...
        {
            CrystalSphereItemType.CardReward => new CrystalSphereCardReward(
                serializable.cardRarity,
                owner
            ),
