...
public class NPotionHolder : NClickableControl
{
    ...
    {
        NPotionHolder nPotionHolder = PreloadManager
            .Cache.GetScene(ScenePath)
            .Instantiate<NPotionHolder>(PackedScene.GenEditState.Disabled);
    ...
    protected override void OnFocus()
    {
        ...
        if (Potion != null)
        {
            ...
            NDebugAudioManager.Instance?.Play(
                Rng.Chaotic.NextItem(TmpSfx.PotionSlosh),
                0.5f,
                PitchVariance.Large
            );
            ...
            {
                NHoverTipSet
                    .CreateAndShow(this, Potion.Model.HoverTips, HoverTipAlignment.Center)
                    ?.SetGlobalPosition(
                        base.GlobalPosition
                            + Vector2.Down * base.Size.Y * Mathf.Max(1.5f, base.Scale.Y)
                    );
            }
        }
        else
        {
            ...
            nHoverTipSet?.SetGlobalPosition(
                base.GlobalPosition + Vector2.Down * base.Size.Y * Mathf.Max(1.5f, base.Scale.Y)
            );
    ...
    protected override void OnUnfocus()
    {
        ...
        if (Potion != null)
        {
            if (!_disabledUntilPotionRemoved)
            {
                _hoverTween = CreateTween().SetParallel();
                _hoverTween
                    .TweenProperty(Potion, "scale", _potionScale, 0.5)
        ...
        else
        {
            _hoverTween = CreateTween().SetParallel();
            _hoverTween
                .TweenProperty(_emptyIcon, "scale", _potionScale, 0.5)
                .SetEase(Tween.EaseType.Out)
                .SetTrans(Tween.TransitionType.Expo);
        }
    }
    ...
    public void RemoveUsedPotion()
    {
        ...
        tween
            .TweenProperty(potionToRemove, "scale", Vector2.Zero, 0.20000000298023224)
        ...
        if (base.IsFocused)
        {
            NHoverTipSet nHoverTipSet = NHoverTipSet.CreateAndShow(this, EmptyHoverTip);
            nHoverTipSet?.SetGlobalPosition(
                base.GlobalPosition + Vector2.Down * base.Size.Y * 1.5f
            );
            nHoverTipSet?.SetAlignment(this, HoverTipAlignment.Center);
        }
        _emptyPotionTween?.Kill();
        ...
        _emptyPotionTween
            .TweenProperty(_emptyIcon, "modulate", Colors.White, 0.20000000298023224)
            .SetDelay(0.20000000298023224);
    }
    ...
    public void DiscardPotion()
    {
        ...
        Tween tween = CreateTween();
        tween
            .TweenProperty(potionToRemove, "position:y", -100f, 0.4000000059604645)
            .SetEase(Tween.EaseType.In)
            .SetTrans(Tween.TransitionType.Back);
        tween.TweenCallback(
            Callable.From(
    ...
    public async Task UsePotion()
    {
        ...
        bool flag = (
            (targetType == TargetType.AnyEnemy || targetType == TargetType.TargetedNoCreature)
                ? true
                : false
        );
        ...
        {
            Creature target = (
                (Potion.Model.TargetType == TargetType.Self) ? Potion.Model.Owner.Creature : null
            );
    ...
    private async Task TargetNode(TargetType targetType)
    {
        ...
        if (isUsingController && CombatManager.Instance.IsInProgress)
        {
            ...
            List<Creature> source = (
                ...
                .Where((Creature c) => c.IsAlive)
                .ToList();
            NCombatRoom.Instance.RestrictControllerNavigation(
                source.Select((Creature c) => NCombatRoom.Instance.GetCreatureNode(c).Hitbox)
            );
        ...
        {
            NMultiplayerPlayerStateContainer multiplayerPlayerContainer = NRun.Instance
                .GlobalUi
        ...
        {
            (merchantButton, merchantScreenContext) = FoulPotion.GetFoulPotionMerchantTarget(
                creature.Player.RunState.CurrentRoom
            );
            if (merchantButton != null)
            {
                if (merchantScreenContext != null)
                {
                    ...
                    merchantScreenContext.FocusBehaviorRecursive =
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.DisableUntilPotionRemoved,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.CancelPotionUseOrDiscard,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.ShouldCancelTargeting,
                new PropertyInfo(
                    Variant.Type.Bool,
                    "",
                    PropertyHint.None,
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NPotionHolder>(
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._emptyPotionTween,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName._disabledUntilPotionRemoved,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._disabledUntilPotionRemoved,
            Variant.From(in _disabledUntilPotionRemoved)
        );
