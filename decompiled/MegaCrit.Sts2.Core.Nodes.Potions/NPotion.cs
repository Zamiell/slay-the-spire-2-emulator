...
public class NPotion : Control
{
    ...
    public static IEnumerable<string> AssetPaths =>
        new global::_003C_003Ez__ReadOnlyArray<string>(
            new string[2] { ScenePath, NPotionFlashVfx.ScenePath }
        );
    ...
    public static NPotion? Create(PotionModel potion)
    {
        ...
        NPotion nPotion = PreloadManager
            .Cache.GetScene(ScenePath)
            .Instantiate<NPotion>(PackedScene.GenEditState.Disabled);
    ...
    public void DoBounce()
    {
        ...
        _bounceTween
            .TweenProperty(_container, "position:y", base.Position.Y - 12f, 0.125)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Sine);
        _bounceTween
            .TweenProperty(_container, "position:y", 0f, 0.125)
