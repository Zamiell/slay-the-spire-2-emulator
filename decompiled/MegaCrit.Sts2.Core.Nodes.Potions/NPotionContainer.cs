...
public class NPotionContainer : Control
{
    ...
    public override void _EnterTree()
    {
        ...
        _potionShortcutButton.Connect(
            NClickableControl.SignalName.Released,
            Callable.From<NButton>(OnPotionShortcutPressed)
        );
    ...
    public override void _ExitTree()
    {
        ...
        _player = null;
        _potionShortcutButton.Disconnect(
            NClickableControl.SignalName.Released,
            Callable.From<NButton>(OnPotionShortcutPressed)
        );
        CombatManager.Instance.CombatSetUp -= OnCombatSetUp;
    ...
    private void UpdateNavigation()
    {
        ...
        if (control != null)
        {
            ...
            {
                _holders[i].FocusNeighborLeft = (
                    (i > 0)
                        ? _holders[i - 1].GetPath()
                        : NRun.Instance.GlobalUi.TopBar.Gold.GetPath()
                );
                _holders[i].FocusNeighborRight = (
                    (i < _holders.Count - 1)
                        ? _holders[i + 1].GetPath()
                        : NRun.Instance.GlobalUi.TopBar.RoomIcon.GetPath()
                );
    ...
    private void Add(PotionModel potion, bool isInitialization)
    {
        if (!_holders.All((NPotionHolder h) => h.HasPotion))
        {
            ...
            NPotionHolder nPotionHolder = _holders[
                potion.Owner.PotionSlots.IndexOf<PotionModel>(potion)
            ];
    ...
    public void AnimatePotion(PotionModel potion, Vector2? startPosition = null)
    {
        ...
        {
            NPotionHolder nPotionHolder = _holders.First(
                (NPotionHolder n) => n.Potion != null && n.Potion.Model == potion
            );
    ...
    {
        NPotionHolder nPotionHolder = _holders.FirstOrDefault(
            (NPotionHolder n) => n.Potion?.Model == potion
        );
        ...
        Log.Error(
            $"Tried to cancel potion use for potion {potion} but a holder for it does not exist in the player's belt!"
        );
    }
    ...
    private void PlayAddFailedAnim()
    {
        ...
        _potionsFullTween.TweenMethod(
            Callable.From(
                delegate(float t)
                {
                    _potionHolders.Position =
                        _potionHolderInitPos
                        + Vector2.Right * 3f * Mathf.Sin(t * 5f) * Mathf.Sin(t * 0.5f);
                }
            ),
            0f,
            (float)Math.PI * 2f,
        ...
        _potionsFullTween
            .TweenProperty(_potionErrorBg, "modulate", Colors.Transparent, 0.5)
            .SetDelay(0.35);
    }
    ...
    private void OnPotionShortcutPressed(NButton _)
    {
        ...
        if (viewport == null)
        {
            ...
            viewport.GuiGetFocusOwner() != null
            && NRun.Instance.GlobalUi.TopBar.IsAncestorOf(viewport.GuiGetFocusOwner())
        )
        {
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.ConnectPlayerEvents,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.DisconnectPlayerEvents,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnPotionHolderFocused,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnPotionHolderUnfocused,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnPotionShortcutPressed,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._potionShortcutButton,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._potionsFullTween,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                ...
                PropertyName._potionHolderInitPos,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName.FirstPotionControl,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName.LastPotionControl,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._potionShortcutButton,
            Variant.From(in _potionShortcutButton)
        );
