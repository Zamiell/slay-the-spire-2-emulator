...
{
    public static void WriteModel<T>(this PacketWriter writer, T model)
    ...
    public static void WriteEpoch<T>(this PacketWriter writer)
        where T : EpochModel
    {
        writer.WriteInt(
            ModelIdSerializationCache.GetNetIdForEpochId(EpochModel.GetId<T>()),
    ...
    {
        writer.WriteInt(
            ModelIdSerializationCache.GetNetIdForEpochId(epochModel.Id),
            ModelIdSerializationCache.EpochIdBitSize
        );
    }
    ...
    {
        writer.WriteInt(
            ModelIdSerializationCache.GetNetIdForEpochId(epochId),
            ModelIdSerializationCache.EpochIdBitSize
        );
    }
    ...
    public static void WriteModelList<T>(this PacketWriter writer, IReadOnlyCollection<T> models)
        where T : AbstractModel
    {
        writer.WriteInt(models.Count);
