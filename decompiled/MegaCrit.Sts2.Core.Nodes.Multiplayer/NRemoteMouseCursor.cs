...
public class NRemoteMouseCursor : Control
{
    ...
    {
        NRemoteMouseCursor nRemoteMouseCursor = PreloadManager
            .Cache.GetAsset<PackedScene>(
                SceneHelper.GetScenePath("ui/multiplayer/remote_mouse_cursor")
            )
            .Instantiate<NRemoteMouseCursor>(PackedScene.GenEditState.Disabled);
    ...
    public override void _Process(double delta)
    {
        if (_previousPosition.HasValue && _nextPosition.HasValue)
        {
            ...
            base.Position = _previousPosition.Value.Lerp(
                _nextPosition.Value,
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NRemoteMouseCursor>(
                Create(VariantUtils.ConvertTo<ulong>(in args[0]))
            );
            return true;
        }
        ...
        {
            UpdateImage(
                VariantUtils.ConvertTo<bool>(in args[0]),
                VariantUtils.ConvertTo<DrawingMode>(in args[1])
            );
            ret = default(godot_variant);
            return true;
        }
        if (method == MethodName.GetHotspot && args.Count == 1)
        {
            ret = VariantUtils.CreateFrom<Vector2>(
                GetHotspot(VariantUtils.ConvertTo<DrawingMode>(in args[0]))
            );
            return true;
        }
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Int,
                PropertyName._lastPositionUpdateMsec,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._defaultCursorImage,
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._tiltedCursorImage,
                PropertyHint.ResourceType,
                "Image",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._defaultDrawingImage,
                PropertyHint.ResourceType,
                "Image",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._tiltedDrawingImage,
                PropertyHint.ResourceType,
                "Image",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._defaultErasingImage,
                PropertyHint.ResourceType,
                "Image",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._tiltedErasingImage,
                PropertyHint.ResourceType,
                "Image",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._defaultCursorTexture,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._tiltedCursorTexture,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._defaultDrawingTexture,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._tiltedDrawingTexture,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._defaultErasingTexture,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._tiltedErasingTexture,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._lastPositionUpdateMsec,
            Variant.From(in _lastPositionUpdateMsec)
        );
        ...
        info.AddProperty(
            PropertyName._defaultCursorTexture,
            Variant.From(in _defaultCursorTexture)
        );
        info.AddProperty(PropertyName._tiltedCursorTexture, Variant.From(in _tiltedCursorTexture));
        info.AddProperty(
            PropertyName._defaultDrawingTexture,
            Variant.From(in _defaultDrawingTexture)
        );
        info.AddProperty(
            PropertyName._tiltedDrawingTexture,
            Variant.From(in _tiltedDrawingTexture)
        );
        info.AddProperty(
            PropertyName._defaultErasingTexture,
            Variant.From(in _defaultErasingTexture)
        );
        info.AddProperty(
            PropertyName._tiltedErasingTexture,
            Variant.From(in _tiltedErasingTexture)
        );
