...
public class NRemoteLobbyPlayerContainer : Control
{
    ...
    public override void _Ready()
    {
        ...
        _soloLabel.SetTextAutoSize(
            new LocString("main_menu_ui", "MULTIPLAYER_CHAR_SELECT.SOLO").GetFormattedText()
        );
    }
    ...
    public void OnPlayerConnected(LobbyPlayer player)
    {
        ...
        {
            NRemoteLobbyPlayer nRemoteLobbyPlayer = NRemoteLobbyPlayer.Create(
                player,
    ...
    public void OnPlayerChanged(LobbyPlayer player)
    {
        ...
        {
            _nodes
                .FirstOrDefault((NRemoteLobbyPlayer p) => p.PlayerId == player.id)
    ...
    private void RefreshSoloLabelVisibility()
    {
        StartRunLobby lobby = _lobby;
        _soloLabel.Visible =
            (lobby == null || lobby.NetService.Type != NetGameType.Singleplayer)
            && lobby != null
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName._displayLocalPlayer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
