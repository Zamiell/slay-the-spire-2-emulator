...
public class NMultiplayerWarningPopup : NVerticalPopup, IScreenContext
{
    ...
    public static NMultiplayerWarningPopup? Create()
    {
        ...
        return PreloadManager
            ...
            .Instantiate<NMultiplayerWarningPopup>(PackedScene.GenEditState.Disabled);
    }
    ...
    public override void _Ready()
    {
        ...
        _verticalPopup.SetText(
            new LocString("main_menu_ui", "MULTIPLAYER_WARNING_POPUP.title"),
            new LocString("main_menu_ui", "MULTIPLAYER_WARNING_POPUP.body")
        );
        _verticalPopup.InitYesButton(
            new LocString("main_menu_ui", "MULTIPLAYER_WARNING_POPUP.back"),
            OnBackButtonPressed
        );
        _verticalPopup.InitNoButton(
            new LocString("main_menu_ui", "MULTIPLAYER_WARNING_POPUP.ignore"),
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnIgnoreButtonPressed,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
