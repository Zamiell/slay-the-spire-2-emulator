...
public class NMultiplayerPlayerIntentHandler : Control
{
    ...
    public new class PropertyName : Control.PropertyName
    {
        ...
        public static readonly StringName _cardInPlayAwaitingPlayerChoice =
            "_cardInPlayAwaitingPlayerChoice";
    ...
    public static NMultiplayerPlayerIntentHandler? Create(Player player)
    {
        ...
        NMultiplayerPlayerIntentHandler nMultiplayerPlayerIntentHandler = PreloadManager
            .Cache.GetScene(SceneHelper.GetScenePath("combat/multiplayer_player_intent"))
            .Instantiate<NMultiplayerPlayerIntentHandler>(PackedScene.GenEditState.Disabled);
    ...
    private void RefreshHoverDisplay()
    {
        ...
        _tween?.Kill();
        HideThinkyDots();
        AbstractModel abstractModel = RunManager.Instance.HoveredModelTracker.GetHoveredModel(
            _player.NetId
        );
                    ...
                    if (!(abstractModel is RelicModel model2))
                    {
                        if (!(abstractModel is PowerModel model3))
                        {
                            throw new InvalidOperationException(
                                $"Player {_player.NetId} hovering unsupported model {abstractModel}"
                            );
                        }
    ...
    {
        Vector2 cursorPosition = NGame.Instance.RemoteCursorContainer.GetCursorPosition(
            _player.NetId
        );
            ...
            if (nCard != null)
            {
                ...
                tween
                    ...
                    .TweenProperty(
                        nCard,
                        "position",
                        _cardIntent.GlobalPosition + _cardIntent.Size / 2f,
    ...
    private void BeforeActionReadyToResumeAfterPlayerChoice(GameAction action)
    {
        ...
        if (_cardInPlayAwaitingPlayerChoice != null)
        {
            ...
            NCardPlayQueue.Instance.ReAddCardAfterPlayerChoice(
                _cardInPlayAwaitingPlayerChoice,
                action
            );
            _cardInPlayAwaitingPlayerChoice = null;
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.RefreshHoverDisplay,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnPeerInputStateChanged,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnPeerInputStateRemoved,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._targetingIndicator,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._potionThinkyDots,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName._shouldShowHoverTip,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName._isInPlayerChoice,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._cardInPlayAwaitingPlayerChoice,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._cardInPlayAwaitingPlayerChoice,
            Variant.From(in _cardInPlayAwaitingPlayerChoice)
        );
