...
public class NMultiplayerPlayerState : Control
{
    ...
    private static readonly string _scenePath = SceneHelper.GetScenePath(
        "ui/multiplayer_player_state"
    );

    private static readonly string _cardScenePath = SceneHelper.GetScenePath(
        "screens/run_history_screen/deck_history_entry"
    );
    ...
    public static IEnumerable<string> AssetPaths =>
        new global::_003C_003Ez__ReadOnlyArray<string>(
            new string[2] { _scenePath, _cardScenePath }
        );
    ...
    {
        NMultiplayerPlayerState nMultiplayerPlayerState = PreloadManager
            .Cache.GetScene(_scenePath)
            .Instantiate<NMultiplayerPlayerState>(PackedScene.GenEditState.Disabled);
    ...
    public override void _Ready()
    {
        ...
        _networkProblemIndicator = GetNode<NMultiplayerNetworkProblemIndicator>(
            "%NetworkProblemIndicator"
        );
        ...
        _nameplateLabel.SetTextAutoSize(
        ...
        _energyImage.Texture = ResourceLoader.Load<Texture2D>(
            Player.Character.CardPool.EnergyIconPath,
            null,
        ...
        RunManager.Instance.MapSelectionSynchronizer.PlayerVoteCancelled +=
            RefreshPlayerReadyIndicator;
    ...
    private void UpdateSelectionReticleWidth()
    {
        ...
        float b =
            _healthBar.HpBarContainer.GlobalPosition.X
            - base.GlobalPosition.X
            + _healthBar.HpBarContainer.Size.X
            + 6f;
    ...
    private void RefreshCombatValues()
    {
        ...
        _energyCount.AddThemeColorOverride(
            ThemeConstants.Label.FontColor,
            (Player.PlayerCombatState.Energy == 0) ? StsColors.red : StsColors.cream
        );
        _energyCount.AddThemeColorOverride(
            ThemeConstants.Label.FontOutlineColor,
            (Player.PlayerCombatState.Energy == 0)
                ? StsColors.unplayableEnergyCostOutline
                : Player.Character.EnergyLabelOutlineColor
        );
        Material material = (
            (Player.PlayerCombatState.Energy == 0)
        ...
        _energyImage.Modulate = (
            (Player.PlayerCombatState.Energy == 0) ? Colors.DarkGray : Colors.White
        );
    }
    ...
    private void UpdateHighlightedState()
    {
        ...
        if (
            ...
            && !NTargetManager.Instance.AllowedToTargetNode(this)
        )
        {
            flag = false;
        }
            ...
            if (_networkProblemIndicator.IsShown)
            {
                ...
                if (RunManager.Instance.NetService.Type == NetGameType.Client)
                {
                    locString = new LocString(
                        "static_hover_tips",
                        "NETWORK_PROBLEM_CLIENT.description"
                    );
                ...
                else
                {
                    locString = new LocString(
                        "static_hover_tips",
                        "NETWORK_PROBLEM_HOST.description"
                    );
                ...
                NHoverTipSet
                    .CreateAndShow(this, new HoverTip(title, locString))
                    ?.SetGlobalPosition(base.GlobalPosition + Vector2.Down * 80f);
            }
        }
        else
        {
    ...
    private void RefreshPlayerReadyIndicator(Player player)
    {
        ...
        {
            _turnEndIndicator.Visible = RunManager
    ...
    {
        NUiFlashVfx nUiFlashVfx = NUiFlashVfx.Create(
            _turnEndIndicator.Texture,
            _turnEndIndicator.SelfModulate
        );
    ...
    private async Task WaitUntilNextTweenTime()
    {
        ...
        if (nextTweenTime >= Time.GetTicksMsec())
        {
            ...
            await GetTree()
                .CreateTimer(timeSec)
                .AwaitSignal(SceneTreeTimer.SignalName.Timeout, this);
        }
    }
    ...
    private async Task ObtainedAnimation(Control node)
    {
        ...
        tween
            .TweenProperty(node, "scale", Vector2.One, 0.30000001192092896)
            .SetEase(Tween.EaseType.In)
            .SetTrans(Tween.TransitionType.Bounce);
        tween
            .TweenProperty(node, "position:x", base.Size.X - node.Size.X, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo)
            .SetDelay(0.30000001192092896);
        tween
            .TweenProperty(node, "modulate:a", 0f, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo)
            .SetDelay(0.30000001192092896);
    ...
    private async Task RemovedAnimation(Control node)
    {
        ...
        Tween tween = node.CreateTween();
        tween
            .TweenProperty(node, "position:x", base.Size.X + 40f, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        tween
            .TweenProperty(node, "modulate:a", 1f, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        tween
            .TweenProperty(node, "scale:y", 0f, 0.30000001192092896)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo)
            .SetDelay(0.5);
        await tween.AwaitFinished(this);
    ...
    private void OnPlayerScreenChanged(ulong playerId, NetScreenType _)
    {
        ...
        Texture2D locationIcon = RunManager
            .Instance.InputSynchronizer.GetScreenType(playerId)
            .GetLocationIcon();
    ...
    private void TweenLocationIconAway()
    {
        ...
        _locationIconTween
            .TweenProperty(_locationIcon, "scale", Vector2.Zero, 0.4)
    ...
    private void TweenLocationIconIn(Texture2D? texture)
    {
        ...
        if (!_locationContainer.Visible)
        {
            ...
            _locationIconTween
                .TweenProperty(_locationIcon, "scale", Vector2.One, 0.4)
                .SetTrans(Tween.TransitionType.Back)
                .SetEase(Tween.EaseType.Out);
            return;
        }
        _locationIconTween
            .TweenProperty(_locationIcon, "scale", Vector2.One * 0.5f, 0.2)
            .SetTrans(Tween.TransitionType.Back)
            .SetEase(Tween.EaseType.In);
        _locationIconTween.TweenCallback(Callable.From(() => _locationIcon.Texture = texture));
        _locationIconTween
            .TweenProperty(_locationIcon, "scale", Vector2.One, 0.3)
            .SetTrans(Tween.TransitionType.Back)
            .SetEase(Tween.EaseType.Out);
    }
    ...
    protected void OnRelease(NButton _)
    {
        if (
            !NTargetManager.Instance.IsInSelection
            && NTargetManager.Instance.LastTargetingFinishedFrame != GetTree().GetFrame()
        )
        {
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnCreatureValueChanged,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.UpdateHealthBarWidth,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.UpdateSelectionReticleWidth,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.RefreshCombatValues,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnCreatureUnhovered,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.UpdateHighlightedState,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.RefreshConnectedState,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnPlayerVotesCleared,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnPlayerEndTurnPing,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnPlayerScreenChanged,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.TweenLocationIconAway,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.TweenLocationIconIn,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    )
    {
        ...
        {
            OnCreatureValueChanged(
                VariantUtils.ConvertTo<int>(in args[0]),
        ...
        if (method == MethodName.OnPlayerScreenChanged && args.Count == 2)
        {
            OnPlayerScreenChanged(
                VariantUtils.ConvertTo<ulong>(in args[0]),
                VariantUtils.ConvertTo<NetScreenType>(in args[1])
            );
            ret = default(godot_variant);
            return true;
        }
    ...
    )
    {
        ...
        {
            _networkProblemIndicator = VariantUtils.ConvertTo<NMultiplayerNetworkProblemIndicator>(
                in value
            );
            return true;
        }
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._turnEndIndicator,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._disconnectedIndicator,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._networkProblemIndicator,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._locationContainer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._locationIconTween,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName._isCreatureHovered,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName._focusedWhileTargeting,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._currentLocationIcon,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._disconnectedIndicator,
            Variant.From(in _disconnectedIndicator)
        );
        info.AddProperty(
            PropertyName._networkProblemIndicator,
            Variant.From(in _networkProblemIndicator)
        );
        ...
        info.AddProperty(
            PropertyName._focusedWhileTargeting,
            Variant.From(in _focusedWhileTargeting)
        );
