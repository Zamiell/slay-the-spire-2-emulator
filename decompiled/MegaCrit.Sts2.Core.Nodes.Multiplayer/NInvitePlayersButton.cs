...
public class NInvitePlayersButton : NButton
{
    ...
    private void UpdateVisibility()
    {
        _container.Visible =
            _startRunLobby != null
            && PlatformUtil.SupportsInviteDialog(_startRunLobby.NetService.Platform)
            && _startRunLobby.Players.Count < _startRunLobby.MaxPlayers;
    }
