...
public static class FontManager
{
    ...
    private static readonly IReadOnlyDictionary<string, FontPathSet> _languageFontPathSets =
        new Dictionary<string, FontPathSet>
        {
    ...
    private static readonly Dictionary<string, Dictionary<FontType, Font>> _localeFonts =
        new Dictionary<string, Dictionary<FontType, Font>>();
    ...
    {
        if (
            _localeFonts.TryGetValue(language, out Dictionary<FontType, Font> value)
            && value.TryGetValue(type, out var value2)
        )
        {
            return value2;
        }
