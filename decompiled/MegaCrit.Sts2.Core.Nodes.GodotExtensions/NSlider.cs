...
public class NSlider : Godot.Range
{
    ...
    {
        _currentHandlePosition = MathHelper.SmoothDamp(
            _currentHandlePosition,
            (float)base.Value,
    ...
    {
        _handle.Position = new Vector2(
            base.Size.X * (float)((double)_currentHandlePosition / base.MaxValue)
                - _handle.Size.X * 0.5f,
            (base.Size.Y - _handle.Size.Y) * 0.5f
        );
    }
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.SetValueBasedOnMousePosition,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.SetValueWithoutAnimation,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.UpdateHandlePosition,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName._currentHandlePosition,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._currentHandlePosition,
            Variant.From(in _currentHandlePosition)
        );
