...
public class NScrollableContainer : Control
{
    ...
    private float ScrollLimitBottom
    {
        get
        {
            ...
            {
                return 0f
                    - (_paddingBottom + _paddingTop + _content.Size.Y)
                    + _content.GetParent<Control>().Size.Y;
            }
            return 0f;
        }
    }
    ...
    public void SetContent(Control? content, float paddingTop = 0f, float paddingBottom = 0f)
    {
        ...
        if (
            _content != null
            && _content.IsConnected(CanvasItem.SignalName.ItemRectChanged, callable)
        )
        {
    ...
    private void ProcessGuiFocus(Control focusedControl)
    {
        if (
            ...
            && !(focusedControl is NDropdownItem)
            && _content.IsAncestorOf(focusedControl)
        )
        {
    ...
    private void UpdateScrollPosition(double delta)
    {
        ...
        if (!Mathf.IsEqualApprox(_content.Position.Y, num))
        {
            ...
            {
                Scrollbar.SetValueWithoutAnimation(
                    Mathf.Clamp((_content.Position.Y - _paddingTop) / ScrollLimitBottom, 0f, 1f)
                        * 100f
                );
            }
        }
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.DisableScrollingIfContentFits,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.InstantlyScrollToTop,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName.ScrollViewportTop,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName.ScrollViewportSize,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName._disableScrollingIfContentFits,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._disableScrollingIfContentFits,
            Variant.From(in _disableScrollingIfContentFits)
        );
    }
