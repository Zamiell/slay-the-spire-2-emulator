...
public class NClickableControl : Control
{
    ...
    {
        add { backing_Released = (ReleasedEventHandler)Delegate.Combine(backing_Released, value); }
        remove
        {
    ...
    {
        add { backing_Focused = (FocusedEventHandler)Delegate.Combine(backing_Focused, value); }
        remove { backing_Focused = (FocusedEventHandler)Delegate.Remove(backing_Focused, value); }
    }
    ...
    public event MouseReleasedEventHandler MouseReleased
    {
        add
        {
            backing_MouseReleased = (MouseReleasedEventHandler)
                Delegate.Combine(backing_MouseReleased, value);
        }
        remove
        {
            backing_MouseReleased = (MouseReleasedEventHandler)
                Delegate.Remove(backing_MouseReleased, value);
        }
    }
    ...
    public event MousePressedEventHandler MousePressed
    {
        add
        {
            backing_MousePressed = (MousePressedEventHandler)
                Delegate.Combine(backing_MousePressed, value);
        }
        remove
        {
            backing_MousePressed = (MousePressedEventHandler)
                Delegate.Remove(backing_MousePressed, value);
        }
    }
    ...
    {
        bool flag =
            (_isEnabled || AllowFocusWhileDisabled)
            && IsVisibleInTree()
            && (_isHovered || _isControllerFocused);
        if (IsFocused != flag)
        {
            IsFocused = flag;
            if (IsFocused)
    ...
    {
        if (
            !(_ignoreDragThreshold <= 0f)
            && _isPressed
            && inputEvent is InputEventMouseMotion { GlobalPosition: var globalPosition }
            && globalPosition.DistanceTo(_beginDragPosition) >= _ignoreDragThreshold
        )
        {
            _isPressed = false;
        }
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.CheckMouseDragThreshold,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName._ignoreDragThreshold,
                PropertyHint.None,
                "",
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName.AllowFocusWhileDisabled,
                PropertyHint.None,
                "",
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName._isControllerFocused,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName._isControllerNavigable,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                ...
                PropertyName._beginDragPosition,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._isControllerNavigable,
            Variant.From(in _isControllerNavigable)
        );
    ...
    protected override void RestoreGodotObjectData(GodotSerializationInfo info)
    {
        ...
        if (
            info.TryGetSignalEventDelegate<ReleasedEventHandler>(
                SignalName.Released,
                out var value9
            )
        )
        ...
        if (
            info.TryGetSignalEventDelegate<FocusedEventHandler>(SignalName.Focused, out var value10)
        )
        {
            backing_Focused = value10;
        }
        if (
            info.TryGetSignalEventDelegate<UnfocusedEventHandler>(
                SignalName.Unfocused,
                out var value11
            )
        )
        {
        ...
        if (
            info.TryGetSignalEventDelegate<MouseReleasedEventHandler>(
                SignalName.MouseReleased,
                out var value12
            )
        )
        ...
        if (
            info.TryGetSignalEventDelegate<MousePressedEventHandler>(
                SignalName.MousePressed,
                out var value13
            )
        )
