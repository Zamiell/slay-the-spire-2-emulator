...
public class NDropdown : NClickableControl
{
    ...
    protected override void ConnectSignals()
    {
        ...
        _dismisser.Connect(
            ...
            Callable.From<NButton>(OnDismisserClicked)
        );
    ...
    private void OpenDropdown()
    {
        ...
        for (int i = 0; i < list.Count; i++)
        {
            ...
            list[i].FocusNeighborBottom = (
                (i < list.Count - 1) ? list[i + 1].GetPath() : list[i].GetPath()
            );
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._currentOptionLabel,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._currentOptionHighlight,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._currentOptionHighlight,
            Variant.From(in _currentOptionHighlight)
        );
