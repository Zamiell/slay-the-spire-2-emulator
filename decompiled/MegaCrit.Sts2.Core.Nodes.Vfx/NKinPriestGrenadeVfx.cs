...
public class NKinPriestGrenadeVfx : Node2D
{
    ...
    private static readonly string _scenePath = SceneHelper.GetScenePath(
        "vfx/monsters/kin_priest_grenade_vfx"
    );
    ...
    public static NKinPriestGrenadeVfx? Create(Creature target)
    {
        ...
        NKinPriestGrenadeVfx nKinPriestGrenadeVfx = PreloadManager
            .Cache.GetScene(_scenePath)
            .Instantiate<NKinPriestGrenadeVfx>(PackedScene.GenEditState.Disabled);
