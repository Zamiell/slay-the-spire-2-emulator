...
public class NGrandFinaleVfx : Node2D
{
    ...
    public static readonly float totalAnticipationDuration =
        _spotlightDuration + _anticipationDuration + _slashDuration;
    ...
    public static NGrandFinaleVfx? Create(Vector2 playerPosition)
    {
        ...
        NGrandFinaleVfx nGrandFinaleVfx = PreloadManager
            .Cache.GetScene(scenePath)
            .Instantiate<NGrandFinaleVfx>(PackedScene.GenEditState.Disabled);
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NGrandFinaleVfx>(
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._spotlightParticles,
                PropertyHint.NodeType,
                "Node2D",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._anticipationParticles,
            Variant.From(in _anticipationParticles)
        );
