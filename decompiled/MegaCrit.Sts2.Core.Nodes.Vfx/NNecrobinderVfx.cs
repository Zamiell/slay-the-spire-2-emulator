...
public class NNecrobinderVfx : Node
{
    ...
    public override void _Ready()
    {
        ...
        _scytheFireParticles1 = _parent.GetNodeOrNull<GpuParticles2D>(
            "ScytheVfxSlot1/ScytheParticles"
        );
        _scytheFireParticles2 = _parent.GetNodeOrNull<GpuParticles2D>(
        ...
        _animController.ConnectAnimationStarted(
            Callable.From<GodotObject, GodotObject, GodotObject>(UpdateFlameVisibility)
        );
    ...
    {
        _headRef.Visible =
            new MegaAnimationState(animationState).GetCurrent(0)?.GetAnimation().GetName() != "die";
    }
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.UpdateFlameVisibility,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._scytheFireParticles1,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._scytheFireParticles2,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._scytheFireParticles1,
            Variant.From(in _scytheFireParticles1)
        );
        info.AddProperty(
            PropertyName._scytheFireParticles2,
            Variant.From(in _scytheFireParticles2)
        );
    }
