...
public class NWaterfallGiantVfx : Node
{
    ...
    public override void _Ready()
    {
        ...
        _animController.ConnectAnimationEvent(
        ...
        _steamLeakParticles1 = _parent.GetNode<GpuParticles2D>(
            "SteamLeakSlot1/steamLeakParticles1"
        );
        _steamLeakParticles2 = _parent.GetNode<GpuParticles2D>(
            "SteamLeakSlot2/steamLeakParticles2"
        );
        _steamLeakParticles3 = _parent.GetNode<GpuParticles2D>(
            "SteamLeakSlot3/steamLeakParticles3"
        );
    ...
    )
    {
        ...
        {
            OnAnimationEvent(
                VariantUtils.ConvertTo<GodotObject>(in args[0]),
                VariantUtils.ConvertTo<GodotObject>(in args[1]),
                VariantUtils.ConvertTo<GodotObject>(in args[2]),
                VariantUtils.ConvertTo<GodotObject>(in args[3])
            );
            ret = default(godot_variant);
            return true;
        }
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._steamLeakParticles1,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._steamLeakParticles2,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._steamLeakParticles3,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._dropletParticles,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
