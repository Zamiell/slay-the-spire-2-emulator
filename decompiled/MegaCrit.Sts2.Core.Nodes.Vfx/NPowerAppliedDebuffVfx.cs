...
public class NPowerAppliedDebuffVfx : Node2D
{
    ...
    public static NPowerAppliedDebuffVfx? Create(Vector2 globalPosition)
    {
        ...
        NPowerAppliedDebuffVfx nPowerAppliedDebuffVfx = PreloadManager
            .Cache.GetScene(scenePath)
            .Instantiate<NPowerAppliedDebuffVfx>(PackedScene.GenEditState.Disabled);
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NPowerAppliedDebuffVfx>(
