...
public class NVantomVfx : Node
{
    ...
    public override void _Ready()
    {
        ...
        _tailShaderMat =
            new MegaSlotNode(_parent.GetNode("TailSlotNode")).GetNormalMaterial() as ShaderMaterial;
        _sprayParticles = _parent.GetNode<GpuParticles2D>("SprayBoneNode/SprayParticles");
        _deathSprayParticles = _parent.GetNode<GpuParticles2D>(
            "DeathSpraySlotNode/DeathSprayParticles"
        );
        _deathSprayParticlesBack = _parent.GetNode<GpuParticles2D>(
            "DeathSprayBackSlotNode/DeathSprayParticlesBack"
        );
        _deathExplosionParticles = _parent.GetNode<GpuParticles2D>(
            "DeathExplosionSlotNode/DeathExplosionParticles"
        );
            ...
            tween.TweenCallback(
                Callable.From(
                    delegate
                    {
                        _animController
                            .GetAnimationState()
                            .SetAnimation("_tracks/charge_up_1", loop: false, 1);
                        _animController
                            .GetAnimationState()
                            .AddAnimation("_tracks/charged_1", 0f, loop: true, 1);
                    }
                )
            );
        }
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._deathSprayParticles,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._deathSprayParticlesBack,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._deathExplosionParticles,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._deathSprayParticlesBack,
            Variant.From(in _deathSprayParticlesBack)
        );
        info.AddProperty(
            PropertyName._deathExplosionParticles,
            Variant.From(in _deathExplosionParticles)
        );
