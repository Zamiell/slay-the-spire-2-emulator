...
public class NPowerUpVfx : Node2D
{
    ...
    private static string NormalScenePath =>
        SceneHelper.GetScenePath("/vfx/vfx_power_up/vfx_power_up");

    private static string GhostlyScenePath =>
        SceneHelper.GetScenePath("/vfx/vfx_ghostly_power_up/vfx_ghostly_power_up");

    public static IEnumerable<string> AssetPaths =>
        new global::_003C_003Ez__ReadOnlyArray<string>(
            new string[2] { NormalScenePath, GhostlyScenePath }
        );
    ...
    private static NPowerUpVfx? CreatePowerUpVfx(Creature target, string scenePath)
    {
        ...
        NPowerUpVfx nPowerUpVfx = PreloadManager
            .Cache.GetScene(scenePath)
            .Instantiate<NPowerUpVfx>(PackedScene.GenEditState.Disabled);
