...
public class NSmallMagicMissileVfx : Node2D
{
    ...
    public static NSmallMagicMissileVfx? Create(Vector2 targetCenterPosition, Color tint)
    {
        ...
        NSmallMagicMissileVfx nSmallMagicMissileVfx = PreloadManager
            .Cache.GetScene(scenePath)
            .Instantiate<NSmallMagicMissileVfx>(PackedScene.GenEditState.Disabled);
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NSmallMagicMissileVfx>(
                Create(
