...
public class NSpookyScreamVfx : Node2D
{
    ...
    public static NSpookyScreamVfx? Create(Vector2 position)
    {
        ...
        NSpookyScreamVfx nSpookyScreamVfx = PreloadManager
            .Cache.GetScene(scenePath)
            .Instantiate<NSpookyScreamVfx>(PackedScene.GenEditState.Disabled);
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NSpookyScreamVfx>(
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Array,
                PropertyName._oneShotParticles,
                PropertyHint.TypeString,
                "24/34:GPUParticles2D",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
