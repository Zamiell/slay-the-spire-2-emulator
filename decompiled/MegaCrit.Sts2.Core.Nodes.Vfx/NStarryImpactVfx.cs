...
public class NStarryImpactVfx : Node2D
{
    ...
    public static NStarryImpactVfx? Create(Vector2 position)
    {
        ...
        NStarryImpactVfx nStarryImpactVfx = PreloadManager
            .Cache.GetScene(scenePath)
            .Instantiate<NStarryImpactVfx>(PackedScene.GenEditState.Disabled);
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NStarryImpactVfx>(
