...
public class NCardTrailVfx : Node2D
{
    ...
    public static NCardTrailVfx? Create(Control card, string characterTrailPath)
    {
        ...
        NCardTrailVfx nCardTrailVfx = PreloadManager
            .Cache.GetScene(characterTrailPath)
    ...
    public override void _Ready()
    {
        ...
        _tween
            .TweenProperty(_sprites, "scale", Vector2.One * 0.5f, 0.5)
            .SetEase(Tween.EaseType.In)
            .SetTrans(Tween.TransitionType.Cubic)
            .SetDelay(0.25);
        _tween
            .TweenProperty(_nodeToFollow, "modulate:a", 0.75f, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Cubic);
        _tween
            .TweenProperty(_sprites, "modulate:a", 1f, 1.0)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Cubic);
    }
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NCardTrailVfx>(
                Create(
