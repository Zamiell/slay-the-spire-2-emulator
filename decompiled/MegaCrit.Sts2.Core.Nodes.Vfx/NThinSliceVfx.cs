...
public class NThinSliceVfx : Node2D
{
    ...
    public static NThinSliceVfx? Create(Creature? target, VfxColor vfxColor = VfxColor.Cyan)
    {
        ...
        NThinSliceVfx nThinSliceVfx = PreloadManager
            .Cache.GetScene("res://scenes/vfx/thin_slice_vfx.tscn")
            .Instantiate<NThinSliceVfx>(PackedScene.GenEditState.Disabled);
    ...
    {
        ParticleProcessMaterial particleProcessMaterial = (ParticleProcessMaterial)
            _slash.GetProcessMaterial();
        switch (_vfxColor)
        {
            case VfxColor.Red:
    ...
    private Vector2 GenerateSpawnPosition()
    {
        ...
        return new Vector2(
            _creatureCenter.X + num * Mathf.Cos(s),
            _creatureCenter.Y + num * Mathf.Sin(s)
        );
    }
