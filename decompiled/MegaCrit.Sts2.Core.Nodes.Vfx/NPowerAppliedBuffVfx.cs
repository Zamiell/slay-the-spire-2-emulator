...
public class NPowerAppliedBuffVfx : Node2D
{
    ...
    public static NPowerAppliedBuffVfx? Create(Vector2 globalPosition)
    {
        ...
        NPowerAppliedBuffVfx nPowerAppliedBuffVfx = PreloadManager
            .Cache.GetScene(scenePath)
            .Instantiate<NPowerAppliedBuffVfx>(PackedScene.GenEditState.Disabled);
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NPowerAppliedBuffVfx>(
