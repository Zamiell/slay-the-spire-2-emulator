...
public class NKaiserCrabBossVfx : Node
{
    ...
    public override void _Ready()
    {
        ...
        _regenSplatParticles = _parent.GetNode<GpuParticles2D>(
            "RegenSplatSlot/RegenSplatParticles"
        );
    ...
    )
    {
        string text = new MegaAnimationState(animationState)
            ...
            .GetName();
        if (
            text != "right/charged_loop"
            && text != "right/charge_up"
            && text != "right/hurt_charged"
        )
        {
            OnChargeSteamEnd();
        }
    ...
    {
        VfxCmd.PlayVfx(
            _leftArmExplosionPosition.GlobalPosition,
            "vfx/monsters/kaiser_crab_boss_explosion",
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnRocketThrustStart,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._regenSplatParticles,
                PropertyHint.None,
                "",
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._plowChunkParticles,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._spittleParticles,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._leftArmExplosionPosition,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._leftArmExplosionPosition,
            Variant.From(in _leftArmExplosionPosition)
        );
