...
public class NSporeImpactVfx : Node2D
{
    ...
    public static NSporeImpactVfx? Create(Vector2 targetGroundPosition, Color tint)
    {
        ...
        NSporeImpactVfx nSporeImpactVfx = PreloadManager
            .Cache.GetScene(scenePath)
            .Instantiate<NSporeImpactVfx>(PackedScene.GenEditState.Disabled);
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NSporeImpactVfx>(
                Create(
