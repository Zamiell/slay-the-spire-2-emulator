...
public class NLaserVfx : Node2D
{
    ...
    public void ExtendLaser(Vector2 targetPos)
    {
        ...
        tween
            .TweenProperty(_targetingBone, "position", targetPos, 0.15000000596046448)
    ...
    public void RetractLaser()
    {
        Tween tween = CreateTween();
        tween
            .TweenProperty(_targetingBone, "position", base.Position, 0.15000000596046448)
            .SetTrans(Tween.TransitionType.Expo)
