...
public class NLivingGasVfx : Node
{
    ...
    private void DissipateFunction(float t)
    {
        for (int i = 0; i < _smokeMaterials.Count; i++)
        {
            _smokeMaterials[i]
                .SetShaderParameter(
                    _alphaStep,
                    _smokeSteps[i] + (Vector2.One - _smokeSteps[i]) * t
                );
        }
    }
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._attackPuffParticles,
                PropertyHint.None,
                "",
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._attackSparkParticles,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._debuffPuffParticles,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._gasPuffParticles,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._attackSparkParticles,
            Variant.From(in _attackSparkParticles)
        );
