...
public class NGoopyImpactVfx : Node2D
{
    ...
    public static NGoopyImpactVfx? Create(Vector2 targetCenterPosition, Color tint)
    {
        ...
        NGoopyImpactVfx nGoopyImpactVfx = PreloadManager
            .Cache.GetScene(scenePath)
            .Instantiate<NGoopyImpactVfx>(PackedScene.GenEditState.Disabled);
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NGoopyImpactVfx>(
                Create(
