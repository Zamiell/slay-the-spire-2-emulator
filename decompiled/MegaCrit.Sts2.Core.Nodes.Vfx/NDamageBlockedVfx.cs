...
public class NDamageBlockedVfx : Node2D
{
    ...
    public static NDamageBlockedVfx? Create(Creature target)
    {
        ...
        NDamageBlockedVfx nDamageBlockedVfx = PreloadManager
            .Cache.GetScene(ScenePath)
            .Instantiate<NDamageBlockedVfx>(PackedScene.GenEditState.Disabled);
        nDamageBlockedVfx.GlobalPosition =
    ...
    private async Task BlockAnim()
    {
        ...
        _tween
            .TweenProperty(this, "scale", Vector2.One * 0.6f, 2.0)
            .From(Vector2.One)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Quad);
        _tween
            .TweenProperty(this, "position:y", base.Position.Y - 250f, 2.0)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Quad);
        _tween
            .TweenProperty(_label, "modulate", Colors.White, 2.0)
            .From(new Color("21C0FF"))
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Cubic);
        _tween
            .TweenProperty(this, "modulate:a", 0f, 1.5)
