...
public class NGainEpochVfx : Node
{
    ...
    private async Task AnimateVfx()
    {
        ...
        _tween
            .TweenProperty(_epoch, "position:x", 164f, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Back);
        _tween
            .TweenProperty(_epoch, "rotation", 0f, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Back);
        _tween.Chain();
    ...
    {
        _vfxCount++;
        NGainEpochVfx nGainEpochVfx = PreloadManager
            .Cache.GetScene(ScenePath)
            .Instantiate<NGainEpochVfx>(PackedScene.GenEditState.Disabled);
