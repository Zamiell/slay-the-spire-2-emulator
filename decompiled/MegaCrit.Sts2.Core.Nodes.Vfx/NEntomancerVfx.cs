...
public class NEntomancerVfx : Node
{
    ...
    public override void _Ready()
    {
        ...
        _attackingBugParticles = _parent.GetNode<GpuParticles2D>(
            "SwarmParticles/AttackingBugParticles"
        );
    ...
    private void LaunchSwarm()
    {
        ...
        _swarmTween
            .TweenCallback(Callable.From(CompleteSwarmAttack))
            .SetDelay(0.009999999776482582);
    }
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.CompleteSwarmAttack,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._attackingBugParticles,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._attackingBugParticles,
            Variant.From(in _attackingBugParticles)
        );
