...
public class NSweepingBeamImpactVfx : Node2D
{
    ...
    public static NSweepingBeamImpactVfx? Create(Vector2 targetCenter)
    {
        ...
        NSweepingBeamImpactVfx nSweepingBeamImpactVfx = PreloadManager
            .Cache.GetScene(scenePath)
            .Instantiate<NSweepingBeamImpactVfx>(PackedScene.GenEditState.Disabled);
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NSweepingBeamImpactVfx>(
