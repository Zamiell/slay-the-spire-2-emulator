...
public class NPoisonImpactVfx : Node2D
{
    ...
    public static NPoisonImpactVfx? Create(Vector2 targetCenter)
    {
        ...
        NPoisonImpactVfx nPoisonImpactVfx = PreloadManager
            .Cache.GetScene(scenePath)
            .Instantiate<NPoisonImpactVfx>(PackedScene.GenEditState.Disabled);
        nPoisonImpactVfx.GlobalPosition = targetCenter;
        nPoisonImpactVfx._horizontalSmokeContainer.Scale = new Vector2(
            ((double)GD.Randf() > 0.5) ? 1f : (-1f),
            1f
        );
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NPoisonImpactVfx>(
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._horizontalSmokeContainer,
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._horizontalSmokeContainer,
            Variant.From(in _horizontalSmokeContainer)
        );
    }
