...
public class NDoomSubEmitterVfx : Node2D
{
    ...
    public new class PropertyName : Node2D.PropertyName
    {
        ...
        public static readonly StringName _dumbHackBecauseOfHowTexturerectsWork =
            "_dumbHackBecauseOfHowTexturerectsWork";

        public static readonly StringName _rotationHackForSameDumbReason =
            "_rotationHackForSameDumbReason";
    ...
    private void FireSpear(TextureRect textureRect = null)
    {
        ...
        position.X =
            Rng.Chaotic.NextFloat(_baseSpearRegionWidth * -0.5f, _baseSpearRegionWidth * 0.5f)
            + _dumbHackBecauseOfHowTexturerectsWork;
        textureRect.Position = position;
        textureRect.RotationDegrees =
            textureRect.Position.X * _spearAngleIntensity + _rotationHackForSameDumbReason;
        ...
        tween
            .TweenProperty(textureRect, "scale", vector, num)
            .From(new Vector2(x, Rng.Chaotic.NextFloat(_minSpearSize, _maxSpearSize)));
        if (_isOn)
        {
            tween.TweenCallback(
                Callable.From(
        ...
        tween2
            .TweenProperty(textureRect, "modulate", new Color(1f, 1f, 1f, a), 0.20000000298023224)
    ...
    public void ShowOrHide(float widthScale, float tweenTime)
    {
        ...
        if (_isOn)
        {
            ...
            int amount = (
                ((int)widthScale * _baseParticleDensity <= 1)
                    ? 1
                    : ((int)widthScale * _baseParticleDensity)
            );
        ...
        _tween = CreateTween();
        _tween
            .TweenProperty(this, "CurScaleX", num2, tweenTime)
            .SetDelay(num)
            .SetEase(ease)
    ...
    private void UpdateWidth(float width)
    {
        ...
        foreach (Node2D scalableLayer in _scalableLayers)
        {
            ...
            Vector2 scale = (
                (scalableLayer != _verticalShrinkingLayer || !(width < 1f))
                    ? new Vector2(vector.X * _curScaleX, vector.Y)
                    : new Vector2(vector.X * _curScaleX, vector.Y * width / 1f)
            );
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._verticalShrinkingLayer,
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._particlesToKeepDense,
                PropertyHint.NodeType,
                "GPUParticles2D",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName._baseSpearRegionWidth,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName._dumbHackBecauseOfHowTexturerectsWork,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName._rotationHackForSameDumbReason,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Int,
                PropertyName._baseParticleDensity,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName._spearFixedHScale,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName._spearAngleIntensity,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._verticalShrinkingLayer,
            Variant.From(in _verticalShrinkingLayer)
        );
        info.AddProperty(
            PropertyName._particlesToKeepDense,
            Variant.From(in _particlesToKeepDense)
        );
        ...
        info.AddProperty(
            PropertyName._baseSpearRegionWidth,
            Variant.From(in _baseSpearRegionWidth)
        );
        info.AddProperty(
            PropertyName._dumbHackBecauseOfHowTexturerectsWork,
            Variant.From(in _dumbHackBecauseOfHowTexturerectsWork)
        );
        info.AddProperty(
            PropertyName._rotationHackForSameDumbReason,
            Variant.From(in _rotationHackForSameDumbReason)
        );
