...
public class NMirrorVfx : Control
{
    ...
    public static NMirrorVfx? Create()
    {
        ...
        return PreloadManager
            ...
            .Instantiate<NMirrorVfx>(PackedScene.GenEditState.Disabled);
    }
