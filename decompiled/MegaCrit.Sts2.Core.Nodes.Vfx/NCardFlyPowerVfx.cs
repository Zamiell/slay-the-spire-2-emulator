...
public class NCardFlyPowerVfx : Node2D
{
    ...
    public static NCardFlyPowerVfx? Create(NCard card)
    {
        ...
        NCardFlyPowerVfx nCardFlyPowerVfx = PreloadManager
            .Cache.GetScene(_scenePath)
            .Instantiate<NCardFlyPowerVfx>(PackedScene.GenEditState.Disabled);
    ...
    public async Task PlayAnim()
    {
        ...
        while (timeAccumulator < (double)duration)
        {
            ...
            CardNode.Rotation +=
                (float)Mathf.Sign(s)
                * Mathf.Min(Mathf.Abs(s), (float)((double)num3 * processDeltaTime));
            if (num >= 0.9f && !_scalingOut)
            {
                ...
                _scaleTween.TweenProperty(
                    ...
                    "scale",
                    Vector2.Zero,
                    (float)((double)duration - timeAccumulator)
                );
            }
        }
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.GetDurationInternal,
                new PropertyInfo(
                    Variant.Type.Float,
                    "",
                    PropertyHint.None,
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NCardFlyPowerVfx>(
