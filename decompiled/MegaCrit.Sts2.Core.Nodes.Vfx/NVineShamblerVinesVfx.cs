...
public class NVineShamblerVinesVfx : Node2D
{
    ...
    public override void _Ready()
    {
        ...
        _frontVinesAnimController.ConnectAnimationEvent(
            Callable.From<GodotObject, GodotObject, GodotObject, GodotObject>(OnFrontEvent)
        );
        _frontVinesAnimController.ConnectAnimationCompleted(
            Callable.From<GodotObject, GodotObject, GodotObject>(AnimationEnded)
        );
