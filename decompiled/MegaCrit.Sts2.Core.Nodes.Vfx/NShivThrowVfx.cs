...
public class NShivThrowVfx : Node2D
{
    ...
    )
    {
        ...
        NShivThrowVfx nShivThrowVfx = PreloadManager
            .Cache.GetScene(scenePath)
            .Instantiate<NShivThrowVfx>(PackedScene.GenEditState.Disabled);
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NShivThrowVfx>(
                Create(
