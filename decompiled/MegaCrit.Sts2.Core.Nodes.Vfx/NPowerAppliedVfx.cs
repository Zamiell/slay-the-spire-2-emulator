...
public class NPowerAppliedVfx : Control
{
    ...
    public static NPowerAppliedVfx? Create(PowerModel power, int amount, bool isBuff)
    {
        ...
        NPowerAppliedVfx nPowerAppliedVfx = PreloadManager
            .Cache.GetScene("res://scenes/vfx/power_applied_vfx.tscn")
            .Instantiate<NPowerAppliedVfx>(PackedScene.GenEditState.Disabled);
    ...
    private async Task StartVfx()
    {
        ...
        _powerField.Position = new Vector2(
            _powerField.Position.X,
            _powerField.Position.Y + NCreature.PowerAppliedVfxPositionOffset.Y
        );
        _spriteTween = CreateTween().SetParallel();
        _spriteTween
            .TweenProperty(_icon, "scale", Vector2.One * 0.8f, 1.25)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo)
            .From(Vector2.One * 0.4f);
        _spriteTween
            .TweenProperty(_icon, "modulate:a", 0.5f, 0.25)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Sine);
        _spriteTween
            .TweenProperty(_icon, "modulate:a", 0f, 1.0)
        ...
        _textTween
            .TweenProperty(_powerField, "position:y", num, 1.25)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Cubic);
        _textTween
            .TweenProperty(_powerField, "modulate:a", 1f, 0.25)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _textTween
            .TweenProperty(_powerField, "modulate:a", 0f, 0.75)
            .SetEase(Tween.EaseType.In)
            .SetTrans(Tween.TransitionType.Expo)
            .From(1f)
            .SetDelay(0.25);
