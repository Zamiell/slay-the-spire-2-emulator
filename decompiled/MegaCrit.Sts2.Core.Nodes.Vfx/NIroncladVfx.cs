...
public class NIroncladVfx : Node
{
    ...
    public override void _Ready()
    {
        ...
        _slashShaderMat =
            new MegaSlotNode(_parent.GetNode("SlashVfxSlot")).GetNormalMaterial() as ShaderMaterial;
