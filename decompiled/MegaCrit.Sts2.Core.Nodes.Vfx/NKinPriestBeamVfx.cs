...
public class NKinPriestBeamVfx : Node2D
{
    ...
    public override void _Process(double delta)
    {
        Vector2 vector = new Vector2(
            Rng.Chaotic.NextFloat(-0.05f, 0.05f),
            Rng.Chaotic.NextFloat(-0.7f, 0.7f)
        );
    ...
    public void Fire()
    {
        ...
        _rotationTween
            .TweenProperty(this, "rotation_degrees", -1f, 0.800000011920929)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Cubic);
        _beamHolder.Scale = Vector2.One;
        _lengthTween = CreateTween();
        _lengthTween
            .TweenProperty(_beamHolder, "scale:x", 4f, 0.3799999952316284)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _lengthTween
            .Chain()
            .TweenProperty(_beamHolder, "scale:x", 0.5, 0.6000000238418579)
