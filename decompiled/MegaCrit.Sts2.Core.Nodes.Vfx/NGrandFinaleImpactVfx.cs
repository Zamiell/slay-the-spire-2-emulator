...
public class NGrandFinaleImpactVfx : Node2D
{
    ...
    )
    {
        ...
        NGrandFinaleImpactVfx nGrandFinaleImpactVfx = PreloadManager
            .Cache.GetScene(scenePath)
            .Instantiate<NGrandFinaleImpactVfx>(PackedScene.GenEditState.Disabled);
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.InitializePositions,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NGrandFinaleImpactVfx>(
                Create(
