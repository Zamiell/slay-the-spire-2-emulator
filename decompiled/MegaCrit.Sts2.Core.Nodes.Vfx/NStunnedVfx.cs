...
public class NStunnedVfx : Node2D
{
    ...
    public static IEnumerable<string> AssetPaths =>
        new global::_003C_003Ez__ReadOnlySingleElementList<string>(
            "res://scenes/vfx/stunned_vfx.tscn"
        );
    ...
    private async Task StartVfx()
    {
        ...
        _textTween
            .TweenProperty(_label, "modulate:a", 1f, 0.25)
        ...
        _positionTween
            .TweenProperty(_label, "position:y", _label.Position.Y - 100f, 2.0)
            .SetEase(Tween.EaseType.Out)
    ...
    public static NStunnedVfx? Create(Creature creature)
    {
        ...
        NStunnedVfx nStunnedVfx = PreloadManager
            .Cache.GetScene("res://scenes/vfx/stunned_vfx.tscn")
            .Instantiate<NStunnedVfx>(PackedScene.GenEditState.Disabled);
