...
public class NSnappingJaxfruitVfx : Node
{
    ...
    private void StartCast()
    {
        ...
        if (nCreature != null)
        {
            _targetBone.GlobalPosition = new Vector2(
                nCreature.GlobalPosition.X,
                nCreature.GlobalPosition.Y - 130f
            );
        }
