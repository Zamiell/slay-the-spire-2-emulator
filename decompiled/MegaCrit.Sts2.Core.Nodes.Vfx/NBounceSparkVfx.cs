...
public class NBounceSparkVfx : Node2D
{
    ...
    public static NBounceSparkVfx? Create(Creature target, VfxColor vfxColor = VfxColor.Gold)
    {
        ...
        NBounceSparkVfx nBounceSparkVfx = PreloadManager
            .Cache.GetScene("res://scenes/vfx/bounce_spark_vfx.tscn")
            .Instantiate<NBounceSparkVfx>(PackedScene.GenEditState.Disabled);
        nBounceSparkVfx._startPosition = NCombatRoom
    ...
    public override void _Ready()
    {
        _startPosition += new Vector2(
            Rng.Chaotic.NextFloat(-120f, 120f),
            Rng.Chaotic.NextFloat(0f, 20f)
        );
        _floorY = _startPosition.Y + Rng.Chaotic.NextFloat(0f, 64f);
        base.GlobalPosition = _startPosition;
        _velocity = new Vector2(
            Rng.Chaotic.NextFloat(-400f, 400f),
            Rng.Chaotic.NextFloat(-800f, -300f)
        );
