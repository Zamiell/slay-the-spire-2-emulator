...
public class NHeavyBluntVfx : Node2D
{
    ...
    public static NHeavyBluntVfx? Create(Vector2 debugPosition)
    {
        ...
        NHeavyBluntVfx nHeavyBluntVfx = PreloadManager
            .Cache.GetScene(scenePath)
            .Instantiate<NHeavyBluntVfx>(PackedScene.GenEditState.Disabled);
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NHeavyBluntVfx>(
