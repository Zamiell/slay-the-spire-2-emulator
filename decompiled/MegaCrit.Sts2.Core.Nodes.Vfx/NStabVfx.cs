...
public class NStabVfx : Node2D
{
    ...
    public static NStabVfx? Create(
        Creature? target,
        bool facingEnemies = false,
    ...
    )
    {
        ...
        NStabVfx nStabVfx = PreloadManager
            .Cache.GetScene("res://scenes/vfx/stab_vfx.tscn")
            .Instantiate<NStabVfx>(PackedScene.GenEditState.Disabled);
        nStabVfx._vfxColor = vfxColor;
        nStabVfx._facingEnemies = facingEnemies;
        Vector2 vector = new Vector2(
            facingEnemies ? Rng.Chaotic.NextFloat(0f, 48f) : Rng.Chaotic.NextFloat(-48f, 0f),
            Rng.Chaotic.NextFloat(-50f, 50f)
        );
    ...
    public override void _Ready()
    {
        ...
        _primaryVfx.Rotation =
            MathHelper.GetAngle(_primaryVfx.GlobalPosition - _creatureCenter) + (float)Math.PI / 2f;
        SetColor();
    ...
    {
        Vector2 vector = new Vector2(
            Rng.Chaotic.NextFloat(-12f, 12f),
            Rng.Chaotic.NextFloat(-64f, 64f)
        );
    ...
    private async Task Animate()
    {
        ...
        _tween
            .TweenProperty(_primaryVfx, "position", _creatureCenter, 0.5)
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.GenerateSpawnPosition,
                new PropertyInfo(
