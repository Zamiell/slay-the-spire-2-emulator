...
public class NMinionDiveBombVfx : Node2D
{
    ...
    )
    {
        ...
        NMinionDiveBombVfx nMinionDiveBombVfx = PreloadManager
            .Cache.GetScene(scenePath)
            .Instantiate<NMinionDiveBombVfx>(PackedScene.GenEditState.Disabled);
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NMinionDiveBombVfx>(
                Create(
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Array,
                PropertyName._minionAnimations,
                PropertyHint.TypeString,
                "4/0:",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName._fallingVfxEntryTime,
                PropertyHint.None,
                "",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Vector2,
                PropertyName._destinationOffset,
                PropertyHint.None,
                "",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Vector2,
                PropertyName._destinationPosition,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Vector2,
                PropertyName.SourceFinalPosition,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Vector2,
                PropertyName.DestinationFinalPosition,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
