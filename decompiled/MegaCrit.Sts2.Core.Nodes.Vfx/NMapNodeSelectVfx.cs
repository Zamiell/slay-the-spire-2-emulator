...
public class NMapNodeSelectVfx : Control
{
    ...
    public static IEnumerable<string> AssetPaths =>
        _textures.Append("res://scenes/vfx/map_node_select_vfx.tscn");
    ...
    public static NMapNodeSelectVfx? Create(float scaleMultiplier)
    {
        ...
        NMapNodeSelectVfx nMapNodeSelectVfx = PreloadManager
            .Cache.GetScene("res://scenes/vfx/map_node_select_vfx.tscn")
            .Instantiate<NMapNodeSelectVfx>(PackedScene.GenEditState.Disabled);
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NMapNodeSelectVfx>(
