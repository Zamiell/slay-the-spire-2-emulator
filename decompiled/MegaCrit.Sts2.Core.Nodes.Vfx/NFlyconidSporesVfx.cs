...
public class NFlyconidSporesVfx : Node
{
    ...
    public override void _Ready()
    {
        ...
        _frailSpores = _parent.GetNode<CpuParticles2D>(
            "SporesAttach/FlyconidSporesVfx/FrailSpores"
        );
        _frailSpores.Emitting = false;
        _vulnerableSpores = _parent.GetNode<CpuParticles2D>(
            "SporesAttach/FlyconidSporesVfx/VulnerableSpores"
        );
    ...
    {
        if (
            new MegaAnimationState(animationState).GetCurrent(0)?.GetAnimation().GetName()
            != "attack"
        )
        {
            _frailSpores.Emitting = false;
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.SetSporeTypeIsVulnerable,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._vulnerableSpores,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
