...
public class NSlimedBerserkerVfx : Node
{
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.StartVomitParticles,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._gooParticlesVomit,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
