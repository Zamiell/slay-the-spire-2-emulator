...
public class NLargeMagicMissileVfx : Node2D
{
    ...
    public static NLargeMagicMissileVfx? Create(Vector2 targetFloorPosition, Color tint)
    {
        ...
        NLargeMagicMissileVfx nLargeMagicMissileVfx = PreloadManager
            .Cache.GetScene(scenePath)
            .Instantiate<NLargeMagicMissileVfx>(PackedScene.GenEditState.Disabled);
    ...
    {
        Vector3 vector =
            Quaternion.FromEuler(new Vector3(0f, 0f, Mathf.DegToRad(-30f))) * Vector3.Up;
    ...
    private void Initialize()
    {
        ...
        _projectileStartPoint.GlobalPosition =
            topPosition + projectileDirection * _projectileOffset;
        _projectileEndPoint.GlobalPosition =
            base.GlobalPosition + projectileDirection * _projectileOffset;
    ...
    private async Task PlaySequence()
    {
        ...
        while (timer < (double)WaitTime && !_cts.IsCancellationRequested)
        {
            ...
            _projectileContainer.GlobalPosition = _projectileStartPoint.GlobalPosition.Lerp(
                _projectileEndPoint.GlobalPosition,
                weight
            );
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.GetProjectileDirection,
                new PropertyInfo(
                    Variant.Type.Vector2,
                    "",
                    PropertyHint.None,
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NLargeMagicMissileVfx>(
                Create(
                    VariantUtils.ConvertTo<Vector2>(in args[0]),
                    VariantUtils.ConvertTo<Color>(in args[1])
                )
            );
            return true;
        }
        ...
        if (method == MethodName.GetTopPosition && args.Count == 1)
        {
            ret = VariantUtils.CreateFrom<Vector2>(
                GetTopPosition(VariantUtils.ConvertTo<Vector2>(in args[0]))
            );
            return true;
        }
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Array,
                PropertyName._anticipationParticles,
                PropertyHint.TypeString,
                "24/34:GPUParticles2D",
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Array,
                PropertyName._projectileStartParticles,
                PropertyHint.TypeString,
                "24/34:GPUParticles2D",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Array,
                PropertyName._projectileParticles,
                PropertyHint.TypeString,
                "24/34:GPUParticles2D",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Array,
                PropertyName._modulateParticles,
                PropertyHint.TypeString,
                "24/34:GPUParticles2D",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._anticipationContainer,
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName._anticipationDuration,
                PropertyHint.None,
                "",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._projectileContainer,
                PropertyHint.NodeType,
                "Node2D",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._projectileStartPoint,
                PropertyHint.NodeType,
                "Node2D",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._projectileEndPoint,
                PropertyHint.NodeType,
                "Node2D",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName._projectileOffset,
                PropertyHint.None,
                "",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._anticipationParticles,
            Variant.CreateFrom(_anticipationParticles)
        );
        info.AddProperty(
            PropertyName._projectileStartParticles,
            Variant.CreateFrom(_projectileStartParticles)
        );
        info.AddProperty(
            PropertyName._projectileParticles,
            Variant.CreateFrom(_projectileParticles)
        );
        ...
        info.AddProperty(
            PropertyName._anticipationContainer,
            Variant.From(in _anticipationContainer)
        );
        info.AddProperty(
            PropertyName._anticipationDuration,
            Variant.From(in _anticipationDuration)
        );
        info.AddProperty(PropertyName._projectileContainer, Variant.From(in _projectileContainer));
        info.AddProperty(
            PropertyName._projectileStartPoint,
            Variant.From(in _projectileStartPoint)
        );
