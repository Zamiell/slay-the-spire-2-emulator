...
public class NDamageNumVfx : Node2D
{
    ...
    public static NDamageNumVfx? Create(
        Creature target,
        int damage,
    ...
    )
    {
        ...
        if (requireInteractable && (nCreature == null || !nCreature.IsInteractable))
        {
            ...
            Vector2 size = ((SceneTree)Engine.GetMainLoop())
                .Root.GetViewport()
                .GetVisibleRect()
                .Size;
    ...
    public static NDamageNumVfx? Create(Vector2 globalPosition, int damage)
    {
        ...
        NDamageNumVfx nDamageNumVfx = PreloadManager
            .Cache.GetScene(_scenePath)
            .Instantiate<NDamageNumVfx>(PackedScene.GenEditState.Disabled);
    ...
    public override void _Ready()
    {
        ...
        _velocity = new Vector2(
            Rng.Chaotic.NextFloat(-100f, 100f),
            Rng.Chaotic.NextFloat(-800f, -700f)
        );
    ...
    private async Task AnimVfx()
    {
        ...
        _tween
            .TweenProperty(this, "modulate", StsColors.cream, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Cubic);
        _tween
            .TweenProperty(this, "modulate:a", 0f, 2.0)
            .SetEase(Tween.EaseType.In)
            .SetTrans(Tween.TransitionType.Quad);
        _tween
            .TweenProperty(this, "scale", Vector2.One, 1.2000000476837158)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Quad)
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NDamageNumVfx>(
                Create(
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Vector2,
                PropertyName._globalSpawnPosition,
                PropertyHint.None,
                "",
