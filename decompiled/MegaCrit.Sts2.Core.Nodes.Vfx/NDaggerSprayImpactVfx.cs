...
public class NDaggerSprayImpactVfx : Node2D
{
    ...
    public static NDaggerSprayImpactVfx? Create(Vector2 targetCenter, Color tint, bool goingRight)
    {
        ...
        NDaggerSprayImpactVfx nDaggerSprayImpactVfx = PreloadManager
            .Cache.GetScene(scenePath)
            .Instantiate<NDaggerSprayImpactVfx>(PackedScene.GenEditState.Disabled);
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NDaggerSprayImpactVfx>(
                Create(
