...
public class NRestSiteFireVfx : Node2D
{
    ...
    private void Flicker()
    {
        Vector2 vector = new Vector2(
            _baseScale.X,
            Rng.Chaotic.NextFloat(_baseScale.Y * _minFlickerScale, _baseScale.Y)
        );
        Vector2 vector2 = new Vector2(
            _baseScale.X,
            Rng.Chaotic.NextFloat(_baseScale.Y, _baseScale.Y * _maxFlickerScale)
        );
        ...
        tween
            .TweenProperty(
                ...
                "scale",
                vector,
                Rng.Chaotic.NextFloat(_minFlickerTime, _maxFlickerTime)
            )
    ...
    private void Sway()
    {
        ...
        Tween tween = CreateTween();
        tween
            .TweenProperty(this, "skew", num, Rng.Chaotic.NextFloat(_minSkewTime, _maxSkewTime))
            .SetTrans(Tween.TransitionType.Sine)
            .SetEase(Tween.EaseType.InOut);
        tween
            .TweenProperty(this, "skew", num2, Rng.Chaotic.NextFloat(_minSkewTime, _maxSkewTime))
            .SetTrans(Tween.TransitionType.Sine)
            .SetEase(Tween.EaseType.InOut);
    ...
    public void Extinguish()
    {
        ...
        foreach (CpuParticles2D cpuGlowParticle in _cpuGlowParticles)
        {
            ...
            tween
                .TweenProperty(cpuGlowParticle, "scale", Vector2.Zero, _extinguishTime)
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Array,
                PropertyName._cpuGlowParticles,
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Array,
                PropertyName._gpuSparkParticles,
                PropertyHint.TypeString,
