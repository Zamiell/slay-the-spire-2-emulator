...
public class NThoughtBubbleVfx : Control
{
    ...
    public static IEnumerable<string> AssetPaths =>
        new global::_003C_003Ez__ReadOnlySingleElementList<string>(
            "res://scenes/vfx/vfx_thought_bubble.tscn"
        );
    ...
    public static NThoughtBubbleVfx? Create(string text, Creature speaker, double? secondsToDisplay)
    {
        ...
        NThoughtBubbleVfx nThoughtBubbleVfx = CreateInternal(
            text,
            null,
            speaker.Side switch
            {
    ...
    private async Task AnimateThoughtBubble()
    {
        ...
        _tween
            .TweenProperty(this, "scale", Vector2.One, 0.25)
            .SetEase(Tween.EaseType.Out)
    ...
    public async Task GoAway()
    {
        if (GodotObject.IsInstanceValid(this))
        {
            ...
            _tween = CreateTween();
            _tween
                .TweenProperty(this, "modulate:a", 0f, 0.4)
                .SetEase(Tween.EaseType.Out)
    ...
    {
        NThoughtBubbleVfx nThoughtBubbleVfx = PreloadManager
            .Cache.GetScene("res://scenes/vfx/vfx_thought_bubble.tscn")
            .Instantiate<NThoughtBubbleVfx>(PackedScene.GenEditState.Disabled);
    ...
    public void SetTexture(Texture2D texture)
    {
        if (_texture == null)
        {
            throw new NotImplementedException(
                "Can't set texture unless thought bubble was initialized with a texture"
            );
        }
        _texture = texture;
