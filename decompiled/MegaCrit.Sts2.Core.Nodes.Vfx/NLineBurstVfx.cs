...
public class NLineBurstVfx : GpuParticles2D
{
    ...
    public static NLineBurstVfx? Create(Creature target)
    {
        ...
        NLineBurstVfx nLineBurstVfx = PreloadManager
            .Cache.GetScene(ScenePath)
            .Instantiate<NLineBurstVfx>(PackedScene.GenEditState.Disabled);
        nLineBurstVfx.GlobalPosition = NCombatRoom
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NLineBurstVfx>(
