...
public class NWormyImpactVfx : Node2D
{
    ...
    public static NWormyImpactVfx? Create(
    ...
    )
    {
        ...
        NWormyImpactVfx nWormyImpactVfx = PreloadManager
            .Cache.GetScene(scenePath)
            .Instantiate<NWormyImpactVfx>(PackedScene.GenEditState.Disabled);
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NWormyImpactVfx>(
                Create(
