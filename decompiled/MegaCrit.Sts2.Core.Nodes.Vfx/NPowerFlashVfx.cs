...
public class NPowerFlashVfx : Node2D
{
    ...
    public static NPowerFlashVfx? Create(PowerModel power)
    {
        ...
        NPowerFlashVfx nPowerFlashVfx = (NPowerFlashVfx)
            PreloadManager
                .Cache.GetScene("res://scenes/vfx/power_flash_vfx.tscn")
