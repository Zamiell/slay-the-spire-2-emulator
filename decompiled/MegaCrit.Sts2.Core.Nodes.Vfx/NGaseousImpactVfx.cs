...
public class NGaseousImpactVfx : Node2D
{
    ...
    public static NGaseousImpactVfx? Create(Vector2 targetCenter, Color tint)
    {
        ...
        NGaseousImpactVfx nGaseousImpactVfx = PreloadManager
            .Cache.GetScene(scenePath)
            .Instantiate<NGaseousImpactVfx>(PackedScene.GenEditState.Disabled);
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NGaseousImpactVfx>(
                Create(
