...
public class NRelicFlashVfx : Control
{
    ...
    public static NRelicFlashVfx? Create(RelicModel relic)
    {
        ...
        NRelicFlashVfx nRelicFlashVfx = PreloadManager
            .Cache.GetScene("res://scenes/vfx/relic_flash_vfx.tscn")
            .Instantiate<NRelicFlashVfx>(PackedScene.GenEditState.Disabled);
    ...
    private async Task StartVfx()
    {
        ...
        if (_target != null)
        {
            ...
            _tween
                .TweenProperty(this, "position:y", base.Position.Y - 64f, 1.0)
                .SetEase(Tween.EaseType.Out)
                .SetTrans(Tween.TransitionType.Expo);
        }
        _tween.TweenProperty(_sprite, "modulate:a", 1f, 0.01);
        _tween
            .TweenProperty(_sprite, "scale", _targetScale, 1.0)
            .SetEase(Tween.EaseType.Out)
        ...
        _tween
            .TweenProperty(_sprite2, "scale", _targetScale, 1.0)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Cubic)
            .SetDelay(0.2);
        ...
        _tween
            .TweenProperty(_sprite3, "scale", _targetScale, 1.0)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Cubic)
            .SetDelay(0.4);
