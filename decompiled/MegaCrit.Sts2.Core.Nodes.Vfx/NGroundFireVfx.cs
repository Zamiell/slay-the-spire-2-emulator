...
public class NGroundFireVfx : Node2D
{
    ...
    public static NGroundFireVfx? Create(Creature target, VfxColor color = VfxColor.Red)
    {
        ...
        NGroundFireVfx nGroundFireVfx = PreloadManager
            .Cache.GetScene(_scenePath)
            .Instantiate<NGroundFireVfx>(PackedScene.GenEditState.Disabled);
    ...
    private void ApplyColor()
    {
        if (_vfxColor != VfxColor.Red)
        {
            ...
            ShaderMaterial shaderMaterial = (ShaderMaterial)
                node.GetNode<Node2D>("SteppedFireMix").Material;
    ...
    private async Task AnimateIn()
    {
        ...
        _tween
            .TweenProperty(_mainFire, "scale", Vector2.One * 4f, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Back);
        _tween
            .TweenProperty(_mainFire, "modulate:a", 0.9f, 0.5)
            .SetEase(Tween.EaseType.Out)
        ...
        if (await _tween.AwaitFinished(this))
        {
            ...
            _tween
                .TweenProperty(_mainFire, "scale", Vector2.One * 2f, 2.0)
