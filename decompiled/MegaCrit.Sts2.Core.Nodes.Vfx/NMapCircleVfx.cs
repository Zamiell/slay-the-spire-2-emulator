...
public class NMapCircleVfx : Control
{
    ...
    public static IEnumerable<string> AssetPaths =>
        _textures.Append("res://scenes/vfx/map_circle_vfx.tscn");
    ...
    public override void _Ready()
    {
        ...
        if (_playAnim)
        {
            ...
            tween
                .TweenProperty(this, "scale", vector, 1.0)
                .SetEase(Tween.EaseType.Out)
                .SetTrans(Tween.TransitionType.Expo)
                .From(vector * 2f);
            tween
                .TweenProperty(this, "modulate:a", 0.95f, 0.5)
                .SetEase(Tween.EaseType.Out)
                .SetTrans(Tween.TransitionType.Expo)
                .From(0f);
    ...
    public static NMapCircleVfx? Create(bool playAnim)
    {
        ...
        NMapCircleVfx nMapCircleVfx = PreloadManager
            .Cache.GetScene("res://scenes/vfx/map_circle_vfx.tscn")
            .Instantiate<NMapCircleVfx>(PackedScene.GenEditState.Disabled);
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NMapCircleVfx>(
