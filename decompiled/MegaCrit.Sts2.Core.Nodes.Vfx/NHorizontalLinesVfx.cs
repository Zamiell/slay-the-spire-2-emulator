...
public class NHorizontalLinesVfx : GpuParticles2D
{
    ...
    private static readonly string _scenePath = SceneHelper.GetScenePath(
        "vfx/whole_screen/horizontal_lines_vfx"
    );
    ...
    public static NHorizontalLinesVfx? Create(
        Color color,
        double duration = 2.0,
    ...
    )
    {
        ...
        NHorizontalLinesVfx nHorizontalLinesVfx = PreloadManager
            .Cache.GetScene(_scenePath)
            .Instantiate<NHorizontalLinesVfx>(PackedScene.GenEditState.Disabled);
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NHorizontalLinesVfx>(
                Create(
                    VariantUtils.ConvertTo<Color>(in args[0]),
