...
public class NBigSlashImpactVfx : Node2D
{
    ...
    )
    {
        ...
        NBigSlashImpactVfx nBigSlashImpactVfx = PreloadManager
            .Cache.GetScene(scenePath)
            .Instantiate<NBigSlashImpactVfx>(PackedScene.GenEditState.Disabled);
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NBigSlashImpactVfx>(
                Create(VariantUtils.ConvertTo<Vector2>(in args[0]))
            );
            return true;
        }
