...
public class NHyperbeamImpactVfx : Node2D
{
    ...
    )
    {
        ...
        NHyperbeamImpactVfx nHyperbeamImpactVfx = PreloadManager
            .Cache.GetScene(scenePath)
            .Instantiate<NHyperbeamImpactVfx>(PackedScene.GenEditState.Disabled);
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NHyperbeamImpactVfx>(
                Create(
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Array,
                PropertyName._impactStartParticles,
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Array,
                PropertyName._impactEndParticles,
                PropertyHint.TypeString,
                "24/34:GPUParticles2D",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._impactStartParticles,
            Variant.CreateFrom(_impactStartParticles)
        );
