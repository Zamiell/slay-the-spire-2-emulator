...
public class NAmalgamVfx : Node
{
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._deathBodyParticles,
                PropertyHint.None,
                "",
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._laserBaseParticles,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
