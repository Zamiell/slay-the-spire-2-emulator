...
public class NMechaKnightVfx : Node
{
    ...
    public override void _Ready()
    {
        ...
        _flameThrowerParticlesDark = _parent.GetNode<GpuParticles2D>(
            "FlameParticlesBone/FlameParticlesDark"
        );
        _flameThrowerParticlesLight = _parent.GetNode<GpuParticles2D>(
            "FlameParticlesBone/FlameParticlesLight"
        );
        ...
        _engineParticlesDark = _parent.GetNode<GpuParticles2D>(
            "EngineSlot/EngineBone/EngineParticlesDark"
        );
        TurnOffFlameThrower();
        TurnOffEngine();
    }
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._flameThrowerParticlesDark,
                PropertyHint.None,
                "",
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._flameThrowerParticlesLight,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._engineParticlesDark,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._flameThrowerParticlesDark,
            Variant.From(in _flameThrowerParticlesDark)
        );
        info.AddProperty(
            PropertyName._flameThrowerParticlesLight,
            Variant.From(in _flameThrowerParticlesLight)
        );
