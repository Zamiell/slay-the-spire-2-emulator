...
public class NFireSmokePuffVfx : Node2D
{
    ...
    public static NFireSmokePuffVfx? Create(Creature target)
    {
        ...
        NFireSmokePuffVfx nFireSmokePuffVfx = PreloadManager
            .Cache.GetScene(ScenePath)
            .Instantiate<NFireSmokePuffVfx>(PackedScene.GenEditState.Disabled);
        nFireSmokePuffVfx.GlobalPosition = NCombatRoom
