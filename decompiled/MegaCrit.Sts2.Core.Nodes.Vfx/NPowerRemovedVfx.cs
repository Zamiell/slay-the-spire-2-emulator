...
public class NPowerRemovedVfx : Node2D
{
    ...
    private async Task StartVfx()
    {
        ...
        _textTween
            .TweenProperty(_vfxContainer, "modulate:a", 1f, 0.25)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _textTween.TweenInterval(0.5);
        _textTween
            .TweenProperty(_vfxContainer, "modulate:a", 0f, 1.0)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Linear);
        _positionTween = CreateTween();
        _positionTween
            .TweenProperty(_vfxContainer, "position:y", _powerField.Position.Y - 160f, 2.0)
            .SetEase(Tween.EaseType.Out)
    ...
    public static NPowerRemovedVfx? Create(PowerModel power)
    {
        ...
        NPowerRemovedVfx nPowerRemovedVfx = PreloadManager
            .Cache.GetScene("res://scenes/vfx/power_removed_vfx.tscn")
            .Instantiate<NPowerRemovedVfx>(PackedScene.GenEditState.Disabled);
