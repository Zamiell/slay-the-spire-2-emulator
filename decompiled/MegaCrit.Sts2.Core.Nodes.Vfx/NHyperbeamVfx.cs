...
public class NHyperbeamVfx : Node2D
{
    ...
    public static NHyperbeamVfx? Create(Vector2 defectEyePosition, Vector2 mainTargetCenterPosition)
    {
        ...
        NHyperbeamVfx nHyperbeamVfx = PreloadManager
            .Cache.GetScene(scenePath)
            .Instantiate<NHyperbeamVfx>(PackedScene.GenEditState.Disabled);
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NHyperbeamVfx>(
                Create(
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Array,
                PropertyName._laserEndParticles,
                PropertyHint.TypeString,
                "24/34:GPUParticles2D",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
