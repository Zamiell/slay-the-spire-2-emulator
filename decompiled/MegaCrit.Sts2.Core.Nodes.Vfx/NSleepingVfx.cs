...
public class NSleepingVfx : Node2D
{
    ...
    public static NSleepingVfx? Create(Vector2 targetTalkPosition, bool goingRight = true)
    {
        ...
        NSleepingVfx nSleepingVfx = PreloadManager
            .Cache.GetScene(scenePath)
            .Instantiate<NSleepingVfx>(PackedScene.GenEditState.Disabled);
        nSleepingVfx.GlobalPosition = targetTalkPosition;
        nSleepingVfx.SetFloatingDirection(goingRight);
        if (
            nSleepingVfx != null
            && nSleepingVfx._zParticles != null
            && nSleepingVfx._localizedZTexture != null
            && nSleepingVfx._localizedZTexture.TryGetTexture(out Texture2D texture)
        )
        {
    ...
    {
        _zParticles.ProcessMaterial = (ParticleProcessMaterial)
            _zParticles.ProcessMaterial.Duplicate();
        _zParticles.ProcessMaterial.Set(
            _direction,
            new Vector3(goingRight ? 0.5f : (-0.5f), -1f, 0f)
        );
    }
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.SetFloatingDirection,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NSleepingVfx>(
                Create(
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._localizedZTexture,
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._continuousParticles,
            Variant.CreateFrom(_continuousParticles)
        );
