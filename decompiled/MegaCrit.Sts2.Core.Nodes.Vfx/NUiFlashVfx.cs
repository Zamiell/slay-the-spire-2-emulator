...
public class NUiFlashVfx : Control
{
    ...
    public static IEnumerable<string> AssetPaths =>
        new global::_003C_003Ez__ReadOnlySingleElementList<string>(
            "res://scenes/vfx/ui_flash_vfx.tscn"
        );
    ...
    public async Task StartVfx()
    {
        ...
        _spriteTween
            .TweenProperty(_textureRect, "modulate:a", 1f, 0.25)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Sine);
        _spriteTween
            .TweenProperty(_textureRect, "modulate:a", 0f, 0.25)
    ...
    public static NUiFlashVfx? Create(Texture2D tex, Color modulate)
    {
        ...
        NUiFlashVfx nUiFlashVfx = (NUiFlashVfx)
            PreloadManager
                .Cache.GetScene("res://scenes/vfx/ui_flash_vfx.tscn")
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NUiFlashVfx>(
                Create(
