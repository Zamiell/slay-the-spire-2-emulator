...
public class NDecimillipedeSegmentVfx : Node
{
    ...
    public void Regenerate()
    {
        for (int i = 0; i < _sprayNodes.Length; i++)
        {
            ...
            tween
                .TweenProperty(node2D, "scale", _sprayNodeScales[i], num + 0.5f)
                .SetTrans(Tween.TransitionType.Expo)
                .SetEase(Tween.EaseType.Out);
            tween
                .TweenProperty(node2D.Material, "shader_parameter/opacity", 0.9f, num)
                .SetTrans(Tween.TransitionType.Expo)
                .SetEase(Tween.EaseType.Out);
        }
    }
    ...
    private void EndRegenerate()
    {
        ...
        foreach (Node2D node2D in sprayNodes)
        {
            ...
            tween
                .TweenProperty(node2D, "scale", Vector2.Zero, num)
    ...
    )
    {
        ...
        {
            _damageParticleNodes = VariantUtils.ConvertToSystemArrayOfGodotObject<CpuParticles2D>(
                in value
            );
            return true;
        }
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Array,
                PropertyName._damageParticleNodes,
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName._particleSpeedScale,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Vector2,
                PropertyName._particleVelocityMinMax,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._particleVelocityMinMax,
            Variant.From(in _particleVelocityMinMax)
        );
