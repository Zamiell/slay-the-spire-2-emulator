...
public class NDaggerSprayFlurryVfx : Node2D
{
    ...
    public static NDaggerSprayFlurryVfx? Create(Vector2 targetCenter, Color tint, bool goingRight)
    {
        ...
        NDaggerSprayFlurryVfx nDaggerSprayFlurryVfx = PreloadManager
            .Cache.GetScene(scenePath)
            .Instantiate<NDaggerSprayFlurryVfx>(PackedScene.GenEditState.Disabled);
    ...
    public void ApplyTint(Color tint)
    {
        ...
        {
            _modulateParticles[i].ProcessMaterial = (ParticleProcessMaterial)
                _modulateParticles[i].ProcessMaterial.Duplicate();
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NDaggerSprayFlurryVfx>(
                Create(
