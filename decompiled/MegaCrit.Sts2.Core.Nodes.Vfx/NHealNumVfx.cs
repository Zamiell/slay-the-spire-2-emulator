...
public class NHealNumVfx : Node2D
{
    ...
    public static NHealNumVfx? Create(Creature target, decimal amount)
    {
        ...
        NHealNumVfx nHealNumVfx = PreloadManager
            .Cache.GetScene(_scenePath)
            .Instantiate<NHealNumVfx>(PackedScene.GenEditState.Disabled);
    ...
    public override void _Ready()
    {
        ...
        _velocity = new Vector2(
            ...
            Rng.Chaotic.NextFloat(-600f, -300f)
        );
    ...
    public override void _Process(double delta)
    {
        ...
        {
            _velocity -= (_velocity.Normalized() * _deceleration * num).LimitLength(
                _velocity.Length()
            );
        }
    }
