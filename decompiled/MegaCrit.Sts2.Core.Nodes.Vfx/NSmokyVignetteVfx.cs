...
public class NSmokyVignetteVfx : Control
{
    ...
    public static IEnumerable<string> AssetPaths =>
        new global::_003C_003Ez__ReadOnlySingleElementList<string>(
            "res://scenes/vfx/whole_screen/vfx_smoky_vignette.tscn"
        );
    ...
    public static NSmokyVignetteVfx? Create(Color tint, Color highlightColor)
    {
        ...
        NSmokyVignetteVfx nSmokyVignetteVfx = PreloadManager
            .Cache.GetScene("res://scenes/vfx/whole_screen/vfx_smoky_vignette.tscn")
            .Instantiate<NSmokyVignetteVfx>(PackedScene.GenEditState.Disabled);
    ...
    private async Task Animate(bool fadeIn)
    {
        ...
        _tween.Chain();
        _tween
            .TweenProperty(this, "modulate:a", 0f, 1.0)
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NSmokyVignetteVfx>(
                Create(
