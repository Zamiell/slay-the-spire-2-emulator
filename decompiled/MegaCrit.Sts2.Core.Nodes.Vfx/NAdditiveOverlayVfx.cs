...
public class NAdditiveOverlayVfx : ColorRect
{
    ...
    public static NAdditiveOverlayVfx? Create(VfxColor vfxColor = VfxColor.Red)
    {
        ...
        NAdditiveOverlayVfx nAdditiveOverlayVfx = PreloadManager
            .Cache.GetScene(_scenePath)
            .Instantiate<NAdditiveOverlayVfx>(PackedScene.GenEditState.Disabled);
    ...
    public override void _Ready()
    {
        ...
        _tween = CreateTween();
        _tween
            .TweenProperty(this, "modulate:a", 0.1f, 0.5)
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NAdditiveOverlayVfx>(
                Create(VariantUtils.ConvertTo<VfxColor>(in args[0]))
            );
            return true;
        }
