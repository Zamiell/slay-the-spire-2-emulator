...
public class NCardEnchantVfx : Node2D
{
    ...
    public static NCardEnchantVfx? Create(CardModel card)
    {
        ...
        NCardEnchantVfx nCardEnchantVfx = PreloadManager
            .Cache.GetScene(ScenePath)
            .Instantiate<NCardEnchantVfx>(PackedScene.GenEditState.Disabled);
    ...
    private async Task PlayAnimation()
    {
        ...
        ((ShaderMaterial)_cardNode.EnchantmentVfxOverride.Material).SetShaderParameter(
            _progress,
            0f
        );
        _tween = CreateTween();
        ...
        _tween
            .TweenProperty(
                _cardNode.EnchantmentVfxOverride,
        ...
        _tween
            .Parallel()
            .TweenCallback(Callable.From(() => _enchantmentSparkles.Emitting = true))
            .SetDelay(0.20000000298023224);
        _tween
            .Parallel()
            .TweenProperty(
                _enchantmentSparkles,
                "position:x",
                _enchantmentSparkles.Position.X + 72f,
                0.4000000059604645
            )
            .SetDelay(0.20000000298023224);
        ...
        else if (_cardNode.IsInsideTree())
        {
            NCardFlyVfx nCardFlyVfx = NCardFlyVfx.Create(
                ...
                model.Owner.Character.TrailPath
            );
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._enchantmentSparkles,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
