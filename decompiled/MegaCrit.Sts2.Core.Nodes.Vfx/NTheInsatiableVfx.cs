...
public class NTheInsatiableVfx : Node
{
    ...
    public override void _Ready()
    {
        ...
        _animController.ConnectAnimationStarted(
            Callable.From<GodotObject, GodotObject, GodotObject>(OnAnimationStart)
        );
        _salivaFountainParticles = _parent.GetNode<CpuParticles2D>(
            "SalivaSlotNode/SalivaFountainParticles"
        );
        _salivaDroolParticles = _parent.GetNode<CpuParticles2D>(
            "SalivaSlotNode/SalivaDroolParticles"
        );
        _salivaCloudParticles = _parent.GetNode<CpuParticles2D>(
            "SalivaSlotNode/SalivaCloudParticles"
        );
    ...
    {
        string text = new MegaAnimationState(animationState)
            .GetCurrent(0)
            ?.GetAnimation()
            .GetName();
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.TurnOffContinuousParticles,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    )
    {
        ...
        {
            _continuousParticles = VariantUtils.ConvertToSystemArrayOfGodotObject<CpuParticles2D>(
                in value
            );
            return true;
        }
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Array,
                PropertyName._continuousParticles,
                PropertyHint.TypeString,
                "24/34:CPUParticles2D",
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._salivaFountainParticles,
                PropertyHint.None,
                "",
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._salivaDroolParticles,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._salivaCloudParticles,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._baseBlastParticles,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._salivaFountainParticles,
            Variant.From(in _salivaFountainParticles)
        );
        info.AddProperty(
            PropertyName._salivaDroolParticles,
            Variant.From(in _salivaDroolParticles)
        );
        info.AddProperty(
            PropertyName._salivaCloudParticles,
            Variant.From(in _salivaCloudParticles)
        );
