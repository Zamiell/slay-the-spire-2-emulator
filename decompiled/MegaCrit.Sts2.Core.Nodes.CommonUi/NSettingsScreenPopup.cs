...
public class NSettingsScreenPopup : Control, IScreenContext
{
    ...
    public static NSettingsScreenPopup? Create(LocString header, LocString description)
    {
        ...
        NSettingsScreenPopup nSettingsScreenPopup = PreloadManager
            .Cache.GetScene(_scenePath)
            .Instantiate<NSettingsScreenPopup>(PackedScene.GenEditState.Disabled);
