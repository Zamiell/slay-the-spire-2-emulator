...
public class NConfirmButton : NButton
{
    ...
    protected override void OnEnable()
    {
        ...
        _moveTween
            .TweenProperty(this, "position", _showPos, 0.3499999940395355)
    ...
    protected override void OnDisable()
    {
        ...
        _moveTween = CreateTween();
        _moveTween
            .TweenProperty(this, "position", _hidePos, 0.3499999940395355)
            .SetEase(Tween.EaseType.Out)
    ...
    private async Task AnimPressDown(CancellationTokenSource cancelToken)
    {
        ...
        while (num < 0.25f)
        {
            ...
            _outline.Modulate = _outlineColor.Lerp(
                _outlineTransparentColor,
                Ease.CubicOut(num / 0.25f)
            );
            float num2 = num;
            num = num2 + await this.AwaitProcessFrame();
        }
