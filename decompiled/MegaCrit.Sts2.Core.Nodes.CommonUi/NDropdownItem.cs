...
public class NDropdownItem : NButton
{
    ...
    public string Text
    {
        ...
        set { _label.SetTextAutoSize(value); }
    }

    public event SelectedEventHandler Selected
    {
        add { backing_Selected = (SelectedEventHandler)Delegate.Combine(backing_Selected, value); }
        remove
        {
    ...
    protected override void RestoreGodotObjectData(GodotSerializationInfo info)
    {
        ...
        if (
            info.TryGetSignalEventDelegate<SelectedEventHandler>(
                SignalName.Selected,
                out var value5
            )
        )
