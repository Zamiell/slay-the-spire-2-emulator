...
public class NAbandonRunConfirmPopup : Control, IScreenContext
{
    ...
    public override void _EnterTree()
    {
        ...
        _tween
            .TweenProperty(this, "position:y", y, 0.3)
    ...
    public static NAbandonRunConfirmPopup? Create(NMainMenu? mainMenu)
    {
        ...
        NAbandonRunConfirmPopup nAbandonRunConfirmPopup = PreloadManager
            .Cache.GetScene(_scenePath)
            .Instantiate<NAbandonRunConfirmPopup>(PackedScene.GenEditState.Disabled);
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NAbandonRunConfirmPopup>(
                Create(VariantUtils.ConvertTo<NMainMenu>(in args[0]))
            );
            return true;
        }
