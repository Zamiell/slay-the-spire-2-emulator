...
public class NDropdownContainer : Control
{
    ...
    private void ProcessGuiFocus(Control focusedControl)
    {
        if (
            ...
            && _dropdownItems.IsAncestorOf(focusedControl)
        )
        {
    ...
    private void UpdateScrollPosition(double delta)
    {
        ...
        {
            _dropdownItems.Position = _dropdownItems.Position.Lerp(
                _targetDragPos,
                (float)delta * 15f
            );
        ...
        if (!_isDragging)
        {
            ...
            {
                _targetDragPos = _targetDragPos.Lerp(
                    new Vector2(0f, _scrollLimitBottom),
                    (float)delta * 12f
                );
            }
    ...
    private void UpdateScrollbar()
    {
        ...
        {
            float num =
                (_dropdownItems.Position.Y - _scrollLimitBottom) / (0f - _scrollLimitBottom);
    ...
    {
        _targetDragPos = new Vector2(
            _targetDragPos.X,
            _scrollLimitBottom + trainPosition * (0f - _scrollLimitBottom)
        );
    }
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.UpdatePositionBasedOnTrain,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName._scrollLimitBottom,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
