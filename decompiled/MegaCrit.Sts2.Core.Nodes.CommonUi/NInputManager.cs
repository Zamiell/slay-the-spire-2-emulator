...
public class NInputManager : Node
{
    ...
    public new class MethodName : Node.MethodName
    {
        ...
        public static new readonly StringName _UnhandledKeyInput = "_UnhandledKeyInput";
    ...
    {
        { Key.Key1, DebugHotkey.hideTopBar },
        { Key.Key2, DebugHotkey.hideIntents },
        { Key.Key3, DebugHotkey.hideCombatUi },
        { Key.Key4, DebugHotkey.hidePlayContainer },
        { Key.Key5, DebugHotkey.hideHand },
        { Key.Key6, DebugHotkey.hideHpBars },
        { Key.Key7, DebugHotkey.hideTextVfx },
        { Key.Key8, DebugHotkey.hideTargetingUi },
        { Key.Key9, DebugHotkey.slowRewards },
        { Key.Key0, DebugHotkey.hideVersionInfo },
        { Key.Minus, DebugHotkey.speedDown },
        { Key.Equal, DebugHotkey.speedUp },
        { Key.F1, DebugHotkey.hideRestSite },
        { Key.F3, DebugHotkey.hideEventUi },
        { Key.F4, DebugHotkey.hideProceedButton },
        { Key.F5, DebugHotkey.hideHoverTips },
        { Key.F6, DebugHotkey.hideMpCursors },
        { Key.F7, DebugHotkey.hideMpTargeting },
        { Key.F9, DebugHotkey.hideMpIntents },
        { Key.F10, DebugHotkey.hideMpHealthBars },
        { Key.U, DebugHotkey.unlockCharacters },
    };
    ...
    private Dictionary<StringName, StringName> _controllerInputMap =
    ...
    private static Dictionary<StringName, Key> DefaultKeyboardInputMap =>
        ...
        {
            { MegaInput.accept, Key.E },
            { MegaInput.select, Key.Enter },
            { MegaInput.viewDiscardPile, Key.S },
            { MegaInput.viewDeckAndTabLeft, Key.D },
            { MegaInput.viewExhaustPileAndTabRight, Key.X },
            { MegaInput.viewDrawPile, Key.A },
            { MegaInput.viewMap, Key.M },
            { MegaInput.cancel, Key.Escape },
            { MegaInput.peek, Key.Space },
            { MegaInput.up, Key.Up },
            { MegaInput.down, Key.Down },
            { MegaInput.left, Key.Left },
            { MegaInput.right, Key.Right },
            { MegaInput.pauseAndBack, Key.Escape },
            { MegaInput.selectCard1, Key.Key1 },
            { MegaInput.selectCard2, Key.Key2 },
            { MegaInput.selectCard3, Key.Key3 },
            { MegaInput.selectCard4, Key.Key4 },
            { MegaInput.selectCard5, Key.Key5 },
            { MegaInput.selectCard6, Key.Key6 },
            { MegaInput.selectCard7, Key.Key7 },
            { MegaInput.selectCard8, Key.Key8 },
            { MegaInput.selectCard9, Key.Key9 },
            { MegaInput.selectCard10, Key.Key0 },
            { MegaInput.releaseCard, Key.Down },
        };
    ...
    public event InputReboundEventHandler InputRebound
    {
        add
        {
            backing_InputRebound = (InputReboundEventHandler)
                Delegate.Combine(backing_InputRebound, value);
        }
        remove
        {
            backing_InputRebound = (InputReboundEventHandler)
                Delegate.Remove(backing_InputRebound, value);
        }
    }
    ...
    public override void _Ready()
    {
        ControllerManager.Connect(
            ...
            Callable.From(OnControllerTypeChanged)
        );
    ...
    private async Task Init()
    {
        ...
        if (
            settingsSave.ControllerMapping.Count > 0
            && settingsSave.ControllerMappingType == ControllerManager.ControllerMappingType
        )
        {
            Dictionary<StringName, StringName> getDefaultControllerInputMap =
                ControllerManager.GetDefaultControllerInputMap;
            _controllerInputMap = new Dictionary<StringName, StringName>(
                getDefaultControllerInputMap
            );
            {
    ...
    {
        if (
            !(inputEvent is InputEventKey inputEventKey)
            || PlatformUtil.IsPlatformOverlayOpen()
    ...
    {
        KeyValuePair<StringName, Key> keyValuePair = _keyboardInputMap.FirstOrDefault<
            KeyValuePair<StringName, Key>
        >(
            (KeyValuePair<StringName, Key> kvp) =>
                kvp.Value == shortcutKey && remappableKeyboardInputs.Contains(kvp.Key)
        );
    ...
    {
        KeyValuePair<StringName, StringName> keyValuePair = _controllerInputMap.FirstOrDefault<
            KeyValuePair<StringName, StringName>
        >(
            (KeyValuePair<StringName, StringName> kvp) =>
                kvp.Value == controllerInput && remappableControllerInputs.Contains(kvp.Key)
        );
        if (keyValuePair.Key != null)
        {
    ...
    {
        if (
            ControllerManager.ControllerMappingType
            != SaveManager.Instance.SettingsSave.ControllerMappingType
        )
        {
            _controllerInputMap = ControllerManager.GetDefaultControllerInputMap;
            SaveControllerInputMapping();
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.ProcessDebugKeyInput,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.ProcessShortcutKeyInput,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.ModifyControllerButton,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnControllerTypeChanged,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.SaveControllerInputMapping,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.SaveKeyboardInputMapping,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<Key>(
                GetShortcutKey(VariantUtils.ConvertTo<StringName>(in args[0]))
            );
            return true;
        }
        if (method == MethodName.GetHotkeyIcon && args.Count == 1)
        {
            ret = VariantUtils.CreateFrom<Texture2D>(
                GetHotkeyIcon(VariantUtils.ConvertTo<string>(in args[0]))
            );
            return true;
        }
        ...
        {
            ModifyShortcutKey(
                VariantUtils.ConvertTo<StringName>(in args[0]),
                VariantUtils.ConvertTo<Key>(in args[1])
            );
            ret = default(godot_variant);
            return true;
        }
        ...
        {
            ModifyControllerButton(
                VariantUtils.ConvertTo<StringName>(in args[0]),
                VariantUtils.ConvertTo<StringName>(in args[1])
            );
            ret = default(godot_variant);
            return true;
        }
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName.ControllerManager,
                PropertyHint.None,
                "",
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName.ControllerManager,
            Variant.From<NControllerManager>(ControllerManager)
        );
    ...
    protected override void RestoreGodotObjectData(GodotSerializationInfo info)
    {
        ...
        if (
            info.TryGetSignalEventDelegate<InputReboundEventHandler>(
                SignalName.InputRebound,
                out var value2
            )
        )
        {
