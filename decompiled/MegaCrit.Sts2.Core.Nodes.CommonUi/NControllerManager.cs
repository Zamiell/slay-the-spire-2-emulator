...
public class NControllerManager : Node
{
    ...
    public new class PropertyName : Node.PropertyName
    {
        public static readonly StringName ShouldAllowControllerRebinding =
            "ShouldAllowControllerRebinding";
    ...
    public bool ShouldAllowControllerRebinding =>
        _inputStrategy?.ShouldAllowControllerRebinding ?? true;
    ...
    public event ControllerDetectedEventHandler ControllerDetected
    {
        add
        {
            backing_ControllerDetected = (ControllerDetectedEventHandler)
                Delegate.Combine(backing_ControllerDetected, value);
        }
        remove
        {
            backing_ControllerDetected = (ControllerDetectedEventHandler)
                Delegate.Remove(backing_ControllerDetected, value);
        }
    }
    ...
    public event MouseDetectedEventHandler MouseDetected
    {
        add
        {
            backing_MouseDetected = (MouseDetectedEventHandler)
                Delegate.Combine(backing_MouseDetected, value);
        }
        remove
        {
            backing_MouseDetected = (MouseDetectedEventHandler)
                Delegate.Remove(backing_MouseDetected, value);
        }
    }
    ...
    public event ControllerTypeChangedEventHandler ControllerTypeChanged
    {
        add
        {
            backing_ControllerTypeChanged = (ControllerTypeChangedEventHandler)
                Delegate.Combine(backing_ControllerTypeChanged, value);
        }
        remove
        {
            backing_ControllerTypeChanged = (ControllerTypeChangedEventHandler)
                Delegate.Remove(backing_ControllerTypeChanged, value);
        }
    }
    ...
    private void CheckForMouseInput(InputEvent inputEvent)
    {
        ...
        bool flag2 =
            inputEvent is InputEventMouseMotion { Velocity: var velocity } inputEventMouseMotion
            && velocity.LengthSquared() > 100f
            && _skipMouseCheckFrames <= 0
            && inputEventMouseMotion.Relative.LengthSquared() <= 250000f;
    ...
    private void CheckForControllerInput(InputEvent inputEvent)
    {
        if (
            ...
            && Controller.AllControllerInputs.Any((StringName i) => inputEvent.IsActionPressed(i))
        )
        {
    ...
    private void ControlModeChanged()
    {
        ...
        if (IsUsingController)
        {
            _label.SetTextAutoSize(
                new LocString("main_menu_ui", "CONTROLLER_DETECTED").GetFormattedText()
            );
            Log.Info(
                "CONTROLLER DETECTED: "
                    + ((_inputStrategy != null) ? _inputStrategy.GetControllerName() : "NONE")
            );
        }
        else
        {
            _label.SetTextAutoSize(
                new LocString("main_menu_ui", "MOUSE_DETECTED").GetFormattedText()
            );
        }
    }
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.CheckForControllerInput,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnScreenContextChanged,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName.ShouldAllowControllerRebinding,
                PropertyHint.None,
                "",
        ...
        list.Add(
            new PropertyInfo(
                ...
                PropertyName._lastMousePosition,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Int,
                PropertyName._skipMouseCheckFrames,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName.IsUsingController,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._skipMouseCheckFrames,
            Variant.From(in _skipMouseCheckFrames)
        );
        ...
        info.AddSignalEventDelegate(
            SignalName.ControllerTypeChanged,
            backing_ControllerTypeChanged
        );
    }
    ...
    protected override void RestoreGodotObjectData(GodotSerializationInfo info)
    {
        ...
        if (
            info.TryGetSignalEventDelegate<ControllerDetectedEventHandler>(
                SignalName.ControllerDetected,
                out var value6
            )
        )
        {
        ...
        if (
            info.TryGetSignalEventDelegate<MouseDetectedEventHandler>(
                SignalName.MouseDetected,
                out var value7
            )
        )
        {
        ...
        if (
            info.TryGetSignalEventDelegate<ControllerTypeChangedEventHandler>(
                SignalName.ControllerTypeChanged,
                out var value8
            )
        )
