...
public class NProceedButton : NButton
{
    ...
    private static readonly Vector2 _hidePosRatio =
        _showPosRatio + new Vector2(400f, 0f) / NGame.devResolution;
    ...
    protected override void OnDisable()
    {
        ...
        _animTween = CreateTween().SetParallel();
        _animTween
            .TweenProperty(this, "position", HidePos, 0.8)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
    ...
    protected override void OnPress()
    {
        ...
        _hoverTween = CreateTween().SetParallel();
        _hoverTween
            .TweenProperty(this, "scale", Vector2.One * 0.95f, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Color,
                PropertyName._defaultOutlineColor,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Color,
                PropertyName._hoveredOutlineColor,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Color,
                PropertyName._outlineTransparentColor,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._outlineTransparentColor,
            Variant.From(in _outlineTransparentColor)
        );
