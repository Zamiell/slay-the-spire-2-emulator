...
public class NGlobalUi : Control
{
    ...
    public override void _Ready()
    {
        ...
        MultiplayerPlayerContainer = GetNode<NMultiplayerPlayerStateContainer>(
    ...
    )
    {
        ...
        {
            MultiplayerPlayerContainer = VariantUtils.ConvertTo<NMultiplayerPlayerStateContainer>(
                in value
            );
            return true;
        }
    ...
    )
    {
        ...
        if (name == PropertyName.MultiplayerPlayerContainer)
        {
            value = VariantUtils.CreateFrom<NMultiplayerPlayerStateContainer>(
                MultiplayerPlayerContainer
            );
            return true;
        }
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName.CapstoneContainer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName.EventCardPreviewContainer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName.GridCardPreviewContainer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName.AboveTopBarVfxContainer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName.MultiplayerPlayerContainer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName.CapstoneContainer,
            Variant.From<NCapstoneContainer>(CapstoneContainer)
        );
        info.AddProperty(
            PropertyName.RelicInventory,
            Variant.From<NRelicInventory>(RelicInventory)
        );
        info.AddProperty(
            PropertyName.EventCardPreviewContainer,
            Variant.From<Control>(EventCardPreviewContainer)
        );
        info.AddProperty(
            PropertyName.CardPreviewContainer,
        ...
        info.AddProperty(
            PropertyName.GridCardPreviewContainer,
            Variant.From<NGridCardPreviewContainer>(GridCardPreviewContainer)
        );
        info.AddProperty(
            PropertyName.AboveTopBarVfxContainer,
            Variant.From<Control>(AboveTopBarVfxContainer)
        );
        info.AddProperty(PropertyName.MapScreen, Variant.From<NMapScreen>(MapScreen));
        info.AddProperty(
            PropertyName.MultiplayerPlayerContainer,
            Variant.From<NMultiplayerPlayerStateContainer>(MultiplayerPlayerContainer)
        );
        info.AddProperty(
            PropertyName.TimeoutOverlay,
        ...
        info.AddProperty(
            PropertyName.SubmenuStack,
            Variant.From<NCapstoneSubmenuStack>(SubmenuStack)
        );
