...
public class NGridCardPreviewContainer : Control
{
    ...
    private void ReformatElements(Node _)
    {
        ...
        for (int i = 0; i < childCount; i++)
        {
            ...
            Vector2 position =
                vector2
                + new Vector2(
                    num7 + (NCard.defaultSize.X + 25f) * (float)num4,
                    num6 + (NCard.defaultSize.Y + 25f) * (float)num3
                );
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.ForceMaxColumnsUntilEmpty,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.CheckAnyChildrenPresent,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
