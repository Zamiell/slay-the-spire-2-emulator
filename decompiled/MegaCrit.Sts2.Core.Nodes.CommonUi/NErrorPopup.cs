...
public class NErrorPopup : NVerticalPopup, IScreenContext
{
    ...
    public static new IEnumerable<string> AssetPaths =>
    ...
    public override void _Ready()
    {
        ...
        if (_showReportBugButton)
        {
            _verticalPopup.InitYesButton(
                new LocString("main_menu_ui", "NETWORK_ERROR.report_bug"),
                OnReportBugButtonPressed
            );
        }
        else
        {
    ...
    public static NErrorPopup? Create(NetErrorInfo info)
    {
        ...
        return Create(
            new LocString("main_menu_ui", "NETWORK_ERROR.header"),
            LocStringFromNetError(info, out showReportBugButton),
            null,
            showReportBugButton
        );
    }
    ...
    )
    {
        ...
        NErrorPopup nErrorPopup = PreloadManager
            .Cache.GetScene(_scenePath)
            .Instantiate<NErrorPopup>(PackedScene.GenEditState.Disabled);
    ...
    private static LocString LocStringFromNetError(NetErrorInfo info, out bool showReportBugButton)
    {
        ...
        bool flag = (
            (
                ...
                || reason == NetError.StateDivergence
                || (uint)(reason - 17) <= 1u
            )
                ? true
                : false
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnCancelButtonPressed,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnReportBugButtonPressed,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NErrorPopup>(
                Create(
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName._showReportBugButton,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
