...
public class NBackButton : NButton
{
    ...
    public new class PropertyName : NButton.PropertyName
    {
        ...
        public static new readonly StringName ControllerIconHotkey = "ControllerIconHotkey";
    ...
    protected override string[] Hotkeys =>
        new string[3] { MegaInput.cancel, MegaInput.pauseAndBack, MegaInput.back };
    ...
    protected override void OnEnable()
    {
        ...
        _moveTween
            .TweenProperty(this, "global_position", _showPos, 0.35)
    ...
    protected override void OnDisable()
    {
        ...
        _moveTween = CreateTween();
        _moveTween
            .TweenProperty(this, "global_position", _hidePos, 0.35)
            .SetEase(Tween.EaseType.Out)
    ...
    protected override void OnUnfocus()
    {
        ...
        _hoverTween = CreateTween().SetParallel();
        _hoverTween
            .TweenProperty(this, "scale", _hoverScale, 0.5)
            .SetTrans(Tween.TransitionType.Expo)
            .SetEase(Tween.EaseType.Out);
    ...
    protected override void OnPress()
    {
        ...
        _hoverTween = CreateTween().SetParallel();
        _hoverTween
            .TweenProperty(this, "scale", _downScale, 0.25)
            .SetTrans(Tween.TransitionType.Expo)
            .SetEase(Tween.EaseType.Out);
        _hoverTween
            .TweenProperty(_buttonImage, "modulate", _downColor, 0.25)
            .SetTrans(Tween.TransitionType.Cubic)
            .SetEase(Tween.EaseType.Out);
        _hoverTween
            .TweenProperty(_outline, "modulate", _outlineTransparentColor, 0.25)
            .SetTrans(Tween.TransitionType.Cubic)
            .SetEase(Tween.EaseType.Out);
    }
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.String,
                PropertyName.ControllerIconHotkey,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
