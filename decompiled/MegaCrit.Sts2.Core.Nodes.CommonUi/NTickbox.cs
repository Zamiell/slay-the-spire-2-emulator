...
public class NTickbox : NButton
{
    ...
    protected override void OnUnfocus()
    {
        ...
        _tween = CreateTween().SetParallel();
        _tween
            .TweenProperty(_imageContainer, "scale", _baseScale, 0.5)
    ...
    protected override void OnPress()
    {
        ...
        _tween = CreateTween().SetParallel();
        _tween
            .TweenProperty(_imageContainer, "scale", _baseScale * _pressDownScale, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _tween
            .TweenMethod(
    ...
    protected override void RestoreGodotObjectData(GodotSerializationInfo info)
    {
        ...
        if (
            info.TryGetSignalEventDelegate<ToggledEventHandler>(SignalName.Toggled, out var value12)
        )
        {
