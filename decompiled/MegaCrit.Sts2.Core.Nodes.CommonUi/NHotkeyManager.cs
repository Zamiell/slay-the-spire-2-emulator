...
public class NHotkeyManager : Node
{
    ...
    private readonly Dictionary<StringName, List<Action>> _hotkeyPressedBindings =
        new Dictionary<StringName, List<Action>>();

    private readonly Dictionary<StringName, List<Action>> _hotkeyReleasedBindings =
        new Dictionary<StringName, List<Action>>();
    ...
    public override void _UnhandledInput(InputEvent inputEvent)
    {
        ...
        if (
            control != null
            && (
                (control is LineEdit lineEdit && lineEdit.IsEditing())
        ...
        foreach (
            KeyValuePair<StringName, List<Action>> hotkeyPressedBinding in _hotkeyPressedBindings
        )
        {
        ...
        foreach (
            KeyValuePair<StringName, List<Action>> hotkeyReleasedBinding in _hotkeyReleasedBindings
        )
        {
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.RemoveBlockingScreen,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
