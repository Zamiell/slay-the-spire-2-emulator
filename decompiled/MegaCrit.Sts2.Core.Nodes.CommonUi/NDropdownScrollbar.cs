...
public class NDropdownScrollbar : NButton
{
    public new class MethodName : NButton.MethodName
    {
        ...
        public static readonly StringName SetTrainPositionFromPercentage =
            "SetTrainPositionFromPercentage";
    }
    ...
    public override void _GuiInput(InputEvent inputEvent)
    {
        ...
        if (hasControl && inputEvent is InputEventMouseMotion inputEventMouseMotion)
        {
            ...
            ClampTrain();
            _dropdownContainer.UpdatePositionBasedOnTrain(
                1f
                    - (_train.Position.Y - _scrollLimitBottom)
                        / (_scrollLimitTop - _scrollLimitBottom)
            );
        }
    }
    ...
    {
        _train.Position = new Vector2(
            _train.Position.X,
            Mathf.Clamp(_train.Position.Y, _scrollLimitBottom, _scrollLimitTop)
        );
    }
    ...
    public void SetTrainPositionFromPercentage(float percentage)
    {
        _train.Position = new Vector2(
            _train.Position.X,
            _scrollLimitBottom + percentage * (_scrollLimitTop - _scrollLimitBottom)
        );
    }
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.SetTrainPositionFromPercentage,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._dropdownContainer,
                PropertyHint.None,
                "",
