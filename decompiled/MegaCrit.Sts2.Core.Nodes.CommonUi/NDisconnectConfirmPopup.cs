...
public class NDisconnectConfirmPopup : Control, IScreenContext
{
    ...
    public override void _Ready()
    {
        ...
        _verticalPopup.SetText(
            new LocString("settings_ui", "DISCONNECT_CONFIRMATION.header"),
            new LocString("settings_ui", "DISCONNECT_CONFIRMATION.body")
        );
    ...
    public static NDisconnectConfirmPopup? Create()
    {
        ...
        return PreloadManager
            ...
            .Instantiate<NDisconnectConfirmPopup>(PackedScene.GenEditState.Disabled);
    }
