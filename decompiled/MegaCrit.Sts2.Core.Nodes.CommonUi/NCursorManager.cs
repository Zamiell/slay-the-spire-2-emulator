...
public class NCursorManager : Node
{
    ...
    public override void _Input(InputEvent inputEvent)
    {
        if (
            ...
            && (
                ...
                || inputEventMouseButton.ButtonIndex == MouseButton.Middle
            )
        )
        {
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.StopOverridingCursor,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.SetIsUsingController,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    )
    {
        ...
        {
            OverrideCursor(
                VariantUtils.ConvertTo<Image>(in args[0]),
                VariantUtils.ConvertTo<Image>(in args[1]),
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._overriddenCursorTilted,
                PropertyHint.None,
                "",
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._overriddenCursorNotTilted,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName._isUsingController,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName._shouldShowCursor,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._overriddenCursorTilted,
            Variant.From(in _overriddenCursorTilted)
        );
        info.AddProperty(
            PropertyName._overriddenCursorNotTilted,
            Variant.From(in _overriddenCursorNotTilted)
        );
