...
public class NTopBar : Control
{
    ...
    public override void _Ready()
    {
        ...
        ActiveScreenProxy.Connect(
            Control.SignalName.FocusEntered,
            Callable.From(
                delegate
                {
                    ActiveScreenContext
                        .Instance.GetCurrentScreen()
                        ?.FocusedControlFromTopBar?.TryGrabFocus();
                }
            )
        );
        _capstoneContainer = GetParent().GetNode<NCapstoneContainer>("%CapstoneScreenContainer");
        _capstoneContainer.Connect(
            Node.SignalName.ChildEnteredTree,
            Callable.From<Node>(ToggleAnimState)
        );
        _capstoneContainer.Connect(
    ...
    public void AnimHide()
    {
        ...
        _hideTween
            .TweenProperty(this, "position:y", -100f, 0.25)
    ...
    public void AnimShow()
    {
        ...
        _hideTween = CreateTween();
        _hideTween
            .TweenProperty(this, "position:y", 0f, 0.25)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Cubic);
    }
    ...
    private void UpdateNavigation()
    {
        ...
        for (int i = 0; i < array.Length; i++)
        {
            ...
            control2.FocusNeighborRight = (
                (i < array.Length - 1) ? array[i + 1].GetPath() : control2.GetPath()
            );
            if (i > 0)
            {
            ...
            {
                control2.FocusNeighborLeft = (
                    BossIcon.IsVisible() ? BossIcon.GetPath() : FloorIcon.GetPath()
                );
            }
        }
    }
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._capstoneContainer,
                PropertyHint.None,
                "",
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName.ActiveScreenProxy,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName.PotionContainer,
            Variant.From<NPotionContainer>(PotionContainer)
        );
