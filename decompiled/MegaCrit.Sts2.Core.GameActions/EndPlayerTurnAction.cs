...
public class EndPlayerTurnAction : GameAction
{
    ...
    protected override Task ExecuteAction()
    {
        ...
        {
            Log.Info(
                $"Ignoring end turn action. Current turn number: {turnNumber} action turn number: {_turnNumber} CombatState: {RunManager.Instance.ActionQueueSynchronizer.CombatState}"
            );
        }
    ...
    {
        return new NetEndPlayerTurnAction { turnNumber = _turnNumber };
    }
