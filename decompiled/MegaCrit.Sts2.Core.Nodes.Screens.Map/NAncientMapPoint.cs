...
public class NAncientMapPoint : NMapPoint
{
    ...
    private static string UntravelableMaterialPath =>
        "res://materials/boss_map_point_unavailable.tres";
    ...
    public static IEnumerable<string> AssetPaths =>
        new global::_003C_003Ez__ReadOnlyArray<string>(
            new string[2] { UntravelableMaterialPath, AncientMapPointPath }
        );
    ...
    {
        NAncientMapPoint nAncientMapPoint = PreloadManager
            .Cache.GetScene(AncientMapPointPath)
            .Instantiate<NAncientMapPoint>(PackedScene.GenEditState.Disabled);
