...
public abstract class NMapPoint : NButton
{
    ...
    public new class PropertyName : NButton.PropertyName
    {
        ...
        public static new readonly StringName AllowFocusWhileDisabled = "AllowFocusWhileDisabled";
    ...
    protected sealed override void OnRelease()
    {
        if (
            ...
            && (_screen.IsNodeOnScreen(this) || !NControllerManager.Instance.IsUsingController)
        )
        {
    ...
    protected override void OnFocus()
    {
        ...
        if (
            _state != MapPointState.Traveled
            || !(_runState.MapLocation.coord != Point.coord)
            || NControllerManager.Instance.IsUsingController
        )
        {
            return;
        }
        MapPointHistoryEntry historyEntryFor = _runState.GetHistoryEntryFor(
            new MapLocation(Point.coord, _runState.CurrentActIndex)
        );
        if (historyEntryFor != null)
        {
            ...
            NHoverTipSet tip = NHoverTipSet.CreateAndShowMapPointHistory(
                this,
                NMapPointHistoryHoverTip.Create(num, LocalContext.NetId.Value, historyEntryFor)
            );
            Callable
                .From(
                    delegate
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.RefreshVisualsInstantly,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._controllerSelectionReticle,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName.VoteContainer,
            Variant.From<NMultiplayerVoteContainer>(VoteContainer)
        );
        ...
        info.AddProperty(
            PropertyName._controllerSelectionReticle,
            Variant.From(in _controllerSelectionReticle)
        );
