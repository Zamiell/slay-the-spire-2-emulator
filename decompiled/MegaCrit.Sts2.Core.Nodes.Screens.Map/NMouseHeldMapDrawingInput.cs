...
public class NMouseHeldMapDrawingInput : NMapDrawingInput
{
    ...
    public override void _Ready()
    {
        ...
        _drawings.BeginLineLocal(
            _drawings.GetGlobalTransform().Inverse() * GetGlobalMousePosition(),
            null
        );
    }
    ...
    public override void _Input(InputEvent inputEvent)
    {
        if (IsVisibleInTree())
        {
            ...
            if (
                inputEvent is InputEventMouseMotion inputEventMouseMotion
                && _drawings.IsLocalDrawing()
            )
            {
                _drawings.UpdateCurrentLinePositionLocal(
                    _drawings.GetGlobalTransform().Inverse() * inputEventMouseMotion.GlobalPosition
                );
            }
        }
    }
    ...
    private void ProcessMouseDrawingEvent(InputEvent inputEvent)
    {
        if (
            ...
            && inputEventMouseButton.ButtonIndex == ListeningButton
