...
public class NMapEraseButton : NButton
{
    ...
    private static readonly StringName _glowImagePath =
        "res://images/packed/map/drawing_eraser_glow.png";
    ...
    public static IEnumerable<string> AssetPaths =>
        new global::_003C_003Ez__ReadOnlyArray<string>(
            new string[2] { _imagePath, _glowImagePath }
        );
    ...
    public override void _Ready()
    {
        ...
        instance.Connect(
            ...
            Callable.From(OnControllerUpdated)
        );
        instance.Connect(
    ...
    protected override void OnFocus()
    {
        ...
        NHoverTipSet
            .CreateAndShow(_drawingToolHolder, _hoverTip)
            ?.SetGlobalPosition(_drawingToolHolder.GlobalPosition + new Vector2(10f, -132f));
    }
    ...
    protected override void OnUnfocus()
    {
        ...
        _tween.TweenProperty(
            _icon,
            "self_modulate",
            _isErasing ? _activeColor : _inactiveColor,
            0.05
        );
    ...
    private void OnControllerUpdated()
    {
        ...
        LocString title = (
            (!NControllerManager.Instance.IsUsingController)
                ...
                : new LocString("map", "ERASING_BUTTON.title_controller")
        );
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnControllerUpdated,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._drawingToolHolder,
                PropertyHint.None,
                "",
