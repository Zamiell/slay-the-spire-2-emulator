...
public class NMapLegendItem : NButton
{
    ...
    private void SetMapPointType(string name)
    {
        _pointType = name switch
        {
            ...
            _ => throw new ArgumentOutOfRangeException(
                "Unknown Node " + name + " when setting MapLegend localization."
            ),
        };
    }
    ...
    private void SetLocalizedFields(string name)
    {
        ...
        GetNode<MegaLabel>("MegaLabel")
            .SetTextAutoSize(new LocString("map", text + ".title").GetFormattedText());
        _hoverTip = new HoverTip(
            new LocString("map", text + ".hoverTip.title"),
            new LocString("map", text + ".hoverTip.description")
        );
    }
    ...
    protected override void OnFocus()
    {
        ...
        nHoverTipSet?.SetGlobalPosition(
            parent.GlobalPosition + new Vector2(parent.Size.X - nHoverTipSet.Size.X, parent.Size.Y)
        );
