...
public class NMapMarker : TextureRect
{
    ...
    public void HideMapPoint()
    {
        if (_isEnabled)
        {
            ...
            _tween = CreateTween();
            _tween
                .TweenProperty(this, "scale", Vector2.Zero, 0.20000000298023224)
                .From(Vector2.One);
    ...
    public void SetMapPoint(NMapPoint node)
    {
        if (_isEnabled)
        {
            ...
            if (!base.Visible)
            {
                ...
                _tween = CreateTween();
                _tween
                    .TweenProperty(this, "scale", Vector2.One, 0.20000000298023224)
                    .From(Vector2.Down);
                _tween
                    .Parallel()
                    .TweenProperty(
                    ...
                    .FromCurrent();
                _tween
                    .TweenProperty(this, "position", base.Position, 0.75)
