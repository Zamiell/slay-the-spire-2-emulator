...
public class NNormalMapPoint : NMapPoint
{
    public new class MethodName : NMapPoint.MethodName
    {
        ...
        public static new readonly StringName OnSelected = "OnSelected";
        ...
        public static new readonly StringName RefreshColorInstantly = "RefreshColorInstantly";

        public static new readonly StringName RefreshState = "RefreshState";
    ...
    {
        public static new readonly StringName TraveledColor = "TraveledColor";

        public static new readonly StringName UntravelableColor = "UntravelableColor";

        public static new readonly StringName HoveredColor = "HoveredColor";

        public static new readonly StringName HoverScale = "HoverScale";

        public static new readonly StringName DownScale = "DownScale";
    ...
    private static string OutlinePath(string filename)
    {
        return ImageHelper.GetImagePath(
            "atlases/compressed.sprites/map/" + filename + "_outline.tres"
        );
    }
    ...
    {
        return ImageHelper.GetImagePath(
            "atlases/ui_atlas.sprites/map/icons/map_"
                + pointType switch
                {
    ...
    {
        NNormalMapPoint nNormalMapPoint = PreloadManager
            .Cache.GetScene(ScenePath)
            .Instantiate<NNormalMapPoint>(PackedScene.GenEditState.Disabled);
    ...
    public override void OnSelected()
    {
        ...
        _tween
            .TweenProperty(_iconContainer, "scale", Vector2.One, 0.3)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Cubic);
        _tween
            .TweenProperty(_icon, "scale", Vector2.One, 0.3)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Back);
        _tween
            .TweenProperty(_questIcon, "scale", Vector2.One, 0.3)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Back);
        _tween
            .TweenProperty(_icon, "self_modulate", base.TargetColor, 0.3)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _tween
            .TweenProperty(_outline, "modulate", _runState.Act.MapBgColor, 0.3)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
    }
    ...
    private void UpdateIcon()
    {
        if (base.Point.PointType != MapPointType.Unknown || base.State != MapPointState.Traveled)
        {
            ...
            _outline.Texture = ResourceLoader.Load<Texture2D>(
                path2,
                null,
                ResourceLoader.CacheMode.Reuse
            );
        ...
        {
            IReadOnlyList<MapPointHistoryEntry> readOnlyList = _runState.MapPointHistory[
    ...
    private void AnimUnhover()
    {
        ...
        _tween = CreateTween().SetParallel();
        _tween
            .TweenProperty(_icon, "scale", Vector2.One, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Cubic);
        _tween
            .TweenProperty(_questIcon, "scale", Vector2.One, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Cubic);
        _tween
            .TweenProperty(_icon, "self_modulate", base.TargetColor, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Cubic);
        _tween
            .TweenProperty(_outline, "modulate", _runState.Act.MapBgColor, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Cubic);
    }
    ...
    private void AnimPressDown()
    {
        ...
        _tween = CreateTween().SetParallel();
        _tween
            .TweenProperty(_icon, "scale", DownScale, 0.3)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Cubic);
        _tween
            .TweenProperty(_questIcon, "scale", DownScale, 0.3)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Cubic);
        _tween
            .TweenProperty(_outline, "modulate", _runState.Act.MapBgColor, 0.3)
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.RefreshMarkedIconVisibility,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnHighlightPointType,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    )
    {
        if (method == MethodName.IconName && args.Count == 1)
        {
            ret = VariantUtils.CreateFrom<string>(
                IconName(VariantUtils.ConvertTo<MapPointType>(in args[0]))
            );
            return true;
        }
        ...
        {
            ret = VariantUtils.CreateFrom<string>(
                IconPath(VariantUtils.ConvertTo<string>(in args[0]))
            );
            return true;
        }
        ...
        {
            ret = VariantUtils.CreateFrom<string>(
                OutlinePath(VariantUtils.ConvertTo<string>(in args[0]))
            );
            return true;
        }
        ...
        {
            ret = VariantUtils.CreateFrom<string>(
                UnknownIconPath(VariantUtils.ConvertTo<RoomType>(in args[0]))
            );
            return true;
        }
        ...
        {
            ret = VariantUtils.CreateFrom<string>(
                UnknownOutlinePath(VariantUtils.ConvertTo<RoomType>(in args[0]))
            );
            return true;
        }
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Color,
                PropertyName.UntravelableColor,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
