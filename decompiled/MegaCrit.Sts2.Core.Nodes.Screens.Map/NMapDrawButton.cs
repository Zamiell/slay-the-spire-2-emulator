...
public class NMapDrawButton : NButton
{
    ...
    private static readonly StringName _glowImagePath =
        "res://images/packed/map/drawing_quill_glow.png";
    ...
    protected override void OnUnfocus()
    {
        ...
        _tween.TweenProperty(
            _icon,
            "self_modulate",
            _isDrawing ? _activeColor : _inactiveColor,
            0.05
        );
    ...
    private void OnControllerUpdated()
    {
        ...
        LocString title = (
            (!NControllerManager.Instance.IsUsingController)
                ...
                : new LocString("map", "DRAWING_BUTTON.title_controller")
        );
