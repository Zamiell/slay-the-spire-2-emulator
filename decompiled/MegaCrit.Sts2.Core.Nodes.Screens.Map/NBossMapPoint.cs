...
public class NBossMapPoint : NMapPoint
{
    ...
    public static IEnumerable<string> AssetPaths =>
        new global::_003C_003Ez__ReadOnlySingleElementList<string>(BossMapPointPath);

    public static NBossMapPoint Create(MapPoint point, NMapScreen screen, IRunState runState)
    {
        NBossMapPoint nBossMapPoint = PreloadManager
            .Cache.GetScene(BossMapPointPath)
            .Instantiate<NBossMapPoint>(PackedScene.GenEditState.Disabled);
    ...
    public override void _Ready()
    {
        ...
        EncounterModel encounterModel = (
            (base.Point == _runState.Map.SecondBossMapPoint)
        ...
        else
        {
            ...
            _placeholderImage.Texture = PreloadManager.Cache.GetAsset<Texture2D>(
                encounterModel.BossNodePath + ".png"
            );
            _placeholderOutline.Texture = PreloadManager.Cache.GetAsset<Texture2D>(
                encounterModel.BossNodePath + "_outline.png"
            );
    ...
    protected override void OnUnfocus()
    {
        ...
        if (IsInputAllowed())
        {
            ...
            _hoverTween = CreateTween().SetParallel();
            _hoverTween
                .TweenProperty(_spriteContainer, "scale", Vector2.One, 0.5)
    ...
    protected override void OnPress()
    {
        if (base.IsTravelable)
        {
            ...
            _hoverTween = CreateTween().SetParallel();
            _hoverTween
                .TweenProperty(_spriteContainer, "scale", DownScale, 0.3)
                .SetEase(Tween.EaseType.Out)
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._placeholderImage,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._placeholderOutline,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
