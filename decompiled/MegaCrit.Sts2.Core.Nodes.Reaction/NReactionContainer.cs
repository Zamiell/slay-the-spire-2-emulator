...
public class NReactionContainer : Control
{
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.DeinitializeNetworking,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    )
    {
        ...
        {
            DoRemoteReaction(
                VariantUtils.ConvertTo<ReactionType>(in args[0]),
                VariantUtils.ConvertTo<Vector2>(in args[1])
            );
            ret = default(godot_variant);
            return true;
