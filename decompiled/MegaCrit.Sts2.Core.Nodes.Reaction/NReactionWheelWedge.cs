...
public class NReactionWheelWedge : TextureRect
{
    ...
    public void OnSelected()
    {
        ...
        _tween.SetParallel();
        _tween
            .TweenProperty(this, "position", _defaultPosition + vector * 25f, 0.05)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _tween
            .TweenProperty(this, "self_modulate", _selectedColor, 0.05)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
    }
    ...
    public void OnDeselected()
    {
        ...
        _tween.SetParallel();
        _tween
            .TweenProperty(this, "position", _defaultPosition, 0.2)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _tween
            .TweenProperty(this, "self_modulate", _defaultColor, 0.2)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
    }
