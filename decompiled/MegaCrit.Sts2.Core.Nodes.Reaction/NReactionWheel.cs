...
public class NReactionWheel : Control
{
    ...
    private void React()
    {
        ...
        {
            NGame.Instance.ReactionContainer.DoLocalReaction(
                _selectedWedge.Reaction,
                _centerPosition
            );
        }
    }
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.WarpMouseBackToOriginalPosition,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NReactionWheelWedge>(
                GetSelectedWedge(VariantUtils.ConvertTo<float>(in args[0]))
            );
            return true;
        }
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName._ignoreNextMouseInput,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._ignoreNextMouseInput,
            Variant.From(in _ignoreNextMouseInput)
        );
