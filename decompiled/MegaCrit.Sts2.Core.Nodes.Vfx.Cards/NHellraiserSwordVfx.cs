...
public class NHellraiserSwordVfx : Control
{
    ...
    private static readonly string _scenePath = SceneHelper.GetScenePath(
        "vfx/cards/vfx_hellraiser/hellraiser_sword_vfx"
    );
    ...
    public static NHellraiserSwordVfx? Create()
    {
        ...
        return PreloadManager
            ...
            .Instantiate<NHellraiserSwordVfx>(PackedScene.GenEditState.Disabled);
    }
    ...
    public override void _Ready()
    {
        ...
        base.Scale =
            new Vector2(Rng.Chaotic.NextFloat(0.7f, 0.9f), Rng.Chaotic.NextFloat(0.8f, 1.2f))
            * Rng.Chaotic.NextFloat(1f, 2f);
        ...
        tween.Chain();
        tween
            .TweenProperty(_sword, "position:y", 80f, 0.25)
            .From(300f)
        ...
        tween.Chain();
        tween
            .TweenProperty(_sword, "position:y", 200f, 0.5)
