...
public class NFanOfKnivesVfx : Node2D
{
    ...
    public static NFanOfKnivesVfx? Create(Creature target)
    {
        ...
        NFanOfKnivesVfx nFanOfKnivesVfx = PreloadManager
            .Cache.GetScene(_scenePath)
            .Instantiate<NFanOfKnivesVfx>(PackedScene.GenEditState.Disabled);
        nFanOfKnivesVfx._spawnPosition = NCombatRoom
            .Instance.GetCreatureNode(target)
            .VfxSpawnPosition;
    ...
    private async Task Animate()
    {
        ...
        foreach (Node2D shiv in _shivs)
        {
            ...
            _spawnTween
                .TweenProperty(shiv, "offset:y", -180f, num)
                .From(0f)
                .SetEase(Tween.EaseType.Out)
                .SetTrans(Tween.TransitionType.Back);
            _spawnTween
                .TweenProperty(shiv, "modulate", Colors.White, num)
                .From(StsColors.transparentBlack);
            _spawnTween
                .TweenProperty(shiv.GetNode<Node2D>("Shadow"), "offset:y", -180f, num)
                .From(0f)
                .SetEase(Tween.EaseType.Out)
                .SetTrans(Tween.TransitionType.Back);
        }
        ...
        {
            _spawnTween
                .TweenProperty(shiv2, "modulate", StsColors.transparentWhite, 0.4)
        ...
        _fanTween.Chain();
        _fanTween
            .TweenProperty(_shiv1, "rotation", -1.74533f, 0.8)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Back);
        _fanTween
            .TweenProperty(_shiv2, "rotation", -1.3089975f, 0.8)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Back);
        _fanTween
            .TweenProperty(_shiv3, "rotation", -0.872665f, 0.8)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Back);
        _fanTween
            .TweenProperty(_shiv4, "rotation", -0.4363325f, 0.8)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Back);
        _fanTween
            .TweenProperty(_shiv6, "rotation", 0.4363325f, 0.8)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Back);
        _fanTween
            .TweenProperty(_shiv7, "rotation", 0.872665f, 0.8)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Back);
        _fanTween
            .TweenProperty(_shiv8, "rotation", 1.3089975f, 0.8)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Back);
        _fanTween
            .TweenProperty(_shiv9, "rotation", 1.74533f, 0.8)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Back);
