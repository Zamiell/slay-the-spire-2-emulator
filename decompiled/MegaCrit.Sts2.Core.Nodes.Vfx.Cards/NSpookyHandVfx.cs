...
public class NSpookyHandVfx : Control
{
    ...
    private void AnimateIn()
    {
        ...
        base.Modulate = new Color(
            base.Modulate.R + Rng.Chaotic.NextFloat(-0.2f, 0.2f),
            base.Modulate.G,
            base.Modulate.B
        );
        ...
        tween.Chain();
        tween
            .TweenProperty(this, "scale", _targetScale, Rng.Chaotic.NextDouble(0.4, 0.5))
        ...
        tween
            .TweenProperty(this, "scale", _targetScale * 0.5f, duration)
            .SetEase(Tween.EaseType.In)
            .SetTrans(Tween.TransitionType.Back);
        tween
            .TweenProperty(this, "modulate:a", 0f, duration)
            .SetEase(Tween.EaseType.Out)
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName._elapsedPauseTime,
                PropertyHint.None,
                "",
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName._originalRotation,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
