...
public class NHellraiserVfx : Control
{
    ...
    private static readonly string _scenePath = SceneHelper.GetScenePath(
        "vfx/cards/vfx_hellraiser/hellraiser_vfx"
    );
    ...
    public static NHellraiserVfx? Create(Creature target)
    {
        ...
        NHellraiserVfx nHellraiserVfx = PreloadManager
            .Cache.GetScene(_scenePath)
            .Instantiate<NHellraiserVfx>(PackedScene.GenEditState.Disabled);
        nHellraiserVfx._spawnPosition =
            NCombatRoom.Instance.GetCreatureNode(target).GetBottomOfHitbox() + _vfxOffset;
