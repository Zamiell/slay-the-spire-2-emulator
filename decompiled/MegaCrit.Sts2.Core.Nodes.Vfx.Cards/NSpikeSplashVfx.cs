...
public class NSpikeSplashVfx : Node2D
{
    ...
    public static NSpikeSplashVfx? Create(Creature target, VfxColor vfxColor = VfxColor.Red)
    {
        ...
        NSpikeSplashVfx nSpikeSplashVfx = PreloadManager
            .Cache.GetScene(_scenePath)
            .Instantiate<NSpikeSplashVfx>(PackedScene.GenEditState.Disabled);
        nSpikeSplashVfx._spawnPosition = NCombatRoom
    ...
    public override void _Ready()
    {
        ...
        {
            NFgGroundSpikeVfx child = NFgGroundSpikeVfx.Create(
                _spawnPosition,
                movingRight: true,
                _vfxColor
            );
        ...
        {
            NBgGroundSpikeVfx child2 = NBgGroundSpikeVfx.Create(
                _spawnPosition,
                movingRight: true,
                _vfxColor
            );
