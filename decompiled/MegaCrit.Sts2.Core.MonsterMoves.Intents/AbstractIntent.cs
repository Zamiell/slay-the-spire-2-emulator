...
public abstract class AbstractIntent
{
    ...
    public virtual IEnumerable<string> AssetPaths
    {
        get
        {
            if (SpritePath != null)
            {
                return new global::_003C_003Ez__ReadOnlySingleElementList<string>(
    ...
    public HoverTip GetHoverTip(IEnumerable<Creature> targets, Creature owner)
    {
        ...
        return new HoverTip(
            IntentTitle,
            GetIntentDescription(targets2, owner),
            GetTexture(targets2, owner)
        );
    }
    ...
    protected virtual LocString GetIntentDescription(IEnumerable<Creature> targets, Creature owner)
    {
        ...
        locString.Add(
            "IsMultiplayer",
            combatState != null && combatState.RunState.Players.Count > 1
        );
        return locString;
    }
}
