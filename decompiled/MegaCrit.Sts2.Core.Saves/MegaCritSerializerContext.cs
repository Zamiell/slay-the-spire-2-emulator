...
internal class MegaCritSerializerContext : JsonSerializerContext, IJsonTypeInfoResolver
{
    ...
    private JsonTypeInfo<
        Dictionary<ulong, List<SerializableReward>>
    >? _DictionaryUInt64ListSerializableReward;
    ...
    private JsonTypeInfo<
        List<SavedProperties.SavedProperty<SerializableCard[]>>
    >? _ListSavedPropertySerializableCardArray;

    private JsonTypeInfo<
        List<SavedProperties.SavedProperty<SerializableCard>>
    >? _ListSavedPropertySerializableCard;
    ...
    private JsonTypeInfo<
        List<SerializableUnlockedAchievement>
    >? _ListSerializableUnlockedAchievement;
    ...
    private JsonTypeInfo<
        List<List<PlayerMapPointHistoryEntry>>
    >? _ListListPlayerMapPointHistoryEntry;
    ...
    private const BindingFlags InstanceMemberBindingFlags =
        BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic;

    public static JsonSerializerOptions DefaultGeneratedSerializerOptions =>
        Default.GeneratedSerializerOptions;

    public JsonTypeInfo<bool> Boolean =>
        _Boolean ?? (_Boolean = (JsonTypeInfo<bool>)base.Options.GetTypeInfo(typeof(bool)));

    public JsonTypeInfo<double> Double =>
        _Double ?? (_Double = (JsonTypeInfo<double>)base.Options.GetTypeInfo(typeof(double)));

    public JsonTypeInfo<float> Single =>
        _Single ?? (_Single = (JsonTypeInfo<float>)base.Options.GetTypeInfo(typeof(float)));

    public JsonTypeInfo<Vector2> Vector2 =>
        _Vector2 ?? (_Vector2 = (JsonTypeInfo<Vector2>)base.Options.GetTypeInfo(typeof(Vector2)));

    public JsonTypeInfo<Vector2I> Vector2I =>
        _Vector2I
        ?? (_Vector2I = (JsonTypeInfo<Vector2I>)base.Options.GetTypeInfo(typeof(Vector2I)));

    public JsonTypeInfo<ControllerMappingType> ControllerMappingType =>
        _ControllerMappingType
        ?? (
            _ControllerMappingType =
                (JsonTypeInfo<ControllerMappingType>)
                    base.Options.GetTypeInfo(typeof(ControllerMappingType))
        );

    public JsonTypeInfo<RelicRarity> RelicRarity =>
        _RelicRarity
        ?? (
            _RelicRarity = (JsonTypeInfo<RelicRarity>)base.Options.GetTypeInfo(typeof(RelicRarity))
        );

    public JsonTypeInfo<PlayerRngType> PlayerRngType =>
        _PlayerRngType
        ?? (
            _PlayerRngType =
                (JsonTypeInfo<PlayerRngType>)base.Options.GetTypeInfo(typeof(PlayerRngType))
        );

    public JsonTypeInfo<RunRngType> RunRngType =>
        _RunRngType
        ?? (_RunRngType = (JsonTypeInfo<RunRngType>)base.Options.GetTypeInfo(typeof(RunRngType)));

    public JsonTypeInfo<LocString> LocString =>
        _LocString
        ?? (_LocString = (JsonTypeInfo<LocString>)base.Options.GetTypeInfo(typeof(LocString)));

    public JsonTypeInfo<MapCoord> MapCoord =>
        _MapCoord
        ?? (_MapCoord = (JsonTypeInfo<MapCoord>)base.Options.GetTypeInfo(typeof(MapCoord)));

    public JsonTypeInfo<MapPointType> MapPointType =>
        _MapPointType
        ?? (
            _MapPointType =
                (JsonTypeInfo<MapPointType>)base.Options.GetTypeInfo(typeof(MapPointType))
        );

    public JsonTypeInfo<ModDependency> ModDependency =>
        _ModDependency
        ?? (
            _ModDependency =
                (JsonTypeInfo<ModDependency>)base.Options.GetTypeInfo(typeof(ModDependency))
        );

    public JsonTypeInfo<ModManifest> ModManifest =>
        _ModManifest
        ?? (
            _ModManifest = (JsonTypeInfo<ModManifest>)base.Options.GetTypeInfo(typeof(ModManifest))
        );

    public JsonTypeInfo<ModSettings> ModSettings =>
        _ModSettings
        ?? (
            _ModSettings = (JsonTypeInfo<ModSettings>)base.Options.GetTypeInfo(typeof(ModSettings))
        );

    public JsonTypeInfo<ModSource> ModSource =>
        _ModSource
        ?? (_ModSource = (JsonTypeInfo<ModSource>)base.Options.GetTypeInfo(typeof(ModSource)));

    public JsonTypeInfo<SettingsSaveMod> SettingsSaveMod =>
        _SettingsSaveMod
        ?? (
            _SettingsSaveMod =
                (JsonTypeInfo<SettingsSaveMod>)base.Options.GetTypeInfo(typeof(SettingsSaveMod))
        );

    public JsonTypeInfo<BadgeRarity> BadgeRarity =>
        _BadgeRarity
        ?? (
            _BadgeRarity = (JsonTypeInfo<BadgeRarity>)base.Options.GetTypeInfo(typeof(BadgeRarity))
        );

    public JsonTypeInfo<ModelId> ModelId =>
        _ModelId ?? (_ModelId = (JsonTypeInfo<ModelId>)base.Options.GetTypeInfo(typeof(ModelId)));

    public JsonTypeInfo<FeedbackData> FeedbackData =>
        _FeedbackData
        ?? (
            _FeedbackData =
                (JsonTypeInfo<FeedbackData>)base.Options.GetTypeInfo(typeof(FeedbackData))
        );

    public JsonTypeInfo<NullLeaderboard> NullLeaderboard =>
        _NullLeaderboard
        ?? (
            _NullLeaderboard =
                (JsonTypeInfo<NullLeaderboard>)base.Options.GetTypeInfo(typeof(NullLeaderboard))
        );

    public JsonTypeInfo<NullLeaderboardFile> NullLeaderboardFile =>
        _NullLeaderboardFile
        ?? (
            _NullLeaderboardFile =
                (JsonTypeInfo<NullLeaderboardFile>)
                    base.Options.GetTypeInfo(typeof(NullLeaderboardFile))
        );

    public JsonTypeInfo<NullLeaderboardFileEntry> NullLeaderboardFileEntry =>
        _NullLeaderboardFileEntry
        ?? (
            _NullLeaderboardFileEntry =
                (JsonTypeInfo<NullLeaderboardFileEntry>)
                    base.Options.GetTypeInfo(typeof(NullLeaderboardFileEntry))
        );

    public JsonTypeInfo<NullMultiplayerName> NullMultiplayerName =>
        _NullMultiplayerName
        ?? (
            _NullMultiplayerName =
                (JsonTypeInfo<NullMultiplayerName>)
                    base.Options.GetTypeInfo(typeof(NullMultiplayerName))
        );

    public JsonTypeInfo<PlatformType> PlatformType =>
        _PlatformType
        ?? (
            _PlatformType =
                (JsonTypeInfo<PlatformType>)base.Options.GetTypeInfo(typeof(PlatformType))
        );

    public JsonTypeInfo<RewardType> RewardType =>
        _RewardType
        ?? (_RewardType = (JsonTypeInfo<RewardType>)base.Options.GetTypeInfo(typeof(RewardType)));

    public JsonTypeInfo<RoomType> RoomType =>
        _RoomType
        ?? (_RoomType = (JsonTypeInfo<RoomType>)base.Options.GetTypeInfo(typeof(RoomType)));

    public JsonTypeInfo<CardCreationSource> CardCreationSource =>
        _CardCreationSource
        ?? (
            _CardCreationSource =
                (JsonTypeInfo<CardCreationSource>)
                    base.Options.GetTypeInfo(typeof(CardCreationSource))
        );

    public JsonTypeInfo<CardRarityOddsType> CardRarityOddsType =>
        _CardRarityOddsType
        ?? (
            _CardRarityOddsType =
                (JsonTypeInfo<CardRarityOddsType>)
                    base.Options.GetTypeInfo(typeof(CardRarityOddsType))
        );

    public JsonTypeInfo<GameMode> GameMode =>
        _GameMode
        ?? (_GameMode = (JsonTypeInfo<GameMode>)base.Options.GetTypeInfo(typeof(GameMode)));

    public JsonTypeInfo<AncientChoiceHistoryEntry> AncientChoiceHistoryEntry =>
        _AncientChoiceHistoryEntry
        ?? (
            _AncientChoiceHistoryEntry =
                (JsonTypeInfo<AncientChoiceHistoryEntry>)
                    base.Options.GetTypeInfo(typeof(AncientChoiceHistoryEntry))
        );

    public JsonTypeInfo<CardChoiceHistoryEntry> CardChoiceHistoryEntry =>
        _CardChoiceHistoryEntry
        ?? (
            _CardChoiceHistoryEntry =
                (JsonTypeInfo<CardChoiceHistoryEntry>)
                    base.Options.GetTypeInfo(typeof(CardChoiceHistoryEntry))
        );

    public JsonTypeInfo<CardEnchantmentHistoryEntry> CardEnchantmentHistoryEntry =>
        _CardEnchantmentHistoryEntry
        ?? (
            _CardEnchantmentHistoryEntry =
                (JsonTypeInfo<CardEnchantmentHistoryEntry>)
                    base.Options.GetTypeInfo(typeof(CardEnchantmentHistoryEntry))
        );

    public JsonTypeInfo<CardTransformationHistoryEntry> CardTransformationHistoryEntry =>
        _CardTransformationHistoryEntry
        ?? (
            _CardTransformationHistoryEntry =
                (JsonTypeInfo<CardTransformationHistoryEntry>)
                    base.Options.GetTypeInfo(typeof(CardTransformationHistoryEntry))
        );

    public JsonTypeInfo<EventOptionHistoryEntry> EventOptionHistoryEntry =>
        _EventOptionHistoryEntry
        ?? (
            _EventOptionHistoryEntry =
                (JsonTypeInfo<EventOptionHistoryEntry>)
                    base.Options.GetTypeInfo(typeof(EventOptionHistoryEntry))
        );

    public JsonTypeInfo<MapPointHistoryEntry> MapPointHistoryEntry =>
        _MapPointHistoryEntry
        ?? (
            _MapPointHistoryEntry =
                (JsonTypeInfo<MapPointHistoryEntry>)
                    base.Options.GetTypeInfo(typeof(MapPointHistoryEntry))
        );

    public JsonTypeInfo<MapPointRoomHistoryEntry> MapPointRoomHistoryEntry =>
        _MapPointRoomHistoryEntry
        ?? (
            _MapPointRoomHistoryEntry =
                (JsonTypeInfo<MapPointRoomHistoryEntry>)
                    base.Options.GetTypeInfo(typeof(MapPointRoomHistoryEntry))
        );

    public JsonTypeInfo<ModelChoiceHistoryEntry> ModelChoiceHistoryEntry =>
        _ModelChoiceHistoryEntry
        ?? (
            _ModelChoiceHistoryEntry =
                (JsonTypeInfo<ModelChoiceHistoryEntry>)
                    base.Options.GetTypeInfo(typeof(ModelChoiceHistoryEntry))
        );

    public JsonTypeInfo<PlayerMapPointHistoryEntry> PlayerMapPointHistoryEntry =>
        _PlayerMapPointHistoryEntry
        ?? (
            _PlayerMapPointHistoryEntry =
                (JsonTypeInfo<PlayerMapPointHistoryEntry>)
                    base.Options.GetTypeInfo(typeof(PlayerMapPointHistoryEntry))
        );

    public JsonTypeInfo<RunHistory> RunHistory =>
        _RunHistory
        ?? (_RunHistory = (JsonTypeInfo<RunHistory>)base.Options.GetTypeInfo(typeof(RunHistory)));

    public JsonTypeInfo<RunHistoryPlayer> RunHistoryPlayer =>
        _RunHistoryPlayer
        ?? (
            _RunHistoryPlayer =
                (JsonTypeInfo<RunHistoryPlayer>)base.Options.GetTypeInfo(typeof(RunHistoryPlayer))
        );

    public JsonTypeInfo<AncientCharacterStats> AncientCharacterStats =>
        _AncientCharacterStats
        ?? (
            _AncientCharacterStats =
                (JsonTypeInfo<AncientCharacterStats>)
                    base.Options.GetTypeInfo(typeof(AncientCharacterStats))
        );

    public JsonTypeInfo<AncientStats> AncientStats =>
        _AncientStats
        ?? (
            _AncientStats =
                (JsonTypeInfo<AncientStats>)base.Options.GetTypeInfo(typeof(AncientStats))
        );

    public JsonTypeInfo<BadgeStats> BadgeStats =>
        _BadgeStats
        ?? (_BadgeStats = (JsonTypeInfo<BadgeStats>)base.Options.GetTypeInfo(typeof(BadgeStats)));

    public JsonTypeInfo<CardStats> CardStats =>
        _CardStats
        ?? (_CardStats = (JsonTypeInfo<CardStats>)base.Options.GetTypeInfo(typeof(CardStats)));

    public JsonTypeInfo<CharacterStats> CharacterStats =>
        _CharacterStats
        ?? (
            _CharacterStats =
                (JsonTypeInfo<CharacterStats>)base.Options.GetTypeInfo(typeof(CharacterStats))
        );

    public JsonTypeInfo<EncounterStats> EncounterStats =>
        _EncounterStats
        ?? (
            _EncounterStats =
                (JsonTypeInfo<EncounterStats>)base.Options.GetTypeInfo(typeof(EncounterStats))
        );

    public JsonTypeInfo<EnemyStats> EnemyStats =>
        _EnemyStats
        ?? (_EnemyStats = (JsonTypeInfo<EnemyStats>)base.Options.GetTypeInfo(typeof(EnemyStats)));

    public JsonTypeInfo<EpochState> EpochState =>
        _EpochState
        ?? (_EpochState = (JsonTypeInfo<EpochState>)base.Options.GetTypeInfo(typeof(EpochState)));

    public JsonTypeInfo<FightStats> FightStats =>
        _FightStats
        ?? (_FightStats = (JsonTypeInfo<FightStats>)base.Options.GetTypeInfo(typeof(FightStats)));

    public JsonTypeInfo<SerializableMapDrawingLine> SerializableMapDrawingLine =>
        _SerializableMapDrawingLine
        ?? (
            _SerializableMapDrawingLine =
                (JsonTypeInfo<SerializableMapDrawingLine>)
                    base.Options.GetTypeInfo(typeof(SerializableMapDrawingLine))
        );

    public JsonTypeInfo<SerializableMapDrawings> SerializableMapDrawings =>
        _SerializableMapDrawings
        ?? (
            _SerializableMapDrawings =
                (JsonTypeInfo<SerializableMapDrawings>)
                    base.Options.GetTypeInfo(typeof(SerializableMapDrawings))
        );

    public JsonTypeInfo<SerializablePlayerMapDrawings> SerializablePlayerMapDrawings =>
        _SerializablePlayerMapDrawings
        ?? (
            _SerializablePlayerMapDrawings =
                (JsonTypeInfo<SerializablePlayerMapDrawings>)
                    base.Options.GetTypeInfo(typeof(SerializablePlayerMapDrawings))
        );

    public JsonTypeInfo<MigratingData> MigratingData =>
        _MigratingData
        ?? (
            _MigratingData =
                (JsonTypeInfo<MigratingData>)base.Options.GetTypeInfo(typeof(MigratingData))
        );

    public JsonTypeInfo<PrefsSave> PrefsSave =>
        _PrefsSave
        ?? (_PrefsSave = (JsonTypeInfo<PrefsSave>)base.Options.GetTypeInfo(typeof(PrefsSave)));

    public JsonTypeInfo<ProfileSave> ProfileSave =>
        _ProfileSave
        ?? (
            _ProfileSave = (JsonTypeInfo<ProfileSave>)base.Options.GetTypeInfo(typeof(ProfileSave))
        );

    public JsonTypeInfo<SavedProperties> SavedProperties =>
        _SavedProperties
        ?? (
            _SavedProperties =
                (JsonTypeInfo<SavedProperties>)base.Options.GetTypeInfo(typeof(SavedProperties))
        );

    public JsonTypeInfo<SavedProperties.SavedProperty<bool>> SavedPropertyBoolean =>
        _SavedPropertyBoolean
        ?? (
            _SavedPropertyBoolean =
                (JsonTypeInfo<SavedProperties.SavedProperty<bool>>)
                    base.Options.GetTypeInfo(typeof(SavedProperties.SavedProperty<bool>))
        );

    public JsonTypeInfo<SavedProperties.SavedProperty<ModelId>> SavedPropertyModelId =>
        _SavedPropertyModelId
        ?? (
            _SavedPropertyModelId =
                (JsonTypeInfo<SavedProperties.SavedProperty<ModelId>>)
                    base.Options.GetTypeInfo(typeof(SavedProperties.SavedProperty<ModelId>))
        );

    public JsonTypeInfo<SavedProperties.SavedProperty<SerializableCard[]>> SavedPropertySerializableCardArray =>
        _SavedPropertySerializableCardArray
        ?? (
            _SavedPropertySerializableCardArray =
                (JsonTypeInfo<SavedProperties.SavedProperty<SerializableCard[]>>)
                    base.Options.GetTypeInfo(
                        typeof(SavedProperties.SavedProperty<SerializableCard[]>)
                    )
        );

    public JsonTypeInfo<SavedProperties.SavedProperty<SerializableCard>> SavedPropertySerializableCard =>
        _SavedPropertySerializableCard
        ?? (
            _SavedPropertySerializableCard =
                (JsonTypeInfo<SavedProperties.SavedProperty<SerializableCard>>)
                    base.Options.GetTypeInfo(
    ...
    public JsonTypeInfo<SavedProperties.SavedProperty<int[]>> SavedPropertyInt32Array =>
        _SavedPropertyInt32Array
        ?? (
            _SavedPropertyInt32Array =
                (JsonTypeInfo<SavedProperties.SavedProperty<int[]>>)
                    base.Options.GetTypeInfo(typeof(SavedProperties.SavedProperty<int[]>))
        );

    public JsonTypeInfo<SavedProperties.SavedProperty<int>> SavedPropertyInt32 =>
        _SavedPropertyInt32
        ?? (
            _SavedPropertyInt32 =
                (JsonTypeInfo<SavedProperties.SavedProperty<int>>)
    ...
    public JsonTypeInfo<SavedProperties.SavedProperty<string>> SavedPropertyString =>
        _SavedPropertyString
        ?? (
            _SavedPropertyString =
                (JsonTypeInfo<SavedProperties.SavedProperty<string>>)
                    base.Options.GetTypeInfo(typeof(SavedProperties.SavedProperty<string>))
        );

    public JsonTypeInfo<SerializableActMap> SerializableActMap =>
        _SerializableActMap
        ?? (
            _SerializableActMap =
                (JsonTypeInfo<SerializableActMap>)
                    base.Options.GetTypeInfo(typeof(SerializableActMap))
        );

    public JsonTypeInfo<SerializableActModel> SerializableActModel =>
        _SerializableActModel
        ?? (
            _SerializableActModel =
                (JsonTypeInfo<SerializableActModel>)
                    base.Options.GetTypeInfo(typeof(SerializableActModel))
        );

    public JsonTypeInfo<SerializableBadge> SerializableBadge =>
        _SerializableBadge
        ?? (
            _SerializableBadge =
                (JsonTypeInfo<SerializableBadge>)base.Options.GetTypeInfo(typeof(SerializableBadge))
        );

    public JsonTypeInfo<SerializableCard> SerializableCard =>
        _SerializableCard
        ?? (
            _SerializableCard =
                (JsonTypeInfo<SerializableCard>)base.Options.GetTypeInfo(typeof(SerializableCard))
        );

    public JsonTypeInfo<SerializableCard[]> SerializableCardArray =>
        _SerializableCardArray
        ?? (
            _SerializableCardArray =
                (JsonTypeInfo<SerializableCard[]>)
                    base.Options.GetTypeInfo(typeof(SerializableCard[]))
        );

    public JsonTypeInfo<SerializableEnchantment> SerializableEnchantment =>
        _SerializableEnchantment
        ?? (
            _SerializableEnchantment =
                (JsonTypeInfo<SerializableEnchantment>)
                    base.Options.GetTypeInfo(typeof(SerializableEnchantment))
        );

    public JsonTypeInfo<SerializableExtraRunFields> SerializableExtraRunFields =>
        _SerializableExtraRunFields
        ?? (
            _SerializableExtraRunFields =
                (JsonTypeInfo<SerializableExtraRunFields>)
                    base.Options.GetTypeInfo(typeof(SerializableExtraRunFields))
        );

    public JsonTypeInfo<SerializableMapPoint> SerializableMapPoint =>
        _SerializableMapPoint
        ?? (
            _SerializableMapPoint =
                (JsonTypeInfo<SerializableMapPoint>)
                    base.Options.GetTypeInfo(typeof(SerializableMapPoint))
        );

    public JsonTypeInfo<SerializableModifier> SerializableModifier =>
        _SerializableModifier
        ?? (
            _SerializableModifier =
                (JsonTypeInfo<SerializableModifier>)
                    base.Options.GetTypeInfo(typeof(SerializableModifier))
        );

    public JsonTypeInfo<SerializablePlayer> SerializablePlayer =>
        _SerializablePlayer
        ?? (
            _SerializablePlayer =
                (JsonTypeInfo<SerializablePlayer>)
                    base.Options.GetTypeInfo(typeof(SerializablePlayer))
        );

    public JsonTypeInfo<SerializablePlayerOddsSet> SerializablePlayerOddsSet =>
        _SerializablePlayerOddsSet
        ?? (
            _SerializablePlayerOddsSet =
                (JsonTypeInfo<SerializablePlayerOddsSet>)
                    base.Options.GetTypeInfo(typeof(SerializablePlayerOddsSet))
        );

    public JsonTypeInfo<SerializablePotion> SerializablePotion =>
        _SerializablePotion
        ?? (
            _SerializablePotion =
                (JsonTypeInfo<SerializablePotion>)
                    base.Options.GetTypeInfo(typeof(SerializablePotion))
        );

    public JsonTypeInfo<SerializableRelic> SerializableRelic =>
        _SerializableRelic
        ?? (
            _SerializableRelic =
                (JsonTypeInfo<SerializableRelic>)base.Options.GetTypeInfo(typeof(SerializableRelic))
        );

    public JsonTypeInfo<SerializableRelicGrabBag> SerializableRelicGrabBag =>
        _SerializableRelicGrabBag
        ?? (
            _SerializableRelicGrabBag =
                (JsonTypeInfo<SerializableRelicGrabBag>)
                    base.Options.GetTypeInfo(typeof(SerializableRelicGrabBag))
        );

    public JsonTypeInfo<SerializableReward> SerializableReward =>
        _SerializableReward
        ?? (
            _SerializableReward =
                (JsonTypeInfo<SerializableReward>)
                    base.Options.GetTypeInfo(typeof(SerializableReward))
        );

    public JsonTypeInfo<SerializableRoom> SerializableRoom =>
        _SerializableRoom
        ?? (
            _SerializableRoom =
                (JsonTypeInfo<SerializableRoom>)base.Options.GetTypeInfo(typeof(SerializableRoom))
        );

    public JsonTypeInfo<SerializableRoomSet> SerializableRoomSet =>
        _SerializableRoomSet
        ?? (
            _SerializableRoomSet =
                (JsonTypeInfo<SerializableRoomSet>)
                    base.Options.GetTypeInfo(typeof(SerializableRoomSet))
        );

    public JsonTypeInfo<SerializableRunOddsSet> SerializableRunOddsSet =>
        _SerializableRunOddsSet
        ?? (
            _SerializableRunOddsSet =
                (JsonTypeInfo<SerializableRunOddsSet>)
                    base.Options.GetTypeInfo(typeof(SerializableRunOddsSet))
        );

    public JsonTypeInfo<SerializableRunRngSet> SerializableRunRngSet =>
        _SerializableRunRngSet
        ?? (
            _SerializableRunRngSet =
                (JsonTypeInfo<SerializableRunRngSet>)
                    base.Options.GetTypeInfo(typeof(SerializableRunRngSet))
        );

    public JsonTypeInfo<SerializableEpoch> SerializableEpoch =>
        _SerializableEpoch
        ?? (
            _SerializableEpoch =
                (JsonTypeInfo<SerializableEpoch>)base.Options.GetTypeInfo(typeof(SerializableEpoch))
        );

    public JsonTypeInfo<SerializableExtraPlayerFields> SerializableExtraPlayerFields =>
        _SerializableExtraPlayerFields
        ?? (
            _SerializableExtraPlayerFields =
                (JsonTypeInfo<SerializableExtraPlayerFields>)
                    base.Options.GetTypeInfo(typeof(SerializableExtraPlayerFields))
        );

    public JsonTypeInfo<SerializablePlayerRngSet> SerializablePlayerRngSet =>
        _SerializablePlayerRngSet
        ?? (
            _SerializablePlayerRngSet =
                (JsonTypeInfo<SerializablePlayerRngSet>)
                    base.Options.GetTypeInfo(typeof(SerializablePlayerRngSet))
        );

    public JsonTypeInfo<SerializableProgress> SerializableProgress =>
        _SerializableProgress
        ?? (
            _SerializableProgress =
                (JsonTypeInfo<SerializableProgress>)
                    base.Options.GetTypeInfo(typeof(SerializableProgress))
        );

    public JsonTypeInfo<SerializableRun> SerializableRun =>
        _SerializableRun
        ?? (
            _SerializableRun =
                (JsonTypeInfo<SerializableRun>)base.Options.GetTypeInfo(typeof(SerializableRun))
        );

    public JsonTypeInfo<SerializableUnlockedAchievement> SerializableUnlockedAchievement =>
        _SerializableUnlockedAchievement
        ?? (
            _SerializableUnlockedAchievement =
                (JsonTypeInfo<SerializableUnlockedAchievement>)
                    base.Options.GetTypeInfo(typeof(SerializableUnlockedAchievement))
        );

    public JsonTypeInfo<SettingsSave> SettingsSave =>
        _SettingsSave
        ?? (
            _SettingsSave =
                (JsonTypeInfo<SettingsSave>)base.Options.GetTypeInfo(typeof(SettingsSave))
        );

    public JsonTypeInfo<AspectRatioSetting> AspectRatioSetting =>
        _AspectRatioSetting
        ?? (
            _AspectRatioSetting =
                (JsonTypeInfo<AspectRatioSetting>)
                    base.Options.GetTypeInfo(typeof(AspectRatioSetting))
        );

    public JsonTypeInfo<FastModeType> FastModeType =>
        _FastModeType
        ?? (
            _FastModeType =
                (JsonTypeInfo<FastModeType>)base.Options.GetTypeInfo(typeof(FastModeType))
        );

    public JsonTypeInfo<VSyncType> VSyncType =>
        _VSyncType
        ?? (_VSyncType = (JsonTypeInfo<VSyncType>)base.Options.GetTypeInfo(typeof(VSyncType)));

    public JsonTypeInfo<SerializableUnlockState> SerializableUnlockState =>
        _SerializableUnlockState
        ?? (
            _SerializableUnlockState =
                (JsonTypeInfo<SerializableUnlockState>)
                    base.Options.GetTypeInfo(typeof(SerializableUnlockState))
        );

    public JsonTypeInfo<Dictionary<RelicRarity, List<ModelId>>> DictionaryRelicRarityListModelId =>
        _DictionaryRelicRarityListModelId
        ?? (
            _DictionaryRelicRarityListModelId =
                (JsonTypeInfo<Dictionary<RelicRarity, List<ModelId>>>)
                    base.Options.GetTypeInfo(typeof(Dictionary<RelicRarity, List<ModelId>>))
        );

    public JsonTypeInfo<Dictionary<PlayerRngType, int>> DictionaryPlayerRngTypeInt32 =>
        _DictionaryPlayerRngTypeInt32
        ?? (
            _DictionaryPlayerRngTypeInt32 =
                (JsonTypeInfo<Dictionary<PlayerRngType, int>>)
                    base.Options.GetTypeInfo(typeof(Dictionary<PlayerRngType, int>))
        );

    public JsonTypeInfo<Dictionary<RunRngType, int>> DictionaryRunRngTypeInt32 =>
        _DictionaryRunRngTypeInt32
        ?? (
            _DictionaryRunRngTypeInt32 =
                (JsonTypeInfo<Dictionary<RunRngType, int>>)
                    base.Options.GetTypeInfo(typeof(Dictionary<RunRngType, int>))
        );

    public JsonTypeInfo<Dictionary<string, object>> DictionaryStringObject =>
        _DictionaryStringObject
        ?? (
            _DictionaryStringObject =
                (JsonTypeInfo<Dictionary<string, object>>)
                    base.Options.GetTypeInfo(typeof(Dictionary<string, object>))
        );

    public JsonTypeInfo<Dictionary<string, string>> DictionaryStringString =>
        _DictionaryStringString
        ?? (
            _DictionaryStringString =
                (JsonTypeInfo<Dictionary<string, string>>)
                    base.Options.GetTypeInfo(typeof(Dictionary<string, string>))
        );

    public JsonTypeInfo<
        Dictionary<ulong, List<SerializableReward>>
    > DictionaryUInt64ListSerializableReward =>
        _DictionaryUInt64ListSerializableReward
        ?? (
            _DictionaryUInt64ListSerializableReward =
                (JsonTypeInfo<Dictionary<ulong, List<SerializableReward>>>)
                    base.Options.GetTypeInfo(typeof(Dictionary<ulong, List<SerializableReward>>))
        );

    public JsonTypeInfo<IEnumerable<SerializableBadge>> IEnumerableSerializableBadge =>
        _IEnumerableSerializableBadge
        ?? (
            _IEnumerableSerializableBadge =
                (JsonTypeInfo<IEnumerable<SerializableBadge>>)
                    base.Options.GetTypeInfo(typeof(IEnumerable<SerializableBadge>))
        );

    public JsonTypeInfo<IEnumerable<SerializableCard>> IEnumerableSerializableCard =>
        _IEnumerableSerializableCard
        ?? (
            _IEnumerableSerializableCard =
                (JsonTypeInfo<IEnumerable<SerializableCard>>)
                    base.Options.GetTypeInfo(typeof(IEnumerable<SerializableCard>))
        );

    public JsonTypeInfo<IEnumerable<SerializablePotion>> IEnumerableSerializablePotion =>
        _IEnumerableSerializablePotion
        ?? (
            _IEnumerableSerializablePotion =
                (JsonTypeInfo<IEnumerable<SerializablePotion>>)
                    base.Options.GetTypeInfo(typeof(IEnumerable<SerializablePotion>))
        );

    public JsonTypeInfo<IEnumerable<SerializableRelic>> IEnumerableSerializableRelic =>
        _IEnumerableSerializableRelic
        ?? (
            _IEnumerableSerializableRelic =
                (JsonTypeInfo<IEnumerable<SerializableRelic>>)
                    base.Options.GetTypeInfo(typeof(IEnumerable<SerializableRelic>))
        );

    public JsonTypeInfo<List<Vector2>> ListVector2 =>
        _ListVector2
        ?? (
            _ListVector2 =
                (JsonTypeInfo<List<Vector2>>)base.Options.GetTypeInfo(typeof(List<Vector2>))
        );

    public JsonTypeInfo<List<MapCoord>> ListMapCoord =>
        _ListMapCoord
        ?? (
            _ListMapCoord =
                (JsonTypeInfo<List<MapCoord>>)base.Options.GetTypeInfo(typeof(List<MapCoord>))
        );

    public JsonTypeInfo<List<ModDependency>> ListModDependency =>
        _ListModDependency
        ?? (
            _ListModDependency =
                (JsonTypeInfo<List<ModDependency>>)
                    base.Options.GetTypeInfo(typeof(List<ModDependency>))
        );

    public JsonTypeInfo<List<SettingsSaveMod>> ListSettingsSaveMod =>
        _ListSettingsSaveMod
        ?? (
            _ListSettingsSaveMod =
                (JsonTypeInfo<List<SettingsSaveMod>>)
                    base.Options.GetTypeInfo(typeof(List<SettingsSaveMod>))
        );

    public JsonTypeInfo<List<ModelId>> ListModelId =>
        _ListModelId
        ?? (
            _ListModelId =
                (JsonTypeInfo<List<ModelId>>)base.Options.GetTypeInfo(typeof(List<ModelId>))
        );

    public JsonTypeInfo<List<NullLeaderboard>> ListNullLeaderboard =>
        _ListNullLeaderboard
        ?? (
            _ListNullLeaderboard =
                (JsonTypeInfo<List<NullLeaderboard>>)
                    base.Options.GetTypeInfo(typeof(List<NullLeaderboard>))
        );

    public JsonTypeInfo<List<NullLeaderboardFileEntry>> ListNullLeaderboardFileEntry =>
        _ListNullLeaderboardFileEntry
        ?? (
            _ListNullLeaderboardFileEntry =
                (JsonTypeInfo<List<NullLeaderboardFileEntry>>)
                    base.Options.GetTypeInfo(typeof(List<NullLeaderboardFileEntry>))
        );

    public JsonTypeInfo<List<NullMultiplayerName>> ListNullMultiplayerName =>
        _ListNullMultiplayerName
        ?? (
            _ListNullMultiplayerName =
                (JsonTypeInfo<List<NullMultiplayerName>>)
                    base.Options.GetTypeInfo(typeof(List<NullMultiplayerName>))
        );

    public JsonTypeInfo<List<AncientChoiceHistoryEntry>> ListAncientChoiceHistoryEntry =>
        _ListAncientChoiceHistoryEntry
        ?? (
            _ListAncientChoiceHistoryEntry =
                (JsonTypeInfo<List<AncientChoiceHistoryEntry>>)
                    base.Options.GetTypeInfo(typeof(List<AncientChoiceHistoryEntry>))
        );

    public JsonTypeInfo<List<CardChoiceHistoryEntry>> ListCardChoiceHistoryEntry =>
        _ListCardChoiceHistoryEntry
        ?? (
            _ListCardChoiceHistoryEntry =
                (JsonTypeInfo<List<CardChoiceHistoryEntry>>)
                    base.Options.GetTypeInfo(typeof(List<CardChoiceHistoryEntry>))
        );

    public JsonTypeInfo<List<CardEnchantmentHistoryEntry>> ListCardEnchantmentHistoryEntry =>
        _ListCardEnchantmentHistoryEntry
        ?? (
            _ListCardEnchantmentHistoryEntry =
                (JsonTypeInfo<List<CardEnchantmentHistoryEntry>>)
                    base.Options.GetTypeInfo(typeof(List<CardEnchantmentHistoryEntry>))
        );

    public JsonTypeInfo<List<CardTransformationHistoryEntry>> ListCardTransformationHistoryEntry =>
        _ListCardTransformationHistoryEntry
        ?? (
            _ListCardTransformationHistoryEntry =
                (JsonTypeInfo<List<CardTransformationHistoryEntry>>)
                    base.Options.GetTypeInfo(typeof(List<CardTransformationHistoryEntry>))
        );

    public JsonTypeInfo<List<EventOptionHistoryEntry>> ListEventOptionHistoryEntry =>
        _ListEventOptionHistoryEntry
        ?? (
            _ListEventOptionHistoryEntry =
                (JsonTypeInfo<List<EventOptionHistoryEntry>>)
                    base.Options.GetTypeInfo(typeof(List<EventOptionHistoryEntry>))
        );

    public JsonTypeInfo<List<MapPointHistoryEntry>> ListMapPointHistoryEntry =>
        _ListMapPointHistoryEntry
        ?? (
            _ListMapPointHistoryEntry =
                (JsonTypeInfo<List<MapPointHistoryEntry>>)
                    base.Options.GetTypeInfo(typeof(List<MapPointHistoryEntry>))
        );

    public JsonTypeInfo<List<MapPointRoomHistoryEntry>> ListMapPointRoomHistoryEntry =>
        _ListMapPointRoomHistoryEntry
        ?? (
            _ListMapPointRoomHistoryEntry =
                (JsonTypeInfo<List<MapPointRoomHistoryEntry>>)
                    base.Options.GetTypeInfo(typeof(List<MapPointRoomHistoryEntry>))
        );

    public JsonTypeInfo<List<ModelChoiceHistoryEntry>> ListModelChoiceHistoryEntry =>
        _ListModelChoiceHistoryEntry
        ?? (
            _ListModelChoiceHistoryEntry =
                (JsonTypeInfo<List<ModelChoiceHistoryEntry>>)
                    base.Options.GetTypeInfo(typeof(List<ModelChoiceHistoryEntry>))
        );

    public JsonTypeInfo<List<PlayerMapPointHistoryEntry>> ListPlayerMapPointHistoryEntry =>
        _ListPlayerMapPointHistoryEntry
        ?? (
            _ListPlayerMapPointHistoryEntry =
                (JsonTypeInfo<List<PlayerMapPointHistoryEntry>>)
                    base.Options.GetTypeInfo(typeof(List<PlayerMapPointHistoryEntry>))
        );

    public JsonTypeInfo<List<RunHistoryPlayer>> ListRunHistoryPlayer =>
        _ListRunHistoryPlayer
        ?? (
            _ListRunHistoryPlayer =
                (JsonTypeInfo<List<RunHistoryPlayer>>)
                    base.Options.GetTypeInfo(typeof(List<RunHistoryPlayer>))
        );

    public JsonTypeInfo<List<AncientCharacterStats>> ListAncientCharacterStats =>
        _ListAncientCharacterStats
        ?? (
            _ListAncientCharacterStats =
                (JsonTypeInfo<List<AncientCharacterStats>>)
                    base.Options.GetTypeInfo(typeof(List<AncientCharacterStats>))
        );

    public JsonTypeInfo<List<AncientStats>> ListAncientStats =>
        _ListAncientStats
        ?? (
            _ListAncientStats =
                (JsonTypeInfo<List<AncientStats>>)
                    base.Options.GetTypeInfo(typeof(List<AncientStats>))
        );

    public JsonTypeInfo<List<BadgeStats>> ListBadgeStats =>
        _ListBadgeStats
        ?? (
            _ListBadgeStats =
                (JsonTypeInfo<List<BadgeStats>>)base.Options.GetTypeInfo(typeof(List<BadgeStats>))
        );

    public JsonTypeInfo<List<CardStats>> ListCardStats =>
        _ListCardStats
        ?? (
            _ListCardStats =
                (JsonTypeInfo<List<CardStats>>)base.Options.GetTypeInfo(typeof(List<CardStats>))
        );

    public JsonTypeInfo<List<CharacterStats>> ListCharacterStats =>
        _ListCharacterStats
        ?? (
            _ListCharacterStats =
                (JsonTypeInfo<List<CharacterStats>>)
                    base.Options.GetTypeInfo(typeof(List<CharacterStats>))
        );

    public JsonTypeInfo<List<EncounterStats>> ListEncounterStats =>
        _ListEncounterStats
        ?? (
            _ListEncounterStats =
                (JsonTypeInfo<List<EncounterStats>>)
                    base.Options.GetTypeInfo(typeof(List<EncounterStats>))
        );

    public JsonTypeInfo<List<EnemyStats>> ListEnemyStats =>
        _ListEnemyStats
        ?? (
            _ListEnemyStats =
                (JsonTypeInfo<List<EnemyStats>>)base.Options.GetTypeInfo(typeof(List<EnemyStats>))
        );

    public JsonTypeInfo<List<FightStats>> ListFightStats =>
        _ListFightStats
        ?? (
            _ListFightStats =
                (JsonTypeInfo<List<FightStats>>)base.Options.GetTypeInfo(typeof(List<FightStats>))
        );

    public JsonTypeInfo<List<SerializableMapDrawingLine>> ListSerializableMapDrawingLine =>
        _ListSerializableMapDrawingLine
        ?? (
            _ListSerializableMapDrawingLine =
                (JsonTypeInfo<List<SerializableMapDrawingLine>>)
                    base.Options.GetTypeInfo(typeof(List<SerializableMapDrawingLine>))
        );

    public JsonTypeInfo<List<SerializablePlayerMapDrawings>> ListSerializablePlayerMapDrawings =>
        _ListSerializablePlayerMapDrawings
        ?? (
            _ListSerializablePlayerMapDrawings =
                (JsonTypeInfo<List<SerializablePlayerMapDrawings>>)
                    base.Options.GetTypeInfo(typeof(List<SerializablePlayerMapDrawings>))
        );

    public JsonTypeInfo<List<MigratingData>> ListMigratingData =>
        _ListMigratingData
        ?? (
            _ListMigratingData =
                (JsonTypeInfo<List<MigratingData>>)
                    base.Options.GetTypeInfo(typeof(List<MigratingData>))
        );

    public JsonTypeInfo<List<SavedProperties.SavedProperty<bool>>> ListSavedPropertyBoolean =>
        _ListSavedPropertyBoolean
        ?? (
            _ListSavedPropertyBoolean =
                (JsonTypeInfo<List<SavedProperties.SavedProperty<bool>>>)
                    base.Options.GetTypeInfo(typeof(List<SavedProperties.SavedProperty<bool>>))
        );

    public JsonTypeInfo<List<SavedProperties.SavedProperty<ModelId>>> ListSavedPropertyModelId =>
        _ListSavedPropertyModelId
        ?? (
            _ListSavedPropertyModelId =
                (JsonTypeInfo<List<SavedProperties.SavedProperty<ModelId>>>)
                    base.Options.GetTypeInfo(typeof(List<SavedProperties.SavedProperty<ModelId>>))
        );

    public JsonTypeInfo<
        List<SavedProperties.SavedProperty<SerializableCard[]>>
    > ListSavedPropertySerializableCardArray =>
        _ListSavedPropertySerializableCardArray
        ?? (
            _ListSavedPropertySerializableCardArray =
                (JsonTypeInfo<List<SavedProperties.SavedProperty<SerializableCard[]>>>)
                    base.Options.GetTypeInfo(
                        typeof(List<SavedProperties.SavedProperty<SerializableCard[]>>)
                    )
        );

    public JsonTypeInfo<
        List<SavedProperties.SavedProperty<SerializableCard>>
    > ListSavedPropertySerializableCard =>
        _ListSavedPropertySerializableCard
        ?? (
            _ListSavedPropertySerializableCard =
                (JsonTypeInfo<List<SavedProperties.SavedProperty<SerializableCard>>>)
    ...
    public JsonTypeInfo<List<SavedProperties.SavedProperty<int[]>>> ListSavedPropertyInt32Array =>
        _ListSavedPropertyInt32Array
        ?? (
            _ListSavedPropertyInt32Array =
                (JsonTypeInfo<List<SavedProperties.SavedProperty<int[]>>>)
                    base.Options.GetTypeInfo(typeof(List<SavedProperties.SavedProperty<int[]>>))
        );

    public JsonTypeInfo<List<SavedProperties.SavedProperty<int>>> ListSavedPropertyInt32 =>
        _ListSavedPropertyInt32
        ?? (
            _ListSavedPropertyInt32 =
                (JsonTypeInfo<List<SavedProperties.SavedProperty<int>>>)
                    base.Options.GetTypeInfo(typeof(List<SavedProperties.SavedProperty<int>>))
    ...
    public JsonTypeInfo<List<SavedProperties.SavedProperty<string>>> ListSavedPropertyString =>
        _ListSavedPropertyString
        ?? (
            _ListSavedPropertyString =
                (JsonTypeInfo<List<SavedProperties.SavedProperty<string>>>)
                    base.Options.GetTypeInfo(typeof(List<SavedProperties.SavedProperty<string>>))
        );

    public JsonTypeInfo<List<SerializableActModel>> ListSerializableActModel =>
        _ListSerializableActModel
        ?? (
            _ListSerializableActModel =
                (JsonTypeInfo<List<SerializableActModel>>)
                    base.Options.GetTypeInfo(typeof(List<SerializableActModel>))
        );

    public JsonTypeInfo<List<SerializableCard>> ListSerializableCard =>
        _ListSerializableCard
        ?? (
            _ListSerializableCard =
                (JsonTypeInfo<List<SerializableCard>>)
                    base.Options.GetTypeInfo(typeof(List<SerializableCard>))
        );

    public JsonTypeInfo<List<SerializableMapPoint>> ListSerializableMapPoint =>
        _ListSerializableMapPoint
        ?? (
            _ListSerializableMapPoint =
                (JsonTypeInfo<List<SerializableMapPoint>>)
                    base.Options.GetTypeInfo(typeof(List<SerializableMapPoint>))
        );

    public JsonTypeInfo<List<SerializableModifier>> ListSerializableModifier =>
        _ListSerializableModifier
        ?? (
            _ListSerializableModifier =
                (JsonTypeInfo<List<SerializableModifier>>)
                    base.Options.GetTypeInfo(typeof(List<SerializableModifier>))
        );

    public JsonTypeInfo<List<SerializablePlayer>> ListSerializablePlayer =>
        _ListSerializablePlayer
        ?? (
            _ListSerializablePlayer =
                (JsonTypeInfo<List<SerializablePlayer>>)
                    base.Options.GetTypeInfo(typeof(List<SerializablePlayer>))
        );

    public JsonTypeInfo<List<SerializablePotion>> ListSerializablePotion =>
        _ListSerializablePotion
        ?? (
            _ListSerializablePotion =
                (JsonTypeInfo<List<SerializablePotion>>)
                    base.Options.GetTypeInfo(typeof(List<SerializablePotion>))
        );

    public JsonTypeInfo<List<SerializableRelic>> ListSerializableRelic =>
        _ListSerializableRelic
        ?? (
            _ListSerializableRelic =
                (JsonTypeInfo<List<SerializableRelic>>)
                    base.Options.GetTypeInfo(typeof(List<SerializableRelic>))
        );

    public JsonTypeInfo<List<SerializableReward>> ListSerializableReward =>
        _ListSerializableReward
        ?? (
            _ListSerializableReward =
                (JsonTypeInfo<List<SerializableReward>>)
                    base.Options.GetTypeInfo(typeof(List<SerializableReward>))
        );

    public JsonTypeInfo<List<SerializableEpoch>> ListSerializableEpoch =>
        _ListSerializableEpoch
        ?? (
            _ListSerializableEpoch =
                (JsonTypeInfo<List<SerializableEpoch>>)
                    base.Options.GetTypeInfo(typeof(List<SerializableEpoch>))
        );

    public JsonTypeInfo<
        List<SerializableUnlockedAchievement>
    > ListSerializableUnlockedAchievement =>
        _ListSerializableUnlockedAchievement
        ?? (
            _ListSerializableUnlockedAchievement =
                (JsonTypeInfo<List<SerializableUnlockedAchievement>>)
                    base.Options.GetTypeInfo(typeof(List<SerializableUnlockedAchievement>))
        );

    public JsonTypeInfo<List<Dictionary<string, object>>> ListDictionaryStringObject =>
        _ListDictionaryStringObject
        ?? (
            _ListDictionaryStringObject =
                (JsonTypeInfo<List<Dictionary<string, object>>>)
                    base.Options.GetTypeInfo(typeof(List<Dictionary<string, object>>))
        );

    public JsonTypeInfo<List<List<MapPointHistoryEntry>>> ListListMapPointHistoryEntry =>
        _ListListMapPointHistoryEntry
        ?? (
            _ListListMapPointHistoryEntry =
                (JsonTypeInfo<List<List<MapPointHistoryEntry>>>)
                    base.Options.GetTypeInfo(typeof(List<List<MapPointHistoryEntry>>))
        );

    public JsonTypeInfo<
        List<List<PlayerMapPointHistoryEntry>>
    > ListListPlayerMapPointHistoryEntry =>
        _ListListPlayerMapPointHistoryEntry
        ?? (
            _ListListPlayerMapPointHistoryEntry =
                (JsonTypeInfo<List<List<PlayerMapPointHistoryEntry>>>)
                    base.Options.GetTypeInfo(typeof(List<List<PlayerMapPointHistoryEntry>>))
        );

    public JsonTypeInfo<List<JsonNode>> ListJsonNode =>
        _ListJsonNode
        ?? (
            _ListJsonNode =
                (JsonTypeInfo<List<JsonNode>>)base.Options.GetTypeInfo(typeof(List<JsonNode>))
        );

    public JsonTypeInfo<List<string>> ListString =>
        _ListString
        ?? (
            _ListString = (JsonTypeInfo<List<string>>)base.Options.GetTypeInfo(typeof(List<string>))
        );

    public JsonTypeInfo<List<ulong>> ListUInt64 =>
        _ListUInt64
        ?? (_ListUInt64 = (JsonTypeInfo<List<ulong>>)base.Options.GetTypeInfo(typeof(List<ulong>)));

    public JsonTypeInfo<DateTimeOffset> DateTimeOffset =>
        _DateTimeOffset
        ?? (
            _DateTimeOffset =
                (JsonTypeInfo<DateTimeOffset>)base.Options.GetTypeInfo(typeof(DateTimeOffset))
        );

    public JsonTypeInfo<DateTimeOffset?> NullableDateTimeOffset =>
        _NullableDateTimeOffset
        ?? (
            _NullableDateTimeOffset =
                (JsonTypeInfo<DateTimeOffset?>)base.Options.GetTypeInfo(typeof(DateTimeOffset?))
        );

    public JsonTypeInfo<JsonNode> JsonNode =>
        _JsonNode
        ?? (_JsonNode = (JsonTypeInfo<JsonNode>)base.Options.GetTypeInfo(typeof(JsonNode)));

    public JsonTypeInfo<JsonObject> JsonObject =>
        _JsonObject
        ?? (_JsonObject = (JsonTypeInfo<JsonObject>)base.Options.GetTypeInfo(typeof(JsonObject)));

    public JsonTypeInfo<int> Int32 =>
        _Int32 ?? (_Int32 = (JsonTypeInfo<int>)base.Options.GetTypeInfo(typeof(int)));

    public JsonTypeInfo<int?> NullableInt32 =>
        _NullableInt32
        ?? (_NullableInt32 = (JsonTypeInfo<int?>)base.Options.GetTypeInfo(typeof(int?)));

    public JsonTypeInfo<int[]> Int32Array =>
        _Int32Array ?? (_Int32Array = (JsonTypeInfo<int[]>)base.Options.GetTypeInfo(typeof(int[])));

    public JsonTypeInfo<long> Int64 =>
        _Int64 ?? (_Int64 = (JsonTypeInfo<long>)base.Options.GetTypeInfo(typeof(long)));

    public JsonTypeInfo<object> Object =>
        _Object ?? (_Object = (JsonTypeInfo<object>)base.Options.GetTypeInfo(typeof(object)));

    public JsonTypeInfo<string> String =>
        _String ?? (_String = (JsonTypeInfo<string>)base.Options.GetTypeInfo(typeof(string)));

    public JsonTypeInfo<uint> UInt32 =>
        _UInt32 ?? (_UInt32 = (JsonTypeInfo<uint>)base.Options.GetTypeInfo(typeof(uint)));

    public JsonTypeInfo<ulong> UInt64 =>
        _UInt64 ?? (_UInt64 = (JsonTypeInfo<ulong>)base.Options.GetTypeInfo(typeof(ulong)));

    public static MegaCritSerializerContext Default { get; } =
        new MegaCritSerializerContext(new JsonSerializerOptions(s_defaultOptions));
    ...
    private JsonTypeInfo<bool> Create_Boolean(JsonSerializerOptions options)
    {
        ...
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<bool>(
                options,
    ...
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(options, out JsonTypeInfo<double> jsonTypeInfo)
        )
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<double>(
                options,
    ...
    private JsonTypeInfo<float> Create_Single(JsonSerializerOptions options)
    {
        ...
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<float>(
                options,
    ...
    private JsonTypeInfo<Vector2> Create_Vector2(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<Vector2> jsonTypeInfo
            )
        )
        {
    ...
    private static JsonPropertyInfo[] Vector2PropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(Vector2).GetField(
                "X",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic
            );
    ...
    private JsonTypeInfo<Vector2I> Create_Vector2I(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<Vector2I> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<Vector2I> objectInfo = new JsonObjectInfoValues<Vector2I>
            {
                ...
                ObjectWithParameterizedConstructorCreator = null,
                PropertyMetadataInitializer = (JsonSerializerContext _) =>
                    Vector2IPropInit(options),
                ConstructorParameterMetadataInitializer = null,
                ConstructorAttributeProviderFactory = () =>
                    typeof(Vector2I).GetConstructor(
                        BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                        null,
                        Array.Empty<Type>(),
                        null
    ...
    private JsonTypeInfo<ControllerMappingType> Create_ControllerMappingType(
    ...
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<ControllerMappingType> jsonTypeInfo
            )
        )
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<ControllerMappingType>(
                options,
                JsonMetadataServices.GetEnumConverter<ControllerMappingType>(options)
            );
        }
        jsonTypeInfo.OriginatingResolver = this;
        return jsonTypeInfo;
    ...
    private JsonTypeInfo<RelicRarity> Create_RelicRarity(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<RelicRarity> jsonTypeInfo
            )
        )
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<RelicRarity>(
                options,
                JsonMetadataServices.GetEnumConverter<RelicRarity>(options)
            );
        }
        jsonTypeInfo.OriginatingResolver = this;
        return jsonTypeInfo;
    ...
    private JsonTypeInfo<PlayerRngType> Create_PlayerRngType(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<PlayerRngType> jsonTypeInfo
            )
        )
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<PlayerRngType>(
                options,
                JsonMetadataServices.GetEnumConverter<PlayerRngType>(options)
            );
        }
        jsonTypeInfo.OriginatingResolver = this;
        return jsonTypeInfo;
    ...
    private JsonTypeInfo<RunRngType> Create_RunRngType(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<RunRngType> jsonTypeInfo
            )
        )
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<RunRngType>(
                options,
                JsonMetadataServices.GetEnumConverter<RunRngType>(options)
            );
        }
        jsonTypeInfo.OriginatingResolver = this;
        return jsonTypeInfo;
    ...
    private JsonTypeInfo<LocString> Create_LocString(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<LocString> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<LocString> jsonObjectInfoValues =
                new JsonObjectInfoValues<LocString>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new LocString((string)args[0], (string)args[1]);
            jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) =>
                LocStringPropInit(options);
            jsonObjectInfoValues.ConstructorParameterMetadataInitializer = LocStringCtorParamInit;
            jsonObjectInfoValues.ConstructorAttributeProviderFactory = () =>
                typeof(LocString).GetConstructor(
                    BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                    null,
    ...
    private static JsonPropertyInfo[] LocStringPropInit(JsonSerializerOptions options)
    {
        ...
        JsonPropertyInfoValues<string> jsonPropertyInfoValues =
        ...
        jsonPropertyInfoValues2.AttributeProviderFactory = () =>
            typeof(LocString).GetProperty(
                "IsEmpty",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
        ...
        JsonPropertyInfoValues<IReadOnlyDictionary<string, object>> jsonPropertyInfoValues3 =
            new JsonPropertyInfoValues<IReadOnlyDictionary<string, object>>();
        ...
        jsonPropertyInfoValues3.AttributeProviderFactory = () =>
            typeof(LocString).GetProperty(
                "Variables",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
        ...
        JsonPropertyInfoValues<IReadOnlyDictionary<string, object>> propertyInfo4 =
            jsonPropertyInfoValues3;
    ...
    private JsonTypeInfo<MapCoord> Create_MapCoord(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<MapCoord> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<MapCoord> objectInfo = new JsonObjectInfoValues<MapCoord>
            {
                ...
                ObjectWithParameterizedConstructorCreator = null,
                PropertyMetadataInitializer = (JsonSerializerContext _) =>
                    MapCoordPropInit(options),
                ConstructorParameterMetadataInitializer = null,
                ConstructorAttributeProviderFactory = () =>
                    typeof(MapCoord).GetConstructor(
                        BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                        null,
                        Array.Empty<Type>(),
                        null
    ...
    private JsonTypeInfo<MapPointType> Create_MapPointType(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<MapPointType> jsonTypeInfo
            )
        )
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<MapPointType>(
                options,
                JsonMetadataServices.GetEnumConverter<MapPointType>(options)
            );
        }
        jsonTypeInfo.OriginatingResolver = this;
        return jsonTypeInfo;
    ...
    private JsonTypeInfo<ModDependency> Create_ModDependency(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<ModDependency> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<ModDependency> jsonObjectInfoValues =
                new JsonObjectInfoValues<ModDependency>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new ModDependency((string)args[0], (string)args[1]);
            jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) =>
                ModDependencyPropInit(options);
            jsonObjectInfoValues.ConstructorParameterMetadataInitializer =
                ModDependencyCtorParamInit;
            jsonObjectInfoValues.ConstructorAttributeProviderFactory = () =>
                typeof(ModDependency).GetConstructor(
                    BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                    null,
                    new Type[2] { typeof(string), typeof(string) },
                    null
    ...
    private JsonTypeInfo<ModManifest> Create_ModManifest(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<ModManifest> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<ModManifest> objectInfo = new JsonObjectInfoValues<ModManifest>
            {
                ...
                ObjectWithParameterizedConstructorCreator = null,
                PropertyMetadataInitializer = (JsonSerializerContext _) =>
                    ModManifestPropInit(options),
                ConstructorParameterMetadataInitializer = null,
                ConstructorAttributeProviderFactory = () =>
                    typeof(ModManifest).GetConstructor(
                        BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                        null,
                        Array.Empty<Type>(),
                        null
    ...
    private static JsonPropertyInfo[] ModManifestPropInit(JsonSerializerOptions options)
    {
        ...
        JsonPropertyInfoValues<List<ModDependency>> jsonPropertyInfoValues3 =
            new JsonPropertyInfoValues<List<ModDependency>>();
    ...
    private JsonTypeInfo<ModSettings> Create_ModSettings(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<ModSettings> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<ModSettings> objectInfo = new JsonObjectInfoValues<ModSettings>
            {
                ...
                ObjectWithParameterizedConstructorCreator = null,
                PropertyMetadataInitializer = (JsonSerializerContext _) =>
                    ModSettingsPropInit(options),
                ConstructorParameterMetadataInitializer = null,
                ConstructorAttributeProviderFactory = () =>
                    typeof(ModSettings).GetConstructor(
                        BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                        null,
                        Array.Empty<Type>(),
                        null
    ...
    private static JsonPropertyInfo[] ModSettingsPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(ModSettings).GetProperty(
        ...
        array[0] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo);
        JsonPropertyInfoValues<List<SettingsSaveMod>> jsonPropertyInfoValues2 =
            new JsonPropertyInfoValues<List<SettingsSaveMod>>();
        jsonPropertyInfoValues2.IsProperty = true;
        jsonPropertyInfoValues2.IsPublic = true;
        jsonPropertyInfoValues2.IsVirtual = false;
    ...
    private JsonTypeInfo<ModSource> Create_ModSource(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<ModSource> jsonTypeInfo
            )
        )
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<ModSource>(
                options,
                JsonMetadataServices.GetEnumConverter<ModSource>(options)
            );
        }
        jsonTypeInfo.OriginatingResolver = this;
        return jsonTypeInfo;
    ...
    private JsonTypeInfo<SettingsSaveMod> Create_SettingsSaveMod(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SettingsSaveMod> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SettingsSaveMod> objectInfo =
                new JsonObjectInfoValues<SettingsSaveMod>
                {
                    ObjectCreator = () => new SettingsSaveMod(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SettingsSaveModPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SettingsSaveMod).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] SettingsSaveModPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.JsonPropertyName = "id";
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SettingsSaveMod).GetProperty(
                "Id",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(string),
        ...
        array[0].IsGetNullable = false;
        array[0].IsSetNullable = false;
        JsonPropertyInfoValues<ModSource> jsonPropertyInfoValues2 =
            new JsonPropertyInfoValues<ModSource>();
        jsonPropertyInfoValues2.IsProperty = true;
        jsonPropertyInfoValues2.IsPublic = true;
        jsonPropertyInfoValues2.IsVirtual = false;
    ...
    private JsonTypeInfo<BadgeRarity> Create_BadgeRarity(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<BadgeRarity> jsonTypeInfo
            )
        )
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<BadgeRarity>(
                options,
                JsonMetadataServices.GetEnumConverter<BadgeRarity>(options)
            );
        }
        jsonTypeInfo.OriginatingResolver = this;
        return jsonTypeInfo;
    ...
    private JsonTypeInfo<ModelId> Create_ModelId(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<ModelId> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<ModelId> jsonObjectInfoValues =
                new JsonObjectInfoValues<ModelId>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new ModelId((string)args[0], (string)args[1]);
            jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) =>
                ModelIdPropInit(options);
            jsonObjectInfoValues.ConstructorParameterMetadataInitializer = ModelIdCtorParamInit;
            jsonObjectInfoValues.ConstructorAttributeProviderFactory = () =>
                typeof(ModelId).GetConstructor(
                    BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                    null,
                    new Type[2] { typeof(string), typeof(string) },
                    null
    ...
    private JsonTypeInfo<FeedbackData> Create_FeedbackData(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<FeedbackData> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<FeedbackData> objectInfo = new JsonObjectInfoValues<FeedbackData>
            {
                ...
                ObjectWithParameterizedConstructorCreator = null,
                PropertyMetadataInitializer = (JsonSerializerContext _) =>
                    FeedbackDataPropInit(options),
                ConstructorParameterMetadataInitializer = null,
                ConstructorAttributeProviderFactory = () =>
                    typeof(FeedbackData).GetConstructor(
                        BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                        null,
                        Array.Empty<Type>(),
                        null
    ...
    private JsonTypeInfo<NullLeaderboard> Create_NullLeaderboard(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<NullLeaderboard> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<NullLeaderboard> objectInfo =
                new JsonObjectInfoValues<NullLeaderboard>
                {
                    ObjectCreator = () => new NullLeaderboard(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        NullLeaderboardPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(NullLeaderboard).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] NullLeaderboardPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.JsonPropertyName = "name";
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(NullLeaderboard).GetField(
                "name",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic
            );
        JsonPropertyInfoValues<string> propertyInfo = jsonPropertyInfoValues;
        ...
        array[0].IsGetNullable = false;
        array[0].IsSetNullable = false;
        JsonPropertyInfoValues<List<NullLeaderboardFileEntry>> jsonPropertyInfoValues2 =
            new JsonPropertyInfoValues<List<NullLeaderboardFileEntry>>();
        jsonPropertyInfoValues2.IsProperty = false;
        jsonPropertyInfoValues2.IsPublic = true;
        jsonPropertyInfoValues2.IsVirtual = false;
        ...
        JsonPropertyInfoValues<List<NullLeaderboardFileEntry>> propertyInfo2 =
            jsonPropertyInfoValues2;
        array[1] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo2);
        array[1].IsGetNullable = false;
        array[1].IsSetNullable = false;
        return array;
    ...
    private JsonTypeInfo<NullLeaderboardFile> Create_NullLeaderboardFile(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<NullLeaderboardFile> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<NullLeaderboardFile> objectInfo =
                new JsonObjectInfoValues<NullLeaderboardFile>
                {
                    ObjectCreator = () => new NullLeaderboardFile(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        NullLeaderboardFilePropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(NullLeaderboardFile).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] NullLeaderboardFilePropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.JsonPropertyName = "version";
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(NullLeaderboardFile).GetProperty(
                "SchemaVersion",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(int),
        ...
        JsonPropertyInfoValues<int> propertyInfo = jsonPropertyInfoValues;
        array[0] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo);
        JsonPropertyInfoValues<List<NullLeaderboard>> jsonPropertyInfoValues2 =
            new JsonPropertyInfoValues<List<NullLeaderboard>>();
        jsonPropertyInfoValues2.IsProperty = false;
        jsonPropertyInfoValues2.IsPublic = true;
        jsonPropertyInfoValues2.IsVirtual = false;
        ...
        jsonPropertyInfoValues2.AttributeProviderFactory = () =>
            typeof(NullLeaderboardFile).GetField(
                "leaderboards",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic
            );
    ...
    private JsonTypeInfo<NullLeaderboardFileEntry> Create_NullLeaderboardFileEntry(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<NullLeaderboardFileEntry> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<NullLeaderboardFileEntry> jsonObjectInfoValues =
                new JsonObjectInfoValues<NullLeaderboardFileEntry>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new NullLeaderboardFileEntry { name = (string)args[0] };
            jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) =>
                NullLeaderboardFileEntryPropInit(options);
            jsonObjectInfoValues.ConstructorParameterMetadataInitializer =
                NullLeaderboardFileEntryCtorParamInit;
            jsonObjectInfoValues.ConstructorAttributeProviderFactory = () =>
                typeof(NullLeaderboardFileEntry).GetConstructor(
                    BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                    null,
                    Array.Empty<Type>(),
                    null
    ...
    private static JsonPropertyInfo[] NullLeaderboardFileEntryPropInit(
        JsonSerializerOptions options
    )
    {
        JsonPropertyInfo[] array = new JsonPropertyInfo[4];
        ...
        jsonPropertyInfoValues.JsonPropertyName = "name";
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(NullLeaderboardFileEntry).GetField(
                "name",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic
            );
        JsonPropertyInfoValues<string> propertyInfo = jsonPropertyInfoValues;
        ...
        array[2] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo3);
        JsonPropertyInfoValues<List<ulong>> jsonPropertyInfoValues4 =
            new JsonPropertyInfoValues<List<ulong>>();
        ...
        jsonPropertyInfoValues4.AttributeProviderFactory = () =>
            typeof(NullLeaderboardFileEntry).GetField(
                "userIds",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic
            );
    ...
    private JsonTypeInfo<NullMultiplayerName> Create_NullMultiplayerName(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<NullMultiplayerName> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<NullMultiplayerName> objectInfo =
                new JsonObjectInfoValues<NullMultiplayerName>
                {
                    ObjectCreator = () => new NullMultiplayerName(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        NullMultiplayerNamePropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(NullMultiplayerName).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] NullMultiplayerNamePropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(NullMultiplayerName).GetField(
                "netId",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic
            );
        JsonPropertyInfoValues<ulong> propertyInfo = jsonPropertyInfoValues;
        array[0] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo);
        JsonPropertyInfoValues<string> jsonPropertyInfoValues2 =
            new JsonPropertyInfoValues<string>();
        jsonPropertyInfoValues2.IsProperty = false;
        jsonPropertyInfoValues2.IsPublic = true;
        jsonPropertyInfoValues2.IsVirtual = false;
    ...
    private JsonTypeInfo<PlatformType> Create_PlatformType(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<PlatformType> jsonTypeInfo
            )
        )
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<PlatformType>(
                options,
                JsonMetadataServices.GetEnumConverter<PlatformType>(options)
            );
        }
        jsonTypeInfo.OriginatingResolver = this;
        return jsonTypeInfo;
    ...
    private JsonTypeInfo<RewardType> Create_RewardType(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<RewardType> jsonTypeInfo
            )
        )
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<RewardType>(
                options,
                JsonMetadataServices.GetEnumConverter<RewardType>(options)
            );
        }
        jsonTypeInfo.OriginatingResolver = this;
        return jsonTypeInfo;
    ...
    private JsonTypeInfo<RoomType> Create_RoomType(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<RoomType> jsonTypeInfo
            )
        )
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<RoomType>(
                options,
                JsonMetadataServices.GetEnumConverter<RoomType>(options)
            );
        }
        jsonTypeInfo.OriginatingResolver = this;
        return jsonTypeInfo;
    ...
    private JsonTypeInfo<CardCreationSource> Create_CardCreationSource(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<CardCreationSource> jsonTypeInfo
            )
        )
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<CardCreationSource>(
                options,
                JsonMetadataServices.GetEnumConverter<CardCreationSource>(options)
            );
        }
        jsonTypeInfo.OriginatingResolver = this;
        return jsonTypeInfo;
    ...
    private JsonTypeInfo<CardRarityOddsType> Create_CardRarityOddsType(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<CardRarityOddsType> jsonTypeInfo
            )
        )
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<CardRarityOddsType>(
                options,
                JsonMetadataServices.GetEnumConverter<CardRarityOddsType>(options)
            );
        }
        jsonTypeInfo.OriginatingResolver = this;
        return jsonTypeInfo;
    ...
    private JsonTypeInfo<GameMode> Create_GameMode(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<GameMode> jsonTypeInfo
            )
        )
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<GameMode>(
                options,
                JsonMetadataServices.GetEnumConverter<GameMode>(options)
            );
        }
        jsonTypeInfo.OriginatingResolver = this;
        return jsonTypeInfo;
    ...
    private JsonTypeInfo<AncientChoiceHistoryEntry> Create_AncientChoiceHistoryEntry(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<AncientChoiceHistoryEntry> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<AncientChoiceHistoryEntry> objectInfo =
                new JsonObjectInfoValues<AncientChoiceHistoryEntry>
                {
                    ObjectCreator = () => new AncientChoiceHistoryEntry(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        AncientChoiceHistoryEntryPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(AncientChoiceHistoryEntry).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] AncientChoiceHistoryEntryPropInit(
        JsonSerializerOptions options
    )
    {
        JsonPropertyInfo[] array = new JsonPropertyInfo[3];
        JsonPropertyInfoValues<LocString> jsonPropertyInfoValues =
            new JsonPropertyInfoValues<LocString>();
        jsonPropertyInfoValues.IsProperty = true;
        jsonPropertyInfoValues.IsPublic = true;
        jsonPropertyInfoValues.IsVirtual = false;
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(AncientChoiceHistoryEntry).GetProperty(
                "Title",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(LocString),
        ...
        array[1] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo2);
        JsonPropertyInfoValues<string> jsonPropertyInfoValues3 =
            new JsonPropertyInfoValues<string>();
        jsonPropertyInfoValues3.IsProperty = true;
        jsonPropertyInfoValues3.IsPublic = true;
        jsonPropertyInfoValues3.IsVirtual = false;
    ...
    private JsonTypeInfo<CardChoiceHistoryEntry> Create_CardChoiceHistoryEntry(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<CardChoiceHistoryEntry> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<CardChoiceHistoryEntry> objectInfo =
                new JsonObjectInfoValues<CardChoiceHistoryEntry>
                {
                    ObjectCreator = () => default(CardChoiceHistoryEntry),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        CardChoiceHistoryEntryPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(CardChoiceHistoryEntry).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    {
        JsonPropertyInfo[] array = new JsonPropertyInfo[2];
        JsonPropertyInfoValues<SerializableCard> jsonPropertyInfoValues =
            new JsonPropertyInfoValues<SerializableCard>();
        jsonPropertyInfoValues.IsProperty = true;
        jsonPropertyInfoValues.IsPublic = true;
        jsonPropertyInfoValues.IsVirtual = false;
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(CardChoiceHistoryEntry).GetProperty(
                "Card",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
        ...
        jsonPropertyInfoValues2.AttributeProviderFactory = () =>
            typeof(CardChoiceHistoryEntry).GetField(
                "wasPicked",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic
            );
        JsonPropertyInfoValues<bool> propertyInfo2 = jsonPropertyInfoValues2;
    ...
    private JsonTypeInfo<CardEnchantmentHistoryEntry> Create_CardEnchantmentHistoryEntry(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<CardEnchantmentHistoryEntry> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<CardEnchantmentHistoryEntry> objectInfo =
                new JsonObjectInfoValues<CardEnchantmentHistoryEntry>
                {
                    ObjectCreator = () => default(CardEnchantmentHistoryEntry),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        CardEnchantmentHistoryEntryPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(CardEnchantmentHistoryEntry).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    )
    {
        ...
        jsonPropertyInfoValues.JsonPropertyName = "card";
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(CardEnchantmentHistoryEntry).GetProperty(
                "Card",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(SerializableCard),
        ...
        array[0].IsGetNullable = false;
        array[0].IsSetNullable = false;
        JsonPropertyInfoValues<ModelId> jsonPropertyInfoValues2 =
            new JsonPropertyInfoValues<ModelId>();
        jsonPropertyInfoValues2.IsProperty = true;
        jsonPropertyInfoValues2.IsPublic = true;
        jsonPropertyInfoValues2.IsVirtual = false;
        jsonPropertyInfoValues2.DeclaringType = typeof(CardEnchantmentHistoryEntry);
        jsonPropertyInfoValues2.Converter = null;
        jsonPropertyInfoValues2.Getter = (object obj) =>
            ((CardEnchantmentHistoryEntry)obj).Enchantment;
    ...
    private JsonTypeInfo<CardTransformationHistoryEntry> Create_CardTransformationHistoryEntry(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<CardTransformationHistoryEntry> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<CardTransformationHistoryEntry> objectInfo =
                new JsonObjectInfoValues<CardTransformationHistoryEntry>
                {
                    ObjectCreator = () => default(CardTransformationHistoryEntry),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        CardTransformationHistoryEntryPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(CardTransformationHistoryEntry).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    )
    {
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((CardTransformationHistoryEntry)obj).OriginalCard;
        jsonPropertyInfoValues.Setter = delegate(object obj, SerializableCard? value)
        {
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(CardTransformationHistoryEntry).GetProperty(
                "OriginalCard",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(SerializableCard),
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((CardTransformationHistoryEntry)obj).FinalCard;
        jsonPropertyInfoValues.Setter = delegate(object obj, SerializableCard? value)
        {
    ...
    private JsonTypeInfo<EventOptionHistoryEntry> Create_EventOptionHistoryEntry(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<EventOptionHistoryEntry> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<EventOptionHistoryEntry> objectInfo =
                new JsonObjectInfoValues<EventOptionHistoryEntry>
                {
                    ObjectCreator = () => default(EventOptionHistoryEntry),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        EventOptionHistoryEntryPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(EventOptionHistoryEntry).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] EventOptionHistoryEntryPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.JsonPropertyName = "title";
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(EventOptionHistoryEntry).GetProperty(
                "Title",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(LocString),
        ...
        array[0].IsGetNullable = false;
        array[0].IsSetNullable = false;
        JsonPropertyInfoValues<Dictionary<string, object>> jsonPropertyInfoValues2 =
            new JsonPropertyInfoValues<Dictionary<string, object>>();
        jsonPropertyInfoValues2.IsProperty = true;
        jsonPropertyInfoValues2.IsPublic = true;
        jsonPropertyInfoValues2.IsVirtual = false;
        jsonPropertyInfoValues2.DeclaringType = typeof(EventOptionHistoryEntry);
        jsonPropertyInfoValues2.Converter =
            (JsonConverter<Dictionary<string, object>>)
                ExpandConverter(
                    typeof(Dictionary<string, object>),
                    new LocStringVariablesJsonConverter(),
                    options
                );
    ...
    private JsonTypeInfo<MapPointHistoryEntry> Create_MapPointHistoryEntry(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<MapPointHistoryEntry> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<MapPointHistoryEntry> objectInfo =
                new JsonObjectInfoValues<MapPointHistoryEntry>
                {
                    ObjectCreator = () => new MapPointHistoryEntry(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        MapPointHistoryEntryPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(MapPointHistoryEntry).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    {
        JsonPropertyInfo[] array = new JsonPropertyInfo[3];
        JsonPropertyInfoValues<MapPointType> jsonPropertyInfoValues =
            new JsonPropertyInfoValues<MapPointType>();
        jsonPropertyInfoValues.IsProperty = true;
        jsonPropertyInfoValues.IsPublic = true;
        jsonPropertyInfoValues.IsVirtual = false;
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(MapPointHistoryEntry).GetProperty(
                "MapPointType",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(MapPointType),
        ...
        array[0] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo);
        JsonPropertyInfoValues<List<MapPointRoomHistoryEntry>> jsonPropertyInfoValues2 =
            new JsonPropertyInfoValues<List<MapPointRoomHistoryEntry>>();
        jsonPropertyInfoValues2.IsProperty = true;
        jsonPropertyInfoValues2.IsPublic = true;
        jsonPropertyInfoValues2.IsVirtual = false;
        ...
        jsonPropertyInfoValues2.AttributeProviderFactory = () =>
            typeof(MapPointHistoryEntry).GetProperty(
                ...
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(List<MapPointRoomHistoryEntry>),
                Array.Empty<Type>(),
                null
            );
        JsonPropertyInfoValues<List<MapPointRoomHistoryEntry>> propertyInfo2 =
            jsonPropertyInfoValues2;
        array[1] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo2);
        array[1].IsGetNullable = false;
        array[1].IsSetNullable = false;
        JsonPropertyInfoValues<List<PlayerMapPointHistoryEntry>> jsonPropertyInfoValues3 =
            new JsonPropertyInfoValues<List<PlayerMapPointHistoryEntry>>();
        jsonPropertyInfoValues3.IsProperty = true;
        jsonPropertyInfoValues3.IsPublic = true;
        jsonPropertyInfoValues3.IsVirtual = false;
        ...
        jsonPropertyInfoValues3.Setter = delegate(
            object obj,
            List<PlayerMapPointHistoryEntry>? value
        )
        {
        ...
        jsonPropertyInfoValues3.AttributeProviderFactory = () =>
            typeof(MapPointHistoryEntry).GetProperty(
                ...
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(List<PlayerMapPointHistoryEntry>),
                Array.Empty<Type>(),
                null
            );
        JsonPropertyInfoValues<List<PlayerMapPointHistoryEntry>> propertyInfo3 =
            jsonPropertyInfoValues3;
        array[2] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo3);
        array[2].IsGetNullable = false;
        array[2].IsSetNullable = false;
    ...
    private JsonTypeInfo<MapPointRoomHistoryEntry> Create_MapPointRoomHistoryEntry(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<MapPointRoomHistoryEntry> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<MapPointRoomHistoryEntry> objectInfo =
                new JsonObjectInfoValues<MapPointRoomHistoryEntry>
                {
                    ObjectCreator = () => new MapPointRoomHistoryEntry(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        MapPointRoomHistoryEntryPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(MapPointRoomHistoryEntry).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] MapPointRoomHistoryEntryPropInit(
        JsonSerializerOptions options
    )
    {
        JsonPropertyInfo[] array = new JsonPropertyInfo[4];
        JsonPropertyInfoValues<RoomType> jsonPropertyInfoValues =
            new JsonPropertyInfoValues<RoomType>();
        jsonPropertyInfoValues.IsProperty = true;
        jsonPropertyInfoValues.IsPublic = true;
        jsonPropertyInfoValues.IsVirtual = false;
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(MapPointRoomHistoryEntry).GetProperty(
                "RoomType",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(RoomType),
        ...
        JsonPropertyInfoValues<ModelId> propertyInfo2 = jsonPropertyInfoValues2;
        array[1] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo2);
        JsonPropertyInfoValues<List<ModelId>> jsonPropertyInfoValues3 =
            new JsonPropertyInfoValues<List<ModelId>>();
        jsonPropertyInfoValues3.IsProperty = true;
        jsonPropertyInfoValues3.IsPublic = true;
        jsonPropertyInfoValues3.IsVirtual = false;
    ...
    private JsonTypeInfo<ModelChoiceHistoryEntry> Create_ModelChoiceHistoryEntry(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<ModelChoiceHistoryEntry> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<ModelChoiceHistoryEntry> objectInfo =
                new JsonObjectInfoValues<ModelChoiceHistoryEntry>
                {
                    ObjectCreator = () => default(ModelChoiceHistoryEntry),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        ModelChoiceHistoryEntryPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(ModelChoiceHistoryEntry).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    {
        JsonPropertyInfo[] array = new JsonPropertyInfo[2];
        JsonPropertyInfoValues<ModelId> jsonPropertyInfoValues =
            new JsonPropertyInfoValues<ModelId>();
        jsonPropertyInfoValues.IsProperty = false;
        jsonPropertyInfoValues.IsPublic = true;
        jsonPropertyInfoValues.IsVirtual = false;
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(ModelChoiceHistoryEntry).GetField(
                "choice",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic
            );
    ...
    private JsonTypeInfo<PlayerMapPointHistoryEntry> Create_PlayerMapPointHistoryEntry(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<PlayerMapPointHistoryEntry> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<PlayerMapPointHistoryEntry> objectInfo =
                new JsonObjectInfoValues<PlayerMapPointHistoryEntry>
                {
                    ObjectCreator = () => new PlayerMapPointHistoryEntry(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        PlayerMapPointHistoryEntryPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(PlayerMapPointHistoryEntry).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] PlayerMapPointHistoryEntryPropInit(
        JsonSerializerOptions options
    )
    {
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(PlayerMapPointHistoryEntry).GetProperty(
                "PlayerId",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(ulong),
        ...
        jsonPropertyInfoValues2.Converter = null;
        jsonPropertyInfoValues2.Getter = (object obj) =>
            ((PlayerMapPointHistoryEntry)obj).GoldGained;
        jsonPropertyInfoValues2.Setter = delegate(object obj, int value)
        {
        ...
        jsonPropertyInfoValues2.Converter = null;
        jsonPropertyInfoValues2.Getter = (object obj) =>
            ((PlayerMapPointHistoryEntry)obj).GoldSpent;
        jsonPropertyInfoValues2.Setter = delegate(object obj, int value)
        {
        ...
        jsonPropertyInfoValues2.Converter = null;
        jsonPropertyInfoValues2.Getter = (object obj) =>
            ((PlayerMapPointHistoryEntry)obj).GoldStolen;
        jsonPropertyInfoValues2.Setter = delegate(object obj, int value)
        {
        ...
        jsonPropertyInfoValues2.Converter = null;
        jsonPropertyInfoValues2.Getter = (object obj) =>
            ((PlayerMapPointHistoryEntry)obj).CurrentGold;
        jsonPropertyInfoValues2.Setter = delegate(object obj, int value)
        {
        ...
        jsonPropertyInfoValues2.Converter = null;
        jsonPropertyInfoValues2.Getter = (object obj) =>
            ((PlayerMapPointHistoryEntry)obj).CurrentHp;
        jsonPropertyInfoValues2.Setter = delegate(object obj, int value)
        {
        ...
        jsonPropertyInfoValues2.Converter = null;
        jsonPropertyInfoValues2.Getter = (object obj) =>
            ((PlayerMapPointHistoryEntry)obj).DamageTaken;
        jsonPropertyInfoValues2.Setter = delegate(object obj, int value)
        {
        ...
        jsonPropertyInfoValues2.Converter = null;
        jsonPropertyInfoValues2.Getter = (object obj) =>
            ((PlayerMapPointHistoryEntry)obj).MaxHpLost;
        jsonPropertyInfoValues2.Setter = delegate(object obj, int value)
        {
        ...
        jsonPropertyInfoValues2.Converter = null;
        jsonPropertyInfoValues2.Getter = (object obj) =>
            ((PlayerMapPointHistoryEntry)obj).MaxHpGained;
        jsonPropertyInfoValues2.Setter = delegate(object obj, int value)
        {
        ...
        JsonPropertyInfoValues<List<AncientChoiceHistoryEntry>> jsonPropertyInfoValues3 =
            new JsonPropertyInfoValues<List<AncientChoiceHistoryEntry>>();
        jsonPropertyInfoValues3.IsProperty = true;
        jsonPropertyInfoValues3.IsPublic = true;
        jsonPropertyInfoValues3.IsVirtual = false;
        jsonPropertyInfoValues3.DeclaringType = typeof(PlayerMapPointHistoryEntry);
        jsonPropertyInfoValues3.Converter = null;
        jsonPropertyInfoValues3.Getter = (object obj) =>
            ((PlayerMapPointHistoryEntry)obj).AncientChoices;
        jsonPropertyInfoValues3.Setter = delegate(
            object obj,
            List<AncientChoiceHistoryEntry>? value
        )
        {
        ...
        jsonPropertyInfoValues3.AttributeProviderFactory = () =>
            typeof(PlayerMapPointHistoryEntry).GetProperty(
                ...
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(List<AncientChoiceHistoryEntry>),
                Array.Empty<Type>(),
                null
            );
        JsonPropertyInfoValues<List<AncientChoiceHistoryEntry>> propertyInfo13 =
            jsonPropertyInfoValues3;
        ...
        JsonPropertyInfoValues<List<SerializableCard>> jsonPropertyInfoValues4 =
            new JsonPropertyInfoValues<List<SerializableCard>>();
        jsonPropertyInfoValues4.IsProperty = true;
        jsonPropertyInfoValues4.IsPublic = true;
        jsonPropertyInfoValues4.IsVirtual = false;
        jsonPropertyInfoValues4.DeclaringType = typeof(PlayerMapPointHistoryEntry);
        jsonPropertyInfoValues4.Converter = null;
        jsonPropertyInfoValues4.Getter = (object obj) =>
            ((PlayerMapPointHistoryEntry)obj).CardsGained;
        ...
        JsonPropertyInfoValues<List<CardChoiceHistoryEntry>> jsonPropertyInfoValues5 =
            new JsonPropertyInfoValues<List<CardChoiceHistoryEntry>>();
        ...
        jsonPropertyInfoValues5.Getter = (object obj) =>
            ((PlayerMapPointHistoryEntry)obj).CardChoices;
        ...
        jsonPropertyInfoValues5.AttributeProviderFactory = () =>
            typeof(PlayerMapPointHistoryEntry).GetProperty(
                "CardChoices",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(List<CardChoiceHistoryEntry>),
                Array.Empty<Type>(),
                null
            );
        JsonPropertyInfoValues<List<CardChoiceHistoryEntry>> propertyInfo15 =
            jsonPropertyInfoValues5;
        ...
        JsonPropertyInfoValues<List<ModelChoiceHistoryEntry>> jsonPropertyInfoValues6 =
            new JsonPropertyInfoValues<List<ModelChoiceHistoryEntry>>();
        ...
        jsonPropertyInfoValues6.Getter = (object obj) =>
            ((PlayerMapPointHistoryEntry)obj).RelicChoices;
        ...
        jsonPropertyInfoValues6.AttributeProviderFactory = () =>
            typeof(PlayerMapPointHistoryEntry).GetProperty(
                "RelicChoices",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(List<ModelChoiceHistoryEntry>),
                Array.Empty<Type>(),
                null
            );
        JsonPropertyInfoValues<List<ModelChoiceHistoryEntry>> propertyInfo16 =
            jsonPropertyInfoValues6;
        ...
        jsonPropertyInfoValues6.Converter = null;
        jsonPropertyInfoValues6.Getter = (object obj) =>
            ((PlayerMapPointHistoryEntry)obj).PotionChoices;
        jsonPropertyInfoValues6.Setter = delegate(object obj, List<ModelChoiceHistoryEntry>? value)
        {
        ...
        JsonPropertyInfoValues<List<ModelChoiceHistoryEntry>> propertyInfo17 =
            jsonPropertyInfoValues6;
        ...
        JsonPropertyInfoValues<List<ModelId>> jsonPropertyInfoValues7 =
            new JsonPropertyInfoValues<List<ModelId>>();
        ...
        jsonPropertyInfoValues7.Getter = (object obj) =>
            ((PlayerMapPointHistoryEntry)obj).PotionDiscarded;
        ...
        jsonPropertyInfoValues7.AttributeProviderFactory = () =>
            typeof(PlayerMapPointHistoryEntry).GetProperty(
                "PotionDiscarded",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
        ...
        jsonPropertyInfoValues7.Converter = null;
        jsonPropertyInfoValues7.Getter = (object obj) =>
            ((PlayerMapPointHistoryEntry)obj).PotionUsed;
        jsonPropertyInfoValues7.Setter = delegate(object obj, List<ModelId>? value)
        {
        ...
        jsonPropertyInfoValues4.Converter = null;
        jsonPropertyInfoValues4.Getter = (object obj) =>
            ((PlayerMapPointHistoryEntry)obj).CardsRemoved;
        jsonPropertyInfoValues4.Setter = delegate(object obj, List<SerializableCard>? value)
        {
        ...
        jsonPropertyInfoValues7.Converter = null;
        jsonPropertyInfoValues7.Getter = (object obj) =>
            ((PlayerMapPointHistoryEntry)obj).RelicsRemoved;
        jsonPropertyInfoValues7.Setter = delegate(object obj, List<ModelId>? value)
        {
        ...
        JsonPropertyInfoValues<List<CardEnchantmentHistoryEntry>> jsonPropertyInfoValues8 =
            new JsonPropertyInfoValues<List<CardEnchantmentHistoryEntry>>();
        ...
        jsonPropertyInfoValues8.Getter = (object obj) =>
            ((PlayerMapPointHistoryEntry)obj).CardsEnchanted;
        jsonPropertyInfoValues8.Setter = delegate(
            object obj,
            List<CardEnchantmentHistoryEntry>? value
        )
        {
        ...
        jsonPropertyInfoValues8.AttributeProviderFactory = () =>
            typeof(PlayerMapPointHistoryEntry).GetProperty(
                "CardsEnchanted",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(List<CardEnchantmentHistoryEntry>),
                Array.Empty<Type>(),
                null
            );
        JsonPropertyInfoValues<List<CardEnchantmentHistoryEntry>> propertyInfo22 =
            jsonPropertyInfoValues8;
        ...
        JsonPropertyInfoValues<List<CardTransformationHistoryEntry>> jsonPropertyInfoValues9 =
            new JsonPropertyInfoValues<List<CardTransformationHistoryEntry>>();
        ...
        jsonPropertyInfoValues9.Getter = (object obj) =>
            ((PlayerMapPointHistoryEntry)obj).CardsTransformed;
        jsonPropertyInfoValues9.Setter = delegate(
            object obj,
            List<CardTransformationHistoryEntry>? value
        )
        {
        ...
        jsonPropertyInfoValues9.AttributeProviderFactory = () =>
            typeof(PlayerMapPointHistoryEntry).GetProperty(
                "CardsTransformed",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(List<CardTransformationHistoryEntry>),
                Array.Empty<Type>(),
                null
            );
        JsonPropertyInfoValues<List<CardTransformationHistoryEntry>> propertyInfo23 =
            jsonPropertyInfoValues9;
        ...
        jsonPropertyInfoValues7.Converter = null;
        jsonPropertyInfoValues7.Getter = (object obj) =>
            ((PlayerMapPointHistoryEntry)obj).UpgradedCards;
        jsonPropertyInfoValues7.Setter = delegate(object obj, List<ModelId>? value)
        {
        ...
        jsonPropertyInfoValues7.Converter = null;
        jsonPropertyInfoValues7.Getter = (object obj) =>
            ((PlayerMapPointHistoryEntry)obj).DowngradedCards;
        jsonPropertyInfoValues7.Setter = delegate(object obj, List<ModelId>? value)
        {
        ...
        JsonPropertyInfoValues<List<EventOptionHistoryEntry>> jsonPropertyInfoValues10 =
            new JsonPropertyInfoValues<List<EventOptionHistoryEntry>>();
        ...
        jsonPropertyInfoValues10.Getter = (object obj) =>
            ((PlayerMapPointHistoryEntry)obj).EventChoices;
        ...
        jsonPropertyInfoValues10.AttributeProviderFactory = () =>
            typeof(PlayerMapPointHistoryEntry).GetProperty(
                "EventChoices",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(List<EventOptionHistoryEntry>),
                Array.Empty<Type>(),
                null
            );
        JsonPropertyInfoValues<List<EventOptionHistoryEntry>> propertyInfo26 =
            jsonPropertyInfoValues10;
        ...
        JsonPropertyInfoValues<List<string>> jsonPropertyInfoValues11 =
            new JsonPropertyInfoValues<List<string>>();
        ...
        jsonPropertyInfoValues11.Getter = (object obj) =>
            ((PlayerMapPointHistoryEntry)obj).RestSiteChoices;
        ...
        jsonPropertyInfoValues11.AttributeProviderFactory = () =>
            typeof(PlayerMapPointHistoryEntry).GetProperty(
                "RestSiteChoices",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
        ...
        jsonPropertyInfoValues7.Converter = null;
        jsonPropertyInfoValues7.Getter = (object obj) =>
            ((PlayerMapPointHistoryEntry)obj).BoughtRelics;
        jsonPropertyInfoValues7.Setter = delegate(object obj, List<ModelId>? value)
        {
        ...
        jsonPropertyInfoValues7.Converter = null;
        jsonPropertyInfoValues7.Getter = (object obj) =>
            ((PlayerMapPointHistoryEntry)obj).BoughtPotions;
        jsonPropertyInfoValues7.Setter = delegate(object obj, List<ModelId>? value)
        {
        ...
        jsonPropertyInfoValues7.Converter = null;
        jsonPropertyInfoValues7.Getter = (object obj) =>
            ((PlayerMapPointHistoryEntry)obj).BoughtColorless;
        jsonPropertyInfoValues7.Setter = delegate(object obj, List<ModelId>? value)
        {
        ...
        jsonPropertyInfoValues7.Converter = null;
        jsonPropertyInfoValues7.Getter = (object obj) =>
            ((PlayerMapPointHistoryEntry)obj).CompletedQuests;
        jsonPropertyInfoValues7.Setter = delegate(object obj, List<ModelId>? value)
        {
    ...
    private JsonTypeInfo<RunHistory> Create_RunHistory(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<RunHistory> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<RunHistory> jsonObjectInfoValues =
                new JsonObjectInfoValues<RunHistory>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new RunHistory
                {
    ...
    private static JsonPropertyInfo[] RunHistoryPropInit(JsonSerializerOptions options)
    {
        ...
        JsonPropertyInfoValues<int> propertyInfo = jsonPropertyInfoValues;
        array[0] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo);
        JsonPropertyInfoValues<PlatformType> jsonPropertyInfoValues2 =
            new JsonPropertyInfoValues<PlatformType>();
        jsonPropertyInfoValues2.IsProperty = true;
        jsonPropertyInfoValues2.IsPublic = true;
        jsonPropertyInfoValues2.IsVirtual = false;
        ...
        array[1] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo2);
        JsonPropertyInfoValues<GameMode> jsonPropertyInfoValues3 =
            new JsonPropertyInfoValues<GameMode>();
        jsonPropertyInfoValues3.IsProperty = true;
        jsonPropertyInfoValues3.IsPublic = true;
        jsonPropertyInfoValues3.IsVirtual = false;
        ...
        array[3] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo4);
        JsonPropertyInfoValues<string> jsonPropertyInfoValues5 =
            new JsonPropertyInfoValues<string>();
        jsonPropertyInfoValues5.IsProperty = true;
        jsonPropertyInfoValues5.IsPublic = true;
        jsonPropertyInfoValues5.IsVirtual = false;
        ...
        array[9] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo10);
        JsonPropertyInfoValues<ModelId> jsonPropertyInfoValues8 =
            new JsonPropertyInfoValues<ModelId>();
        jsonPropertyInfoValues8.IsProperty = true;
        jsonPropertyInfoValues8.IsPublic = true;
        jsonPropertyInfoValues8.IsVirtual = false;
        ...
        JsonPropertyInfoValues<List<RunHistoryPlayer>> jsonPropertyInfoValues9 =
            new JsonPropertyInfoValues<List<RunHistoryPlayer>>();
        jsonPropertyInfoValues9.IsProperty = true;
        jsonPropertyInfoValues9.IsPublic = true;
        jsonPropertyInfoValues9.IsVirtual = false;
        ...
        array[12].IsGetNullable = false;
        array[12].IsSetNullable = false;
        JsonPropertyInfoValues<List<ModelId>> jsonPropertyInfoValues10 =
            new JsonPropertyInfoValues<List<ModelId>>();
        jsonPropertyInfoValues10.IsProperty = true;
        jsonPropertyInfoValues10.IsPublic = true;
        jsonPropertyInfoValues10.IsVirtual = false;
        ...
        array[13].IsGetNullable = false;
        array[13].IsSetNullable = false;
        JsonPropertyInfoValues<List<SerializableModifier>> jsonPropertyInfoValues11 =
            new JsonPropertyInfoValues<List<SerializableModifier>>();
        jsonPropertyInfoValues11.IsProperty = true;
        jsonPropertyInfoValues11.IsPublic = true;
        jsonPropertyInfoValues11.IsVirtual = false;
        ...
        jsonPropertyInfoValues11.AttributeProviderFactory = () =>
            typeof(RunHistory).GetProperty(
                ...
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(List<SerializableModifier>),
                Array.Empty<Type>(),
                null
            );
        JsonPropertyInfoValues<List<SerializableModifier>> propertyInfo15 =
            jsonPropertyInfoValues11;
        array[14] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo15);
        array[14].IsGetNullable = false;
        array[14].IsSetNullable = false;
        JsonPropertyInfoValues<List<List<MapPointHistoryEntry>>> jsonPropertyInfoValues12 =
            new JsonPropertyInfoValues<List<List<MapPointHistoryEntry>>>();
        ...
        jsonPropertyInfoValues12.AttributeProviderFactory = () =>
            typeof(RunHistory).GetProperty(
                "MapPointHistory",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(List<List<MapPointHistoryEntry>>),
                Array.Empty<Type>(),
                null
            );
        JsonPropertyInfoValues<List<List<MapPointHistoryEntry>>> propertyInfo16 =
            jsonPropertyInfoValues12;
        array[15] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo16);
        array[15].IsGetNullable = false;
        array[15].IsSetNullable = false;
        return array;
    ...
    private JsonTypeInfo<RunHistoryPlayer> Create_RunHistoryPlayer(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<RunHistoryPlayer> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<RunHistoryPlayer> jsonObjectInfoValues =
                new JsonObjectInfoValues<RunHistoryPlayer>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new RunHistoryPlayer { Id = (ulong)args[0], Character = (ModelId)args[1] };
            jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) =>
                RunHistoryPlayerPropInit(options);
            jsonObjectInfoValues.ConstructorParameterMetadataInitializer =
                RunHistoryPlayerCtorParamInit;
            jsonObjectInfoValues.ConstructorAttributeProviderFactory = () =>
                typeof(RunHistoryPlayer).GetConstructor(
                    BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                    null,
                    Array.Empty<Type>(),
                    null
    ...
    private static JsonPropertyInfo[] RunHistoryPlayerPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.JsonPropertyName = "id";
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(RunHistoryPlayer).GetProperty(
                "Id",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(ulong),
        ...
        array[1].IsGetNullable = false;
        array[1].IsSetNullable = false;
        JsonPropertyInfoValues<IEnumerable<SerializableCard>> jsonPropertyInfoValues3 =
            new JsonPropertyInfoValues<IEnumerable<SerializableCard>>();
        jsonPropertyInfoValues3.IsProperty = true;
        jsonPropertyInfoValues3.IsPublic = true;
        jsonPropertyInfoValues3.IsVirtual = false;
        ...
        jsonPropertyInfoValues3.AttributeProviderFactory = () =>
            typeof(RunHistoryPlayer).GetProperty(
                ...
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(IEnumerable<SerializableCard>),
                Array.Empty<Type>(),
                null
            );
        JsonPropertyInfoValues<IEnumerable<SerializableCard>> propertyInfo3 =
            jsonPropertyInfoValues3;
        array[2] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo3);
        array[2].IsGetNullable = false;
        array[2].IsSetNullable = false;
        JsonPropertyInfoValues<IEnumerable<SerializableRelic>> jsonPropertyInfoValues4 =
            new JsonPropertyInfoValues<IEnumerable<SerializableRelic>>();
        jsonPropertyInfoValues4.IsProperty = true;
        jsonPropertyInfoValues4.IsPublic = true;
        jsonPropertyInfoValues4.IsVirtual = false;
        ...
        jsonPropertyInfoValues4.AttributeProviderFactory = () =>
            typeof(RunHistoryPlayer).GetProperty(
                ...
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(IEnumerable<SerializableRelic>),
                Array.Empty<Type>(),
                null
            );
        JsonPropertyInfoValues<IEnumerable<SerializableRelic>> propertyInfo4 =
            jsonPropertyInfoValues4;
        array[3] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo4);
        array[3].IsGetNullable = false;
        array[3].IsSetNullable = false;
        JsonPropertyInfoValues<IEnumerable<SerializablePotion>> jsonPropertyInfoValues5 =
            new JsonPropertyInfoValues<IEnumerable<SerializablePotion>>();
        jsonPropertyInfoValues5.IsProperty = true;
        jsonPropertyInfoValues5.IsPublic = true;
        jsonPropertyInfoValues5.IsVirtual = false;
        ...
        jsonPropertyInfoValues5.Setter = delegate(
            object obj,
            IEnumerable<SerializablePotion>? value
        )
        {
        ...
        jsonPropertyInfoValues5.AttributeProviderFactory = () =>
            typeof(RunHistoryPlayer).GetProperty(
                ...
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(IEnumerable<SerializablePotion>),
                Array.Empty<Type>(),
                null
            );
        JsonPropertyInfoValues<IEnumerable<SerializablePotion>> propertyInfo5 =
            jsonPropertyInfoValues5;
        array[4] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo5);
        array[4].IsGetNullable = false;
        array[4].IsSetNullable = false;
        JsonPropertyInfoValues<IEnumerable<SerializableBadge>> jsonPropertyInfoValues6 =
            new JsonPropertyInfoValues<IEnumerable<SerializableBadge>>();
        jsonPropertyInfoValues6.IsProperty = true;
        jsonPropertyInfoValues6.IsPublic = true;
        jsonPropertyInfoValues6.IsVirtual = false;
        ...
        jsonPropertyInfoValues6.AttributeProviderFactory = () =>
            typeof(RunHistoryPlayer).GetProperty(
                ...
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(IEnumerable<SerializableBadge>),
                Array.Empty<Type>(),
                null
            );
        JsonPropertyInfoValues<IEnumerable<SerializableBadge>> propertyInfo6 =
            jsonPropertyInfoValues6;
        array[5] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo6);
    ...
    private JsonTypeInfo<AncientCharacterStats> Create_AncientCharacterStats(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<AncientCharacterStats> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<AncientCharacterStats> jsonObjectInfoValues =
                new JsonObjectInfoValues<AncientCharacterStats>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new AncientCharacterStats { Character = (ModelId)args[0] };
            jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) =>
                AncientCharacterStatsPropInit(options);
            jsonObjectInfoValues.ConstructorParameterMetadataInitializer =
                AncientCharacterStatsCtorParamInit;
            jsonObjectInfoValues.ConstructorAttributeProviderFactory = () =>
                typeof(AncientCharacterStats).GetConstructor(
                    BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                    null,
                    Array.Empty<Type>(),
                    null
    ...
    private static JsonPropertyInfo[] AncientCharacterStatsPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(AncientCharacterStats).GetProperty(
                "Character",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(ModelId),
    ...
    private JsonTypeInfo<AncientStats> Create_AncientStats(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<AncientStats> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<AncientStats> jsonObjectInfoValues =
                new JsonObjectInfoValues<AncientStats>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new AncientStats
                {
            ...
            jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) =>
                AncientStatsPropInit(options);
            jsonObjectInfoValues.ConstructorParameterMetadataInitializer =
                AncientStatsCtorParamInit;
            jsonObjectInfoValues.ConstructorAttributeProviderFactory = () =>
                typeof(AncientStats).GetConstructor(
                    BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                    null,
                    Array.Empty<Type>(),
                    null
    ...
    private static JsonPropertyInfo[] AncientStatsPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(AncientStats).GetProperty(
                "Id",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(ModelId),
        ...
        array[0].IsGetNullable = false;
        array[0].IsSetNullable = false;
        JsonPropertyInfoValues<List<AncientCharacterStats>> jsonPropertyInfoValues2 =
            new JsonPropertyInfoValues<List<AncientCharacterStats>>();
        jsonPropertyInfoValues2.IsProperty = true;
        jsonPropertyInfoValues2.IsPublic = true;
        jsonPropertyInfoValues2.IsVirtual = false;
        ...
        jsonPropertyInfoValues2.AttributeProviderFactory = () =>
            typeof(AncientStats).GetProperty(
                ...
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(List<AncientCharacterStats>),
                Array.Empty<Type>(),
                null
            );
    ...
    private JsonTypeInfo<BadgeStats> Create_BadgeStats(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<BadgeStats> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<BadgeStats> jsonObjectInfoValues =
                new JsonObjectInfoValues<BadgeStats>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new BadgeStats
                {
    ...
    private static JsonPropertyInfo[] BadgeStatsPropInit(JsonSerializerOptions options)
    {
        ...
        JsonPropertyInfoValues<BadgeRarity> jsonPropertyInfoValues3 =
            new JsonPropertyInfoValues<BadgeRarity>();
        jsonPropertyInfoValues3.IsProperty = true;
        jsonPropertyInfoValues3.IsPublic = true;
        jsonPropertyInfoValues3.IsVirtual = false;
    ...
    private JsonTypeInfo<CardStats> Create_CardStats(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<CardStats> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<CardStats> jsonObjectInfoValues =
                new JsonObjectInfoValues<CardStats>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new CardStats { Id = (ModelId)args[0] };
            jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) =>
                CardStatsPropInit(options);
            jsonObjectInfoValues.ConstructorParameterMetadataInitializer = CardStatsCtorParamInit;
            jsonObjectInfoValues.ConstructorAttributeProviderFactory = () =>
                typeof(CardStats).GetConstructor(
                    BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                    null,
                    Array.Empty<Type>(),
                    null
    ...
    private JsonTypeInfo<CharacterStats> Create_CharacterStats(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<CharacterStats> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<CharacterStats> jsonObjectInfoValues =
                new JsonObjectInfoValues<CharacterStats>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new CharacterStats { Id = (ModelId)args[0] };
            jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) =>
                CharacterStatsPropInit(options);
            jsonObjectInfoValues.ConstructorParameterMetadataInitializer =
                CharacterStatsCtorParamInit;
            jsonObjectInfoValues.ConstructorAttributeProviderFactory = () =>
                typeof(CharacterStats).GetConstructor(
                    BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                    null,
                    Array.Empty<Type>(),
                    null
    ...
    private static JsonPropertyInfo[] CharacterStatsPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.JsonPropertyName = "id";
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(CharacterStats).GetProperty(
                "Id",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(ModelId),
        ...
        array[8] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo9);
        JsonPropertyInfoValues<List<BadgeStats>> jsonPropertyInfoValues4 =
            new JsonPropertyInfoValues<List<BadgeStats>>();
        jsonPropertyInfoValues4.IsProperty = true;
        jsonPropertyInfoValues4.IsPublic = true;
        jsonPropertyInfoValues4.IsVirtual = false;
    ...
    private JsonTypeInfo<EncounterStats> Create_EncounterStats(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<EncounterStats> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<EncounterStats> jsonObjectInfoValues =
                new JsonObjectInfoValues<EncounterStats>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new EncounterStats
                {
            ...
            jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) =>
                EncounterStatsPropInit(options);
            jsonObjectInfoValues.ConstructorParameterMetadataInitializer =
                EncounterStatsCtorParamInit;
            jsonObjectInfoValues.ConstructorAttributeProviderFactory = () =>
                typeof(EncounterStats).GetConstructor(
                    BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                    null,
                    Array.Empty<Type>(),
                    null
    ...
    private static JsonPropertyInfo[] EncounterStatsPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(EncounterStats).GetProperty(
                "Id",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(ModelId),
        ...
        array[0].IsGetNullable = false;
        array[0].IsSetNullable = false;
        JsonPropertyInfoValues<List<FightStats>> jsonPropertyInfoValues2 =
            new JsonPropertyInfoValues<List<FightStats>>();
        jsonPropertyInfoValues2.IsProperty = true;
        jsonPropertyInfoValues2.IsPublic = true;
        jsonPropertyInfoValues2.IsVirtual = false;
    ...
    private JsonTypeInfo<EnemyStats> Create_EnemyStats(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<EnemyStats> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<EnemyStats> jsonObjectInfoValues =
                new JsonObjectInfoValues<EnemyStats>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new EnemyStats { Id = (ModelId)args[0], FightStats = (List<FightStats>)args[1] };
            jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) =>
                EnemyStatsPropInit(options);
            jsonObjectInfoValues.ConstructorParameterMetadataInitializer = EnemyStatsCtorParamInit;
            jsonObjectInfoValues.ConstructorAttributeProviderFactory = () =>
                typeof(EnemyStats).GetConstructor(
                    BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                    null,
                    Array.Empty<Type>(),
                    null
    ...
    private JsonTypeInfo<EpochState> Create_EpochState(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<EpochState> jsonTypeInfo
            )
        )
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<EpochState>(
                options,
                JsonMetadataServices.GetEnumConverter<EpochState>(options)
            );
        }
        jsonTypeInfo.OriginatingResolver = this;
        return jsonTypeInfo;
    ...
    private JsonTypeInfo<FightStats> Create_FightStats(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<FightStats> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<FightStats> jsonObjectInfoValues =
                new JsonObjectInfoValues<FightStats>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new FightStats { Character = (ModelId)args[0] };
            jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) =>
                FightStatsPropInit(options);
            jsonObjectInfoValues.ConstructorParameterMetadataInitializer = FightStatsCtorParamInit;
            jsonObjectInfoValues.ConstructorAttributeProviderFactory = () =>
                typeof(FightStats).GetConstructor(
                    BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                    null,
                    Array.Empty<Type>(),
                    null
    ...
    private JsonTypeInfo<SerializableMapDrawingLine> Create_SerializableMapDrawingLine(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializableMapDrawingLine> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializableMapDrawingLine> objectInfo =
                new JsonObjectInfoValues<SerializableMapDrawingLine>
                {
                    ObjectCreator = () => new SerializableMapDrawingLine(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SerializableMapDrawingLinePropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SerializableMapDrawingLine).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] SerializableMapDrawingLinePropInit(
        JsonSerializerOptions options
    )
    {
        JsonPropertyInfo[] array = new JsonPropertyInfo[2];
        ...
        jsonPropertyInfoValues.JsonPropertyName = null;
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializableMapDrawingLine).GetField(
                "isEraser",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic
            );
        JsonPropertyInfoValues<bool> propertyInfo = jsonPropertyInfoValues;
        array[0] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo);
        JsonPropertyInfoValues<List<Vector2>> jsonPropertyInfoValues2 =
            new JsonPropertyInfoValues<List<Vector2>>();
        jsonPropertyInfoValues2.IsProperty = false;
        jsonPropertyInfoValues2.IsPublic = true;
        jsonPropertyInfoValues2.IsVirtual = false;
        ...
        jsonPropertyInfoValues2.Converter = null;
        jsonPropertyInfoValues2.Getter = (object obj) =>
            ((SerializableMapDrawingLine)obj).mapPoints;
    ...
    private JsonTypeInfo<SerializableMapDrawings> Create_SerializableMapDrawings(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializableMapDrawings> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializableMapDrawings> objectInfo =
                new JsonObjectInfoValues<SerializableMapDrawings>
                {
                    ObjectCreator = () => new SerializableMapDrawings(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SerializableMapDrawingsPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SerializableMapDrawings).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] SerializableMapDrawingsPropInit(JsonSerializerOptions options)
    {
        ...
        JsonPropertyInfoValues<List<SerializablePlayerMapDrawings>> jsonPropertyInfoValues =
            new JsonPropertyInfoValues<List<SerializablePlayerMapDrawings>>();
        jsonPropertyInfoValues.IsProperty = false;
        jsonPropertyInfoValues.IsPublic = true;
        jsonPropertyInfoValues.IsVirtual = false;
        ...
        jsonPropertyInfoValues.Setter = delegate(
            object obj,
            List<SerializablePlayerMapDrawings>? value
        )
        {
        ...
        jsonPropertyInfoValues.JsonPropertyName = null;
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializableMapDrawings).GetField(
                "drawings",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic
            );
        JsonPropertyInfoValues<List<SerializablePlayerMapDrawings>> propertyInfo =
    ...
    private JsonTypeInfo<SerializablePlayerMapDrawings> Create_SerializablePlayerMapDrawings(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializablePlayerMapDrawings> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializablePlayerMapDrawings> objectInfo =
                new JsonObjectInfoValues<SerializablePlayerMapDrawings>
                {
                    ObjectCreator = () => new SerializablePlayerMapDrawings(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SerializablePlayerMapDrawingsPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SerializablePlayerMapDrawings).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    )
    {
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((SerializablePlayerMapDrawings)obj).playerId;
        jsonPropertyInfoValues.Setter = delegate(object obj, ulong value)
        {
        ...
        jsonPropertyInfoValues.JsonPropertyName = null;
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializablePlayerMapDrawings).GetField(
                "playerId",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic
            );
        JsonPropertyInfoValues<ulong> propertyInfo = jsonPropertyInfoValues;
        array[0] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo);
        JsonPropertyInfoValues<List<SerializableMapDrawingLine>> jsonPropertyInfoValues2 =
            new JsonPropertyInfoValues<List<SerializableMapDrawingLine>>();
        jsonPropertyInfoValues2.IsProperty = false;
        jsonPropertyInfoValues2.IsPublic = true;
        jsonPropertyInfoValues2.IsVirtual = false;
        ...
        jsonPropertyInfoValues2.Setter = delegate(
            object obj,
            List<SerializableMapDrawingLine>? value
        )
        {
        ...
        JsonPropertyInfoValues<List<SerializableMapDrawingLine>> propertyInfo2 =
            jsonPropertyInfoValues2;
        array[1] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo2);
        array[1].IsGetNullable = false;
        array[1].IsSetNullable = false;
    ...
    private JsonTypeInfo<MigratingData> Create_MigratingData(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<MigratingData> jsonTypeInfo
            )
        )
        {
    ...
    private JsonTypeInfo<PrefsSave> Create_PrefsSave(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<PrefsSave> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<PrefsSave> objectInfo = new JsonObjectInfoValues<PrefsSave>
            {
                ...
                ObjectWithParameterizedConstructorCreator = null,
                PropertyMetadataInitializer = (JsonSerializerContext _) =>
                    PrefsSavePropInit(options),
                ConstructorParameterMetadataInitializer = null,
                ConstructorAttributeProviderFactory = () =>
                    typeof(PrefsSave).GetConstructor(
                        BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                        null,
                        Array.Empty<Type>(),
                        null
    ...
    private static JsonPropertyInfo[] PrefsSavePropInit(JsonSerializerOptions options)
    {
        ...
        JsonPropertyInfoValues<int> propertyInfo = jsonPropertyInfoValues;
        array[0] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo);
        JsonPropertyInfoValues<FastModeType> jsonPropertyInfoValues2 =
            new JsonPropertyInfoValues<FastModeType>();
        jsonPropertyInfoValues2.IsProperty = true;
        jsonPropertyInfoValues2.IsPublic = true;
        jsonPropertyInfoValues2.IsVirtual = false;
    ...
    private JsonTypeInfo<ProfileSave> Create_ProfileSave(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<ProfileSave> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<ProfileSave> objectInfo = new JsonObjectInfoValues<ProfileSave>
            {
                ...
                ObjectWithParameterizedConstructorCreator = null,
                PropertyMetadataInitializer = (JsonSerializerContext _) =>
                    ProfileSavePropInit(options),
                ConstructorParameterMetadataInitializer = null,
                ConstructorAttributeProviderFactory = () =>
                    typeof(ProfileSave).GetConstructor(
                        BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                        null,
                        Array.Empty<Type>(),
                        null
    ...
    private static JsonPropertyInfo[] ProfileSavePropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.JsonPropertyName = "schema_version";
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(ProfileSave).GetProperty(
                "SchemaVersion",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(int),
    ...
    private JsonTypeInfo<SavedProperties> Create_SavedProperties(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SavedProperties> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SavedProperties> objectInfo =
                new JsonObjectInfoValues<SavedProperties>
                {
                    ObjectCreator = () => new SavedProperties(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SavedPropertiesPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SavedProperties).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    {
        JsonPropertyInfo[] array = new JsonPropertyInfo[7];
        JsonPropertyInfoValues<List<SavedProperties.SavedProperty<int>>> jsonPropertyInfoValues =
            new JsonPropertyInfoValues<List<SavedProperties.SavedProperty<int>>>();
        jsonPropertyInfoValues.IsProperty = false;
        jsonPropertyInfoValues.IsPublic = true;
        jsonPropertyInfoValues.IsVirtual = false;
        ...
        jsonPropertyInfoValues.Setter = delegate(
            object obj,
            List<SavedProperties.SavedProperty<int>>? value
        )
        {
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SavedProperties).GetField(
                "ints",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic
            );
        JsonPropertyInfoValues<List<SavedProperties.SavedProperty<int>>> propertyInfo =
            jsonPropertyInfoValues;
        array[0] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo);
        JsonPropertyInfoValues<List<SavedProperties.SavedProperty<bool>>> jsonPropertyInfoValues2 =
            new JsonPropertyInfoValues<List<SavedProperties.SavedProperty<bool>>>();
        jsonPropertyInfoValues2.IsProperty = false;
        jsonPropertyInfoValues2.IsPublic = true;
        jsonPropertyInfoValues2.IsVirtual = false;
        ...
        jsonPropertyInfoValues2.Setter = delegate(
            object obj,
            List<SavedProperties.SavedProperty<bool>>? value
        )
        {
        ...
        JsonPropertyInfoValues<List<SavedProperties.SavedProperty<bool>>> propertyInfo2 =
            jsonPropertyInfoValues2;
        array[1] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo2);
        JsonPropertyInfoValues<
            List<SavedProperties.SavedProperty<string>>
        > jsonPropertyInfoValues3 =
            new JsonPropertyInfoValues<List<SavedProperties.SavedProperty<string>>>();
        jsonPropertyInfoValues3.IsProperty = false;
        jsonPropertyInfoValues3.IsPublic = true;
        jsonPropertyInfoValues3.IsVirtual = false;
        ...
        jsonPropertyInfoValues3.Setter = delegate(
            object obj,
            List<SavedProperties.SavedProperty<string>>? value
        )
        {
        ...
        JsonPropertyInfoValues<List<SavedProperties.SavedProperty<string>>> propertyInfo3 =
            jsonPropertyInfoValues3;
        array[2] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo3);
        JsonPropertyInfoValues<List<SavedProperties.SavedProperty<int[]>>> jsonPropertyInfoValues4 =
            new JsonPropertyInfoValues<List<SavedProperties.SavedProperty<int[]>>>();
        jsonPropertyInfoValues4.IsProperty = false;
        jsonPropertyInfoValues4.IsPublic = true;
        jsonPropertyInfoValues4.IsVirtual = false;
        ...
        JsonPropertyInfoValues<List<SavedProperties.SavedProperty<int[]>>> propertyInfo4 =
            jsonPropertyInfoValues4;
        array[3] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo4);
        JsonPropertyInfoValues<
            List<SavedProperties.SavedProperty<ModelId>>
        > jsonPropertyInfoValues5 =
            new JsonPropertyInfoValues<List<SavedProperties.SavedProperty<ModelId>>>();
        ...
        jsonPropertyInfoValues5.Setter = delegate(
            object obj,
            List<SavedProperties.SavedProperty<ModelId>>? value
        )
        {
        ...
        JsonPropertyInfoValues<List<SavedProperties.SavedProperty<ModelId>>> propertyInfo5 =
            jsonPropertyInfoValues5;
        array[4] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo5);
        JsonPropertyInfoValues<
            List<SavedProperties.SavedProperty<SerializableCard>>
        > jsonPropertyInfoValues6 =
            new JsonPropertyInfoValues<List<SavedProperties.SavedProperty<SerializableCard>>>();
        ...
        jsonPropertyInfoValues6.Setter = delegate(
            object obj,
            List<SavedProperties.SavedProperty<SerializableCard>>? value
        )
        {
        ...
        JsonPropertyInfoValues<
            List<SavedProperties.SavedProperty<SerializableCard>>
        > propertyInfo6 = jsonPropertyInfoValues6;
        array[5] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo6);
        JsonPropertyInfoValues<
            List<SavedProperties.SavedProperty<SerializableCard[]>>
        > jsonPropertyInfoValues7 =
            new JsonPropertyInfoValues<List<SavedProperties.SavedProperty<SerializableCard[]>>>();
        ...
        JsonPropertyInfoValues<
            List<SavedProperties.SavedProperty<SerializableCard[]>>
        > propertyInfo7 = jsonPropertyInfoValues7;
        array[6] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo7);
        return array;
    }

    private JsonTypeInfo<SavedProperties.SavedProperty<bool>> Create_SavedPropertyBoolean(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SavedProperties.SavedProperty<bool>> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SavedProperties.SavedProperty<bool>> objectInfo =
                new JsonObjectInfoValues<SavedProperties.SavedProperty<bool>>
                {
                    ObjectCreator = () => default(SavedProperties.SavedProperty<bool>),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SavedPropertyBooleanPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SavedProperties.SavedProperty<bool>).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] SavedPropertyBooleanPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((SavedProperties.SavedProperty<bool>)obj).name;
        jsonPropertyInfoValues.Setter = delegate(object obj, string? value)
        {
        ...
        jsonPropertyInfoValues.JsonPropertyName = null;
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SavedProperties.SavedProperty<bool>).GetField(
                "name",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic
            );
        JsonPropertyInfoValues<string> propertyInfo = jsonPropertyInfoValues;
        ...
        jsonPropertyInfoValues2.Converter = null;
        jsonPropertyInfoValues2.Getter = (object obj) =>
            ((SavedProperties.SavedProperty<bool>)obj).value;
        jsonPropertyInfoValues2.Setter = delegate(object obj, bool value)
        {
    ...
    private JsonTypeInfo<SavedProperties.SavedProperty<ModelId>> Create_SavedPropertyModelId(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SavedProperties.SavedProperty<ModelId>> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SavedProperties.SavedProperty<ModelId>> objectInfo =
                new JsonObjectInfoValues<SavedProperties.SavedProperty<ModelId>>
                {
                    ObjectCreator = () => default(SavedProperties.SavedProperty<ModelId>),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SavedPropertyModelIdPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SavedProperties.SavedProperty<ModelId>).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] SavedPropertyModelIdPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((SavedProperties.SavedProperty<ModelId>)obj).name;
        jsonPropertyInfoValues.Setter = delegate(object obj, string? value)
        {
        ...
        jsonPropertyInfoValues.JsonPropertyName = null;
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SavedProperties.SavedProperty<ModelId>).GetField(
                "name",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic
            );
        JsonPropertyInfoValues<string> propertyInfo = jsonPropertyInfoValues;
        ...
        jsonPropertyInfoValues2.Converter = null;
        jsonPropertyInfoValues2.Getter = (object obj) =>
            ((SavedProperties.SavedProperty<ModelId>)obj).value;
        jsonPropertyInfoValues2.Setter = delegate(object obj, ModelId? value)
        {
    ...
    private JsonTypeInfo<SavedProperties.SavedProperty<SerializableCard[]>> Create_SavedPropertySerializableCardArray(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SavedProperties.SavedProperty<SerializableCard[]>> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SavedProperties.SavedProperty<SerializableCard[]>> objectInfo =
                new JsonObjectInfoValues<SavedProperties.SavedProperty<SerializableCard[]>>
                {
                    ObjectCreator = () =>
                        default(SavedProperties.SavedProperty<SerializableCard[]>),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SavedPropertySerializableCardArrayPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SavedProperties.SavedProperty<SerializableCard[]>).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    )
    {
        ...
        jsonPropertyInfoValues.IsPublic = true;
        jsonPropertyInfoValues.IsVirtual = false;
        jsonPropertyInfoValues.DeclaringType =
            typeof(SavedProperties.SavedProperty<SerializableCard[]>);
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((SavedProperties.SavedProperty<SerializableCard[]>)obj).name;
        jsonPropertyInfoValues.Setter = delegate(object obj, string? value)
        {
        ...
        jsonPropertyInfoValues.JsonPropertyName = null;
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SavedProperties.SavedProperty<SerializableCard[]>).GetField(
                "name",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic
            );
        JsonPropertyInfoValues<string> propertyInfo = jsonPropertyInfoValues;
        ...
        array[0].IsGetNullable = false;
        array[0].IsSetNullable = false;
        JsonPropertyInfoValues<SerializableCard[]> jsonPropertyInfoValues2 =
            new JsonPropertyInfoValues<SerializableCard[]>();
        jsonPropertyInfoValues2.IsProperty = false;
        jsonPropertyInfoValues2.IsPublic = true;
        jsonPropertyInfoValues2.IsVirtual = false;
        jsonPropertyInfoValues2.DeclaringType =
            typeof(SavedProperties.SavedProperty<SerializableCard[]>);
        jsonPropertyInfoValues2.Converter = null;
        jsonPropertyInfoValues2.Getter = (object obj) =>
            ((SavedProperties.SavedProperty<SerializableCard[]>)obj).value;
    ...
    private JsonTypeInfo<SavedProperties.SavedProperty<SerializableCard>> Create_SavedPropertySerializableCard(
        JsonSerializerOptions options
    )
    {
        if (
        ...
        )
        {
            JsonObjectInfoValues<SavedProperties.SavedProperty<SerializableCard>> objectInfo =
                new JsonObjectInfoValues<SavedProperties.SavedProperty<SerializableCard>>
                {
                    ...
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SavedPropertySerializableCardPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SavedProperties.SavedProperty<SerializableCard>).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
    ...
    private JsonTypeInfo<SavedProperties.SavedProperty<int[]>> Create_SavedPropertyInt32Array(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SavedProperties.SavedProperty<int[]>> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SavedProperties.SavedProperty<int[]>> objectInfo =
                new JsonObjectInfoValues<SavedProperties.SavedProperty<int[]>>
                {
                    ObjectCreator = () => default(SavedProperties.SavedProperty<int[]>),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SavedPropertyInt32ArrayPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SavedProperties.SavedProperty<int[]>).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] SavedPropertyInt32ArrayPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((SavedProperties.SavedProperty<int[]>)obj).name;
        jsonPropertyInfoValues.Setter = delegate(object obj, string? value)
        {
        ...
        jsonPropertyInfoValues.JsonPropertyName = null;
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SavedProperties.SavedProperty<int[]>).GetField(
                "name",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic
            );
        JsonPropertyInfoValues<string> propertyInfo = jsonPropertyInfoValues;
        ...
        jsonPropertyInfoValues2.Converter = null;
        jsonPropertyInfoValues2.Getter = (object obj) =>
            ((SavedProperties.SavedProperty<int[]>)obj).value;
        jsonPropertyInfoValues2.Setter = delegate(object obj, int[]? value)
        {
    ...
    private JsonTypeInfo<SavedProperties.SavedProperty<int>> Create_SavedPropertyInt32(
        JsonSerializerOptions options
    )
    {
        if (
        ...
        )
        {
            JsonObjectInfoValues<SavedProperties.SavedProperty<int>> objectInfo =
                new JsonObjectInfoValues<SavedProperties.SavedProperty<int>>
                {
                    ...
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SavedPropertyInt32PropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SavedProperties.SavedProperty<int>).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
    ...
    private JsonTypeInfo<SavedProperties.SavedProperty<string>> Create_SavedPropertyString(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SavedProperties.SavedProperty<string>> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SavedProperties.SavedProperty<string>> objectInfo =
                new JsonObjectInfoValues<SavedProperties.SavedProperty<string>>
                {
                    ObjectCreator = () => default(SavedProperties.SavedProperty<string>),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SavedPropertyStringPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SavedProperties.SavedProperty<string>).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] SavedPropertyStringPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((SavedProperties.SavedProperty<string>)obj).name;
        jsonPropertyInfoValues.Setter = delegate(object obj, string? value)
        {
        ...
        jsonPropertyInfoValues.JsonPropertyName = null;
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SavedProperties.SavedProperty<string>).GetField(
                "name",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic
            );
        JsonPropertyInfoValues<string> propertyInfo = jsonPropertyInfoValues;
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((SavedProperties.SavedProperty<string>)obj).value;
        jsonPropertyInfoValues.Setter = delegate(object obj, string? value)
        {
    ...
    private JsonTypeInfo<SerializableActMap> Create_SerializableActMap(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializableActMap> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializableActMap> objectInfo =
                new JsonObjectInfoValues<SerializableActMap>
                {
                    ObjectCreator = () => new SerializableActMap(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SerializableActMapPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SerializableActMap).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    {
        JsonPropertyInfo[] array = new JsonPropertyInfo[7];
        JsonPropertyInfoValues<List<SerializableMapPoint>> jsonPropertyInfoValues =
            new JsonPropertyInfoValues<List<SerializableMapPoint>>();
        jsonPropertyInfoValues.IsProperty = true;
        jsonPropertyInfoValues.IsPublic = true;
        jsonPropertyInfoValues.IsVirtual = false;
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializableActMap).GetProperty(
                "Points",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(List<SerializableMapPoint>),
                Array.Empty<Type>(),
                null
            );
        ...
        array[0].IsGetNullable = false;
        array[0].IsSetNullable = false;
        JsonPropertyInfoValues<SerializableMapPoint> jsonPropertyInfoValues2 =
            new JsonPropertyInfoValues<SerializableMapPoint>();
        jsonPropertyInfoValues2.IsProperty = true;
        jsonPropertyInfoValues2.IsPublic = true;
        jsonPropertyInfoValues2.IsVirtual = false;
        ...
        array[3].IsGetNullable = false;
        array[3].IsSetNullable = false;
        JsonPropertyInfoValues<List<MapCoord>> jsonPropertyInfoValues3 =
            new JsonPropertyInfoValues<List<MapCoord>>();
        jsonPropertyInfoValues3.IsProperty = true;
        jsonPropertyInfoValues3.IsPublic = true;
        jsonPropertyInfoValues3.IsVirtual = false;
        ...
        jsonPropertyInfoValues3.Converter = null;
        jsonPropertyInfoValues3.Getter = (object obj) =>
            ((SerializableActMap)obj).StartMapPointCoords;
    ...
    private JsonTypeInfo<SerializableActModel> Create_SerializableActModel(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializableActModel> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializableActModel> objectInfo =
                new JsonObjectInfoValues<SerializableActModel>
                {
                    ObjectCreator = () => new SerializableActModel(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SerializableActModelPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SerializableActModel).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] SerializableActModelPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.JsonPropertyName = "id";
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializableActModel).GetProperty(
                "Id",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(ModelId),
        ...
        JsonPropertyInfoValues<ModelId> propertyInfo = jsonPropertyInfoValues;
        array[0] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo);
        JsonPropertyInfoValues<SerializableRoomSet> jsonPropertyInfoValues2 =
            new JsonPropertyInfoValues<SerializableRoomSet>();
        jsonPropertyInfoValues2.IsProperty = true;
        jsonPropertyInfoValues2.IsPublic = true;
        jsonPropertyInfoValues2.IsVirtual = false;
        ...
        jsonPropertyInfoValues2.Converter = null;
        jsonPropertyInfoValues2.Getter = (object obj) =>
            ((SerializableActModel)obj).SerializableRooms;
        ...
        array[1].IsGetNullable = false;
        array[1].IsSetNullable = false;
        JsonPropertyInfoValues<SerializableActMap> jsonPropertyInfoValues3 =
            new JsonPropertyInfoValues<SerializableActMap>();
        jsonPropertyInfoValues3.IsProperty = true;
        jsonPropertyInfoValues3.IsPublic = true;
        jsonPropertyInfoValues3.IsVirtual = false;
    ...
    private JsonTypeInfo<SerializableBadge> Create_SerializableBadge(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializableBadge> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializableBadge> jsonObjectInfoValues =
                new JsonObjectInfoValues<SerializableBadge>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new SerializableBadge { Id = (string)args[0], Rarity = (BadgeRarity)args[1] };
            jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) =>
                SerializableBadgePropInit(options);
            jsonObjectInfoValues.ConstructorParameterMetadataInitializer =
                SerializableBadgeCtorParamInit;
            jsonObjectInfoValues.ConstructorAttributeProviderFactory = () =>
                typeof(SerializableBadge).GetConstructor(
                    BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                    null,
                    Array.Empty<Type>(),
                    null
    ...
    private static JsonPropertyInfo[] SerializableBadgePropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.JsonPropertyName = "id";
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializableBadge).GetProperty(
                "Id",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(string),
        ...
        array[0].IsGetNullable = false;
        array[0].IsSetNullable = false;
        JsonPropertyInfoValues<BadgeRarity> jsonPropertyInfoValues2 =
            new JsonPropertyInfoValues<BadgeRarity>();
        jsonPropertyInfoValues2.IsProperty = true;
        jsonPropertyInfoValues2.IsPublic = true;
        jsonPropertyInfoValues2.IsVirtual = false;
    ...
    private JsonTypeInfo<SerializableCard> Create_SerializableCard(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializableCard> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializableCard> objectInfo =
                new JsonObjectInfoValues<SerializableCard>
                {
                    ObjectCreator = () => new SerializableCard(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SerializableCardPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SerializableCard).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] SerializableCardPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.JsonPropertyName = "id";
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializableCard).GetProperty(
                "Id",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(ModelId),
        ...
        jsonPropertyInfoValues2.Converter = null;
        jsonPropertyInfoValues2.Getter = (object obj) =>
            ((SerializableCard)obj).CurrentUpgradeLevel;
        jsonPropertyInfoValues2.Setter = delegate(object obj, int value)
        {
        ...
        JsonPropertyInfoValues<int> propertyInfo2 = jsonPropertyInfoValues2;
        array[1] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo2);
        JsonPropertyInfoValues<SerializableEnchantment> jsonPropertyInfoValues3 =
            new JsonPropertyInfoValues<SerializableEnchantment>();
        jsonPropertyInfoValues3.IsProperty = true;
        jsonPropertyInfoValues3.IsPublic = true;
        jsonPropertyInfoValues3.IsVirtual = false;
        ...
        jsonPropertyInfoValues3.AttributeProviderFactory = () =>
            typeof(SerializableCard).GetProperty(
                ...
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(SerializableEnchantment),
                Array.Empty<Type>(),
                null
            );
        JsonPropertyInfoValues<SerializableEnchantment> propertyInfo3 = jsonPropertyInfoValues3;
        array[2] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo3);
        JsonPropertyInfoValues<SavedProperties> jsonPropertyInfoValues4 =
            new JsonPropertyInfoValues<SavedProperties>();
        jsonPropertyInfoValues4.IsProperty = true;
        jsonPropertyInfoValues4.IsPublic = true;
        jsonPropertyInfoValues4.IsVirtual = false;
    ...
    private JsonTypeInfo<SerializableCard[]> Create_SerializableCardArray(
        JsonSerializerOptions options
    )
    {
        if (
        ...
        {
            JsonCollectionInfoValues<SerializableCard[]> collectionInfo =
                new JsonCollectionInfoValues<SerializableCard[]>
                {
                    ObjectCreator = null,
                    SerializeHandler = null,
                };
    ...
    private JsonTypeInfo<SerializableEnchantment> Create_SerializableEnchantment(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializableEnchantment> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializableEnchantment> objectInfo =
                new JsonObjectInfoValues<SerializableEnchantment>
                {
                    ObjectCreator = () => new SerializableEnchantment(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SerializableEnchantmentPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SerializableEnchantment).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] SerializableEnchantmentPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.JsonPropertyName = "id";
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializableEnchantment).GetProperty(
                "Id",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(ModelId),
        ...
        JsonPropertyInfoValues<int> propertyInfo2 = jsonPropertyInfoValues2;
        array[1] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo2);
        JsonPropertyInfoValues<SavedProperties> jsonPropertyInfoValues3 =
            new JsonPropertyInfoValues<SavedProperties>();
        jsonPropertyInfoValues3.IsProperty = true;
        jsonPropertyInfoValues3.IsPublic = true;
        jsonPropertyInfoValues3.IsVirtual = false;
    ...
    private JsonTypeInfo<SerializableExtraRunFields> Create_SerializableExtraRunFields(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializableExtraRunFields> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializableExtraRunFields> objectInfo =
                new JsonObjectInfoValues<SerializableExtraRunFields>
                {
                    ObjectCreator = () => new SerializableExtraRunFields(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SerializableExtraRunFieldsPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SerializableExtraRunFields).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] SerializableExtraRunFieldsPropInit(
        JsonSerializerOptions options
    )
    {
        JsonPropertyInfo[] array = new JsonPropertyInfo[3];
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((SerializableExtraRunFields)obj).StartedWithNeow;
        jsonPropertyInfoValues.Setter = delegate(object obj, bool value)
        {
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializableExtraRunFields).GetProperty(
                "StartedWithNeow",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(bool),
        ...
        jsonPropertyInfoValues2.Converter = null;
        jsonPropertyInfoValues2.Getter = (object obj) =>
            ((SerializableExtraRunFields)obj).TestSubjectKills;
        jsonPropertyInfoValues2.Setter = delegate(object obj, int value)
        {
    ...
    private JsonTypeInfo<SerializableMapPoint> Create_SerializableMapPoint(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializableMapPoint> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializableMapPoint> objectInfo =
                new JsonObjectInfoValues<SerializableMapPoint>
                {
                    ObjectCreator = () => new SerializableMapPoint(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SerializableMapPointPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SerializableMapPoint).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    {
        JsonPropertyInfo[] array = new JsonPropertyInfo[4];
        JsonPropertyInfoValues<MapCoord> jsonPropertyInfoValues =
            new JsonPropertyInfoValues<MapCoord>();
        jsonPropertyInfoValues.IsProperty = true;
        jsonPropertyInfoValues.IsPublic = true;
        jsonPropertyInfoValues.IsVirtual = false;
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializableMapPoint).GetProperty(
                "Coord",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(MapCoord),
        ...
        array[0] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo);
        JsonPropertyInfoValues<MapPointType> jsonPropertyInfoValues2 =
            new JsonPropertyInfoValues<MapPointType>();
        jsonPropertyInfoValues2.IsProperty = true;
        jsonPropertyInfoValues2.IsPublic = true;
        jsonPropertyInfoValues2.IsVirtual = false;
        ...
        JsonPropertyInfoValues<bool> propertyInfo3 = jsonPropertyInfoValues3;
        array[2] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo3);
        JsonPropertyInfoValues<List<MapCoord>> jsonPropertyInfoValues4 =
            new JsonPropertyInfoValues<List<MapCoord>>();
        jsonPropertyInfoValues4.IsProperty = true;
        jsonPropertyInfoValues4.IsPublic = true;
        jsonPropertyInfoValues4.IsVirtual = false;
    ...
    private JsonTypeInfo<SerializableModifier> Create_SerializableModifier(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializableModifier> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializableModifier> objectInfo =
                new JsonObjectInfoValues<SerializableModifier>
                {
                    ObjectCreator = () => new SerializableModifier(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SerializableModifierPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SerializableModifier).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] SerializableModifierPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.JsonPropertyName = "id";
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializableModifier).GetProperty(
                "Id",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(ModelId),
        ...
        JsonPropertyInfoValues<ModelId> propertyInfo = jsonPropertyInfoValues;
        array[0] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo);
        JsonPropertyInfoValues<SavedProperties> jsonPropertyInfoValues2 =
            new JsonPropertyInfoValues<SavedProperties>();
        jsonPropertyInfoValues2.IsProperty = true;
        jsonPropertyInfoValues2.IsPublic = true;
        jsonPropertyInfoValues2.IsVirtual = false;
    ...
    private JsonTypeInfo<SerializablePlayer> Create_SerializablePlayer(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializablePlayer> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializablePlayer> objectInfo =
                new JsonObjectInfoValues<SerializablePlayer>
                {
                    ObjectCreator = () => new SerializablePlayer(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SerializablePlayerPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SerializablePlayer).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] SerializablePlayerPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializablePlayer).GetProperty(
                "CharacterId",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(ModelId),
        ...
        jsonPropertyInfoValues2.Converter = null;
        jsonPropertyInfoValues2.Getter = (object obj) =>
            ((SerializablePlayer)obj).MaxPotionSlotCount;
        jsonPropertyInfoValues2.Setter = delegate(object obj, int value)
        {
        ...
        array[8].IsGetNullable = false;
        array[8].IsSetNullable = false;
        JsonPropertyInfoValues<List<SerializableRelic>> jsonPropertyInfoValues5 =
            new JsonPropertyInfoValues<List<SerializableRelic>>();
        jsonPropertyInfoValues5.IsProperty = true;
        jsonPropertyInfoValues5.IsPublic = true;
        jsonPropertyInfoValues5.IsVirtual = false;
        ...
        array[9].IsGetNullable = false;
        array[9].IsSetNullable = false;
        JsonPropertyInfoValues<List<SerializablePotion>> jsonPropertyInfoValues6 =
            new JsonPropertyInfoValues<List<SerializablePotion>>();
        jsonPropertyInfoValues6.IsProperty = true;
        jsonPropertyInfoValues6.IsPublic = true;
        jsonPropertyInfoValues6.IsVirtual = false;
        ...
        jsonPropertyInfoValues6.AttributeProviderFactory = () =>
            typeof(SerializablePlayer).GetProperty(
                ...
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(List<SerializablePotion>),
                Array.Empty<Type>(),
                null
            );
        ...
        array[10].IsGetNullable = false;
        array[10].IsSetNullable = false;
        JsonPropertyInfoValues<SerializablePlayerRngSet> jsonPropertyInfoValues7 =
            new JsonPropertyInfoValues<SerializablePlayerRngSet>();
        jsonPropertyInfoValues7.IsProperty = true;
        jsonPropertyInfoValues7.IsPublic = true;
        jsonPropertyInfoValues7.IsVirtual = false;
        ...
        jsonPropertyInfoValues7.AttributeProviderFactory = () =>
            typeof(SerializablePlayer).GetProperty(
                ...
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(SerializablePlayerRngSet),
                Array.Empty<Type>(),
                null
            );
        ...
        array[11].IsGetNullable = false;
        array[11].IsSetNullable = false;
        JsonPropertyInfoValues<SerializablePlayerOddsSet> jsonPropertyInfoValues8 =
            new JsonPropertyInfoValues<SerializablePlayerOddsSet>();
        jsonPropertyInfoValues8.IsProperty = true;
        jsonPropertyInfoValues8.IsPublic = true;
        jsonPropertyInfoValues8.IsVirtual = false;
        ...
        jsonPropertyInfoValues8.AttributeProviderFactory = () =>
            typeof(SerializablePlayer).GetProperty(
                ...
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(SerializablePlayerOddsSet),
                Array.Empty<Type>(),
                null
            );
        ...
        array[12].IsGetNullable = false;
        array[12].IsSetNullable = false;
        JsonPropertyInfoValues<SerializableRelicGrabBag> jsonPropertyInfoValues9 =
            new JsonPropertyInfoValues<SerializableRelicGrabBag>();
        jsonPropertyInfoValues9.IsProperty = true;
        jsonPropertyInfoValues9.IsPublic = true;
        jsonPropertyInfoValues9.IsVirtual = false;
        ...
        jsonPropertyInfoValues9.AttributeProviderFactory = () =>
            typeof(SerializablePlayer).GetProperty(
                ...
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(SerializableRelicGrabBag),
                Array.Empty<Type>(),
                null
            );
        ...
        array[13].IsGetNullable = false;
        array[13].IsSetNullable = false;
        JsonPropertyInfoValues<SerializableExtraPlayerFields> jsonPropertyInfoValues10 =
            new JsonPropertyInfoValues<SerializableExtraPlayerFields>();
        jsonPropertyInfoValues10.IsProperty = true;
        jsonPropertyInfoValues10.IsPublic = true;
        jsonPropertyInfoValues10.IsVirtual = false;
        ...
        jsonPropertyInfoValues10.AttributeProviderFactory = () =>
            typeof(SerializablePlayer).GetProperty(
                ...
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(SerializableExtraPlayerFields),
                Array.Empty<Type>(),
                null
            );
        JsonPropertyInfoValues<SerializableExtraPlayerFields> propertyInfo15 =
            jsonPropertyInfoValues10;
        array[14] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo15);
        array[14].IsGetNullable = false;
        array[14].IsSetNullable = false;
        JsonPropertyInfoValues<SerializableUnlockState> jsonPropertyInfoValues11 =
            new JsonPropertyInfoValues<SerializableUnlockState>();
        jsonPropertyInfoValues11.IsProperty = true;
        jsonPropertyInfoValues11.IsPublic = true;
        jsonPropertyInfoValues11.IsVirtual = false;
        ...
        jsonPropertyInfoValues11.AttributeProviderFactory = () =>
            typeof(SerializablePlayer).GetProperty(
                ...
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(SerializableUnlockState),
                Array.Empty<Type>(),
                null
            );
        ...
        array[15].IsGetNullable = false;
        array[15].IsSetNullable = false;
        JsonPropertyInfoValues<List<ModelId>> jsonPropertyInfoValues12 =
            new JsonPropertyInfoValues<List<ModelId>>();
        jsonPropertyInfoValues12.IsProperty = true;
        jsonPropertyInfoValues12.IsPublic = true;
        jsonPropertyInfoValues12.IsVirtual = false;
        ...
        jsonPropertyInfoValues12.DeclaringType = typeof(SerializablePlayer);
        jsonPropertyInfoValues12.Converter = null;
        jsonPropertyInfoValues12.Getter = (object obj) =>
            ((SerializablePlayer)obj).DiscoveredEnemies;
        jsonPropertyInfoValues12.Setter = delegate(object obj, List<ModelId>? value)
        {
        ...
        array[17].IsGetNullable = false;
        array[17].IsSetNullable = false;
        JsonPropertyInfoValues<List<string>> jsonPropertyInfoValues13 =
            new JsonPropertyInfoValues<List<string>>();
        ...
        jsonPropertyInfoValues13.Converter =
            (JsonConverter<List<string>>)
                ExpandConverter(typeof(List<string>), new EpochIdListConverter(), options);
        jsonPropertyInfoValues13.Getter = (object obj) =>
            ((SerializablePlayer)obj).DiscoveredEpochs;
        ...
        jsonPropertyInfoValues13.AttributeProviderFactory = () =>
            typeof(SerializablePlayer).GetProperty(
                "DiscoveredEpochs",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
        ...
        jsonPropertyInfoValues12.Converter = null;
        jsonPropertyInfoValues12.Getter = (object obj) =>
            ((SerializablePlayer)obj).DiscoveredPotions;
        jsonPropertyInfoValues12.Setter = delegate(object obj, List<ModelId>? value)
        {
        ...
        jsonPropertyInfoValues12.Converter = null;
        jsonPropertyInfoValues12.Getter = (object obj) =>
            ((SerializablePlayer)obj).DiscoveredRelics;
        jsonPropertyInfoValues12.Setter = delegate(object obj, List<ModelId>? value)
        {
    ...
    private JsonTypeInfo<SerializablePlayerOddsSet> Create_SerializablePlayerOddsSet(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializablePlayerOddsSet> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializablePlayerOddsSet> objectInfo =
                new JsonObjectInfoValues<SerializablePlayerOddsSet>
                {
                    ObjectCreator = () => new SerializablePlayerOddsSet(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SerializablePlayerOddsSetPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SerializablePlayerOddsSet).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] SerializablePlayerOddsSetPropInit(
        JsonSerializerOptions options
    )
    {
        JsonPropertyInfo[] array = new JsonPropertyInfo[2];
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((SerializablePlayerOddsSet)obj).CardRarityOddsValue;
        jsonPropertyInfoValues.Setter = delegate(object obj, float value)
        {
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializablePlayerOddsSet).GetProperty(
                "CardRarityOddsValue",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(float),
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((SerializablePlayerOddsSet)obj).PotionRewardOddsValue;
        jsonPropertyInfoValues.Setter = delegate(object obj, float value)
        {
    ...
    private JsonTypeInfo<SerializablePotion> Create_SerializablePotion(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializablePotion> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializablePotion> objectInfo =
                new JsonObjectInfoValues<SerializablePotion>
                {
                    ObjectCreator = () => new SerializablePotion(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SerializablePotionPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SerializablePotion).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] SerializablePotionPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.JsonPropertyName = "id";
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializablePotion).GetProperty(
                "Id",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(ModelId),
    ...
    private JsonTypeInfo<SerializableRelic> Create_SerializableRelic(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializableRelic> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializableRelic> objectInfo =
                new JsonObjectInfoValues<SerializableRelic>
                {
                    ObjectCreator = () => new SerializableRelic(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SerializableRelicPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SerializableRelic).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] SerializableRelicPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.JsonPropertyName = "id";
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializableRelic).GetProperty(
                "Id",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(ModelId),
    ...
    private JsonTypeInfo<SerializableRelicGrabBag> Create_SerializableRelicGrabBag(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializableRelicGrabBag> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializableRelicGrabBag> objectInfo =
                new JsonObjectInfoValues<SerializableRelicGrabBag>
                {
                    ObjectCreator = () => new SerializableRelicGrabBag(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SerializableRelicGrabBagPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SerializableRelicGrabBag).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] SerializableRelicGrabBagPropInit(
        JsonSerializerOptions options
    )
    {
        JsonPropertyInfo[] array = new JsonPropertyInfo[1];
        JsonPropertyInfoValues<Dictionary<RelicRarity, List<ModelId>>> jsonPropertyInfoValues =
            new JsonPropertyInfoValues<Dictionary<RelicRarity, List<ModelId>>>();
        jsonPropertyInfoValues.IsProperty = true;
        jsonPropertyInfoValues.IsPublic = true;
        jsonPropertyInfoValues.IsVirtual = false;
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((SerializableRelicGrabBag)obj).RelicIdLists;
        jsonPropertyInfoValues.Setter = delegate(
            object obj,
            Dictionary<RelicRarity, List<ModelId>>? value
        )
        {
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializableRelicGrabBag).GetProperty(
                "RelicIdLists",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(Dictionary<RelicRarity, List<ModelId>>),
                Array.Empty<Type>(),
                null
            );
        JsonPropertyInfoValues<Dictionary<RelicRarity, List<ModelId>>> propertyInfo =
            jsonPropertyInfoValues;
        array[0] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo);
        array[0].IsGetNullable = false;
        array[0].IsSetNullable = false;
    ...
    private JsonTypeInfo<SerializableReward> Create_SerializableReward(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializableReward> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializableReward> objectInfo =
                new JsonObjectInfoValues<SerializableReward>
                {
                    ObjectCreator = () => new SerializableReward(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SerializableRewardPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SerializableReward).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    {
        JsonPropertyInfo[] array = new JsonPropertyInfo[10];
        JsonPropertyInfoValues<RewardType> jsonPropertyInfoValues =
            new JsonPropertyInfoValues<RewardType>();
        jsonPropertyInfoValues.IsProperty = true;
        jsonPropertyInfoValues.IsPublic = true;
        jsonPropertyInfoValues.IsVirtual = false;
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializableReward).GetProperty(
                "RewardType",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(RewardType),
        ...
        jsonPropertyInfoValues2.Converter = null;
        jsonPropertyInfoValues2.Getter = (object obj) =>
            ((SerializableReward)obj).PredeterminedModelId;
        jsonPropertyInfoValues2.Setter = delegate(object obj, ModelId? value)
        {
        ...
        array[1].IsGetNullable = false;
        array[1].IsSetNullable = false;
        JsonPropertyInfoValues<SerializableCard> jsonPropertyInfoValues3 =
            new JsonPropertyInfoValues<SerializableCard>();
        jsonPropertyInfoValues3.IsProperty = true;
        jsonPropertyInfoValues3.IsPublic = true;
        jsonPropertyInfoValues3.IsVirtual = false;
        ...
        jsonPropertyInfoValues5.Converter = null;
        jsonPropertyInfoValues5.Getter = (object obj) =>
            ((SerializableReward)obj).WasGoldStolenBack;
        ...
        array[4] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo5);
        JsonPropertyInfoValues<CardCreationSource> jsonPropertyInfoValues6 =
            new JsonPropertyInfoValues<CardCreationSource>();
        jsonPropertyInfoValues6.IsProperty = true;
        jsonPropertyInfoValues6.IsPublic = true;
        jsonPropertyInfoValues6.IsVirtual = false;
        ...
        array[5] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo6);
        JsonPropertyInfoValues<CardRarityOddsType> jsonPropertyInfoValues7 =
            new JsonPropertyInfoValues<CardRarityOddsType>();
        jsonPropertyInfoValues7.IsProperty = true;
        jsonPropertyInfoValues7.IsPublic = true;
        jsonPropertyInfoValues7.IsVirtual = false;
        ...
        array[6] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo7);
        JsonPropertyInfoValues<List<ModelId>> jsonPropertyInfoValues8 =
            new JsonPropertyInfoValues<List<ModelId>>();
        jsonPropertyInfoValues8.IsProperty = true;
        jsonPropertyInfoValues8.IsPublic = true;
        jsonPropertyInfoValues8.IsVirtual = false;
        ...
        jsonPropertyInfoValues2.Converter = null;
        jsonPropertyInfoValues2.Getter = (object obj) =>
            ((SerializableReward)obj).CustomDescriptionEncounterSourceId;
        jsonPropertyInfoValues2.Setter = delegate(object obj, ModelId? value)
        {
        ...
        jsonPropertyInfoValues2.AttributeProviderFactory = () =>
            typeof(SerializableReward).GetProperty(
                "CustomDescriptionEncounterSourceId",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(ModelId),
                Array.Empty<Type>(),
    ...
    private JsonTypeInfo<SerializableRoom> Create_SerializableRoom(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializableRoom> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializableRoom> objectInfo =
                new JsonObjectInfoValues<SerializableRoom>
                {
                    ObjectCreator = () => new SerializableRoom(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SerializableRoomPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SerializableRoom).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] SerializableRoomPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.JsonPropertyName = "room_type";
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializableRoom).GetProperty(
                "RoomType",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(RoomType),
        ...
        JsonPropertyInfoValues<
            Dictionary<ulong, List<SerializableReward>>
        > jsonPropertyInfoValues5 =
            new JsonPropertyInfoValues<Dictionary<ulong, List<SerializableReward>>>();
        jsonPropertyInfoValues5.IsProperty = true;
        jsonPropertyInfoValues5.IsPublic = true;
        jsonPropertyInfoValues5.IsVirtual = false;
        ...
        jsonPropertyInfoValues5.Setter = delegate(
            object obj,
            Dictionary<ulong, List<SerializableReward>>? value
        )
        {
        ...
        jsonPropertyInfoValues5.AttributeProviderFactory = () =>
            typeof(SerializableRoom).GetProperty(
                ...
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(Dictionary<ulong, List<SerializableReward>>),
                Array.Empty<Type>(),
                null
            );
        JsonPropertyInfoValues<Dictionary<ulong, List<SerializableReward>>> propertyInfo6 =
            jsonPropertyInfoValues5;
        array[5] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo6);
        array[5].IsGetNullable = false;
        array[5].IsSetNullable = false;
        ...
        jsonPropertyInfoValues3.Converter = null;
        jsonPropertyInfoValues3.Getter = (object obj) =>
            ((SerializableRoom)obj).ShouldResumeParentEvent;
        jsonPropertyInfoValues3.Setter = delegate(object obj, bool value)
        {
        ...
        JsonPropertyInfoValues<bool> propertyInfo8 = jsonPropertyInfoValues3;
        array[7] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo8);
        JsonPropertyInfoValues<Dictionary<string, string>> jsonPropertyInfoValues6 =
            new JsonPropertyInfoValues<Dictionary<string, string>>();
        jsonPropertyInfoValues6.IsProperty = true;
        jsonPropertyInfoValues6.IsPublic = true;
        jsonPropertyInfoValues6.IsVirtual = false;
    ...
    private JsonTypeInfo<SerializableRoomSet> Create_SerializableRoomSet(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializableRoomSet> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializableRoomSet> objectInfo =
                new JsonObjectInfoValues<SerializableRoomSet>
                {
                    ObjectCreator = () => new SerializableRoomSet(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SerializableRoomSetPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SerializableRoomSet).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    {
        JsonPropertyInfo[] array = new JsonPropertyInfo[10];
        JsonPropertyInfoValues<List<ModelId>> jsonPropertyInfoValues =
            new JsonPropertyInfoValues<List<ModelId>>();
        jsonPropertyInfoValues.IsProperty = true;
        jsonPropertyInfoValues.IsPublic = true;
        jsonPropertyInfoValues.IsVirtual = false;
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializableRoomSet).GetProperty(
                "EventIds",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(List<ModelId>),
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((SerializableRoomSet)obj).NormalEncounterIds;
        jsonPropertyInfoValues.Setter = delegate(object obj, List<ModelId>? value)
        {
        ...
        jsonPropertyInfoValues2.Converter = null;
        jsonPropertyInfoValues2.Getter = (object obj) =>
            ((SerializableRoomSet)obj).NormalEncountersVisited;
        jsonPropertyInfoValues2.Setter = delegate(object obj, int value)
        {
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((SerializableRoomSet)obj).EliteEncounterIds;
        jsonPropertyInfoValues.Setter = delegate(object obj, List<ModelId>? value)
        {
        ...
        jsonPropertyInfoValues2.Converter = null;
        jsonPropertyInfoValues2.Getter = (object obj) =>
            ((SerializableRoomSet)obj).EliteEncountersVisited;
        jsonPropertyInfoValues2.Setter = delegate(object obj, int value)
        {
        ...
        jsonPropertyInfoValues2.Converter = null;
        jsonPropertyInfoValues2.Getter = (object obj) =>
            ((SerializableRoomSet)obj).BossEncountersVisited;
        jsonPropertyInfoValues2.Setter = delegate(object obj, int value)
        {
        ...
        JsonPropertyInfoValues<int> propertyInfo7 = jsonPropertyInfoValues2;
        array[6] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo7);
        JsonPropertyInfoValues<ModelId> jsonPropertyInfoValues3 =
            new JsonPropertyInfoValues<ModelId>();
        jsonPropertyInfoValues3.IsProperty = true;
        jsonPropertyInfoValues3.IsPublic = true;
        jsonPropertyInfoValues3.IsVirtual = false;
    ...
    private JsonTypeInfo<SerializableRunOddsSet> Create_SerializableRunOddsSet(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializableRunOddsSet> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializableRunOddsSet> objectInfo =
                new JsonObjectInfoValues<SerializableRunOddsSet>
                {
                    ObjectCreator = () => new SerializableRunOddsSet(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SerializableRunOddsSetPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SerializableRunOddsSet).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] SerializableRunOddsSetPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((SerializableRunOddsSet)obj).UnknownMapPointMonsterOddsValue;
        jsonPropertyInfoValues.Setter = delegate(object obj, float value)
        {
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializableRunOddsSet).GetProperty(
                "UnknownMapPointMonsterOddsValue",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(float),
                Array.Empty<Type>(),
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((SerializableRunOddsSet)obj).UnknownMapPointEliteOddsValue;
        jsonPropertyInfoValues.Setter = delegate(object obj, float value)
        {
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((SerializableRunOddsSet)obj).UnknownMapPointTreasureOddsValue;
        jsonPropertyInfoValues.Setter = delegate(object obj, float value)
        {
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializableRunOddsSet).GetProperty(
                "UnknownMapPointTreasureOddsValue",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(float),
                Array.Empty<Type>(),
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((SerializableRunOddsSet)obj).UnknownMapPointShopOddsValue;
        jsonPropertyInfoValues.Setter = delegate(object obj, float value)
        {
    ...
    private JsonTypeInfo<SerializableRunRngSet> Create_SerializableRunRngSet(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializableRunRngSet> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializableRunRngSet> objectInfo =
                new JsonObjectInfoValues<SerializableRunRngSet>
                {
                    ObjectCreator = () => new SerializableRunRngSet(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SerializableRunRngSetPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SerializableRunRngSet).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] SerializableRunRngSetPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializableRunRngSet).GetProperty(
                "Seed",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(string),
        ...
        JsonPropertyInfoValues<string> propertyInfo = jsonPropertyInfoValues;
        array[0] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo);
        JsonPropertyInfoValues<Dictionary<RunRngType, int>> jsonPropertyInfoValues2 =
            new JsonPropertyInfoValues<Dictionary<RunRngType, int>>();
        jsonPropertyInfoValues2.IsProperty = true;
        jsonPropertyInfoValues2.IsPublic = true;
        jsonPropertyInfoValues2.IsVirtual = false;
        ...
        jsonPropertyInfoValues2.AttributeProviderFactory = () =>
            typeof(SerializableRunRngSet).GetProperty(
                ...
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(Dictionary<RunRngType, int>),
                Array.Empty<Type>(),
                null
            );
    ...
    private JsonTypeInfo<SerializableEpoch> Create_SerializableEpoch(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializableEpoch> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializableEpoch> jsonObjectInfoValues =
                new JsonObjectInfoValues<SerializableEpoch>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new SerializableEpoch((string)args[0], (EpochState)args[1]);
            jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) =>
                SerializableEpochPropInit(options);
            jsonObjectInfoValues.ConstructorParameterMetadataInitializer =
                SerializableEpochCtorParamInit;
            jsonObjectInfoValues.ConstructorAttributeProviderFactory = () =>
                typeof(SerializableEpoch).GetConstructor(
                    BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                    null,
                    new Type[2] { typeof(string), typeof(EpochState) },
                    null
                );
            jsonObjectInfoValues.SerializeHandler = null;
    ...
    private static JsonPropertyInfo[] SerializableEpochPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.JsonPropertyName = "id";
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializableEpoch).GetProperty(
                "Id",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(string),
        ...
        array[0] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo);
        array[0].IsGetNullable = false;
        JsonPropertyInfoValues<EpochState> jsonPropertyInfoValues2 =
            new JsonPropertyInfoValues<EpochState>();
        jsonPropertyInfoValues2.IsProperty = true;
        jsonPropertyInfoValues2.IsPublic = true;
        jsonPropertyInfoValues2.IsVirtual = false;
    ...
    private JsonTypeInfo<SerializableExtraPlayerFields> Create_SerializableExtraPlayerFields(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializableExtraPlayerFields> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializableExtraPlayerFields> objectInfo =
                new JsonObjectInfoValues<SerializableExtraPlayerFields>
                {
                    ObjectCreator = () => new SerializableExtraPlayerFields(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SerializableExtraPlayerFieldsPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SerializableExtraPlayerFields).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    )
    {
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((SerializableExtraPlayerFields)obj).CardShopRemovalsUsed;
        jsonPropertyInfoValues.Setter = delegate(object obj, int value)
        {
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializableExtraPlayerFields).GetProperty(
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((SerializableExtraPlayerFields)obj).WongoPoints;
        jsonPropertyInfoValues.Setter = delegate(object obj, int value)
        {
        ...
        jsonPropertyInfoValues2.Converter = null;
        jsonPropertyInfoValues2.Getter = (object obj) =>
            ((SerializableExtraPlayerFields)obj).CccomboBadgeUnlocked;
        jsonPropertyInfoValues2.Setter = delegate(object obj, bool value)
        {
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((SerializableExtraPlayerFields)obj).DamageDealt;
        jsonPropertyInfoValues.Setter = delegate(object obj, int value)
        {
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((SerializableExtraPlayerFields)obj).DebuffsApplied;
        jsonPropertyInfoValues.Setter = delegate(object obj, int value)
        {
    ...
    private JsonTypeInfo<SerializablePlayerRngSet> Create_SerializablePlayerRngSet(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializablePlayerRngSet> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializablePlayerRngSet> objectInfo =
                new JsonObjectInfoValues<SerializablePlayerRngSet>
                {
                    ObjectCreator = () => new SerializablePlayerRngSet(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SerializablePlayerRngSetPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SerializablePlayerRngSet).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] SerializablePlayerRngSetPropInit(
        JsonSerializerOptions options
    )
    {
        JsonPropertyInfo[] array = new JsonPropertyInfo[2];
        ...
        jsonPropertyInfoValues.JsonPropertyName = "seed";
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializablePlayerRngSet).GetProperty(
                "Seed",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(uint),
        ...
        array[0] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo);
        JsonPropertyInfoValues<Dictionary<PlayerRngType, int>> jsonPropertyInfoValues2 =
            new JsonPropertyInfoValues<Dictionary<PlayerRngType, int>>();
        jsonPropertyInfoValues2.IsProperty = true;
        jsonPropertyInfoValues2.IsPublic = true;
        jsonPropertyInfoValues2.IsVirtual = false;
        ...
        jsonPropertyInfoValues2.AttributeProviderFactory = () =>
            typeof(SerializablePlayerRngSet).GetProperty(
                ...
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(Dictionary<PlayerRngType, int>),
                Array.Empty<Type>(),
                null
            );
        JsonPropertyInfoValues<Dictionary<PlayerRngType, int>> propertyInfo2 =
            jsonPropertyInfoValues2;
        array[1] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo2);
        array[1].IsGetNullable = false;
        array[1].IsSetNullable = false;
    ...
    private JsonTypeInfo<SerializableProgress> Create_SerializableProgress(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializableProgress> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializableProgress> jsonObjectInfoValues =
                new JsonObjectInfoValues<SerializableProgress>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new SerializableProgress { UniqueId = (string)args[0] };
            jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) =>
                SerializableProgressPropInit(options);
            jsonObjectInfoValues.ConstructorParameterMetadataInitializer =
                SerializableProgressCtorParamInit;
            jsonObjectInfoValues.ConstructorAttributeProviderFactory = () =>
                typeof(SerializableProgress).GetConstructor(
                    BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                    null,
                    Array.Empty<Type>(),
                    null
    ...
    private static JsonPropertyInfo[] SerializableProgressPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.JsonPropertyName = "schema_version";
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializableProgress).GetProperty(
                "SchemaVersion",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(int),
        ...
        array[1].IsGetNullable = false;
        array[1].IsSetNullable = false;
        JsonPropertyInfoValues<List<CharacterStats>> jsonPropertyInfoValues3 =
            new JsonPropertyInfoValues<List<CharacterStats>>();
        jsonPropertyInfoValues3.IsProperty = true;
        jsonPropertyInfoValues3.IsPublic = true;
        jsonPropertyInfoValues3.IsVirtual = false;
        ...
        array[2].IsGetNullable = false;
        array[2].IsSetNullable = false;
        JsonPropertyInfoValues<List<CardStats>> jsonPropertyInfoValues4 =
            new JsonPropertyInfoValues<List<CardStats>>();
        jsonPropertyInfoValues4.IsProperty = true;
        jsonPropertyInfoValues4.IsPublic = true;
        jsonPropertyInfoValues4.IsVirtual = false;
        ...
        array[3].IsGetNullable = false;
        array[3].IsSetNullable = false;
        JsonPropertyInfoValues<List<EncounterStats>> jsonPropertyInfoValues5 =
            new JsonPropertyInfoValues<List<EncounterStats>>();
        jsonPropertyInfoValues5.IsProperty = true;
        jsonPropertyInfoValues5.IsPublic = true;
        jsonPropertyInfoValues5.IsVirtual = false;
        ...
        array[4].IsGetNullable = false;
        array[4].IsSetNullable = false;
        JsonPropertyInfoValues<List<EnemyStats>> jsonPropertyInfoValues6 =
            new JsonPropertyInfoValues<List<EnemyStats>>();
        jsonPropertyInfoValues6.IsProperty = true;
        jsonPropertyInfoValues6.IsPublic = true;
        jsonPropertyInfoValues6.IsVirtual = false;
        ...
        array[5].IsGetNullable = false;
        array[5].IsSetNullable = false;
        JsonPropertyInfoValues<List<AncientStats>> jsonPropertyInfoValues7 =
            new JsonPropertyInfoValues<List<AncientStats>>();
        jsonPropertyInfoValues7.IsProperty = true;
        jsonPropertyInfoValues7.IsPublic = true;
        jsonPropertyInfoValues7.IsVirtual = false;
        ...
        array[7] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo8);
        JsonPropertyInfoValues<List<SerializableEpoch>> jsonPropertyInfoValues9 =
            new JsonPropertyInfoValues<List<SerializableEpoch>>();
        jsonPropertyInfoValues9.IsProperty = true;
        jsonPropertyInfoValues9.IsPublic = true;
        jsonPropertyInfoValues9.IsVirtual = false;
        ...
        array[8].IsGetNullable = false;
        array[8].IsSetNullable = false;
        JsonPropertyInfoValues<List<string>> jsonPropertyInfoValues10 =
            new JsonPropertyInfoValues<List<string>>();
        jsonPropertyInfoValues10.IsProperty = true;
        jsonPropertyInfoValues10.IsPublic = true;
        jsonPropertyInfoValues10.IsVirtual = false;
        ...
        array[9].IsGetNullable = false;
        array[9].IsSetNullable = false;
        JsonPropertyInfoValues<List<SerializableUnlockedAchievement>> jsonPropertyInfoValues11 =
            new JsonPropertyInfoValues<List<SerializableUnlockedAchievement>>();
        jsonPropertyInfoValues11.IsProperty = true;
        jsonPropertyInfoValues11.IsPublic = true;
        jsonPropertyInfoValues11.IsVirtual = false;
        ...
        jsonPropertyInfoValues11.Converter = null;
        jsonPropertyInfoValues11.Getter = (object obj) =>
            ((SerializableProgress)obj).UnlockedAchievements;
        jsonPropertyInfoValues11.Setter = delegate(
            object obj,
            List<SerializableUnlockedAchievement>? value
        )
        {
        ...
        jsonPropertyInfoValues11.AttributeProviderFactory = () =>
            typeof(SerializableProgress).GetProperty(
                ...
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(List<SerializableUnlockedAchievement>),
                Array.Empty<Type>(),
                null
            );
        JsonPropertyInfoValues<List<SerializableUnlockedAchievement>> propertyInfo11 =
            jsonPropertyInfoValues11;
        array[10] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo11);
        array[10].IsGetNullable = false;
        array[10].IsSetNullable = false;
        ...
        jsonPropertyInfoValues12.Converter = null;
        jsonPropertyInfoValues12.Getter = (object obj) =>
            ((SerializableProgress)obj).DiscoveredCards;
        jsonPropertyInfoValues12.Setter = delegate(object obj, List<ModelId>? value)
        {
        ...
        jsonPropertyInfoValues12.Converter = null;
        jsonPropertyInfoValues12.Getter = (object obj) =>
            ((SerializableProgress)obj).DiscoveredRelics;
        jsonPropertyInfoValues12.Setter = delegate(object obj, List<ModelId>? value)
        {
        ...
        jsonPropertyInfoValues12.Converter = null;
        jsonPropertyInfoValues12.Getter = (object obj) =>
            ((SerializableProgress)obj).DiscoveredEvents;
        jsonPropertyInfoValues12.Setter = delegate(object obj, List<ModelId>? value)
        {
        ...
        jsonPropertyInfoValues12.Converter = null;
        jsonPropertyInfoValues12.Getter = (object obj) =>
            ((SerializableProgress)obj).DiscoveredPotions;
        jsonPropertyInfoValues12.Setter = delegate(object obj, List<ModelId>? value)
        {
        ...
        jsonPropertyInfoValues12.Converter = null;
        jsonPropertyInfoValues12.Getter = (object obj) =>
            ((SerializableProgress)obj).DiscoveredActs;
        jsonPropertyInfoValues12.Setter = delegate(object obj, List<ModelId>? value)
        {
        ...
        jsonPropertyInfoValues13.Converter = null;
        jsonPropertyInfoValues13.Getter = (object obj) =>
            ((SerializableProgress)obj).ArchitectDamage;
        jsonPropertyInfoValues13.Setter = delegate(object obj, long value)
        {
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((SerializableProgress)obj).PreferredMultiplayerAscension;
        jsonPropertyInfoValues.Setter = delegate(object obj, int value)
        {
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((SerializableProgress)obj).MaxMultiplayerAscension;
        jsonPropertyInfoValues.Setter = delegate(object obj, int value)
        {
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((SerializableProgress)obj).TestSubjectKills;
        jsonPropertyInfoValues.Setter = delegate(object obj, int value)
        {
        ...
        array[24] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo25);
        JsonPropertyInfoValues<ModelId> jsonPropertyInfoValues14 =
            new JsonPropertyInfoValues<ModelId>();
        ...
        jsonPropertyInfoValues14.Getter = (object obj) =>
            ((SerializableProgress)obj).PendingCharacterUnlock;
        ...
        jsonPropertyInfoValues14.AttributeProviderFactory = () =>
            typeof(SerializableProgress).GetProperty(
                "PendingCharacterUnlock",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(ModelId),
                Array.Empty<Type>(),
    ...
    private JsonTypeInfo<SerializableRun> Create_SerializableRun(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializableRun> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializableRun> objectInfo =
                new JsonObjectInfoValues<SerializableRun>
                {
                    ObjectCreator = () => new SerializableRun(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SerializableRunPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SerializableRun).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] SerializableRunPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.JsonPropertyName = "schema_version";
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializableRun).GetProperty(
                "SchemaVersion",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(int),
        ...
        JsonPropertyInfoValues<int> propertyInfo = jsonPropertyInfoValues;
        array[0] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo);
        JsonPropertyInfoValues<List<SerializableActModel>> jsonPropertyInfoValues2 =
            new JsonPropertyInfoValues<List<SerializableActModel>>();
        jsonPropertyInfoValues2.IsProperty = true;
        jsonPropertyInfoValues2.IsPublic = true;
        jsonPropertyInfoValues2.IsVirtual = false;
        ...
        jsonPropertyInfoValues2.AttributeProviderFactory = () =>
            typeof(SerializableRun).GetProperty(
                ...
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(List<SerializableActModel>),
                Array.Empty<Type>(),
                null
            );
        ...
        array[1].IsGetNullable = false;
        array[1].IsSetNullable = false;
        JsonPropertyInfoValues<List<SerializableModifier>> jsonPropertyInfoValues3 =
            new JsonPropertyInfoValues<List<SerializableModifier>>();
        jsonPropertyInfoValues3.IsProperty = true;
        jsonPropertyInfoValues3.IsPublic = true;
        jsonPropertyInfoValues3.IsVirtual = false;
        ...
        array[2].IsGetNullable = false;
        array[2].IsSetNullable = false;
        JsonPropertyInfoValues<DateTimeOffset?> jsonPropertyInfoValues4 =
        ...
        JsonPropertyInfoValues<int> propertyInfo5 = jsonPropertyInfoValues;
        array[4] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo5);
        JsonPropertyInfoValues<List<ModelId>> jsonPropertyInfoValues5 =
            new JsonPropertyInfoValues<List<ModelId>>();
        jsonPropertyInfoValues5.IsProperty = true;
        jsonPropertyInfoValues5.IsPublic = true;
        jsonPropertyInfoValues5.IsVirtual = false;
        ...
        array[5].IsGetNullable = false;
        array[5].IsSetNullable = false;
        JsonPropertyInfoValues<SerializableRoom> jsonPropertyInfoValues6 =
            new JsonPropertyInfoValues<SerializableRoom>();
        jsonPropertyInfoValues6.IsProperty = true;
        jsonPropertyInfoValues6.IsPublic = true;
        jsonPropertyInfoValues6.IsVirtual = false;
        ...
        jsonPropertyInfoValues6.AttributeProviderFactory = () =>
            typeof(SerializableRun).GetProperty(
                ...
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(SerializableRoom),
                Array.Empty<Type>(),
                null
            );
        JsonPropertyInfoValues<SerializableRoom> propertyInfo7 = jsonPropertyInfoValues6;
        array[6] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo7);
        JsonPropertyInfoValues<SerializableRunOddsSet> jsonPropertyInfoValues7 =
            new JsonPropertyInfoValues<SerializableRunOddsSet>();
        jsonPropertyInfoValues7.IsProperty = true;
        jsonPropertyInfoValues7.IsPublic = true;
        jsonPropertyInfoValues7.IsVirtual = false;
        ...
        array[7].IsGetNullable = false;
        array[7].IsSetNullable = false;
        JsonPropertyInfoValues<SerializableRelicGrabBag> jsonPropertyInfoValues8 =
            new JsonPropertyInfoValues<SerializableRelicGrabBag>();
        jsonPropertyInfoValues8.IsProperty = true;
        jsonPropertyInfoValues8.IsPublic = true;
        jsonPropertyInfoValues8.IsVirtual = false;
        ...
        jsonPropertyInfoValues8.Converter = null;
        jsonPropertyInfoValues8.Getter = (object obj) =>
            ((SerializableRun)obj).SerializableSharedRelicGrabBag;
        ...
        array[8].IsGetNullable = false;
        array[8].IsSetNullable = false;
        JsonPropertyInfoValues<List<SerializablePlayer>> jsonPropertyInfoValues9 =
            new JsonPropertyInfoValues<List<SerializablePlayer>>();
        jsonPropertyInfoValues9.IsProperty = true;
        jsonPropertyInfoValues9.IsPublic = true;
        jsonPropertyInfoValues9.IsVirtual = false;
        ...
        jsonPropertyInfoValues9.AttributeProviderFactory = () =>
            typeof(SerializableRun).GetProperty(
                ...
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(List<SerializablePlayer>),
                Array.Empty<Type>(),
                null
            );
        ...
        array[9].IsGetNullable = false;
        array[9].IsSetNullable = false;
        JsonPropertyInfoValues<SerializableRunRngSet> jsonPropertyInfoValues10 =
            new JsonPropertyInfoValues<SerializableRunRngSet>();
        jsonPropertyInfoValues10.IsProperty = true;
        jsonPropertyInfoValues10.IsPublic = true;
        jsonPropertyInfoValues10.IsVirtual = false;
        ...
        array[10].IsGetNullable = false;
        array[10].IsSetNullable = false;
        JsonPropertyInfoValues<List<MapCoord>> jsonPropertyInfoValues11 =
            new JsonPropertyInfoValues<List<MapCoord>>();
        jsonPropertyInfoValues11.IsProperty = true;
        jsonPropertyInfoValues11.IsPublic = true;
        jsonPropertyInfoValues11.IsVirtual = false;
        ...
        jsonPropertyInfoValues12.Setter = delegate(
            object obj,
            List<List<MapPointHistoryEntry>>? value
        )
        {
        ...
        JsonPropertyInfoValues<List<List<MapPointHistoryEntry>>> propertyInfo13 =
            jsonPropertyInfoValues12;
        array[12] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo13);
        array[12].IsGetNullable = false;
        array[12].IsSetNullable = false;
        ...
        JsonPropertyInfoValues<int> propertyInfo19 = jsonPropertyInfoValues;
        array[18] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo19);
        JsonPropertyInfoValues<PlatformType> jsonPropertyInfoValues14 =
            new JsonPropertyInfoValues<PlatformType>();
        jsonPropertyInfoValues14.IsProperty = true;
        jsonPropertyInfoValues14.IsPublic = true;
        jsonPropertyInfoValues14.IsVirtual = false;
        ...
        array[19] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo20);
        JsonPropertyInfoValues<SerializableMapDrawings> jsonPropertyInfoValues15 =
            new JsonPropertyInfoValues<SerializableMapDrawings>();
        ...
        jsonPropertyInfoValues15.Converter =
            (JsonConverter<SerializableMapDrawings>)
                ExpandConverter(
                    typeof(SerializableMapDrawings),
                    new SerializableMapDrawingsJsonConverter(),
                    options
                );
        ...
        jsonPropertyInfoValues15.AttributeProviderFactory = () =>
            typeof(SerializableRun).GetProperty(
                "MapDrawings",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
        ...
        array[20] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo21);
        JsonPropertyInfoValues<SerializableExtraRunFields> jsonPropertyInfoValues16 =
            new JsonPropertyInfoValues<SerializableExtraRunFields>();
        ...
        jsonPropertyInfoValues16.AttributeProviderFactory = () =>
            typeof(SerializableRun).GetProperty(
                "ExtraFields",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(SerializableExtraRunFields),
                Array.Empty<Type>(),
                null
            );
        JsonPropertyInfoValues<SerializableExtraRunFields> propertyInfo22 =
            jsonPropertyInfoValues16;
        array[21] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo22);
        array[21].IsGetNullable = false;
        array[21].IsSetNullable = false;
        JsonPropertyInfoValues<GameMode> jsonPropertyInfoValues17 =
            new JsonPropertyInfoValues<GameMode>();
        ...
        jsonPropertyInfoValues17.AttributeProviderFactory = () =>
            typeof(SerializableRun).GetProperty(
                "GameMode",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
    ...
    private JsonTypeInfo<SerializableUnlockedAchievement> Create_SerializableUnlockedAchievement(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializableUnlockedAchievement> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializableUnlockedAchievement> jsonObjectInfoValues =
                new JsonObjectInfoValues<SerializableUnlockedAchievement>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new SerializableUnlockedAchievement
                {
                    Achievement = (string)args[0],
                    UnlockTime = (long)args[1],
                };
            jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) =>
                SerializableUnlockedAchievementPropInit(options);
            jsonObjectInfoValues.ConstructorParameterMetadataInitializer =
                SerializableUnlockedAchievementCtorParamInit;
            jsonObjectInfoValues.ConstructorAttributeProviderFactory = () =>
                typeof(SerializableUnlockedAchievement).GetConstructor(
                    BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                    null,
                    Array.Empty<Type>(),
                    null
    ...
    )
    {
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((SerializableUnlockedAchievement)obj).Achievement;
        jsonPropertyInfoValues.Setter = delegate
        {
            throw new InvalidOperationException(
                "Setting init-only properties is not supported in source generation mode."
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializableUnlockedAchievement).GetProperty(
                "Achievement",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(string),
        ...
        jsonPropertyInfoValues2.Converter = null;
        jsonPropertyInfoValues2.Getter = (object obj) =>
            ((SerializableUnlockedAchievement)obj).UnlockTime;
        jsonPropertyInfoValues2.Setter = delegate
        {
            throw new InvalidOperationException(
                "Setting init-only properties is not supported in source generation mode."
    ...
    private JsonTypeInfo<SettingsSave> Create_SettingsSave(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SettingsSave> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SettingsSave> objectInfo = new JsonObjectInfoValues<SettingsSave>
            {
                ...
                ObjectWithParameterizedConstructorCreator = null,
                PropertyMetadataInitializer = (JsonSerializerContext _) =>
                    SettingsSavePropInit(options),
                ConstructorParameterMetadataInitializer = null,
                ConstructorAttributeProviderFactory = () =>
                    typeof(SettingsSave).GetConstructor(
                        BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                        null,
                        Array.Empty<Type>(),
                        null
    ...
    private static JsonPropertyInfo[] SettingsSavePropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.JsonPropertyName = "schema_version";
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SettingsSave).GetProperty(
                "SchemaVersion",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(int),
        ...
        array[2] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo3);
        JsonPropertyInfoValues<Vector2I> jsonPropertyInfoValues3 =
            new JsonPropertyInfoValues<Vector2I>();
        jsonPropertyInfoValues3.IsProperty = true;
        jsonPropertyInfoValues3.IsPublic = true;
        jsonPropertyInfoValues3.IsVirtual = false;
        ...
        array[5] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo6);
        JsonPropertyInfoValues<AspectRatioSetting> jsonPropertyInfoValues5 =
            new JsonPropertyInfoValues<AspectRatioSetting>();
        jsonPropertyInfoValues5.IsProperty = true;
        jsonPropertyInfoValues5.IsPublic = true;
        jsonPropertyInfoValues5.IsVirtual = false;
        ...
        array[8] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo9);
        JsonPropertyInfoValues<VSyncType> jsonPropertyInfoValues6 =
            new JsonPropertyInfoValues<VSyncType>();
        jsonPropertyInfoValues6.IsProperty = true;
        jsonPropertyInfoValues6.IsPublic = true;
        jsonPropertyInfoValues6.IsVirtual = false;
        ...
        array[14] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo15);
        JsonPropertyInfoValues<ModSettings> jsonPropertyInfoValues8 =
            new JsonPropertyInfoValues<ModSettings>();
        jsonPropertyInfoValues8.IsProperty = true;
        jsonPropertyInfoValues8.IsPublic = true;
        jsonPropertyInfoValues8.IsVirtual = false;
        ...
        array[16] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo17);
        JsonPropertyInfoValues<Dictionary<string, string>> jsonPropertyInfoValues9 =
            new JsonPropertyInfoValues<Dictionary<string, string>>();
        jsonPropertyInfoValues9.IsProperty = true;
        jsonPropertyInfoValues9.IsPublic = true;
        jsonPropertyInfoValues9.IsVirtual = false;
        ...
        array[17].IsGetNullable = false;
        array[17].IsSetNullable = false;
        JsonPropertyInfoValues<ControllerMappingType> jsonPropertyInfoValues10 =
            new JsonPropertyInfoValues<ControllerMappingType>();
        jsonPropertyInfoValues10.IsProperty = true;
        jsonPropertyInfoValues10.IsPublic = true;
        jsonPropertyInfoValues10.IsVirtual = false;
        ...
        jsonPropertyInfoValues10.AttributeProviderFactory = () =>
            typeof(SettingsSave).GetProperty(
                "ControllerMappingType",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(ControllerMappingType),
                Array.Empty<Type>(),
                null
            );
    ...
    private JsonTypeInfo<AspectRatioSetting> Create_AspectRatioSetting(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<AspectRatioSetting> jsonTypeInfo
            )
        )
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<AspectRatioSetting>(
                options,
                JsonMetadataServices.GetEnumConverter<AspectRatioSetting>(options)
            );
        }
        jsonTypeInfo.OriginatingResolver = this;
        return jsonTypeInfo;
    ...
    private JsonTypeInfo<FastModeType> Create_FastModeType(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<FastModeType> jsonTypeInfo
            )
        )
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<FastModeType>(
                options,
                JsonMetadataServices.GetEnumConverter<FastModeType>(options)
            );
        }
        jsonTypeInfo.OriginatingResolver = this;
        return jsonTypeInfo;
    ...
    private JsonTypeInfo<VSyncType> Create_VSyncType(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<VSyncType> jsonTypeInfo
            )
        )
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<VSyncType>(
                options,
                JsonMetadataServices.GetEnumConverter<VSyncType>(options)
            );
        }
        jsonTypeInfo.OriginatingResolver = this;
        return jsonTypeInfo;
    ...
    private JsonTypeInfo<SerializableUnlockState> Create_SerializableUnlockState(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializableUnlockState> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializableUnlockState> objectInfo =
                new JsonObjectInfoValues<SerializableUnlockState>
                {
                    ObjectCreator = () => new SerializableUnlockState(),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SerializableUnlockStatePropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SerializableUnlockState).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    {
        JsonPropertyInfo[] array = new JsonPropertyInfo[3];
        JsonPropertyInfoValues<List<string>> jsonPropertyInfoValues =
            new JsonPropertyInfoValues<List<string>>();
        jsonPropertyInfoValues.IsProperty = true;
        jsonPropertyInfoValues.IsPublic = true;
        jsonPropertyInfoValues.IsVirtual = false;
        ...
        jsonPropertyInfoValues.Converter = null;
        jsonPropertyInfoValues.Getter = (object obj) =>
            ((SerializableUnlockState)obj).UnlockedEpochs;
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializableUnlockState).GetProperty(
                "UnlockedEpochs",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(List<string>),
        ...
        array[0].IsGetNullable = false;
        array[0].IsSetNullable = false;
        JsonPropertyInfoValues<List<ModelId>> jsonPropertyInfoValues2 =
            new JsonPropertyInfoValues<List<ModelId>>();
        jsonPropertyInfoValues2.IsProperty = true;
        jsonPropertyInfoValues2.IsPublic = true;
        jsonPropertyInfoValues2.IsVirtual = false;
        ...
        jsonPropertyInfoValues2.Converter = null;
        jsonPropertyInfoValues2.Getter = (object obj) =>
            ((SerializableUnlockState)obj).EncountersSeen;
        ...
        jsonPropertyInfoValues3.Converter = null;
        jsonPropertyInfoValues3.Getter = (object obj) =>
            ((SerializableUnlockState)obj).NumberOfRuns;
        jsonPropertyInfoValues3.Setter = delegate(object obj, int value)
        {
    ...
    private JsonTypeInfo<
        Dictionary<RelicRarity, List<ModelId>>
    > Create_DictionaryRelicRarityListModelId(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<Dictionary<RelicRarity, List<ModelId>>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<Dictionary<RelicRarity, List<ModelId>>> collectionInfo =
                new JsonCollectionInfoValues<Dictionary<RelicRarity, List<ModelId>>>
                {
                    ObjectCreator = () => new Dictionary<RelicRarity, List<ModelId>>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateDictionaryInfo<
                Dictionary<RelicRarity, List<ModelId>>,
                RelicRarity,
                List<ModelId>
    ...
    private JsonTypeInfo<Dictionary<PlayerRngType, int>> Create_DictionaryPlayerRngTypeInt32(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<Dictionary<PlayerRngType, int>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<Dictionary<PlayerRngType, int>> collectionInfo =
                new JsonCollectionInfoValues<Dictionary<PlayerRngType, int>>
                {
    ...
    private JsonTypeInfo<Dictionary<RunRngType, int>> Create_DictionaryRunRngTypeInt32(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<Dictionary<RunRngType, int>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<Dictionary<RunRngType, int>> collectionInfo =
                new JsonCollectionInfoValues<Dictionary<RunRngType, int>>
                {
    ...
    private JsonTypeInfo<Dictionary<string, object>> Create_DictionaryStringObject(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<Dictionary<string, object>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<Dictionary<string, object>> collectionInfo =
                new JsonCollectionInfoValues<Dictionary<string, object>>
                {
    ...
    private JsonTypeInfo<Dictionary<string, string>> Create_DictionaryStringString(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<Dictionary<string, string>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<Dictionary<string, string>> collectionInfo =
                new JsonCollectionInfoValues<Dictionary<string, string>>
                {
    ...
    private JsonTypeInfo<
        Dictionary<ulong, List<SerializableReward>>
    > Create_DictionaryUInt64ListSerializableReward(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<Dictionary<ulong, List<SerializableReward>>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<Dictionary<ulong, List<SerializableReward>>> collectionInfo =
                new JsonCollectionInfoValues<Dictionary<ulong, List<SerializableReward>>>
                {
    ...
    private JsonTypeInfo<IEnumerable<SerializableBadge>> Create_IEnumerableSerializableBadge(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<IEnumerable<SerializableBadge>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<IEnumerable<SerializableBadge>> collectionInfo =
                new JsonCollectionInfoValues<IEnumerable<SerializableBadge>>
                {
                    ObjectCreator = null,
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateIEnumerableInfo<
                IEnumerable<SerializableBadge>,
                SerializableBadge
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
    ...
    private JsonTypeInfo<IEnumerable<SerializableCard>> Create_IEnumerableSerializableCard(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<IEnumerable<SerializableCard>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<IEnumerable<SerializableCard>> collectionInfo =
                new JsonCollectionInfoValues<IEnumerable<SerializableCard>>
                {
                    ObjectCreator = null,
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateIEnumerableInfo<
                IEnumerable<SerializableCard>,
                SerializableCard
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
    ...
    private JsonTypeInfo<IEnumerable<SerializablePotion>> Create_IEnumerableSerializablePotion(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<IEnumerable<SerializablePotion>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<IEnumerable<SerializablePotion>> collectionInfo =
                new JsonCollectionInfoValues<IEnumerable<SerializablePotion>>
                {
                    ObjectCreator = null,
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateIEnumerableInfo<
                IEnumerable<SerializablePotion>,
                SerializablePotion
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
    ...
    private JsonTypeInfo<IEnumerable<SerializableRelic>> Create_IEnumerableSerializableRelic(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<IEnumerable<SerializableRelic>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<IEnumerable<SerializableRelic>> collectionInfo =
                new JsonCollectionInfoValues<IEnumerable<SerializableRelic>>
                {
                    ObjectCreator = null,
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateIEnumerableInfo<
                IEnumerable<SerializableRelic>,
                SerializableRelic
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
    ...
    private JsonTypeInfo<List<Vector2>> Create_ListVector2(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<Vector2>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<Vector2>> collectionInfo = new JsonCollectionInfoValues<
                List<Vector2>
            >
            {
            ...
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<List<Vector2>, Vector2>(
                options,
                collectionInfo
            );
            jsonTypeInfo.NumberHandling = null;
    ...
    private JsonTypeInfo<List<MapCoord>> Create_ListMapCoord(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<MapCoord>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<MapCoord>> collectionInfo = new JsonCollectionInfoValues<
                List<MapCoord>
            >
            {
            ...
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<List<MapCoord>, MapCoord>(
                options,
                collectionInfo
            );
            jsonTypeInfo.NumberHandling = null;
    ...
    private JsonTypeInfo<List<ModDependency>> Create_ListModDependency(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<ModDependency>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<ModDependency>> collectionInfo =
                new JsonCollectionInfoValues<List<ModDependency>>
                {
                    ObjectCreator = () => new List<ModDependency>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<List<ModDependency>, ModDependency>(
                options,
                collectionInfo
            );
            jsonTypeInfo.NumberHandling = null;
    ...
    private JsonTypeInfo<List<SettingsSaveMod>> Create_ListSettingsSaveMod(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<SettingsSaveMod>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<SettingsSaveMod>> collectionInfo =
                new JsonCollectionInfoValues<List<SettingsSaveMod>>
                {
                    ObjectCreator = () => new List<SettingsSaveMod>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
    ...
    private JsonTypeInfo<List<ModelId>> Create_ListModelId(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<ModelId>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<ModelId>> collectionInfo = new JsonCollectionInfoValues<
                List<ModelId>
            >
            {
            ...
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<List<ModelId>, ModelId>(
                options,
                collectionInfo
            );
            jsonTypeInfo.NumberHandling = null;
    ...
    private JsonTypeInfo<List<NullLeaderboard>> Create_ListNullLeaderboard(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<NullLeaderboard>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<NullLeaderboard>> collectionInfo =
                new JsonCollectionInfoValues<List<NullLeaderboard>>
                {
                    ObjectCreator = () => new List<NullLeaderboard>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<NullLeaderboard>,
                NullLeaderboard
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
    ...
    private JsonTypeInfo<List<NullLeaderboardFileEntry>> Create_ListNullLeaderboardFileEntry(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<NullLeaderboardFileEntry>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<NullLeaderboardFileEntry>> collectionInfo =
                new JsonCollectionInfoValues<List<NullLeaderboardFileEntry>>
                {
                    ObjectCreator = () => new List<NullLeaderboardFileEntry>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<NullLeaderboardFileEntry>,
                NullLeaderboardFileEntry
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
        jsonTypeInfo.OriginatingResolver = this;
    ...
    private JsonTypeInfo<List<NullMultiplayerName>> Create_ListNullMultiplayerName(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<NullMultiplayerName>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<NullMultiplayerName>> collectionInfo =
                new JsonCollectionInfoValues<List<NullMultiplayerName>>
                {
                    ObjectCreator = () => new List<NullMultiplayerName>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<NullMultiplayerName>,
                NullMultiplayerName
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
    ...
    private JsonTypeInfo<List<AncientChoiceHistoryEntry>> Create_ListAncientChoiceHistoryEntry(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<AncientChoiceHistoryEntry>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<AncientChoiceHistoryEntry>> collectionInfo =
                new JsonCollectionInfoValues<List<AncientChoiceHistoryEntry>>
                {
                    ObjectCreator = () => new List<AncientChoiceHistoryEntry>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<AncientChoiceHistoryEntry>,
                AncientChoiceHistoryEntry
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
        jsonTypeInfo.OriginatingResolver = this;
    ...
    private JsonTypeInfo<List<CardChoiceHistoryEntry>> Create_ListCardChoiceHistoryEntry(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<CardChoiceHistoryEntry>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<CardChoiceHistoryEntry>> collectionInfo =
                new JsonCollectionInfoValues<List<CardChoiceHistoryEntry>>
                {
                    ObjectCreator = () => new List<CardChoiceHistoryEntry>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<CardChoiceHistoryEntry>,
    ...
    private JsonTypeInfo<List<CardEnchantmentHistoryEntry>> Create_ListCardEnchantmentHistoryEntry(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<CardEnchantmentHistoryEntry>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<CardEnchantmentHistoryEntry>> collectionInfo =
                new JsonCollectionInfoValues<List<CardEnchantmentHistoryEntry>>
                {
                    ObjectCreator = () => new List<CardEnchantmentHistoryEntry>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<CardEnchantmentHistoryEntry>,
                CardEnchantmentHistoryEntry
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
        jsonTypeInfo.OriginatingResolver = this;
    ...
    private JsonTypeInfo<
        List<CardTransformationHistoryEntry>
    > Create_ListCardTransformationHistoryEntry(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<CardTransformationHistoryEntry>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<CardTransformationHistoryEntry>> collectionInfo =
                new JsonCollectionInfoValues<List<CardTransformationHistoryEntry>>
                {
            ...
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<CardTransformationHistoryEntry>,
                CardTransformationHistoryEntry
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
        jsonTypeInfo.OriginatingResolver = this;
    ...
    private JsonTypeInfo<List<EventOptionHistoryEntry>> Create_ListEventOptionHistoryEntry(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<EventOptionHistoryEntry>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<EventOptionHistoryEntry>> collectionInfo =
                new JsonCollectionInfoValues<List<EventOptionHistoryEntry>>
                {
                    ObjectCreator = () => new List<EventOptionHistoryEntry>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<EventOptionHistoryEntry>,
    ...
    private JsonTypeInfo<List<MapPointHistoryEntry>> Create_ListMapPointHistoryEntry(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<MapPointHistoryEntry>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<MapPointHistoryEntry>> collectionInfo =
                new JsonCollectionInfoValues<List<MapPointHistoryEntry>>
                {
                    ObjectCreator = () => new List<MapPointHistoryEntry>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<MapPointHistoryEntry>,
    ...
    private JsonTypeInfo<List<MapPointRoomHistoryEntry>> Create_ListMapPointRoomHistoryEntry(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<MapPointRoomHistoryEntry>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<MapPointRoomHistoryEntry>> collectionInfo =
                new JsonCollectionInfoValues<List<MapPointRoomHistoryEntry>>
                {
                    ObjectCreator = () => new List<MapPointRoomHistoryEntry>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<MapPointRoomHistoryEntry>,
                MapPointRoomHistoryEntry
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
        jsonTypeInfo.OriginatingResolver = this;
    ...
    private JsonTypeInfo<List<ModelChoiceHistoryEntry>> Create_ListModelChoiceHistoryEntry(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<ModelChoiceHistoryEntry>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<ModelChoiceHistoryEntry>> collectionInfo =
                new JsonCollectionInfoValues<List<ModelChoiceHistoryEntry>>
                {
                    ObjectCreator = () => new List<ModelChoiceHistoryEntry>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<ModelChoiceHistoryEntry>,
                ModelChoiceHistoryEntry
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
        jsonTypeInfo.OriginatingResolver = this;
    ...
    private JsonTypeInfo<List<PlayerMapPointHistoryEntry>> Create_ListPlayerMapPointHistoryEntry(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<PlayerMapPointHistoryEntry>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<PlayerMapPointHistoryEntry>> collectionInfo =
                new JsonCollectionInfoValues<List<PlayerMapPointHistoryEntry>>
                {
                    ObjectCreator = () => new List<PlayerMapPointHistoryEntry>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<PlayerMapPointHistoryEntry>,
    ...
    private JsonTypeInfo<List<RunHistoryPlayer>> Create_ListRunHistoryPlayer(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<RunHistoryPlayer>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<RunHistoryPlayer>> collectionInfo =
                new JsonCollectionInfoValues<List<RunHistoryPlayer>>
                {
                    ObjectCreator = () => new List<RunHistoryPlayer>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<RunHistoryPlayer>,
                RunHistoryPlayer
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
    ...
    private JsonTypeInfo<List<AncientCharacterStats>> Create_ListAncientCharacterStats(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<AncientCharacterStats>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<AncientCharacterStats>> collectionInfo =
                new JsonCollectionInfoValues<List<AncientCharacterStats>>
                {
                    ObjectCreator = () => new List<AncientCharacterStats>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<AncientCharacterStats>,
                AncientCharacterStats
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
        jsonTypeInfo.OriginatingResolver = this;
    ...
    private JsonTypeInfo<List<AncientStats>> Create_ListAncientStats(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<AncientStats>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<AncientStats>> collectionInfo =
                new JsonCollectionInfoValues<List<AncientStats>>
                {
                    ObjectCreator = () => new List<AncientStats>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<List<AncientStats>, AncientStats>(
                options,
                collectionInfo
            );
            jsonTypeInfo.NumberHandling = null;
    ...
    private JsonTypeInfo<List<BadgeStats>> Create_ListBadgeStats(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<BadgeStats>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<BadgeStats>> collectionInfo =
                new JsonCollectionInfoValues<List<BadgeStats>>
                {
                    ObjectCreator = () => new List<BadgeStats>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<List<BadgeStats>, BadgeStats>(
                options,
                collectionInfo
            );
            jsonTypeInfo.NumberHandling = null;
    ...
    private JsonTypeInfo<List<CardStats>> Create_ListCardStats(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<CardStats>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<CardStats>> collectionInfo = new JsonCollectionInfoValues<
                List<CardStats>
            >
            {
            ...
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<List<CardStats>, CardStats>(
                options,
                collectionInfo
            );
            jsonTypeInfo.NumberHandling = null;
    ...
    private JsonTypeInfo<List<CharacterStats>> Create_ListCharacterStats(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<CharacterStats>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<CharacterStats>> collectionInfo =
                new JsonCollectionInfoValues<List<CharacterStats>>
                {
    ...
    private JsonTypeInfo<List<EncounterStats>> Create_ListEncounterStats(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<EncounterStats>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<EncounterStats>> collectionInfo =
                new JsonCollectionInfoValues<List<EncounterStats>>
                {
    ...
    private JsonTypeInfo<List<EnemyStats>> Create_ListEnemyStats(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<EnemyStats>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<EnemyStats>> collectionInfo =
                new JsonCollectionInfoValues<List<EnemyStats>>
                {
                    ObjectCreator = () => new List<EnemyStats>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<List<EnemyStats>, EnemyStats>(
                options,
                collectionInfo
            );
            jsonTypeInfo.NumberHandling = null;
    ...
    private JsonTypeInfo<List<FightStats>> Create_ListFightStats(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<FightStats>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<FightStats>> collectionInfo =
                new JsonCollectionInfoValues<List<FightStats>>
                {
                    ObjectCreator = () => new List<FightStats>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<List<FightStats>, FightStats>(
                options,
                collectionInfo
            );
            jsonTypeInfo.NumberHandling = null;
    ...
    private JsonTypeInfo<List<SerializableMapDrawingLine>> Create_ListSerializableMapDrawingLine(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<SerializableMapDrawingLine>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<SerializableMapDrawingLine>> collectionInfo =
                new JsonCollectionInfoValues<List<SerializableMapDrawingLine>>
                {
                    ObjectCreator = () => new List<SerializableMapDrawingLine>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<SerializableMapDrawingLine>,
                SerializableMapDrawingLine
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
        jsonTypeInfo.OriginatingResolver = this;
    ...
    private JsonTypeInfo<
        List<SerializablePlayerMapDrawings>
    > Create_ListSerializablePlayerMapDrawings(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<SerializablePlayerMapDrawings>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<SerializablePlayerMapDrawings>> collectionInfo =
                new JsonCollectionInfoValues<List<SerializablePlayerMapDrawings>>
                {
    ...
    private JsonTypeInfo<List<MigratingData>> Create_ListMigratingData(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<MigratingData>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<MigratingData>> collectionInfo =
                new JsonCollectionInfoValues<List<MigratingData>>
                {
                    ObjectCreator = () => new List<MigratingData>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<List<MigratingData>, MigratingData>(
                options,
                collectionInfo
            );
            jsonTypeInfo.NumberHandling = null;
    ...
    private JsonTypeInfo<List<SavedProperties.SavedProperty<bool>>> Create_ListSavedPropertyBoolean(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<SavedProperties.SavedProperty<bool>>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<SavedProperties.SavedProperty<bool>>> collectionInfo =
                new JsonCollectionInfoValues<List<SavedProperties.SavedProperty<bool>>>
                {
                    ObjectCreator = () => new List<SavedProperties.SavedProperty<bool>>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<SavedProperties.SavedProperty<bool>>,
                SavedProperties.SavedProperty<bool>
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
        jsonTypeInfo.OriginatingResolver = this;
    ...
    private JsonTypeInfo<
        List<SavedProperties.SavedProperty<ModelId>>
    > Create_ListSavedPropertyModelId(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<SavedProperties.SavedProperty<ModelId>>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<SavedProperties.SavedProperty<ModelId>>> collectionInfo =
                new JsonCollectionInfoValues<List<SavedProperties.SavedProperty<ModelId>>>
                {
            ...
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<SavedProperties.SavedProperty<ModelId>>,
                SavedProperties.SavedProperty<ModelId>
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
        jsonTypeInfo.OriginatingResolver = this;
    ...
    private JsonTypeInfo<
        List<SavedProperties.SavedProperty<SerializableCard[]>>
    > Create_ListSavedPropertySerializableCardArray(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
        ...
        )
        {
            JsonCollectionInfoValues<
                List<SavedProperties.SavedProperty<SerializableCard[]>>
            > collectionInfo = new JsonCollectionInfoValues<
                List<SavedProperties.SavedProperty<SerializableCard[]>>
            >
            {
            ...
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<SavedProperties.SavedProperty<SerializableCard[]>>,
                SavedProperties.SavedProperty<SerializableCard[]>
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
        jsonTypeInfo.OriginatingResolver = this;
    ...
    private JsonTypeInfo<
        List<SavedProperties.SavedProperty<SerializableCard>>
    > Create_ListSavedPropertySerializableCard(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<SavedProperties.SavedProperty<SerializableCard>>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<
    ...
    private JsonTypeInfo<
        List<SavedProperties.SavedProperty<int[]>>
    > Create_ListSavedPropertyInt32Array(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<SavedProperties.SavedProperty<int[]>>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<SavedProperties.SavedProperty<int[]>>> collectionInfo =
                new JsonCollectionInfoValues<List<SavedProperties.SavedProperty<int[]>>>
                {
            ...
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<SavedProperties.SavedProperty<int[]>>,
                SavedProperties.SavedProperty<int[]>
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
        jsonTypeInfo.OriginatingResolver = this;
    ...
    private JsonTypeInfo<List<SavedProperties.SavedProperty<int>>> Create_ListSavedPropertyInt32(
        JsonSerializerOptions options
    )
    {
        if (
    ...
    private JsonTypeInfo<
        List<SavedProperties.SavedProperty<string>>
    > Create_ListSavedPropertyString(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<SavedProperties.SavedProperty<string>>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<SavedProperties.SavedProperty<string>>> collectionInfo =
                new JsonCollectionInfoValues<List<SavedProperties.SavedProperty<string>>>
                {
            ...
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<SavedProperties.SavedProperty<string>>,
                SavedProperties.SavedProperty<string>
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
        jsonTypeInfo.OriginatingResolver = this;
    ...
    private JsonTypeInfo<List<SerializableActModel>> Create_ListSerializableActModel(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<SerializableActModel>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<SerializableActModel>> collectionInfo =
                new JsonCollectionInfoValues<List<SerializableActModel>>
                {
                    ObjectCreator = () => new List<SerializableActModel>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<SerializableActModel>,
                SerializableActModel
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
        jsonTypeInfo.OriginatingResolver = this;
    ...
    private JsonTypeInfo<List<SerializableCard>> Create_ListSerializableCard(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<SerializableCard>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<SerializableCard>> collectionInfo =
                new JsonCollectionInfoValues<List<SerializableCard>>
                {
    ...
    private JsonTypeInfo<List<SerializableMapPoint>> Create_ListSerializableMapPoint(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<SerializableMapPoint>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<SerializableMapPoint>> collectionInfo =
                new JsonCollectionInfoValues<List<SerializableMapPoint>>
                {
                    ObjectCreator = () => new List<SerializableMapPoint>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<SerializableMapPoint>,
                SerializableMapPoint
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
        jsonTypeInfo.OriginatingResolver = this;
    ...
    private JsonTypeInfo<List<SerializableModifier>> Create_ListSerializableModifier(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<SerializableModifier>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<SerializableModifier>> collectionInfo =
                new JsonCollectionInfoValues<List<SerializableModifier>>
                {
                    ObjectCreator = () => new List<SerializableModifier>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<SerializableModifier>,
    ...
    private JsonTypeInfo<List<SerializablePlayer>> Create_ListSerializablePlayer(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<SerializablePlayer>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<SerializablePlayer>> collectionInfo =
                new JsonCollectionInfoValues<List<SerializablePlayer>>
                {
                    ObjectCreator = () => new List<SerializablePlayer>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<SerializablePlayer>,
                SerializablePlayer
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
    ...
    private JsonTypeInfo<List<SerializablePotion>> Create_ListSerializablePotion(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<SerializablePotion>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<SerializablePotion>> collectionInfo =
                new JsonCollectionInfoValues<List<SerializablePotion>>
                {
                    ObjectCreator = () => new List<SerializablePotion>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<SerializablePotion>,
                SerializablePotion
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
    ...
    private JsonTypeInfo<List<SerializableRelic>> Create_ListSerializableRelic(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<SerializableRelic>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<SerializableRelic>> collectionInfo =
                new JsonCollectionInfoValues<List<SerializableRelic>>
                {
                    ObjectCreator = () => new List<SerializableRelic>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<SerializableRelic>,
                SerializableRelic
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
    ...
    private JsonTypeInfo<List<SerializableReward>> Create_ListSerializableReward(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<SerializableReward>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<SerializableReward>> collectionInfo =
                new JsonCollectionInfoValues<List<SerializableReward>>
                {
    ...
    private JsonTypeInfo<List<SerializableEpoch>> Create_ListSerializableEpoch(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<SerializableEpoch>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<SerializableEpoch>> collectionInfo =
                new JsonCollectionInfoValues<List<SerializableEpoch>>
                {
                    ObjectCreator = () => new List<SerializableEpoch>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<SerializableEpoch>,
                SerializableEpoch
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
    ...
    private JsonTypeInfo<
        List<SerializableUnlockedAchievement>
    > Create_ListSerializableUnlockedAchievement(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<SerializableUnlockedAchievement>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<SerializableUnlockedAchievement>> collectionInfo =
                new JsonCollectionInfoValues<List<SerializableUnlockedAchievement>>
                {
            ...
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<SerializableUnlockedAchievement>,
                SerializableUnlockedAchievement
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
        jsonTypeInfo.OriginatingResolver = this;
    ...
    private JsonTypeInfo<List<Dictionary<string, object>>> Create_ListDictionaryStringObject(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<Dictionary<string, object>>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<Dictionary<string, object>>> collectionInfo =
                new JsonCollectionInfoValues<List<Dictionary<string, object>>>
                {
    ...
    private JsonTypeInfo<List<List<MapPointHistoryEntry>>> Create_ListListMapPointHistoryEntry(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<List<MapPointHistoryEntry>>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<List<MapPointHistoryEntry>>> collectionInfo =
                new JsonCollectionInfoValues<List<List<MapPointHistoryEntry>>>
                {
                    ObjectCreator = () => new List<List<MapPointHistoryEntry>>(),
                    SerializeHandler = null,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<List<MapPointHistoryEntry>>,
                List<MapPointHistoryEntry>
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
    ...
    private JsonTypeInfo<
        List<List<PlayerMapPointHistoryEntry>>
    > Create_ListListPlayerMapPointHistoryEntry(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<List<PlayerMapPointHistoryEntry>>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<List<PlayerMapPointHistoryEntry>>> collectionInfo =
                new JsonCollectionInfoValues<List<List<PlayerMapPointHistoryEntry>>>
                {
    ...
    private JsonTypeInfo<List<JsonNode>> Create_ListJsonNode(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<JsonNode>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<JsonNode>> collectionInfo = new JsonCollectionInfoValues<
                List<JsonNode>
            >
            {
            ...
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<List<JsonNode>, JsonNode>(
                options,
                collectionInfo
            );
            jsonTypeInfo.NumberHandling = null;
    ...
    private JsonTypeInfo<List<string>> Create_ListString(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<string>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<string>> collectionInfo = new JsonCollectionInfoValues<
                List<string>
            >
            {
            ...
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<List<string>, string>(
                options,
                collectionInfo
            );
            jsonTypeInfo.NumberHandling = null;
    ...
    private JsonTypeInfo<List<ulong>> Create_ListUInt64(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<ulong>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<ulong>> collectionInfo = new JsonCollectionInfoValues<
                List<ulong>
            >
            {
            ...
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<List<ulong>, ulong>(
                options,
                collectionInfo
            );
            jsonTypeInfo.NumberHandling = null;
    ...
    private JsonTypeInfo<DateTimeOffset> Create_DateTimeOffset(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<DateTimeOffset> jsonTypeInfo
            )
        )
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<DateTimeOffset>(
                options,
    ...
    private JsonTypeInfo<DateTimeOffset?> Create_NullableDateTimeOffset(
        JsonSerializerOptions options
    )
    {
        if (
        ...
        {
            JsonConverter nullableConverter =
    ...
    private JsonTypeInfo<JsonNode> Create_JsonNode(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<JsonNode> jsonTypeInfo
            )
        )
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<JsonNode>(
                options,
    ...
    private JsonTypeInfo<JsonObject> Create_JsonObject(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<JsonObject> jsonTypeInfo
            )
        )
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<JsonObject>(
                options,
    ...
    private JsonTypeInfo<int> Create_Int32(JsonSerializerOptions options)
    {
        ...
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<int>(
                options,
    ...
    private JsonTypeInfo<int?> Create_NullableInt32(JsonSerializerOptions options)
    {
        if (!TryGetTypeInfoForRuntimeCustomConverter(options, out JsonTypeInfo<int?> jsonTypeInfo))
        {
            JsonConverter nullableConverter = JsonMetadataServices.GetNullableConverter<int>(
                options
            );
    ...
    private JsonTypeInfo<long> Create_Int64(JsonSerializerOptions options)
    {
        ...
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<long>(
                options,
    ...
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(options, out JsonTypeInfo<object> jsonTypeInfo)
        )
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<object>(
                options,
    ...
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(options, out JsonTypeInfo<string> jsonTypeInfo)
        )
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<string>(
                options,
    ...
    private JsonTypeInfo<uint> Create_UInt32(JsonSerializerOptions options)
    {
        ...
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<uint>(
                options,
    ...
    private JsonTypeInfo<ulong> Create_UInt64(JsonSerializerOptions options)
    {
        ...
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<ulong>(
                options,
    ...
    {
        JsonConverter runtimeConverterForType = GetRuntimeConverterForType(
            typeof(TJsonMetadataType),
            options
        );
        if (runtimeConverterForType != null)
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<TJsonMetadataType>(
                options,
                runtimeConverterForType
            );
            return true;
        }
        jsonTypeInfo = null;
    ...
    )
    {
        ...
        {
            throw new InvalidOperationException(
                $"The converter '{converter.GetType()}' is not compatible with the type '{type}'."
            );
        }
        if (converter is JsonConverterFactory jsonConverterFactory)
        {
            ...
            {
                throw new InvalidOperationException(
                    $"The converter '{jsonConverterFactory.GetType()}' cannot return null or a JsonConverterFactory instance."
                );
            }
        }
        return converter;
