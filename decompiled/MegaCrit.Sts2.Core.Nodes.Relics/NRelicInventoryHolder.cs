...
public class NRelicInventoryHolder : NButton
{
    ...
    private static readonly string _scenePath = SceneHelper.GetScenePath(
        "relics/relic_inventory_holder"
    );

    private static readonly string _flashPath = SceneHelper.GetScenePath(
        "vfx/relic_inventory_flash_vfx"
    );
    ...
    public static IEnumerable<string> AssetPaths =>
        new global::_003C_003Ez__ReadOnlyArray<string>(new string[2] { _scenePath, _flashPath });
    ...
    public static NRelicInventoryHolder? Create(RelicModel relic)
    {
        ...
        NRelicInventoryHolder nRelicInventoryHolder = PreloadManager
            .Cache.GetScene(_scenePath)
            .Instantiate<NRelicInventoryHolder>(PackedScene.GenEditState.Disabled);
    ...
    public async Task PlayNewlyAcquiredAnimation(Vector2? startLocation, Vector2? startScale)
    {
        ...
        if (!cancelTokenSource.IsCancellationRequested)
        {
            ...
            if (!startLocation.HasValue)
            {
                ...
                _obtainedTween.TweenProperty(
                    _relic.Icon,
                    "position:y",
                    _originalIconPosition.Y,
                    0.3499999940395355
                );
            ...
            else
            {
                ...
                _obtainedTween.TweenProperty(
                    _relic.Icon,
                    "position",
                    _originalIconPosition,
                    0.3499999940395355
                );
                _obtainedTween
                    .Parallel()
                    .TweenProperty(_relic.Icon, "scale", Vector2.One, 0.3499999940395355);
                _obtainedTween.TweenCallback(Callable.From(DoFlash));
            }
        }
    }
    ...
    protected override void OnUnfocus()
    {
        ...
        _hoverTween = CreateTween();
        _hoverTween
            .TweenProperty(_relic.Icon, "scale", Vector2.One, 1.0)
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnDisplayAmountChanged,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                ...
                PropertyName._originalIconPosition,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._originalIconPosition,
            Variant.From(in _originalIconPosition)
        );
    }
