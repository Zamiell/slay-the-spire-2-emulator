...
public sealed class QueenBoss : EncounterModel
{
    ...
    public override IReadOnlyList<string> Slots =>
        new global::_003C_003Ez__ReadOnlyArray<string>(new string[2] { "amalgam", "queen" });
    ...
    public override IEnumerable<MonsterModel> AllPossibleMonsters =>
        new global::_003C_003Ez__ReadOnlyArray<MonsterModel>(
            new MonsterModel[2] { ModelDb.Monster<Queen>(), ModelDb.Monster<TorchHeadAmalgam>() }
        );

    public override IEnumerable<string> ExtraAssetPaths =>
        new global::_003C_003Ez__ReadOnlySingleElementList<string>(
            ModelDb.Affliction<Bound>().OverlayPath
        );
