...
public sealed class FakeMerchantEventEncounter : EncounterModel
{
    ...
    public override IReadOnlyList<string> Slots =>
        new global::_003C_003Ez__ReadOnlySingleElementList<string>("merchant");

    public override IEnumerable<MonsterModel> AllPossibleMonsters =>
        new global::_003C_003Ez__ReadOnlySingleElementList<MonsterModel>(
            ModelDb.Monster<FakeMerchantMonster>()
        );
    ...
    protected override IReadOnlyList<(MonsterModel, string?)> GenerateMonsters()
    {
        return new global::_003C_003Ez__ReadOnlySingleElementList<(MonsterModel, string)>(
            (ModelDb.Monster<FakeMerchantMonster>().ToMutable(), "merchant")
        );
    }
}
