...
public sealed class FabricatorNormal : EncounterModel
{
    ...
    public override IReadOnlyList<string> Slots =>
        new global::_003C_003Ez__ReadOnlyArray<string>(
            new string[5] { "bot1", "bot2", "fabricator", "bot3", "bot4" }
        );
    ...
    protected override IReadOnlyList<(MonsterModel, string?)> GenerateMonsters()
    {
        return new global::_003C_003Ez__ReadOnlySingleElementList<(MonsterModel, string)>(
            (ModelDb.Monster<Fabricator>().ToMutable(), "fabricator")
        );
    }
    ...
    public static void SetBotFallPosition(NCreature creatureNode)
    {
        ...
        if (specialNode != null)
        {
            ...
            specialNode.Position =
                Vector2.Down
                * ((num - creatureNode.Position.Y) / creatureNode.Visuals.GetCurrentBody().Scale.Y);
        }
    }
}
