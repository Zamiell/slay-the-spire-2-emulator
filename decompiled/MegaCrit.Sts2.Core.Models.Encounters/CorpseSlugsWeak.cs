...
public sealed class CorpseSlugsWeak : EncounterModel
{
    public override IEnumerable<EncounterTag> Tags =>
        new global::_003C_003Ez__ReadOnlySingleElementList<EncounterTag>(EncounterTag.Slugs);
    ...
    protected override IReadOnlyList<(MonsterModel, string?)> GenerateMonsters()
    {
        ...
        CorpseSlug.EnsureCorpseSlugsStartWithDifferentMoves(
            list2.Select(((MonsterModel, string) kvp) => kvp.Item1),
            base.Rng
        );
        return list2;
    }
