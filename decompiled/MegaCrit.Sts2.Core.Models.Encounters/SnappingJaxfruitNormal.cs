...
public sealed class SnappingJaxfruitNormal : EncounterModel
{
    ...
    public override IEnumerable<EncounterTag> Tags =>
        new global::_003C_003Ez__ReadOnlySingleElementList<EncounterTag>(EncounterTag.Mushroom);

    public override IEnumerable<MonsterModel> AllPossibleMonsters =>
        new global::_003C_003Ez__ReadOnlyArray<MonsterModel>(
            new MonsterModel[2] { ModelDb.Monster<SnappingJaxfruit>(), ModelDb.Monster<Flyconid>() }
        );
