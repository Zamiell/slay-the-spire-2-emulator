...
public sealed class SeapunkNormal : EncounterModel
{
    ...
    public override IEnumerable<EncounterTag> Tags =>
        new global::_003C_003Ez__ReadOnlySingleElementList<EncounterTag>(EncounterTag.Seapunk);

    public override IEnumerable<MonsterModel> AllPossibleMonsters =>
        new global::_003C_003Ez__ReadOnlyArray<MonsterModel>(
            new MonsterModel[2] { ModelDb.Monster<Seapunk>(), ModelDb.Monster<CalcifiedCultist>() }
        );
