...
public sealed class PhrogParasiteElite : EncounterModel
{
    ...
    public override IReadOnlyList<string> Slots =>
        new global::_003C_003Ez__ReadOnlyArray<string>(
            new string[5] { "phrog", "wriggler1", "wriggler2", "wriggler3", "wriggler4" }
        );
    ...
    public override IEnumerable<MonsterModel> AllPossibleMonsters =>
        new global::_003C_003Ez__ReadOnlyArray<MonsterModel>(
            new MonsterModel[2] { ModelDb.Monster<PhrogParasite>(), ModelDb.Monster<Wriggler>() }
        );

    public override IEnumerable<string> ExtraAssetPaths =>
        new global::_003C_003Ez__ReadOnlySingleElementList<string>(
            ModelDb.Card<Infection>().OverlayPath
        );
    ...
    protected override IReadOnlyList<(MonsterModel, string?)> GenerateMonsters()
    {
        return new global::_003C_003Ez__ReadOnlySingleElementList<(MonsterModel, string)>(
            (ModelDb.Monster<PhrogParasite>().ToMutable(), "phrog")
        );
    }
}
