...
public abstract class OrbModel : AbstractModel
{
    ...
    public static HoverTip EmptySlotHoverTipHoverTip =>
        new HoverTip(
            new LocString("orbs", "EMPTY_SLOT.title"),
            new LocString("orbs", "EMPTY_SLOT.description")
        );
    ...
    private string IconPath =>
        ImageHelper.GetImagePath("orbs/" + base.Id.Entry.ToLowerInvariant() + ".png");

    private string SpritePath =>
        SceneHelper.GetScenePath("orbs/orb_visuals/" + base.Id.Entry.ToLowerInvariant());
    ...
    public IEnumerable<string> AssetPaths =>
        new global::_003C_003Ez__ReadOnlyArray<string>(new string[2] { IconPath, SpritePath });
    ...
    public Node2D CreateSprite()
    {
        Node2D node2D = PreloadManager
            .Cache.GetScene(SpritePath)
            .Instantiate<Node2D>(PackedScene.GenEditState.Disabled);
        new MegaSprite(node2D.GetNode("SpineSkeleton"))
            .GetAnimationState()
