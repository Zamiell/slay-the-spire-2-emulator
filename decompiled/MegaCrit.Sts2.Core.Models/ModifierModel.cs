...
public abstract class ModifierModel : AbstractModel
{
    ...
    public virtual LocString Description =>
        new LocString("modifiers", base.Id.Entry + ".description");
    ...
    protected LocString? AdditionalRestSiteHealText =>
        LocString.GetIfExists("modifiers", base.Id.Entry + ".additionalRestSiteHealText");
    ...
    protected virtual string IconPath =>
        ImageHelper.GetImagePath("packed/modifiers/" + base.Id.Entry.ToLowerInvariant() + ".png");

    private static string MissingIconPath => ImageHelper.GetImagePath("powers/missing_power.png");

    protected RunState RunState =>
        _runState ?? throw new InvalidOperationException("Modifier was never initialized!");
    ...
    {
        AssertMutable();
        return new SerializableModifier { Id = base.Id, Props = SavedProperties.From(this) };
    }
