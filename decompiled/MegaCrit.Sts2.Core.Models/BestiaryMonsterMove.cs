...
{
    private static readonly LocString _attackMoveName = new LocString(
        "bestiary",
        "ACTION_NAME.attack"
    );
    ...
    private static readonly LocString _reviveMoveName = new LocString(
        "bestiary",
        "ACTION_NAME.revive"
    );
    ...
    {
        BestiaryMonsterMove result = new BestiaryMonsterMove { animId = animId };
        string text = (
            animId.StartsWith("attack")
                ? _attackMoveName.GetRawText()
                : (
                    animId switch
                    {
    ...
    {
        return new BestiaryMonsterMove { displayName = moveName.GetRawText(), stateId = stateId };
    }

    public static BestiaryMonsterMove FromState(string stateId)
    {
        return new BestiaryMonsterMove { displayName = stateId, stateId = stateId };
    }
    ...
    {
        return new BestiaryMonsterMove { displayName = moveName.GetRawText(), action = action };
    }
