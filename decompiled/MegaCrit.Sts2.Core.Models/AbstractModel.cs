...
public abstract class AbstractModel : IComparable<AbstractModel>
{
    ...
    public virtual Task AfterAutoPrePlayPhaseEntered(
        PlayerChoiceContext choiceContext,
        Player player
    )
    {
    ...
    public virtual Task AfterItemPurchased(
        Player player,
    ...
    public virtual Task AfterModifyingCardPlayResultPileOrPosition(
        CardModel card,
        PileType pileType,
    ...
    public virtual decimal ModifySummonAmount(
        Player summoner,
        decimal amount,
    ...
    public virtual float ModifyOddsIncreaseForUnrolledRoomType(
        RoomType roomType,
        float oddsIncrease
    )
    {
    ...
    public virtual bool TryModifyRewardsLate(
        Player player,
        List<Reward> rewards,
        AbstractRoom? room
    )
