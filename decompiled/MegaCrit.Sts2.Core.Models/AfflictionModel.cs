...
public abstract class AfflictionModel : AbstractModel
{
    ...
    private LocString ExtraCardText =>
        new LocString("afflictions", base.Id.Entry + ".extraCardText");
    ...
    public string OverlayPath =>
        SceneHelper.GetScenePath("cards/overlays/afflictions/" + base.Id.Entry.ToLowerInvariant());
        ...
        set
        {
            ...
            if (_card != null)
            {
                throw new InvalidOperationException(
                    "Afflictions cannot be moved from one card to another."
                );
            }
            _card = value;
        }
