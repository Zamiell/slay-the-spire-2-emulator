...
public class NLowHpBorderVfx : ColorRect
{
    ...
    private static readonly StringName _noiseInitialOffsetString = new StringName(
        "noise_initial_offset"
    );
    ...
    public static NLowHpBorderVfx? Create()
    {
        ...
        return PreloadManager
            ...
            .Instantiate<NLowHpBorderVfx>(PackedScene.GenEditState.Disabled);
    }
    ...
    {
        _materialCopy.SetShaderParameter(
            _noiseInitialOffsetString,
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.RandomizeInitialOffset,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._noiseOffsetCurve,
                PropertyHint.ResourceType,
                "Curve",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
