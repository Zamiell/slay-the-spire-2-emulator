...
public class NEpochChains : TextureRect
{
    ...
    public event OnAnimationFinishedEventHandler OnAnimationFinished
    {
        add
        {
            backing_OnAnimationFinished = (OnAnimationFinishedEventHandler)
                Delegate.Combine(backing_OnAnimationFinished, value);
        }
        remove
        {
            backing_OnAnimationFinished = (OnAnimationFinishedEventHandler)
                Delegate.Remove(backing_OnAnimationFinished, value);
        }
    }
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._brightEnabledCurve,
                PropertyHint.ResourceType,
                "Curve",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._erosionEnabledCurve,
                PropertyHint.ResourceType,
                "Curve",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._erosionBaseCurve,
                PropertyHint.ResourceType,
                "Curve",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Int,
                PropertyName._previousParticleIndex,
                PropertyHint.None,
                "",
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._asShaderMaterial,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._previousParticleIndex,
            Variant.From(in _previousParticleIndex)
        );
    ...
    protected override void RestoreGodotObjectData(GodotSerializationInfo info)
    {
        ...
        if (
            info.TryGetSignalEventDelegate<OnAnimationFinishedEventHandler>(
                SignalName.OnAnimationFinished,
                out var value10
            )
        )
        {
