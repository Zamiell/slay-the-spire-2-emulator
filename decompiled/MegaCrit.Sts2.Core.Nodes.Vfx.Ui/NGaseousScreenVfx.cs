...
public class NGaseousScreenVfx : AspectRatioContainer
{
    ...
    private static readonly StringName _noiseAOffsetString = new StringName(
        "noise_a_static_offset"
    );

    private static readonly StringName _noiseBOffsetString = new StringName(
        "noise_b_static_offset"
    );
    ...
    public static NGaseousScreenVfx? Create()
    {
        ...
        return PreloadManager
            ...
            .Instantiate<NGaseousScreenVfx>(PackedScene.GenEditState.Disabled);
    }
        ...
        list.Add(
            new MethodInfo(
                ...
                new PropertyInfo(
                    ...
                    new StringName("AspectRatioContainer"),
                    exported: false
                ),
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._alphaMultiplierCurve,
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._minBaseAlphaCurve,
                PropertyHint.ResourceType,
                "Curve",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._noiseAOffsetCurve,
                PropertyHint.ResourceType,
                "Curve",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._noiseBOffsetCurve,
                PropertyHint.ResourceType,
                "Curve",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._originalMaterial,
                PropertyHint.None,
                "",
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._alphaMultiplierCurve,
            Variant.From(in _alphaMultiplierCurve)
        );
