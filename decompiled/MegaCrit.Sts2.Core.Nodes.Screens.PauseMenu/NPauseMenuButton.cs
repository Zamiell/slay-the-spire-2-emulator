...
public class NPauseMenuButton : NButton
{
    ...
    protected override void OnUnfocus()
    {
        ...
        _tween
            ...
            .SetTrans(Tween.TransitionType.Expo);
        _tween
            .TweenProperty(_image, "scale", Vector2.One * 0.9f, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _tween
            .TweenProperty(_image, "position:y", 0f, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _tween
            .TweenProperty(_label, "position:y", 0f, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _tween.TweenProperty(
            _label,
    ...
    protected override void OnPress()
    {
        ...
        _tween
            ...
            .SetTrans(Tween.TransitionType.Expo);
        _tween
            .TweenProperty(_image, "scale", Vector2.One * 0.85f, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _tween
            .TweenProperty(_image, "position:y", 6f, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _tween
            .TweenProperty(_label, "position:y", 6f, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
    }
