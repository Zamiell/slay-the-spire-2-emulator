...
public class LocTextLabel : RichTextLabel
{
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.String,
                PropertyName._localizationTable,
                PropertyHint.None,
                "",
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.String,
                PropertyName.LocalizationTable,
                PropertyHint.None,
                "",
