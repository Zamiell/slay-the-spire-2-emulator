        ...
        IJsonTypeInfoResolver
{
    ...
    private JsonTypeInfo<
        Dictionary<string, SerializableDynamicVar>
    ...
    private static readonly JsonEncodedText PropName_decimal_value = JsonEncodedText.Encode(
        "decimal_value"
    );

    private static readonly JsonEncodedText PropName_bool_value = JsonEncodedText.Encode(
        "bool_value"
    );

    private static readonly JsonEncodedText PropName_string_value = JsonEncodedText.Encode(
        "string_value"
    );
    ...
    public JsonTypeInfo<decimal> Decimal =>
        _Decimal ?? (_Decimal = (JsonTypeInfo<decimal>)base.Options.GetTypeInfo(typeof(decimal)));

    public JsonTypeInfo<DynamicVarType> DynamicVarType =>
        _DynamicVarType
        ?? (
            _DynamicVarType =
                (JsonTypeInfo<DynamicVarType>)base.Options.GetTypeInfo(typeof(DynamicVarType))
        );

    public JsonTypeInfo<SerializableDynamicVar> SerializableDynamicVar =>
        _SerializableDynamicVar
        ?? (
            _SerializableDynamicVar =
                (JsonTypeInfo<SerializableDynamicVar>)
                    base.Options.GetTypeInfo(typeof(SerializableDynamicVar))
        );

    public JsonTypeInfo<
        Dictionary<string, SerializableDynamicVar>
    > DictionaryStringSerializableDynamicVar =>
        _DictionaryStringSerializableDynamicVar
        ?? (
            _DictionaryStringSerializableDynamicVar =
                (JsonTypeInfo<Dictionary<string, SerializableDynamicVar>>)
                    base.Options.GetTypeInfo(typeof(Dictionary<string, SerializableDynamicVar>))
        );

    public JsonTypeInfo<string> String =>
        _String ?? (_String = (JsonTypeInfo<string>)base.Options.GetTypeInfo(typeof(string)));

    public static SerializableDynamicVarDictionarySerializerContext Default { get; } =
        new SerializableDynamicVarDictionarySerializerContext(
    ...
    private JsonTypeInfo<decimal> Create_Decimal(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<decimal> jsonTypeInfo
            )
        )
        {
            jsonTypeInfo = JsonMetadataServices.CreateValueInfo<decimal>(
                options,
    ...
    private JsonTypeInfo<DynamicVarType> Create_DynamicVarType(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<DynamicVarType> jsonTypeInfo
            )
        )
        {
            JsonConverter converter = ExpandConverter(
                typeof(DynamicVarType),
                new JsonStringEnumConverter<DynamicVarType>(),
                options
            );
    ...
    private JsonTypeInfo<SerializableDynamicVar> Create_SerializableDynamicVar(
    ...
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SerializableDynamicVar> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SerializableDynamicVar> objectInfo =
                new JsonObjectInfoValues<SerializableDynamicVar>
                {
                    ObjectCreator = () => default(SerializableDynamicVar),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        SerializableDynamicVarPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(SerializableDynamicVar).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] SerializableDynamicVarPropInit(JsonSerializerOptions options)
    {
        ...
        JsonPropertyInfoValues<DynamicVarType> jsonPropertyInfoValues =
            new JsonPropertyInfoValues<DynamicVarType>();
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SerializableDynamicVar).GetField(
                "type",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic
            );
        ...
        JsonPropertyInfoValues<decimal> jsonPropertyInfoValues2 =
            new JsonPropertyInfoValues<decimal>();
        ...
        JsonPropertyInfoValues<string> jsonPropertyInfoValues4 =
    ...
    private JsonTypeInfo<
        Dictionary<string, SerializableDynamicVar>
    > Create_DictionaryStringSerializableDynamicVar(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<Dictionary<string, SerializableDynamicVar>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<Dictionary<string, SerializableDynamicVar>> collectionInfo =
                new JsonCollectionInfoValues<Dictionary<string, SerializableDynamicVar>>
                {
    ...
    private void DictionaryStringSerializableDynamicVarSerializeHandler(
        Utf8JsonWriter writer,
        Dictionary<string, SerializableDynamicVar>? value
    )
    {
        if (value == null)
        {
