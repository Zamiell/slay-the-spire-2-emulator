...
public class NReturnToMainMenuButton : NButton
{
    ...
    private static readonly LocString _mainMenuLoc = new LocString(
        "game_over_screen",
        "BUTTON.mainMenu"
    );
    ...
    public void SetLabelForUnlock()
    {
        _label.SetTextAutoSize(
            new LocString("game_over_screen", "BUTTON.unlock").GetFormattedText()
        );
    }
    ...
    protected override void OnPress()
    {
        ...
        _hoverTween
            .TweenProperty(this, "scale", Vector2.One, 1.0)
            .SetTrans(Tween.TransitionType.Expo)
            .SetEase(Tween.EaseType.Out);
        _hoverTween
            .TweenMethod(Callable.From<float>(UpdateShaderS), _hsv.GetShaderParameter(_s), 1f, 1.0)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _hoverTween
            .TweenMethod(Callable.From<float>(UpdateShaderV), _hsv.GetShaderParameter(_v), 1f, 1.0)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
    }
    ...
    private void HideButton()
    {
        ...
        _tween = CreateTween().SetParallel();
        _tween
            .TweenProperty(this, "position:y", _showPosition.Y + 190f, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
    }
