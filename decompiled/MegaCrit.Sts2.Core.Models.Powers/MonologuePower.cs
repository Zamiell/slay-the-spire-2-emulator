...
public sealed class MonologuePower : PowerModel
{
    ...
    public override Task BeforeCardPlayed(CardPlay cardPlay)
    {
        ...
        GetInternalData<Data>()
            .amountsForPlayedCards.Add(cardPlay.Card, base.DynamicVars.Strength.IntValue);
        return Task.CompletedTask;
    }
    ...
    public override async Task AfterCardPlayed(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        )
        {
            ...
            base.DynamicVars["StrengthApplied"].BaseValue += (decimal)
    ...
    )
    {
        if (participants.Contains(base.Owner))
        {
            ...
            await PowerCmd.Apply<StrengthPower>(
                choiceContext,
                base.Owner,
                -base.DynamicVars["StrengthApplied"].BaseValue,
                base.Owner,
                null,
                silent: true
            );
