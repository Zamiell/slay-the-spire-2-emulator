...
public sealed class InterceptPower : PowerModel
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars =>
        new global::_003C_003Ez__ReadOnlySingleElementList<DynamicVar>(new StringVar("Covering"));
    ...
    public void AddCoveredCreature(Creature c)
    {
        ...
        {
            stringVar.StringValue += PlatformUtil.GetPlayerName(
                RunManager.Instance.NetService.Platform,
                coveredCreatures[i].Player.NetId
            );
