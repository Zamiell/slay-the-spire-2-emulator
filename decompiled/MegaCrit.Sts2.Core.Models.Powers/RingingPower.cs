...
public sealed class RingingPower : PowerModel
{
    ...
    public override Task AfterRemoved(Creature oldOwner)
    {
        IEnumerable<CardModel> enumerable =
            oldOwner.Player?.PlayerCombatState?.AllCards ?? Array.Empty<CardModel>();
    ...
    public override bool ShouldPlay(CardModel card, AutoPlayType _)
    {
        ...
        return !CombatManager.Instance.History.CardPlaysStarted.Any(
            (CardPlayStartedEntry e) =>
                e.HappenedThisTurn(base.CombatState) && e.CardPlay.Card.Owner.Creature == base.Owner
        );
    }
}
