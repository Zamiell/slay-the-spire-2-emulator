...
public sealed class SkittishPower : PowerModel
{
    ...
    public bool HasGainedBlockThisTurn
    {
        get { return GetInternalData<Data>().hasGainedBlockThisTurn; }
        private set
        {
            AssertMutable();
