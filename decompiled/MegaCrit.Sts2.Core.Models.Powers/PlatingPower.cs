...
public sealed class PlatingPower : PowerModel
{
    ...
    )
    {
        if (
            ...
            && (base.Owner.Player == null || base.Owner.Player.PlayerCombatState.TurnNumber != 1)
            && (base.Owner.Side != CombatSide.Enemy || combatState.RoundNumber != 1)
        )
        {
            if (base.Owner.Side == CombatSide.Enemy)
            {
                await PowerCmd.ModifyAmount(
                    ...
                    this,
                    -base.DynamicVars["Decrement"].BaseValue,
                    null,
                    null
                );
            }
