...
public class NScreenShake : Node
{
    ...
    private readonly Dictionary<ShakeStrength, float> _strength =
        new Dictionary<ShakeStrength, float>();

    private readonly Dictionary<ShakeDuration, double> _duration =
        new Dictionary<ShakeDuration, double>();
    ...
    public void Shake(ShakeStrength strength, ShakeDuration duration, float degAngle)
    {
        ...
        {
            _shakeInstance = new ScreenPunchInstance(
                _strength[strength] * _multiplier,
                _duration[duration],
                degAngle
            );
        }
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                ...
                PropertyName._originalTargetPosition,
                PropertyHint.None,
                "",
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._originalTargetPosition,
            Variant.From(in _originalTargetPosition)
        );
