...
public class NBestiaryActDivider : NButton
{
    ...
    private static string ScenePath =>
        SceneHelper.GetScenePath("screens/bestiary/bestiary_act_divider");

    private ActModel Act { get; set; }

    public static NBestiaryActDivider Create(ActModel act)
    {
        NBestiaryActDivider nBestiaryActDivider = PreloadManager
            .Cache.GetScene(ScenePath)
            .Instantiate<NBestiaryActDivider>(PackedScene.GenEditState.Disabled);
