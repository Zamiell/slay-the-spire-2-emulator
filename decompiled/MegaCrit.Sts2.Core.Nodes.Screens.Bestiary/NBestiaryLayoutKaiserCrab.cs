...
public class NBestiaryLayoutKaiserCrab : NBestiaryLayout
{
    ...
    private static readonly string _scenePath = SceneHelper.GetScenePath(
        "screens/bestiary/bestiary_layout_kaiser_crab"
    );
    ...
    public static NBestiaryLayoutKaiserCrab? Create()
    {
        return PreloadManager
            ...
            .Instantiate<NBestiaryLayoutKaiserCrab>(PackedScene.GenEditState.Disabled);
    }
    ...
    public override List<BestiaryMonsterMove> Setup(BestiaryEntry entry, Tween tween)
    {
        ...
        if (monsterModel is Crusher)
        {
            _background.Position =
                _backgroundPosition + 1020f * Vector2.Right * 0.5f / _background.Scale;
        }
        else if (monsterModel is Rocket)
        {
            _background.Position =
                _backgroundPosition + 1240f * Vector2.Left * 0.5f / _background.Scale;
        }
        ...
        list.Add(
            BestiaryMonsterMove.FromAction(new LocString("bestiary", "ACTION_NAME.hurt"), AnimHurt)
        );
        list.Add(
            BestiaryMonsterMove.FromAction(new LocString("bestiary", "ACTION_NAME.die"), AnimDie)
        );
        return list;
    }
    ...
    {
        _background.PlayHurtAnim(
            (!(_creature.Entity.Monster is Crusher))
                ? NKaiserCrabBossBackground.ArmSide.Right
                : NKaiserCrabBossBackground.ArmSide.Left
        );
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                ...
                PropertyName._backgroundPosition,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
