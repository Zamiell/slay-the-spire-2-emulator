...
public class NBestiaryEntry : NButton
{
    ...
    {
        NBestiaryEntry nBestiaryEntry = PreloadManager
            .Cache.GetScene(ScenePath)
            .Instantiate<NBestiaryEntry>(PackedScene.GenEditState.Disabled);
    ...
    protected override void OnUnfocus()
    {
        ...
        _tween = CreateTween();
        _tween
            .TweenProperty(_label, "scale", Vector2.One, 0.3)
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._underConstructionIcon,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._underConstructionIcon,
            Variant.From(in _underConstructionIcon)
        );
