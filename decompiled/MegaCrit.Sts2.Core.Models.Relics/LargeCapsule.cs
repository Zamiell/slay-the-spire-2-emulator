...
public sealed class LargeCapsule : RelicModel
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars =>
        new global::_003C_003Ez__ReadOnlySingleElementList<DynamicVar>(new IntVar("Relics", 2m));
    ...
    public override async Task AfterObtained()
    {
        ...
        list2.Add(
            await CardPileCmd.Add(
                base.Owner.RunState.CreateCard(
                    GetStrikeForCharacter(base.Owner.Character),
                    base.Owner
                ),
                PileType.Deck
            )
        ...
        list3.Add(
            await CardPileCmd.Add(
                base.Owner.RunState.CreateCard(
                    GetDefendForCharacter(base.Owner.Character),
                    base.Owner
                ),
                PileType.Deck
            )
    ...
    private static CardModel GetStrikeForCharacter(CharacterModel character)
    {
        ...
        return character.CardPool.AllCards.First(
            (CardModel c) => c.Rarity == CardRarity.Basic && c.Tags.Contains(CardTag.Strike)
        );
    }
