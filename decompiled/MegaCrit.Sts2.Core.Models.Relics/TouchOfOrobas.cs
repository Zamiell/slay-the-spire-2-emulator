...
public sealed class TouchOfOrobas : RelicModel
{
    ...
    private static Dictionary<ModelId, RelicModel> RefinementUpgrades =>
        new Dictionary<ModelId, RelicModel>
        {
    ...
    public ModelId? StarterRelic
    {
        ...
        set
        {
            ...
            if (_starterRelic != null)
            {
                ...
                ((StringVar)base.DynamicVars["StarterRelic"]).StringValue =
    ...
    public ModelId? UpgradedRelic
    {
        ...
        set
        {
            ...
            if (_upgradedRelic != null)
            {
                ...
                _extraHoverTips.AddRange(relicModel.HoverTips);
                ((StringVar)base.DynamicVars["UpgradedRelic"]).StringValue =
                    relicModel.Title.GetFormattedText();
            }
        }
    }
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars =>
        new global::_003C_003Ez__ReadOnlyArray<DynamicVar>(
            new DynamicVar[2] { new StringVar("StarterRelic"), new StringVar("UpgradedRelic") }
        );
    ...
    public override async Task AfterObtained()
    {
        ModelId id =
            StarterRelic
            ?? base.Owner.Relics.First((RelicModel r) => r.Rarity == RelicRarity.Starter).Id;
