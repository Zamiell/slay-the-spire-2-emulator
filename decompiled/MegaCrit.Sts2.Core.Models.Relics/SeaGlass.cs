...
public class SeaGlass : RelicModel
{
    ...
    public ModelId? CharacterId
    {
        ...
        set
        {
            AssertMutable();
            _characterId = value;
            ((StringVar)base.DynamicVars["Character"]).StringValue =
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars =>
        new global::_003C_003Ez__ReadOnlyArray<DynamicVar>(
            new DynamicVar[2] { new CardsVar(15), new StringVar("Character") }
        );
    ...
    public override async Task AfterObtained()
    {
        ...
        {
            Log.Error(
                "Sea Glass was obtained without a character ID assigned! This could be a bug, or the player could have used the console. Defaulting to Ironclad"
            );
        ...
        CardCreationOptions options = CardCreationOptions
            ...
            .WithFlags(
                CardCreationFlags.NoRarityModification | CardCreationFlags.NoCardPoolModifications
            );
        ...
        CardCreationOptions options3 = CardCreationOptions
            .ForNonCombatWithUniformOdds(
                new global::_003C_003Ez__ReadOnlySingleElementList<CardPoolModel>(
                    Character.CardPool
                ),
        ...
        List<CardCreationResult> first = CardFactory
            .CreateForReward(base.Owner, cardCount, options)
            .ToList();
        List<CardCreationResult> second = CardFactory
            .CreateForReward(base.Owner, cardCount, options2)
            .ToList();
        List<CardCreationResult> second2 = CardFactory
            .CreateForReward(base.Owner, cardCount, options3)
            .ToList();
