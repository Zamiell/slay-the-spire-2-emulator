...
public sealed class TuningFork : RelicModel
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars =>
        new global::_003C_003Ez__ReadOnlyArray<DynamicVar>(
            new DynamicVar[2] { new CardsVar(10), new BlockVar(7m, ValueProp.Unpowered) }
        );
    ...
    private void UpdateDisplay()
    {
        ...
        {
            base.Status = (
                (SkillsPlayed == SkillsThreshold - 1) ? RelicStatus.Active : RelicStatus.Normal
            );
        }
