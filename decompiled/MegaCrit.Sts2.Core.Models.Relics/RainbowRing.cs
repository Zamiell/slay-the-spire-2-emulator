...
public sealed class RainbowRing : RelicModel
{
    ...
    {
        get { return _attacksPlayedThisTurn; }
        set
        {
            AssertMutable();
    ...
    {
        get { return _skillsPlayedThisTurn; }
        set
        {
            AssertMutable();
    ...
    {
        get { return _powersPlayedThisTurn; }
        set
        {
            AssertMutable();
    ...
    {
        get { return _activationCountThisTurn; }
        set
        {
            AssertMutable();
            _activationCountThisTurn = value;
            base.Status = (
                (_activationCountThisTurn > 0) ? RelicStatus.Active : RelicStatus.Normal
            );
        }
    }
