...
public sealed class GnarledHammer : RelicModel
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars =>
        new global::_003C_003Ez__ReadOnlyArray<DynamicVar>(
            new DynamicVar[2] { new CardsVar(3), new DynamicVar("SharpAmount", 3m) }
        );

    protected override IEnumerable<IHoverTip> ExtraHoverTips =>
        HoverTipFactory.FromEnchantment<Sharp>(base.DynamicVars["SharpAmount"].IntValue);
    ...
    public override async Task AfterObtained()
    {
        ...
        foreach (
            CardModel item in await CardSelectCmd.FromDeckForEnchantment(
                ...
                base.DynamicVars["SharpAmount"].IntValue,
                prefs
            )
        )
        {
