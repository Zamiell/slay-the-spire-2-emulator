...
public sealed class PaelsEye : RelicModel
{
    ...
    {
        get { return _wasOwnerPartOfLastPlayerTurn; }
        set
        {
            AssertMutable();
    ...
    private bool AnyCardsPlayedThisTurn()
    {
        ...
        if (
            ...
            && base.Owner.Relics.Any((RelicModel r) => r is WhisperingEarring)
        )
        {
            return true;
        }
