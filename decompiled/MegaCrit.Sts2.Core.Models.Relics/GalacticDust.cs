...
public sealed class GalacticDust : RelicModel
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars =>
        new global::_003C_003Ez__ReadOnlyArray<DynamicVar>(
            new DynamicVar[2] { new StarsVar(10), new BlockVar(10m, ValueProp.Unpowered) }
        );
        ...
        if (spender == base.Owner)
        {
            ...
            if (StarsSpent >= base.DynamicVars.Stars.IntValue)
            {
                ...
                await CreatureCmd.GainBlock(
                    base.Owner.Creature,
                    Mathf.FloorToInt((float)StarsSpent / (float)base.DynamicVars.Stars.IntValue)
                        * base.DynamicVars.Block.IntValue,
                    ValueProp.Unpowered,
                    null
                );
