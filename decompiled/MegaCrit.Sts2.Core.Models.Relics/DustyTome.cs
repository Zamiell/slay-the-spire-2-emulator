...
public sealed class DustyTome : RelicModel
{
    ...
    public ModelId? AncientCard
    {
        ...
        set
        {
            ...
            if (_ancientCard != null)
            {
                ...
                _extraHoverTips = cardModel.HoverTips.Concat(
                    new global::_003C_003Ez__ReadOnlySingleElementList<IHoverTip>(
                        HoverTipFactory.FromCard(cardModel, upgrade: true)
                    )
                );
    ...
    {
        CardModel card = base.Owner.RunState.CreateCard(
            ModelDb.GetById<CardModel>(AncientCard),
            base.Owner
        );
