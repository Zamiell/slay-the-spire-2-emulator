...
public class NCombatVfxSpawner : Control
{
    ...
    public override void _Input(InputEvent inputEvent)
    {
        ...
        if (
            inputEvent is InputEventKey inputEventKey2
            && inputEventKey2.Keycode == Key.W
            && inputEventKey2.Pressed
        )
        {
            TestFunctionB(_shiftPressed);
        }
        if (
            inputEvent is InputEventKey inputEventKey3
            && inputEventKey3.Keycode == Key.E
            && inputEventKey3.Pressed
        )
        {
    ...
    {
        NSweepingBeamVfx child = NSweepingBeamVfx.Create(
            _defectEyePosition.GlobalPosition,
            new Array<Vector2> { _enemyPosition.GlobalPosition }
        );
    ...
    {
        NWormyImpactVfx child = NWormyImpactVfx.Create(
            _playerGroundPosition.GlobalPosition,
    ...
    {
        NItemThrowVfx child = NItemThrowVfx.Create(
            _playerPosition.GlobalPosition + Vector2.Up * 150f,
            _enemyPosition.GlobalPosition,
            null
        );
        _combatVfxContainer.AddChildSafely(child);
        await Cmd.Wait(0.55f);
        NSplashVfx child2 = NSplashVfx.Create(
            _enemyPosition.GlobalPosition,
    ...
    {
        NHyperbeamVfx child = NHyperbeamVfx.Create(
            _defectEyePosition.GlobalPosition,
            _enemyPosition.GlobalPosition
        );
        _combatVfxContainer.AddChildSafely(child);
        await Cmd.Wait(NHyperbeamVfx.hyperbeamAnticipationDuration);
        NHyperbeamImpactVfx child2 = NHyperbeamImpactVfx.Create(
            _defectEyePosition.GlobalPosition,
            _enemyPosition.GlobalPosition
        );
        _combatVfxContainer.AddChildSafely(child2);
    ...
    private async Task PlayingGrandFinale()
    {
        ...
        NGrandFinaleImpactVfx child2 = NGrandFinaleImpactVfx.Create(
            _enemyPosition.GlobalPosition,
            _enemyGroundPosition.GlobalPosition
        );
        _combatVfxContainer.AddChildSafely(child2);
    }
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._backCombatVfxContainer,
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._combatVfxContainer,
                PropertyHint.NodeType,
                "Control",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._playerTopPosition,
                PropertyHint.NodeType,
                "Node2D",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._playerGroundPosition,
                PropertyHint.NodeType,
                "Node2D",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._enemyTopPosition,
                PropertyHint.NodeType,
                "Node2D",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._enemyGroundPosition,
                PropertyHint.NodeType,
                "Node2D",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._defectEyePosition,
                PropertyHint.NodeType,
                "Node2D",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._gaseousScreenVfx,
                PropertyHint.NodeType,
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._backCombatVfxContainer,
            Variant.From(in _backCombatVfxContainer)
        );
        ...
        info.AddProperty(
            PropertyName._playerGroundPosition,
            Variant.From(in _playerGroundPosition)
        );
