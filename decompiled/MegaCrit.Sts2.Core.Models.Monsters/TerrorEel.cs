...
public sealed class TerrorEel : MonsterModel
{
    ...
    private const string _attackMultiSfx =
    ...
    private int ShriekAmount =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 75, 70);
    ...
    public override async Task AfterAddedToRoom()
    {
        ...
        await PowerCmd.Apply<ShriekPower>(
