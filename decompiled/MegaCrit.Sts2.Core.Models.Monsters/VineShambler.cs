...
{
    private const string _vineShamblerVfxPath =
        "vfx/monsters/vine_shambler_vines/vine_shambler_vines_vfx";
    ...
    {
        await DamageCmd
            .Attack(GraspingVinesDamage)
            .FromMonster(this)
            .WithAttackerAnim("Vines", 0.5f)
