...
public sealed class Entomancer : MonsterModel
{
    ...
    private const string _attackRangedSfx =
        "event:/sfx/enemy/enemy_attacks/entomancer/entomancer_attack_ranged";

    public override int MinInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 155, 145);
    ...
    public override async Task AfterAddedToRoom()
    {
        ...
        await PowerCmd.Apply<PersonalHivePower>(
    ...
    protected override MonsterMoveStateMachine GenerateMoveStateMachine()
    {
        ...
        MoveState moveState2 = new MoveState(
            "BEES_MOVE",
            BeesMove,
            new MultiAttackIntent(BeesDamage, BeesRepeat)
        );
        MoveState moveState3 = (MoveState)(
            moveState2.FollowUpState = new MoveState(
                "SPEAR_MOVE",
                SpearMove,
                new SingleAttackIntent(SpearMoveDamage)
            )
        );
    ...
    private async Task SpitMove(IReadOnlyList<Creature> targets)
    {
        ...
        PersonalHivePower personalHivePower = base
            .Creature.Powers.OfType<PersonalHivePower>()
            .First();
