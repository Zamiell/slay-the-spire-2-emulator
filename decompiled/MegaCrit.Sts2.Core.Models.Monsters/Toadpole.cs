...
public sealed class Toadpole : MonsterModel
{
    ...
    private const string _spinAttackSfx =
    ...
    public override int MaxInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 26, 25);
    ...
    public override void SetupSkins(MegaSprite spine, MegaSkeleton skeleton)
    {
        ...
        megaSkin.AddSkin(
            data.FindSkin(MegaCrit.Sts2.Core.Random.Rng.Chaotic.NextItem(_eyeOptions))
        );
        megaSkin.AddSkin(
            data.FindSkin(MegaCrit.Sts2.Core.Random.Rng.Chaotic.NextItem(_patternOptions))
        );
    ...
    protected override MonsterMoveStateMachine GenerateMoveStateMachine()
    {
        ...
        MoveState moveState = new MoveState(
            "SPIKE_SPIT_MOVE",
            SpikeSpitMove,
            new MultiAttackIntent(SpikeSpitDamage, SpikeSpitRepeat)
        );
        MoveState moveState2 = new MoveState(
            "WHIRL_MOVE",
            WhirlMove,
            new SingleAttackIntent(WhirlDamage)
        );
    ...
    private async Task SpikeSpitMove(IReadOnlyList<Creature> targets)
    {
        ...
        await DamageCmd
            .Attack(SpikeSpitDamage)
            .WithHitCount(SpikeSpitRepeat)
            .FromMonster(this)
    ...
    public override CreatureAnimator GenerateAnimator(MegaSprite controller)
    {
        ...
        creatureAnimator.AddAnyState(
            "AttackSingle",
            animState3,
            () => !base.Creature.HasPower<ThornsPower>()
        );
        creatureAnimator.AddAnyState(
            "AttackTriple",
            animState4,
