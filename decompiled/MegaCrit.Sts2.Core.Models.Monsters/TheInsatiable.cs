...
public sealed class TheInsatiable : MonsterModel
{
    ...
    public override int MinInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 341, 321);
    ...
    private int BiteDamage =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.DeadlyEnemies, 31, 28);
    ...
    protected override MonsterMoveStateMachine GenerateMoveStateMachine()
    {
        ...
        MoveState moveState2 = new MoveState(
            "THRASH_MOVE",
            ThrashMove,
            new MultiAttackIntent(ThrashDamage, 2)
        );
