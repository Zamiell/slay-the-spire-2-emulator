...
public sealed class BruteRubyRaider : MonsterModel
{
    ...
    public override int MaxInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 34, 33);
    ...
    protected override MonsterMoveStateMachine GenerateMoveStateMachine()
    {
        ...
        MoveState moveState = new MoveState(
            "BEAT_MOVE",
            BeatMove,
            new SingleAttackIntent(BeatDamage)
        );
        MoveState moveState2 = (MoveState)(
            moveState.FollowUpState = new MoveState("ROAR_MOVE", RoarMove, new BuffIntent())
        );
