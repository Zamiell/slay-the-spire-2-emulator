...
public sealed class PunchConstruct : MonsterModel
{
    ...
    public override int MinInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 60, 55);
    ...
    {
        get { return _startsWithFastPunch; }
        set
        {
            AssertMutable();
    ...
    {
        get { return _startingHpReduction; }
        set
        {
            AssertMutable();
    ...
    protected override MonsterMoveStateMachine GenerateMoveStateMachine()
    {
        ...
        MoveState moveState2 = new MoveState(
            "STRONG_PUNCH_MOVE",
            StrongPunchMove,
            new SingleAttackIntent(StrongPunchDamage)
        );
        MoveState moveState3 = (MoveState)(
            moveState.FollowUpState = new MoveState(
                "FAST_PUNCH_MOVE",
                FastPunchMove,
                new MultiAttackIntent(FastPunchDamage, FastPunchRepeat),
                new DebuffIntent()
            )
        );
