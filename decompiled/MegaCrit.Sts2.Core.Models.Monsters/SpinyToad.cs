...
public sealed class SpinyToad : MonsterModel
{
    ...
    private const string _attackHeavySfx =
    ...
    public override int MinInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 121, 116);

    public override int MaxInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 124, 119);
    ...
    protected override MonsterMoveStateMachine GenerateMoveStateMachine()
    {
        ...
        MoveState moveState2 = new MoveState(
            ...
            ExplosionMove,
            new SingleAttackIntent(ExplosionDamage)
        );
    ...
    private async Task ExplosionMove(IReadOnlyList<Creature> targets)
    {
        IsSpiny = false;
        await DamageCmd
            .Attack(ExplosionDamage)
            .FromMonster(this)
            .WithAttackerAnim("Unspiked", 0.7f)
