...
public sealed class SlumberingBeetle : MonsterModel
{
    ...
    public const string sleepLoop =
        "event:/sfx/enemy/enemy_attacks/slumbering_beetle/slumbering_beetle_sleep_loop";
    ...
    public override int MinInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 89, 86);
    ...
    public override async Task AfterAddedToRoom()
    {
        ...
        await PowerCmd.Apply<SlumberPower>(
            new ThrowingPlayerChoiceContext(),
            base.Creature,
            3m,
            base.Creature,
    ...
    protected override MonsterMoveStateMachine GenerateMoveStateMachine()
    {
        ...
        MoveState moveState2 = new MoveState(
            "ROLL_OUT_MOVE",
            RolloutMove,
            new SingleAttackIntent(RolloutDamage),
            new BuffIntent()
        );
        ConditionalBranchState conditionalBranchState = (ConditionalBranchState)(
            moveState.FollowUpState = new ConditionalBranchState("SNORE_NEXT")
        );
        ...
        if (nCreature != null)
        {
            ...
            if (specialNode != null && nCreature2 != null)
            {
                specialNode.Position =
                    Vector2.Left * (nCreature.GlobalPosition.X - nCreature2.GlobalPosition.X);
            }
        }
        await DamageCmd
            .Attack(RolloutDamage)
            .FromMonster(this)
