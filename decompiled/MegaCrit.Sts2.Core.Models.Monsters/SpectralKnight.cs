...
public sealed class SpectralKnight : MonsterModel
{
    ...
    protected override MonsterMoveStateMachine GenerateMoveStateMachine()
    {
        ...
        MoveState moveState2 = new MoveState(
            "SOUL_SLASH",
            SoulSlashMove,
            new SingleAttackIntent(SoulSlashDamage)
        );
        MoveState moveState3 = new MoveState(
            "SOUL_FLAME",
            SoulFlameMove,
            new MultiAttackIntent(SoulFlameDamage, 3)
        );
    ...
    {
        await DamageCmd
            .Attack(SoulSlashDamage)
            .FromMonster(this)
            .WithAttackerAnim("AttackSword", 0.25f)
            .WithAttackerFx(
                null,
                "event:/sfx/enemy/enemy_attacks/spectral_knight/spectral_knight_soul_slash"
            )
