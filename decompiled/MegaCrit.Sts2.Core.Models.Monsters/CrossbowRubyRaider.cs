...
public sealed class CrossbowRubyRaider : MonsterModel
{
    ...
    private const string _reloadSfx =
    ...
    {
        get { return _isCrossbowReloaded; }
        set
        {
            AssertMutable();
    ...
    protected override MonsterMoveStateMachine GenerateMoveStateMachine()
    {
        ...
        MoveState moveState = new MoveState(
            "FIRE_MOVE",
            FireMove,
            new SingleAttackIntent(FireDamage)
        );
        MoveState moveState2 = (MoveState)(
            moveState.FollowUpState = new MoveState("RELOAD_MOVE", ReloadMove, new DefendIntent())
        );
