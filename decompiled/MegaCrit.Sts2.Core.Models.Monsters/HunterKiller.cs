...
public sealed class HunterKiller : MonsterModel
{
    ...
    public override int MinInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 126, 121);
    ...
    protected override MonsterMoveStateMachine GenerateMoveStateMachine()
    {
        ...
        MoveState moveState3 = new MoveState(
            "PUNCTURE_MOVE",
            PunctureMove,
            new MultiAttackIntent(PunctureDamage, 3)
        );
    ...
    private async Task GoopMove(IReadOnlyList<Creature> targets)
    {
        ...
        await PowerCmd.Apply<TenderPower>(
