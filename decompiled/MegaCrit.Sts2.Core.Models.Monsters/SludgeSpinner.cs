...
public sealed class SludgeSpinner : MonsterModel
{
    ...
    private const string _dashAttackSfx =
    ...
    public override int MinInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 41, 37);

    public override int MaxInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 42, 39);
    ...
    protected override MonsterMoveStateMachine GenerateMoveStateMachine()
    {
        ...
        MoveState moveState = new MoveState(
            "OIL_SPRAY_MOVE",
            OilSprayMove,
            new SingleAttackIntent(OilSprayDamage),
            new DebuffIntent()
        );
        ...
        MoveState moveState3 = new MoveState(
            "RAGE_MOVE",
            RageMove,
            new SingleAttackIntent(RageDamage),
            new BuffIntent()
        );
