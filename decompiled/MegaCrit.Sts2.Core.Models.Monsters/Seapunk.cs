...
public sealed class Seapunk : MonsterModel
{
    ...
    private const string _kickMultiSfx =
    ...
    public override int MaxInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 49, 46);
    ...
    protected override MonsterMoveStateMachine GenerateMoveStateMachine()
    {
        ...
        MoveState moveState = new MoveState(
            "SEA_KICK_MOVE",
            SeaKickMove,
            new SingleAttackIntent(SeaKickDamage)
        );
        MoveState moveState2 = new MoveState(
            "SPINNING_KICK_MOVE",
            SpinningKickMove,
            new MultiAttackIntent(SpinningKickDamage, SpinningKickRepeat)
        );
    ...
    {
        await DamageCmd
            .Attack(SpinningKickDamage)
            .WithHitCount(SpinningKickRepeat)
            .FromMonster(this)
