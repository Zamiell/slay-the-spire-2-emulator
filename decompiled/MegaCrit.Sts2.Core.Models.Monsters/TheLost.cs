...
public sealed class TheLost : MonsterModel
{
    ...
    public override int MinInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 99, 93);
    ...
    {
        await PowerCmd.Apply<PossessStrengthPower>(
    ...
    protected override MonsterMoveStateMachine GenerateMoveStateMachine()
    {
        ...
        MoveState moveState2 = (MoveState)(
            moveState.FollowUpState = new MoveState(
                "EYE_LASERS",
                EyeLasersMove,
                new MultiAttackIntent(EyeLasersDamage, 2)
            )
        );
    ...
    private async Task DebilitatingSmogMove(IReadOnlyList<Creature> targets)
    {
        ...
        await PowerCmd.Apply<StrengthPower>(
            new ThrowingPlayerChoiceContext(),
            targets,
            -DebilitatingSmogStrengthStealAmount,
            base.Creature,
            null
        );
        await PowerCmd.Apply<StrengthPower>(
