...
public sealed class Exoskeleton : MonsterModel
{
    ...
    public override int MinInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 25, 24);
    ...
    protected override MonsterMoveStateMachine GenerateMoveStateMachine()
    {
        ...
        MoveState moveState = new MoveState(
            "SKITTER_MOVE",
            SkitterMove,
            new MultiAttackIntent(SkitterDamage, SkitterRepeats)
        );
        MoveState moveState2 = new MoveState(
            "MANDIBLES_MOVE",
            MandiblesMove,
            new SingleAttackIntent(MandiblesDamage)
        );
