...
public sealed class SkulkingColony : MonsterModel
{
    ...
    private const string _thrustSfx =
    ...
    public override int MinInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 80, 75);
    ...
    protected override MonsterMoveStateMachine GenerateMoveStateMachine()
    {
        ...
        MoveState moveState = new MoveState(
            "ZOOM_MOVE",
            ZoomMove,
            new SingleAttackIntent(ZoomDamage)
        );
        ...
        MoveState moveState4 = new MoveState(
            "PIERCING_STABS_MOVE",
            PiercingStabsMove,
            new MultiAttackIntent(PiercingStabsDamage, PiercingStabsRepeat)
        );
    ...
    {
        await DamageCmd
            .Attack(InertiaDamage)
            .FromMonster(this)
            .WithAttackerAnim("AttackBuff", 0.5f)
            .WithAttackerFx(
                null,
                "event:/sfx/enemy/enemy_attacks/skulking_colony/skulking_colony_thrust"
            )
    ...
    {
        await DamageCmd
            .Attack(PiercingStabsDamage)
            .WithHitCount(PiercingStabsRepeat)
            .OnlyPlayAnimOnce()
            .FromMonster(this)
    ...
    private async Task ZoomMove(IReadOnlyList<Creature> targets)
    {
        await DamageCmd
            .Attack(ZoomDamage)
            .FromMonster(this)
            .WithAttackerAnim("AttackHeavy", 0.25f)
            .WithAttackerFx(
                null,
                "event:/sfx/enemy/enemy_attacks/skulking_colony/skulking_colony_kick"
            )
