...
public sealed class Crusher : MonsterModel
{
    ...
    public override int MinInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 219, 209);
    ...
    private int EnlargingStrikeDamage =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.DeadlyEnemies, 4, 4);
    ...
    protected override MonsterMoveStateMachine GenerateMoveStateMachine()
    {
        ...
        MoveState moveState = new MoveState(
            "THRASH_MOVE",
            ThrashMove,
            new SingleAttackIntent(ThrashDamage)
        );
        MoveState moveState2 = new MoveState(
            "ENLARGING_STRIKE_MOVE",
            EnlargingStrikeMove,
            new SingleAttackIntent(EnlargingStrikeDamage)
        );
        MoveState moveState3 = new MoveState(
            "BUG_STING_MOVE",
            BugStingMove,
            new MultiAttackIntent(BugStingDamage, BugStingTimes),
            new DebuffIntent()
        );
        ...
        MoveState moveState5 = new MoveState(
            "GUARDED_STRIKE_MOVE",
            GuardedStrikeMove,
            new SingleAttackIntent(GuardedStrikeDamage),
            new DefendIntent()
        );
    ...
    private async Task BugStingMove(IReadOnlyList<Creature> targets)
    {
        ...
        await DamageCmd
            .Attack(BugStingDamage)
            .WithHitCount(BugStingTimes)
            .FromMonster(this)
