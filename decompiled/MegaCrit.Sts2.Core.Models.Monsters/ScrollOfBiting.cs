...
public sealed class ScrollOfBiting : MonsterModel
{
    ...
    public const string biteSfx =
        "event:/sfx/enemy/enemy_attacks/scroll_of_biting/scroll_of_biting_bite";

    public const string biteDoubleSfx =
        "event:/sfx/enemy/enemy_attacks/scroll_of_biting/scroll_of_biting_bite_double";

    public const string buffSfx =
        "event:/sfx/enemy/enemy_attacks/scroll_of_biting/scroll_of_biting_buff";

    public override int MinInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 33, 30);

    public override int MaxInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 39, 37);
    ...
    public override void SetupSkins(MegaSprite spine, MegaSkeleton skeleton)
    {
        ...
        megaSkin.AddSkin(
            data.FindSkin(MegaCrit.Sts2.Core.Random.Rng.Chaotic.NextItem(_skinOptions))
        );
    ...
    public override async Task AfterAddedToRoom()
    {
        ...
        await PowerCmd.Apply<PaperCutsPower>(
    ...
    protected override MonsterMoveStateMachine GenerateMoveStateMachine()
    {
        ...
        MoveState moveState2 = new MoveState(
            "CHEW",
            ChewState,
            new MultiAttackIntent(ChewDamage, 2)
        );
