...
public sealed class Rocket : MonsterModel
{
    ...
    public override int MinInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 209, 199);
    ...
    private int PrecisionBeamDamage =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.DeadlyEnemies, 20, 18);

    private int LaserDamage =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.DeadlyEnemies, 35, 31);
    ...
    public override async Task AfterAddedToRoom()
    {
        ...
        await PowerCmd.Apply<SurroundedPower>(
            ...
            base.CombatState.GetOpponentsOf(base.Creature),
            1m,
            base.Creature,
            null
        );
    ...
    private async Task PrecisionBeamMove(IReadOnlyList<Creature> targets)
    {
        ...
        await Background.PlayAttackAnim(
            NKaiserCrabBossBackground.ArmSide.Right,
            "attack_med",
            0.5f
        );
        await DamageCmd
            .Attack(PrecisionBeamDamage)
            .FromMonster(this)
            .WithAttackerFx(null, AttackSfx)
