...
public sealed class TheForgotten : MonsterModel
{
    public override int MinInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 111, 106);
    ...
    private int DreadDamage
    {
        get
        {
            int valueIfAscension = AscensionHelper.GetValueIfAscension(
    ...
    {
        await PowerCmd.Apply<PossessSpeedPower>(
    ...
    protected override MonsterMoveStateMachine GenerateMoveStateMachine()
    {
        ...
        MoveState moveState2 = (MoveState)(
            moveState.FollowUpState = new MoveState(
                "DREAD",
                DreadMove,
                new SingleAttackIntent(() => DreadDamage)
            )
        );
