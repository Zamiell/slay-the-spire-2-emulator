...
public sealed class SlimedBerserker : MonsterModel
{
    ...
    public override int MinInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 281, 261);
    ...
    private int SmotherDamage =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.DeadlyEnemies, 33, 30);
    ...
    protected override MonsterMoveStateMachine GenerateMoveStateMachine()
    {
        ...
        MoveState moveState3 = new MoveState(
            "SMOTHER_MOVE",
            SmotherMove,
            new SingleAttackIntent(SmotherDamage)
        );
        MoveState moveState4 = (MoveState)(
            moveState.FollowUpState = new MoveState(
                "FURIOUS_PUMMELING_MOVE",
                FuriousPummelingMove,
                new MultiAttackIntent(PummelingDamage, 4)
            )
        );
