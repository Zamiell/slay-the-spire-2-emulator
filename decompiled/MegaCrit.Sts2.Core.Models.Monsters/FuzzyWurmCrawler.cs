...
public sealed class FuzzyWurmCrawler : MonsterModel
{
    ...
    public override int MaxInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 59, 57);
    ...
    protected override MonsterMoveStateMachine GenerateMoveStateMachine()
    {
        ...
        MoveState moveState3 = (MoveState)(
            moveState.FollowUpState = new MoveState("INHALE", Inhale, new BuffIntent())
        );
                ...
                if (specialNode != null)
                {
                    specialNode.Position =
                        ...
                        * (
                            ...
                            - NCombatRoom.Instance.GetCreatureNode(targets.First()).GlobalPosition.X
                        );
                }
            }
        }
