...
public sealed class BowlbugRock : MonsterModel
{
    ...
    public override int MinInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 46, 45);

    public override int MaxInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 49, 48);
    ...
    public override async Task AfterAddedToRoom()
    {
        ...
        await PowerCmd.Apply<ImbalancedPower>(
    ...
    protected override MonsterMoveStateMachine GenerateMoveStateMachine()
    {
        ...
        ConditionalBranchState conditionalBranchState = (ConditionalBranchState)(
            moveState.FollowUpState = new ConditionalBranchState("POST_HEADBUTT")
        );
