...
public sealed class Inklet : MonsterModel
{
    ...
    private const string _attackTripleSfx =
    ...
    protected override MonsterMoveStateMachine GenerateMoveStateMachine()
    {
        ...
        RandomBranchState randomBranchState2 = (RandomBranchState)(
            moveState2.FollowUpState = (
                moveState3.FollowUpState = (moveState.FollowUpState = new RandomBranchState("RAND"))
            )
        );
