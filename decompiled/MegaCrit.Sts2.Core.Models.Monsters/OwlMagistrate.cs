...
public sealed class OwlMagistrate : MonsterModel
{
    ...
    private const string _attackPeckSfx =
        "event:/sfx/enemy/enemy_attacks/owl_magistrate/owl_magistrate_attack_peck";

    private const string _attackDiveSfx =
        "event:/sfx/enemy/enemy_attacks/owl_magistrate/owl_magistrate_attack_dive";

    private const string _takeOffSfx =
        "event:/sfx/enemy/enemy_attacks/owl_magistrate/owl_magistrate_take_off";

    private const string _flyLoopSfx =
        "event:/sfx/enemy/enemy_attacks/owl_magistrate/owl_magistrate_fly_loop";

    private bool _isFlying;

    public override int MinInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 247, 231);

    public override int MaxInitialHp => MinInitialHp;

    private int VerdictDamage =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.DeadlyEnemies, 36, 33);
    ...
    private async Task JudicialFlightMove(IReadOnlyList<Creature> targets)
    {
        ...
        await PowerCmd.Apply<SoarPower>(
    ...
    public override CreatureAnimator GenerateAnimator(MegaSprite controller)
    {
        ...
        AnimState animState6 = new AnimState("attack_dive") { BoundsContainer = "IdleBounds" };
