...
public sealed class LouseProgenitor : MonsterModel
{
    ...
    private const string _uncurlSfx =
    ...
    public override int MinInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 138, 134);

    public override int MaxInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 141, 136);
    ...
    private int CurlBlock =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 18, 14);

    public override async Task AfterAddedToRoom()
    {
        await base.AfterAddedToRoom();
        await PowerCmd.Apply<CurlUpPower>(
    ...
    protected override MonsterMoveStateMachine GenerateMoveStateMachine()
    {
        ...
        MoveState moveState = new MoveState(
            "WEB_CANNON_MOVE",
            WebMove,
            new SingleAttackIntent(WebDamage),
            new DebuffIntent()
        );
        MoveState moveState2 = new MoveState(
            "POUNCE_MOVE",
            PounceMove,
            new SingleAttackIntent(PounceDamage)
        );
