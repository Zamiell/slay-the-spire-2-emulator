...
public sealed class CubexConstruct : MonsterModel
{
    ...
    private const string _chargedLoopSfx =
    ...
    public override int MinInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 70, 65);
    ...
    public override void SetupSkins(MegaSprite spine, MegaSkeleton skeleton)
    {
        ...
        megaSkin.AddSkin(
            data.FindSkin(MegaCrit.Sts2.Core.Random.Rng.Chaotic.NextItem(_mossOptions))
        );
    ...
    protected override MonsterMoveStateMachine GenerateMoveStateMachine()
    {
        ...
        MoveState moveState4 = new MoveState(
            "EXPEL_MOVE",
            ExpelBlastMove,
            new MultiAttackIntent(ExpelDamage, 2)
        );
    ...
    public override CreatureAnimator GenerateAnimator(MegaSprite controller)
    {
        ...
        AnimState animState5 = new AnimState("charge_start") { BoundsContainer = "ChargingBounds" };
