...
public sealed class LivingShield : MonsterModel
{
    public override int MinInitialHp =>
        AscensionHelper.GetValueIfAscension(AscensionLevel.ToughEnemies, 65, 55);
    ...
    public override async Task AfterAddedToRoom()
    {
        ...
        await PowerCmd.Apply<RampartPower>(
    ...
    protected override MonsterMoveStateMachine GenerateMoveStateMachine()
    {
        ...
        MoveState moveState = new MoveState(
            "SHIELD_SLAM_MOVE",
            ShieldSlamMove,
            new SingleAttackIntent(ShieldSlamDamage)
        );
    ...
    {
        return base
            .Creature.CombatState.GetTeammatesOf(base.Creature)
