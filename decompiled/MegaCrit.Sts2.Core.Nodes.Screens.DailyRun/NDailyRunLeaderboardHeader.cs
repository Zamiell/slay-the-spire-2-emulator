...
public class NDailyRunLeaderboardHeader : Control
{
    ...
    private static readonly string _scenePath = SceneHelper.GetScenePath(
        "screens/daily_run/daily_run_leaderboard_header"
    );
    ...
    public static NDailyRunLeaderboardHeader? Create()
    {
        ...
        return PreloadManager
            ...
            .Instantiate<NDailyRunLeaderboardHeader>(PackedScene.GenEditState.Disabled);
    }

    public override void _Ready()
    {
        _name = GetNode<MegaLabel>("%Name");
        _name.SetTextAutoSize(
            new LocString("main_menu_ui", "LEADERBOARDS.nameHeader").GetRawText()
        );
    }
