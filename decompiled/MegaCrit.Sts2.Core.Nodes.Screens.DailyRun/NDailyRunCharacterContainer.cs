...
public class NDailyRunCharacterContainer : Control
{
    ...
    )
    {
        ...
        _playerNameLabel.SetTextAutoSize(
            PlatformUtil.GetPlayerNameRaw(netService.Platform, playerId)
        );
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._characterIconContainer,
                PropertyHint.None,
                "",
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._characterNameLabel,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._ascensionNumberLabel,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._characterIconContainer,
            Variant.From(in _characterIconContainer)
        );
        ...
        info.AddProperty(
            PropertyName._ascensionNumberLabel,
            Variant.From(in _ascensionNumberLabel)
        );
