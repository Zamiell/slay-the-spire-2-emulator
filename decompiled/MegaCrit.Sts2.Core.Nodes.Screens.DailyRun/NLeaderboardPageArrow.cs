...
public class NLeaderboardPageArrow : NButton
{
    public new class MethodName : NButton.MethodName
    {
        ...
        public static new readonly StringName GetControllerIconNode = "GetControllerIconNode";
    ...
    public override void _Ready()
    {
        _hotkeys = (
            (!_isLeftArrow)
                ? new string[1] { MegaInput.viewDiscardPile }
                : new string[1] { MegaInput.viewDrawPile }
        );
        ConnectSignals();
    ...
    protected override void OnPress()
    {
        ...
        _tween = CreateTween().SetParallel();
        _tween
            .TweenProperty(_image, "scale", _baseScale * 0.9f, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _tween
            .TweenMethod(
