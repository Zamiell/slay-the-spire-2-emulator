...
public class PlayerMapPointHistoryEntry : IPacketSerializable
{
    ...
    public List<AncientChoiceHistoryEntry> AncientChoices { get; set; } =
        new List<AncientChoiceHistoryEntry>();
    ...
    public List<EventOptionHistoryEntry> EventChoices { get; set; } =
        new List<EventOptionHistoryEntry>();
    ...
    {
        return (from o in AncientChoices where !o.WasChosen select o.Title).ToList();
    }
