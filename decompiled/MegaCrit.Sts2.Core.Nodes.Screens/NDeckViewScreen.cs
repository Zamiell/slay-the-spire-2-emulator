...
public class NDeckViewScreen : NCardsViewScreen
{
    public new class MethodName : NCardsViewScreen.MethodName
    {
        ...
        public static new readonly StringName AfterCapstoneClosed = "AfterCapstoneClosed";
    ...
    {
        public static new readonly StringName ScreenType = "ScreenType";
    ...
    public static NDeckViewScreen? ShowScreen(Player player)
    {
        ...
        NDeckViewScreen nDeckViewScreen = PreloadManager
    ...
    public override void _Ready()
    {
        ...
        _obtainedSorter.Connect(
            NClickableControl.SignalName.Released,
            Callable.From<NButton>(OnObtainedSort)
        );
        _typeSorter.Connect(
            NClickableControl.SignalName.Released,
        ...
        for (int i = 0; i < array.Length; i++)
        {
            ...
            array[i].FocusNeighborBottom = (
                (_grid.DefaultFocusedControl != null)
                    ? _grid.DefaultFocusedControl.GetPath()
                    : array[i].GetPath()
            );
            array[i].FocusNeighborLeft = ((i > 0) ? array[i - 1].GetPath() : array[i].GetPath());
            array[i].FocusNeighborRight = (
                (i < array.Length - 1) ? array[i + 1].GetPath() : array[i].GetPath()
            );
        }
    }
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnPileContentsChanged,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
