...
public class NInspectCardScreen : Control, IScreenContext
{
    ...
    public static NInspectCardScreen? Create()
    {
        ...
        return PreloadManager
            ...
            .Instantiate<NInspectCardScreen>(PackedScene.GenEditState.Disabled);
    }
    ...
    public override void _Ready()
    {
        ...
        _upgradeTickbox.Connect(
            NTickbox.SignalName.Toggled,
            Callable.From<NTickbox>(ToggleShowUpgrade)
        );
        GetNode<MegaLabel>("%ShowUpgradeLabel")
    ...
    public void Open(List<CardModel> cards, int index, bool viewAllUpgraded = false)
    {
        ...
        _openTween
            .TweenProperty(this, "modulate:a", 1f, 0.25)
        ...
        _cardTween
            .TweenProperty(_card, "scale", Vector2.One * 2f, 0.15)
            .SetEase(Tween.EaseType.Out)
    ...
    private void OnRightButtonReleased()
    {
        if (_rightButton.Visible)
        {
            ...
            _openTween = CreateTween().SetParallel();
            _openTween
                .TweenProperty(_card, "position", _cardPosition, 0.25)
                .SetEase(Tween.EaseType.Out)
                .SetTrans(Tween.TransitionType.Expo)
    ...
    private void UpdateCardDisplay()
    {
        ...
        NHoverTipSet.Clear();
        NHoverTipSet
            .CreateAndShow(this, cardModel2.HoverTips)
    ...
    private void SetCard(int index)
    {
        ...
        _upgradeTickbox.MouseFilter = (MouseFilterEnum)(
            (_cards[_index].MaxUpgradeLevel > 0) ? 0 : 2
        );
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnRightButtonReleased,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnLeftButtonReleased,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
