...
public class NSimpleCardsViewScreen : NCardsViewScreen
{
    public new class MethodName : NCardsViewScreen.MethodName
    {
        ...
        public static new readonly StringName OnInspectCardHidden = "OnInspectCardHidden";

        public static new readonly StringName AfterCapstoneOpened = "AfterCapstoneOpened";
    }
    ...
    protected override void ConnectSignals()
    {
        ...
        _confirmButton.Connect(
            ...
            Callable.From<NButton>(base.OnReturnButtonPressed)
        );
    ...
    public static NCardsViewScreen? ShowScreen(List<CardPileAddResult> cards, LocString infoText)
    {
        ...
        NSimpleCardsViewScreen nSimpleCardsViewScreen = PreloadManager
            .Cache.GetScene(ScenePath)
            .Instantiate<NSimpleCardsViewScreen>(PackedScene.GenEditState.Disabled);
    ...
    private async Task FlashRelicsOnModifiedCards()
    {
        ...
        foreach (CardPileAddResult result in _cardResults)
        {
            NGridCardHolder nGridCardHolder = _grid.CurrentlyDisplayedCardHolders.FirstOrDefault(
                (NGridCardHolder h) => h.CardModel == result.cardAdded
            );
            if (
                nGridCardHolder == null
                || result.modifyingModels == null
                || result.modifyingModels.Count == 0
            )
            {
                continue;
            }
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnInspectCardHidden,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
