...
public class NRunSubmenuStack : NSubmenuStack
{
    ...
    public override NSubmenu GetSubmenuType(Type type)
    {
        ...
        if (type == typeof(NRunHistory))
        {
            ...
            {
                _runHistoryScreen = _runHistoryScreenScene.Instantiate<NRunHistory>(
        ...
        if (type == typeof(NStatsScreen))
        {
            ...
            {
                _statsScreen = _statsScreenScene.Instantiate<NStatsScreen>(
                    PackedScene.GenEditState.Disabled
                );
        ...
        if (type == typeof(NPauseMenu))
        {
            if (_pauseMenu == null)
            {
                _pauseMenu = _pauseMenuScene.Instantiate<NPauseMenu>(
                    PackedScene.GenEditState.Disabled
                );
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._statsScreenScene,
                PropertyHint.ResourceType,
                "PackedScene",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._runHistoryScreenScene,
                PropertyHint.ResourceType,
                "PackedScene",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._runHistoryScreen,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._runHistoryScreenScene,
            Variant.From(in _runHistoryScreenScene)
        );
