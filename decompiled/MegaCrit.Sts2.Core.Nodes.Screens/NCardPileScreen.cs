...
public class NCardPileScreen : Control, ICapstoneScreen, IScreenContext
{
    ...
    public override void _Ready()
    {
        ...
        switch (Pile.Type)
        {
            case PileType.Draw:
                _bottomLabel.Text =
                    "[center]" + new LocString("gameplay_ui", "DRAW_PILE_INFO").GetFormattedText();
                break;
            case PileType.Discard:
                _bottomLabel.Text =
                    "[center]"
                    + new LocString("gameplay_ui", "DISCARD_PILE_INFO").GetFormattedText();
                break;
            case PileType.Exhaust:
                _bottomLabel.Text =
                    "[center]"
                    + new LocString("gameplay_ui", "EXHAUST_PILE_INFO").GetFormattedText();
                break;
            default:
        ...
        _backButton.Connect(
            ...
            Callable.From<NButton>(OnReturnButtonPressed)
        );
        _backButton.Enable();
        ...
        _currentTween
            .TweenProperty(_background, "modulate", StsColors.screenBackdrop, 1.0)
    ...
    public static NCardPileScreen ShowScreen(CardPile pile, string[] closeHotkeys)
    {
        ...
        NCardPileScreen nCardPileScreen = PreloadManager
            .Cache.GetScene(ScenePath)
            .Instantiate<NCardPileScreen>(PackedScene.GenEditState.Disabled);
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnReturnButtonPressed,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
