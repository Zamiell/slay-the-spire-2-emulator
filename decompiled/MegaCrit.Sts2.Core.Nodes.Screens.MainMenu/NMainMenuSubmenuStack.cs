...
public class NMainMenuSubmenuStack : NSubmenuStack
{
    ...
    public override NSubmenu GetSubmenuType(Type type)
    {
        ...
        if (type == typeof(NCharacterSelectScreen))
        {
            ...
            {
                _characterSelectSubmenu =
                    _characterSelectScreenScene.Instantiate<NCharacterSelectScreen>(
        ...
        if (type == typeof(NSettingsScreen))
        {
            ...
            {
                _settingsScreen = _settingsScreenScene.Instantiate<NSettingsScreen>(
                    PackedScene.GenEditState.Disabled
                );
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._settingsScreenScene,
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._characterSelectScreenScene,
                PropertyHint.ResourceType,
                "PackedScene",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._singleplayerSubmenu,
                PropertyHint.None,
                "",
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._multiplayerSubmenu,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._multiplayerHostSubmenu,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._joinFriendSubmenu,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._characterSelectSubmenu,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._loadMultiplayerSubmenu,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._compendiumSubmenu,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._relicCollectionSubmenu,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._potionLabSubmenu,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._cardLibrarySubmenu,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._runHistorySubmenu,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._customRunLoadScreen,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._characterSelectScreenScene,
            Variant.From(in _characterSelectScreenScene)
        );
        ...
        info.AddProperty(
            PropertyName._multiplayerHostSubmenu,
            Variant.From(in _multiplayerHostSubmenu)
        );
        info.AddProperty(PropertyName._joinFriendSubmenu, Variant.From(in _joinFriendSubmenu));
        info.AddProperty(
            PropertyName._characterSelectSubmenu,
            Variant.From(in _characterSelectSubmenu)
        );
        info.AddProperty(
            PropertyName._loadMultiplayerSubmenu,
            Variant.From(in _loadMultiplayerSubmenu)
        );
        ...
        info.AddProperty(
            PropertyName._relicCollectionSubmenu,
            Variant.From(in _relicCollectionSubmenu)
        );
