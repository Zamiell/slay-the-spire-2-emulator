...
public class NMainMenuTextButton : NButton
{
    ...
    private void AnimUnhover()
    {
        ...
        if (label != null)
        {
            ...
            _tween = CreateTween();
            _tween
                .TweenProperty(label, "scale", Vector2.One, 0.5)
    ...
    private void AnimPressDown()
    {
        ...
        if (label != null)
        {
            ...
            _tween = CreateTween();
            _tween
                .TweenProperty(label, "scale", _downScale, 0.2)
                .SetTrans(Tween.TransitionType.Cubic)
                .SetEase(Tween.EaseType.Out);
            _tween
                .TweenProperty(label, "self_modulate", _downColor, 0.2)
                .SetTrans(Tween.TransitionType.Cubic)
                .SetEase(Tween.EaseType.Out);
        }
    }
    ...
    private void AnimRelease()
    {
        ...
        if (label != null)
        {
            _tween = CreateTween();
            _tween
                .TweenProperty(label, "scale", base.IsFocused ? _hoverScale : Vector2.One, 0.2)
                .SetTrans(Tween.TransitionType.Cubic)
                .SetEase(Tween.EaseType.Out);
            _tween
                .TweenProperty(label, "self_modulate", _defaultColor, 0.2)
                .SetTrans(Tween.TransitionType.Cubic)
                .SetEase(Tween.EaseType.Out);
        }
    }
