...
public class NPatchNotesScreen : Control, IScreenContext
{
    ...
    {
        _cachedScene = ResourceLoader.Load<PackedScene>(
            "res://scenes/screens/patch_screen_contents.tscn",
            null,
    ...
    public void Open()
    {
        ...
        {
            _patchNotePaths = (
                from fileName in DirAccess.GetFilesAt("res://localization/eng/patch_notes")
                select "res://localization/eng/patch_notes/" + fileName
            )
                .Reverse()
                .ToList();
        }
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.CreateNewPatchEntry,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.GetFileNameFromPath,
                new PropertyInfo(
                    Variant.Type.String,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.RemoveFileExtension,
                new PropertyInfo(
                    Variant.Type.String,
                    "",
                    PropertyHint.None,
    ...
    )
    {
        ...
        if (method == MethodName.ReadPatchNoteFile && args.Count == 1)
        {
            ret = VariantUtils.CreateFrom<string>(
                ReadPatchNoteFile(VariantUtils.ConvertTo<string>(in args[0]))
            );
            return true;
        }
        ...
        {
            ret = VariantUtils.CreateFrom<string>(
                GetFileNameFromPath(VariantUtils.ConvertTo<string>(in args[0]))
            );
            return true;
        }
        ...
        {
            ret = VariantUtils.CreateFrom<string>(
                RemoveFileExtension(VariantUtils.ConvertTo<string>(in args[0]))
            );
            return true;
        }
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._patchNotesToggle,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Int,
                PropertyName._currentScrollLine,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
