...
public class NSingleplayerSubmenu : NSubmenu
{
    ...
    public static NSingleplayerSubmenu? Create()
    {
        ...
        return PreloadManager
            ...
            .Instantiate<NSingleplayerSubmenu>(PackedScene.GenEditState.Disabled);
    }
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.OpenCharacterSelect,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
