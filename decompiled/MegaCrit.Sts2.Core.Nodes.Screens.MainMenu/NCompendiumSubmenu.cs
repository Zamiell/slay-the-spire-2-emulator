...
public class NCompendiumSubmenu : NSubmenu
{
    ...
    public static NCompendiumSubmenu? Create()
    {
        ...
        return PreloadManager
            ...
            .Instantiate<NCompendiumSubmenu>(PackedScene.GenEditState.Disabled);
    }
    ...
    public override void _Ready()
    {
        ...
        _cardLibraryButton.Connect(
            NClickableControl.SignalName.Released,
            Callable.From<NButton>(OpenCardLibrary)
        );
        ...
        _relicCollectionButton.Connect(
            NClickableControl.SignalName.Released,
            Callable.From<NButton>(OpenRelicCollection)
        );
        ...
        _potionLabButton.Connect(
            NClickableControl.SignalName.Released,
            Callable.From<NButton>(OpenPotionLab)
        );
        _potionLabButton.SetIconAndLocalization("COMPENDIUM_POTION_LAB");
        _bestiaryButton = GetNode<NShortSubmenuButton>("%BestiaryButton");
        _bestiaryButton.Connect(
            NClickableControl.SignalName.Released,
            Callable.From((Action<NButton>)OpenBestiary)
        );
        ...
        for (int i = 0; i < list2.Count; i++)
        {
            ...
            list2[i].FocusNeighborRight = (
                (i < list2.Count - 1) ? list2[i + 1].GetPath() : list2[i].GetPath()
            );
        }
        for (int j = 0; j < list4.Count; j++)
        {
            ...
            list4[j].FocusNeighborRight = (
                (j < list4.Count - 1) ? list4[j + 1].GetPath() : list4[j].GetPath()
            );
        }
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.OpenRelicCollection,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._cardLibraryButton,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._relicCollectionButton,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._leaderboardsButton,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._statisticsButton,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._runHistoryButton,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._relicCollectionButton,
            Variant.From(in _relicCollectionButton)
        );
