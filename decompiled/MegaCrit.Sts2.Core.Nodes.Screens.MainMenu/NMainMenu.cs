...
public class NMainMenu : Control, IScreenContext
{
    ...
    {
        NMainMenu nMainMenu = PreloadManager
            .Cache.GetScene("res://scenes/screens/main_menu.tscn")
    ...
    public override void _Ready()
    {
        ...
        _continueButton.Connect(
            ...
            Callable.From<NButton>(OnContinueButtonPressed)
        );
        ...
        _abandonRunButton.Connect(
            NClickableControl.SignalName.Released,
            Callable.From<NButton>(OnAbandonRunButtonPressed)
        );
        _abandonRunButton.SetLocalization("ABANDON_RUN");
        _singleplayerButton = GetNode<NMainMenuTextButton>(
            "MainMenuTextButtons/SingleplayerButton"
        );
        _singleplayerButton.Connect(
            NClickableControl.SignalName.Released,
            Callable.From<NButton>(SingleplayerButtonPressed)
        );
        ...
        _multiplayerButton.Connect(
            NClickableControl.SignalName.Released,
            Callable.From((Action<NButton>)OpenMultiplayerSubmenu)
        );
        ...
        _compendiumButton.Connect(
            NClickableControl.SignalName.Released,
            Callable.From((Action<NButton>)OpenCompendiumSubmenu)
        );
        ...
        _timelineButton.Connect(
            NClickableControl.SignalName.Released,
            Callable.From<NButton>(OpenTimelineScreen)
        );
        ...
        _settingsButton.Connect(
            NClickableControl.SignalName.Released,
            Callable.From((Action<NButton>)OpenSettingsMenu)
        );
        ...
        _patchNotesButtonNode.Connect(
            NClickableControl.SignalName.Released,
            Callable.From<NButton>(OpenPatchNotes)
        );
        ...
        SubmenuStack.Connect(
            NSubmenuStack.SignalName.StackModified,
            Callable.From(OnSubmenuStackChanged)
        );
    ...
    {
        foreach (
            NMainMenuTextButton item in GetNode<Control>("%MainMenuTextButtons")
                .GetChildren()
        ...
        )
        {
            item.Connect(
                ...
                Callable.From<NMainMenuTextButton>(MainMenuButtonUnfocused)
            );
            item.Connect(
                NClickableControl.SignalName.Focused,
                Callable.From(
                    delegate(NMainMenuTextButton b)
                    {
                        Callable
                            .From(
                                delegate
    ...
    private void MainMenuButtonFocused(NMainMenuTextButton button)
    {
        ...
        _reticleTween
            .TweenProperty(_buttonReticleLeft, "global_position:x", num3 - 28f, 0.25)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Back)
            .From(num3);
        _reticleTween
            .TweenProperty(_buttonReticleLeft, "modulate", StsColors.gold, 0.05)
            .From(StsColors.transparentWhite);
        _reticleTween
            .TweenProperty(_buttonReticleRight, "global_position:x", num4 + 28f, 0.25)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Back)
            .From(num4);
        _reticleTween
            .TweenProperty(_buttonReticleRight, "modulate", StsColors.gold, 0.05)
            .From(StsColors.transparentWhite);
    }
    ...
    private void MainMenuButtonUnfocused(NMainMenuTextButton obj)
    {
        _reticleTween?.Kill();
        _reticleTween = CreateTween().SetParallel();
        _reticleTween.TweenProperty(
            _buttonReticleLeft,
            "modulate",
            StsColors.transparentWhite,
            0.25
        );
        _reticleTween.TweenProperty(
            _buttonReticleRight,
    ...
    public void EnableBackstop()
    {
        ...
        _backstopTween.TweenMethod(
            Callable.From<float>(UpdateShaderLod),
            _blur.GetShaderParameter(_lod),
            3f,
            0.25
        );
        _backstopTween.TweenMethod(
            Callable.From<float>(UpdateShaderMix),
            _blur.GetShaderParameter(_mixPercentage),
            0.7f,
            0.25
        );
    }
    ...
    private void UpdateTimelineButtonBehavior()
    {
        if (
            ...
            && SaveManager.Instance.GetDiscoveredEpochCount() > 0
        ...
        )
        {
            ...
            SaveManager.Instance.Progress.Epochs.Count > 1
            && SaveManager.Instance.IsEpochRevealed<NeowEpoch>()
        )
        {
            _timelineButton.Visible = true;
    ...
    private void OnContinueButtonPressed(NButton _)
    {
        if (
            _readRunSaveResult == null
            || !_readRunSaveResult.Success
            || _readRunSaveResult.SaveData == null
        )
        {
    ...
    public void AbandonRun()
    {
        ...
        if (_readRunSaveResult.Success && _readRunSaveResult.SaveData != null)
        {
            try
            {
                ...
                {
                    int score = ScoreUtility.CalculateDailyScore(
                        saveData,
                        saveData.Players.First().NetId,
                        isVictory: false
                    );
                    TaskHelper.RunSafely(
                        DailyRunUtility.UploadScore(
                            saveData.DailyTime.Value,
                            score,
                            saveData.Players
                        )
                    );
        ...
        switch (value)
        {
            ...
            case "load":
            {
                PlatformType platformType = (
                    SteamInitializer.Initialized ? PlatformType.Steam : PlatformType.None
                );
            ...
            default:
                Log.Error(
                    "fastmp command line argument passed with invalid value: "
                        + value
                        + ". Expected host, load, or join"
                );
                break;
        }
    }
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.ConnectMainMenuTextButtonFocusLogic,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.MainMenuButtonFocused,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.MainMenuButtonUnfocused,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.DisableBackstopInstantly,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.EnableBackstopInstantly,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.UpdateTimelineButtonBehavior,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnSubmenuStackChanged,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnContinueButtonPressed,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.DisplayLoadSaveError,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnAbandonRunButtonPressed,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.SingleplayerButtonPressed,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OpenSingleplayerSubmenu,
                new PropertyInfo(
                    Variant.Type.Object,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OpenMultiplayerSubmenu,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OpenCompendiumSubmenu,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.CheckCommandLineArgs,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NMainMenu>(
                Create(VariantUtils.ConvertTo<bool>(in args[0]))
            );
            return true;
        }
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._abandonRunButton,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._singleplayerButton,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._compendiumButton,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._multiplayerButton,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._buttonReticleLeft,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._buttonReticleRight,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._patchNotesButtonNode,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._openProfileScreenButton,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._timelineNotificationDot,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName.PatchNotesScreen,
            Variant.From<NPatchNotesScreen>(PatchNotesScreen)
        );
        info.AddProperty(PropertyName.BlurBackstop, Variant.From<Control>(BlurBackstop));
        info.AddProperty(
            PropertyName.SubmenuStack,
            Variant.From<NMainMenuSubmenuStack>(SubmenuStack)
        );
        ...
        info.AddProperty(
            PropertyName._patchNotesButtonNode,
            Variant.From(in _patchNotesButtonNode)
        );
        info.AddProperty(
            PropertyName._openProfileScreenButton,
            Variant.From(in _openProfileScreenButton)
        );
        ...
        info.AddProperty(
            PropertyName._timelineNotificationDot,
            Variant.From(in _timelineNotificationDot)
        );
