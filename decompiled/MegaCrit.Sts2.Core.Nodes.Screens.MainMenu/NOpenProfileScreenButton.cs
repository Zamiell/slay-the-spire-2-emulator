...
public class NOpenProfileScreenButton : NButton
{
    ...
    private readonly LocString _titleLoc = new LocString(
        "main_menu_ui",
        "OPEN_PROFILE_SCREEN.title"
    );

    private static readonly LocString _descriptionLoc = new LocString(
        "main_menu_ui",
        "OPEN_PROFILE_SCREEN.description"
    );
    ...
    public override void _EnterTree()
    {
        ...
        if (NControllerManager.Instance != null)
        {
            NControllerManager.Instance.Connect(
                ...
                Callable.From(UpdateDescription)
            );
            NControllerManager.Instance.Connect(
    ...
    protected override void OnUnfocus()
    {
        ...
        _tween = CreateTween();
        _tween
            .TweenProperty(this, "scale", Vector2.One * 1f, 0.3)
