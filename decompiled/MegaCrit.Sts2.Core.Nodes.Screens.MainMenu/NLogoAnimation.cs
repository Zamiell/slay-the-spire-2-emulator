...
public class NLogoAnimation : Control, IScreenContext
{
    ...
    public static string[] AssetPaths =>
        new string[1] { "res://scenes/screens/main_menu/logo_animation.tscn" };
    ...
    public static NLogoAnimation Create()
    {
        return PreloadManager
            .Cache.GetScene("res://scenes/screens/main_menu/logo_animation.tscn")
            .Instantiate<NLogoAnimation>(PackedScene.GenEditState.Disabled);
    }
    ...
    public override void _Ready()
    {
        ...
        if (skeleton != null)
        {
            ...
            float num = Math.Min(
                base.Size.X * 0.33f / bounds.Size.X,
                base.Size.Y * 0.33f / bounds.Size.Y
            );
    ...
    public async Task PlayAnimation(CancellationToken token)
    {
        ...
        _tween
            .TweenProperty(_logoSpineNode, "position:y", _logoSpineNode.Position.Y, 0.5)
            .From(_logoSpineNode.Position.Y - 800f)
        ...
        while (true)
        {
            ...
            if (token.IsCancellationRequested)
            {
                ...
                _tween = CreateTween().SetParallel();
                _tween
                    .TweenProperty(_logoContainer, "modulate", StsColors.transparentWhite, 0.25)
                    .SetEase(Tween.EaseType.Out)
        ...
        if (!_cancelled)
        {
            ...
            _tween = CreateTween();
            _tween
                .TweenProperty(_bg, "modulate", _logoBgColor, 2.0)
                .SetEase(Tween.EaseType.Out)
