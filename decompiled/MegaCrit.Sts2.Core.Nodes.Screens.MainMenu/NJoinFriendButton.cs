...
public class NJoinFriendButton : NButton
{
    ...
    public static readonly string scenePath = SceneHelper.GetScenePath(
        "ui/multiplayer/join_friend_button"
    );
    ...
    public static NJoinFriendButton Create(ulong playerId)
    {
        ...
        NJoinFriendButton nJoinFriendButton = scene.Instantiate<NJoinFriendButton>(
    ...
    public override void _Ready()
    {
        ...
        node.Text =
            "[center]"
            + PlatformUtil.GetPlayerName(PlatformUtil.PrimaryPlatform, PlayerId)
            + "[/center]";
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NJoinFriendButton>(
