...
public class NSubmenuButton : NButton
{
    ...
    public void RefreshLabels()
    {
        ...
        else
        {
            ...
            {
                Log.Warn(
                    $"Submenu button {base.Name} tried to find locked description for {_locKeyPrefix} but couldn't"
                );
                locString2 = new LocString("main_menu_ui", _locKeyPrefix + ".description");
            }
        }
    ...
    protected override void OnUnfocus()
    {
        ...
        _scaleTween
            .TweenMethod(Callable.From<float>(UpdateShaderParam), 1f, _defaultV, 1.0)
            .SetEase(Tween.EaseType.Out)
