...
public class NEarlyAccessDisclaimer : Control, IScreenContext
{
    ...
    {
        NEarlyAccessDisclaimer nEarlyAccessDisclaimer = ResourceLoader
            .Load<PackedScene>(
                "res://scenes/screens/main_menu/early_access_disclaimer.tscn",
                null,
                ResourceLoader.CacheMode.Reuse
            )
            .Instantiate<NEarlyAccessDisclaimer>(PackedScene.GenEditState.Disabled);
    ...
    public override void _Ready()
    {
        string formattedText = new LocString(
            "main_menu_ui",
            "EARLY_ACCESS_DISCLAIMER.header"
        ).GetFormattedText();
        ...
        NControllerManager.Instance.Connect(
            ...
            Callable.From(UpdateEaDisclaimerDescription)
        );
        NControllerManager.Instance.Connect(
    ...
    public async Task CloseScreen()
    {
        ...
        _tween
            .TweenProperty(_image, "position:y", _image.Position.Y - 1000f, 0.5)
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.UpdateEaDisclaimerDescription,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
