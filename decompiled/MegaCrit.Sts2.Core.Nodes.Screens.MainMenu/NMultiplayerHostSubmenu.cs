...
public class NMultiplayerHostSubmenu : NSubmenu
{
    ...
    private static readonly string _scenePath = SceneHelper.GetScenePath(
        "screens/multiplayer_host_submenu"
    );
    ...
    public static NMultiplayerHostSubmenu? Create()
    {
        ...
        return PreloadManager
            ...
            .Instantiate<NMultiplayerHostSubmenu>(PackedScene.GenEditState.Disabled);
    }
    ...
    )
    {
        ...
        try
        {
            ...
            if (!netErrorInfo.HasValue)
            {
                switch (gameMode)
                {
                    ...
                    {
                        NCharacterSelectScreen submenuType3 =
                            stack.GetSubmenuType<NCharacterSelectScreen>();
        ...
        {
            NErrorPopup nErrorPopup2 = NErrorPopup.Create(
