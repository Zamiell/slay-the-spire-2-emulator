...
public class NMultiplayerSubmenu : NSubmenu
{
    ...
    public static NMultiplayerSubmenu? Create()
    {
        ...
        return PreloadManager
            ...
            .Instantiate<NMultiplayerSubmenu>(PackedScene.GenEditState.Disabled);
    }
    ...
    private void OnHostPressed(NButton _)
    {
        ...
        {
            TaskHelper.RunSafely(
                NMultiplayerHostSubmenu.StartHostAsync(GameMode.Standard, _loadingOverlay, _stack)
            );
        }
    }
    ...
    {
        NMultiplayerHostSubmenu nMultiplayerHostSubmenu =
            _stack.PushSubmenuType<NMultiplayerHostSubmenu>();
        ...
        try
        {
            ...
            if (!netErrorInfo.HasValue)
            {
                switch (run.GameMode)
                {
                    case GameMode.Daily:
                    {
                        NDailyRunLoadScreen submenuType3 =
                            _stack.GetSubmenuType<NDailyRunLoadScreen>();
                    ...
                    {
                        NCustomRunLoadScreen submenuType2 =
                    ...
                    default:
                    {
                        NMultiplayerLoadGameScreen submenuType =
    ...
    protected override void OnSubmenuShown()
    {
        base.OnSubmenuShown();
        if (
            !SaveManager.Instance.SeenFtue("multiplayer_warning")
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.OpenJoinFriendsScreen,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnJoinFriendsPressed,
                new PropertyInfo(
                    Variant.Type.Object,
                    "",
                    PropertyHint.None,
