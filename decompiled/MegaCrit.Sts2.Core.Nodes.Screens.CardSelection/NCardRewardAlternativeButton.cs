...
public class NCardRewardAlternativeButton : NButton
{
    ...
    private static string ScenePath =>
        SceneHelper.GetScenePath("/ui/card_reward_alternative_button");
    ...
    {
        NCardRewardAlternativeButton nCardRewardAlternativeButton = PreloadManager
            .Cache.GetScene(ScenePath)
            .Instantiate<NCardRewardAlternativeButton>(PackedScene.GenEditState.Disabled);
    ...
    public void AnimateIn()
    {
        ...
        _animInTween
            .TweenProperty(this, "modulate:a", 1f, 0.4)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo)
            .From(0f);
        _animInTween
            .TweenProperty(this, "position", _showPosition, 0.4)
            .SetEase(Tween.EaseType.Out)
    ...
    protected override void OnPress()
    {
        ...
        _currentTween
            ...
            .SetTrans(Tween.TransitionType.Expo);
        _currentTween
            .TweenProperty(this, "scale", _downScale, 0.20000000298023224)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
    }
    ...
    protected override void OnUnfocus()
    {
        ...
        _currentTween
            ...
            .SetTrans(Tween.TransitionType.Expo);
        _currentTween
            .TweenProperty(this, "scale", _defaultScale, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
    }
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NCardRewardAlternativeButton>(
                Create(
