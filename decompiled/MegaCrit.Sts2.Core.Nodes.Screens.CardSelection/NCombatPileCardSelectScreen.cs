...
public sealed class NCombatPileCardSelectScreen : NCardGridSelectionScreen
{
    public new class MethodName : NCardGridSelectionScreen.MethodName
    {
        ...
        public static new readonly StringName ConnectSignalsAndInitGrid =
            "ConnectSignalsAndInitGrid";

        public static new readonly StringName AfterOverlayOpened = "AfterOverlayOpened";
    ...
    private static string ScenePath =>
        SceneHelper.GetScenePath("screens/card_selection/combat_pile_card_select_screen");
    ...
    protected override IEnumerable<Control> PeekButtonTargets =>
        new global::_003C_003Ez__ReadOnlySingleElementList<Control>(_bottomTextContainer);
    ...
    {
        NCombatPileCardSelectScreen nCombatPileCardSelectScreen = PreloadManager
            .Cache.GetScene(ScenePath)
            .Instantiate<NCombatPileCardSelectScreen>(PackedScene.GenEditState.Disabled);
    ...
    private async Task FlashRelicsOnModifiedCards()
    {
        ...
        {
            NGridCardHolder nGridCardHolder = _grid.CurrentlyDisplayedCardHolders.FirstOrDefault(
                (NGridCardHolder h) => h.CardModel == result.Card
            );
    ...
    private void UpdatePileContents()
    {
        ...
        _selectedCards = _selectedCards
            .Where((CardModel c) => validPileCards.Contains(c))
            .ToHashSet();
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.UpdateConfirmButton,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.UnsubscribeFromPile,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName._isSubscribedToPile,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
