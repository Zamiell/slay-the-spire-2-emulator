...
public sealed class NDeckCardSelectScreen : NCardGridSelectionScreen
{
    public new class MethodName : NCardGridSelectionScreen.MethodName
    {
        ...
        public static new readonly StringName AfterOverlayShown = "AfterOverlayShown";

        public static new readonly StringName AfterOverlayHidden = "AfterOverlayHidden";
    }
    ...
    protected override IEnumerable<Control> PeekButtonTargets =>
        new global::_003C_003Ez__ReadOnlyArray<Control>(
            new Control[3] { _previewContainer, _closeButton, _confirmButton }
        );
    ...
    {
        NDeckCardSelectScreen nDeckCardSelectScreen = PreloadManager
            .Cache.GetScene(ScenePath)
            .Instantiate<NDeckCardSelectScreen>(PackedScene.GenEditState.Disabled);
    ...
    private void PreviewSelection()
    {
        ...
        foreach (CardModel selectedCard in _selectedCards)
        {
            ...
            NPreviewCardHolder child = NPreviewCardHolder.Create(
                nCard,
                showHoverTips: true,
                scaleOnHover: false
            );
