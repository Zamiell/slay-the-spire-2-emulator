...
public sealed class NDeckTransformSelectScreen : NCardGridSelectionScreen
{
    ...
    private static string ScenePath =>
        SceneHelper.GetScenePath("screens/card_selection/deck_transform_select_screen");
    ...
    protected override IEnumerable<Control> PeekButtonTargets =>
        new global::_003C_003Ez__ReadOnlyArray<Control>(
            new Control[3] { _previewContainer, _closeButton, _bottomTextContainer }
        );
    ...
    public override void _Ready()
    {
        ...
        _previewConfirmButton.Connect(
            NClickableControl.SignalName.Released,
            Callable.From<NButton>(CompleteSelection)
        );
    ...
    {
        NDeckTransformSelectScreen nDeckTransformSelectScreen = PreloadManager
            .Cache.GetScene(ScenePath)
            .Instantiate<NDeckTransformSelectScreen>(PackedScene.GenEditState.Disabled);
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._previewContainer,
                PropertyHint.None,
                "",
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._transformPreview,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
