...
public sealed class NSimpleCardSelectScreen : NCardGridSelectionScreen
{
    ...
    {
        NSimpleCardSelectScreen nSimpleCardSelectScreen = PreloadManager
            .Cache.GetScene(ScenePath)
            .Instantiate<NSimpleCardSelectScreen>(PackedScene.GenEditState.Disabled);
    ...
    )
    {
        ...
        {
            list.Sort(
                (CardCreationResult c1, CardCreationResult c2) => prefs.Comparison(c1.Card, c2.Card)
            );
        }
        nSimpleCardSelectScreen.Name = "NSimpleCardSelectScreen";
        nSimpleCardSelectScreen._cardResults = list;
        nSimpleCardSelectScreen._cards = nSimpleCardSelectScreen
            ._cardResults.Select((CardCreationResult r) => r.Card)
            .ToList();
        nSimpleCardSelectScreen._prefs = prefs;
        return nSimpleCardSelectScreen;
    }
