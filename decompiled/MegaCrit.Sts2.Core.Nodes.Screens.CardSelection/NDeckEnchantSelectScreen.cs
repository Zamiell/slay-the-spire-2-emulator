...
public sealed class NDeckEnchantSelectScreen : NCardGridSelectionScreen
{
    ...
    public new class PropertyName : NCardGridSelectionScreen.PropertyName
    {
        ...
        public static new readonly StringName FocusedControlFromTopBar = "FocusedControlFromTopBar";
    ...
    private static string ScenePath =>
        SceneHelper.GetScenePath("screens/card_selection/deck_enchant_select_screen");
    ...
    protected override IEnumerable<Control> PeekButtonTargets =>
        new global::_003C_003Ez__ReadOnlyArray<Control>(
            new Control[5]
            {
                _enchantSinglePreviewContainer,
                _enchantMultiPreviewContainer,
    ...
    public override void _Ready()
    {
        ...
        _singlePreviewConfirmButton = _enchantSinglePreviewContainer.GetNode<NConfirmButton>(
            "Confirm"
        );
        ...
        _multiPreviewConfirmButton = _enchantMultiPreviewContainer.GetNode<NConfirmButton>(
            "Confirm"
        );
        _enchantmentDescriptionContainer = GetNode<Control>("%EnchantmentDescriptionContainer");
        _enchantmentIcon = _enchantmentDescriptionContainer.GetNode<TextureRect>(
            "%EnchantmentIcon"
        );
        _enchantmentTitle = _enchantmentDescriptionContainer.GetNode<MegaLabel>(
            "%EnchantmentTitle"
        );
        _enchantmentDescription = _enchantmentDescriptionContainer.GetNode<MegaRichTextLabel>(
            "%EnchantmentDescription"
        );
        _closeButton = GetNode<NBackButton>("%Close");
        _singlePreviewCancelButton.Connect(
            NClickableControl.SignalName.Released,
            Callable.From<NButton>(CancelSelection)
        );
        _singlePreviewConfirmButton.Connect(
            NClickableControl.SignalName.Released,
            Callable.From<NButton>(ConfirmSelection)
        );
        _multiPreviewCancelButton.Connect(
            NClickableControl.SignalName.Released,
            Callable.From<NButton>(CancelSelection)
        );
        _multiPreviewConfirmButton.Connect(
            NClickableControl.SignalName.Released,
            Callable.From<NButton>(ConfirmSelection)
        );
        _closeButton.Connect(
            NClickableControl.SignalName.Released,
            Callable.From<NButton>(CloseSelection)
        );
        _confirmButton.Connect(
            NClickableControl.SignalName.Released,
            Callable.From((Action<NButton>)PreviewSelection)
        );
    ...
    {
        NDeckEnchantSelectScreen nDeckEnchantSelectScreen = PreloadManager
            .Cache.GetScene(ScenePath)
            .Instantiate<NDeckEnchantSelectScreen>(PackedScene.GenEditState.Disabled);
    ...
    private void PreviewSelection()
    {
        ...
        foreach (CardModel selectedCard in _selectedCards)
        {
            ...
            _multiPreview.AddChildSafely(
                NPreviewCardHolder.Create(nCard, showHoverTips: true, scaleOnHover: false)
            );
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.RefreshConfirmButtonVisibility,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName.UseSingleSelection,
                PropertyHint.None,
                "",
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Int,
                PropertyName._enchantmentAmount,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._enchantSinglePreviewContainer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._singlePreviewCancelButton,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._singlePreviewConfirmButton,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._enchantMultiPreviewContainer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._multiPreviewCancelButton,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._multiPreviewConfirmButton,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._enchantmentDescriptionContainer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._enchantmentTitle,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._enchantmentDescription,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._bottomTextContainer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._enchantSinglePreviewContainer,
            Variant.From(in _enchantSinglePreviewContainer)
        );
        info.AddProperty(PropertyName._singlePreview, Variant.From(in _singlePreview));
        info.AddProperty(
            PropertyName._singlePreviewCancelButton,
            Variant.From(in _singlePreviewCancelButton)
        );
        info.AddProperty(
            PropertyName._singlePreviewConfirmButton,
            Variant.From(in _singlePreviewConfirmButton)
        );
        info.AddProperty(PropertyName._confirmButton, Variant.From(in _confirmButton));
        info.AddProperty(
            PropertyName._enchantMultiPreviewContainer,
            Variant.From(in _enchantMultiPreviewContainer)
        );
        info.AddProperty(PropertyName._multiPreview, Variant.From(in _multiPreview));
        info.AddProperty(
            PropertyName._multiPreviewCancelButton,
            Variant.From(in _multiPreviewCancelButton)
        );
        info.AddProperty(
            PropertyName._multiPreviewConfirmButton,
            Variant.From(in _multiPreviewConfirmButton)
        );
        info.AddProperty(
            PropertyName._enchantmentDescriptionContainer,
            Variant.From(in _enchantmentDescriptionContainer)
        );
        info.AddProperty(PropertyName._enchantmentTitle, Variant.From(in _enchantmentTitle));
        info.AddProperty(
            PropertyName._enchantmentDescription,
            Variant.From(in _enchantmentDescription)
        );
