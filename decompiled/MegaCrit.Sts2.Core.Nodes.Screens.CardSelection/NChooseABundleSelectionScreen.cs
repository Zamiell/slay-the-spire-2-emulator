...
public class NChooseABundleSelectionScreen : Control, IOverlayScreen, IScreenContext
{
    ...
    private readonly TaskCompletionSource<IEnumerable<IReadOnlyList<CardModel>>> _completionSource =
        new TaskCompletionSource<IEnumerable<IReadOnlyList<CardModel>>>();
    ...
    private static string ScenePath =>
        SceneHelper.GetScenePath("/screens/card_selection/choose_a_bundle_selection_screen");
    ...
    public override void _Ready()
    {
        ...
        for (int i = 0; i < _bundles.Count; i++)
        {
            ...
            nCardBundle.Connect(
                ...
                Callable.From<NCardBundle>(OnBundleClicked)
            );
        ...
        for (int j = 0; j < _bundleRow.GetChildCount(); j++)
        {
            ...
            child.Hitbox.FocusNeighborLeft = (
                (j > 0)
                    ? _bundleRow.GetChild<NCardBundle>(j - 1).Hitbox.GetPath()
                    : _bundleRow
                        .GetChild<NCardBundle>(_bundleRow.GetChildCount() - 1)
                        .Hitbox.GetPath()
            );
            child.Hitbox.FocusNeighborRight = (
                (j < _bundleRow.GetChildCount() - 1)
                    ? _bundleRow.GetChild<NCardBundle>(j + 1).Hitbox.GetPath()
                    : _bundleRow.GetChild<NCardBundle>(0).Hitbox.GetPath()
            );
    ...
    {
        NChooseABundleSelectionScreen nChooseABundleSelectionScreen = PreloadManager
            .Cache.GetScene(ScenePath)
            .Instantiate<NChooseABundleSelectionScreen>(PackedScene.GenEditState.Disabled);
    ...
    private void OnBundleClicked(NCardBundle bundleNode)
    {
        ...
        for (int i = 0; i < readOnlyList.Count; i++)
        {
            ...
            NPreviewCardHolder nPreviewCardHolder = NPreviewCardHolder.Create(
                readOnlyList[i],
                showHoverTips: true,
                scaleOnHover: true
            );
        ...
        for (int j = 0; j < _bundlePreviewCards.GetChildCount(); j++)
        {
            ...
            child.FocusNeighborLeft = (
                (j < _bundlePreviewCards.GetChildCount() - 1)
                    ? _bundlePreviewCards.GetChild(j + 1).GetPath()
                    : _bundlePreviewCards.GetChild(0).GetPath()
            );
            child.FocusNeighborRight = (
                (j > 0)
                    ? _bundlePreviewCards.GetChild(j - 1).GetPath()
                    : _bundlePreviewCards
                        .GetChild(_bundlePreviewCards.GetChildCount() - 1)
                        .GetPath()
            );
        ...
        _bundlePreviewCards
            .GetChild<Control>(_bundlePreviewCards.GetChildCount() - 1)
            .TryGrabFocus();
    }
    ...
    private void ConfirmSelection(NButton _)
    {
        ...
        foreach (NCard item in cardNodes)
        {
            ...
            NCardFlyVfx child = NCardFlyVfx.Create(
                item,
                PileType.Deck,
                isAddingToPile: true,
                item.Model.Owner.Character.TrailPath
            );
            NRun.Instance.GlobalUi.TopBar.TrailContainer.AddChildSafely(child);
        }
        _completionSource.SetResult(
            new global::_003C_003Ez__ReadOnlySingleElementList<IReadOnlyList<CardModel>>(
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._bundlePreviewContainer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._bundlePreviewCards,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._previewCancelButton,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._previewConfirmButton,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._bundlePreviewContainer,
            Variant.From(in _bundlePreviewContainer)
        );
        ...
        info.AddProperty(
            PropertyName._previewConfirmButton,
            Variant.From(in _previewConfirmButton)
        );
