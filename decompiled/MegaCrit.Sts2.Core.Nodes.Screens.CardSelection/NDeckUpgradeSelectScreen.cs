...
public sealed class NDeckUpgradeSelectScreen : NCardGridSelectionScreen
{
    ...
    private static string ScenePath =>
        SceneHelper.GetScenePath("screens/card_selection/deck_upgrade_select_screen");
    ...
    public override void _Ready()
    {
        ...
        _singlePreviewConfirmButton = _upgradeSinglePreviewContainer.GetNode<NConfirmButton>(
            "Confirm"
        );
        ...
        _multiPreviewConfirmButton = _upgradeMultiPreviewContainer.GetNode<NConfirmButton>(
            "Confirm"
        );
        ...
        NControllerManager.Instance.Connect(
            ...
            Callable.From(OnControllerStateUpdated)
        );
        NControllerManager.Instance.Connect(
        ...
        GetNode<MegaLabel>("%ViewUpgradesLabel")
            .SetTextAutoSize(new LocString("card_selection", "VIEW_UPGRADES").GetFormattedText());
    }
    ...
    {
        NDeckUpgradeSelectScreen nDeckUpgradeSelectScreen = PreloadManager
            .Cache.GetScene(ScenePath)
            .Instantiate<NDeckUpgradeSelectScreen>(PackedScene.GenEditState.Disabled);
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnControllerStateUpdated,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._upgradeSinglePreviewContainer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._upgradeMultiPreviewContainer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._upgradeSinglePreviewContainer,
            Variant.From(in _upgradeSinglePreviewContainer)
        );
        ...
        info.AddProperty(
            PropertyName._upgradeMultiPreviewContainer,
            Variant.From(in _upgradeMultiPreviewContainer)
        );
