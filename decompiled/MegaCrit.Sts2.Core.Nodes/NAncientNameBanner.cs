...
public class NAncientNameBanner : Control
{
    ...
    public static IEnumerable<string> AssetPaths =>
        new global::_003C_003Ez__ReadOnlySingleElementList<string>(_path);
    ...
    public static NAncientNameBanner? Create(AncientEventModel ancient)
    {
        ...
        NAncientNameBanner nAncientNameBanner = PreloadManager
            .Cache.GetScene(_path)
            .Instantiate<NAncientNameBanner>(PackedScene.GenEditState.Disabled);
    ...
    public override void _Ready()
    {
        ...
        _ancientBannerEffect.CenterCharacter = GetTextCenterGlyphIndex(
            text,
            _titleLabel.GetThemeFont(ThemeConstants.RichTextLabel.NormalFont, "RichTextLabel"),
            _titleLabel.GetThemeFontSize(
    ...
    private async Task AnimateVfx()
    {
        ...
        _moveTween
            .TweenProperty(this, "position:y", -100f, 4.0)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Circ);
        _tween = CreateTween().SetParallel();
        _tween
            .TweenMethod(Callable.From<float>(UpdateGlyphSpace), 1f, 0f, 3.0)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _tween
            .TweenMethod(Callable.From<float>(UpdateTransform), 0f, 1f, 3.0)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Spring);
        _tween
            .TweenProperty(_epithetLabel, "position:y", 42f, 2.0)
            .SetEase(Tween.EaseType.Out)
        ...
        _tween.Chain();
        _tween
            .TweenProperty(_titleLabel, "modulate", Colors.Red, 1.0)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _tween
            .TweenProperty(_titleLabel, "modulate:a", 0f, 1.0)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Cubic);
        _tween
            .TweenProperty(_epithetLabel, "modulate", Colors.Red, 1.0)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _tween
            .TweenProperty(_epithetLabel, "modulate:a", 0f, 1.0)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Cubic);
        if (await _tween.AwaitFinished(this) && this.IsValid())
        {
            ...
            _epithetLabel.AddThemeColorOverride(
            ...
            _moveTween
                .TweenProperty(_epithetLabel, "modulate:a", 0.5f, 2.0)
                .SetEase(Tween.EaseType.Out)
                .SetTrans(Tween.TransitionType.Circ);
            _moveTween
                .TweenProperty(this, "position:x", 48f, 2.0)
                .SetEase(Tween.EaseType.Out)
                .From(0)
                .SetTrans(Tween.TransitionType.Circ);
        }
    ...
    )
    {
        ...
        if (method == MethodName.GetTextCenterGlyphIndex && args.Count == 3)
        {
            ret = VariantUtils.CreateFrom<float>(
                GetTextCenterGlyphIndex(
                    VariantUtils.ConvertTo<string>(in args[0]),
                    VariantUtils.ConvertTo<Font>(in args[1]),
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._ancientBannerEffect,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
