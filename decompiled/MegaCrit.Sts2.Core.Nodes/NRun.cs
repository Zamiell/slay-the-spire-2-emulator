...
public class NRun : Control
{
    ...
    public static IEnumerable<string> AssetPaths =>
        new global::_003C_003Ez__ReadOnlySingleElementList<string>("res://scenes/run.tscn");
    ...
    {
        NRun nRun = PreloadManager
            .Cache.GetScene("res://scenes/run.tscn")
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName.RunMusicController,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName.RunMusicController,
            Variant.From<NRunMusicController>(RunMusicController)
        );
