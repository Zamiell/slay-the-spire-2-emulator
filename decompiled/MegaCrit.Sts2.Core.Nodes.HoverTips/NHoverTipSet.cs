...
public class NHoverTipSet : Control
{
    ...
    private static readonly StringName _cardHoverTipContainerStr = new StringName(
        "cardHoverTipContainer"
    );

    private static readonly StringName _textHoverTipContainerStr = new StringName(
    ...
    private static readonly Dictionary<Control, NHoverTipSet> _activeHoverTips =
        new Dictionary<Control, NHoverTipSet>();
    ...
    )
    {
        return CreateAndShow(
            owner,
            new global::_003C_003Ez__ReadOnlySingleElementList<IHoverTip>(hoverTip),
            alignment
        );
    }
    ...
    )
    {
        ...
        NHoverTipSet nHoverTipSet = PreloadManager
            .Cache.GetScene("res://scenes/ui/hover_tip_set.tscn")
        ...
        foreach (IHoverTip item in IHoverTip.RemoveDupes(hoverTips))
        {
            if (item is HoverTip hoverTip)
            {
                Control control = PreloadManager
                    .Cache.GetScene("res://scenes/ui/hover_tip.tscn")
                ...
                control.GetNode<MegaRichTextLabel>("%Description").AutowrapMode =
                    (TextServer.AutowrapMode)(hoverTip.ShouldOverrideTextOverflow ? 0 : 3);
                control.GetNode<TextureRect>("%Icon").Texture = hoverTip.Icon;
                if (hoverTip.IsDebuff)
                {
                    control.GetNode<CanvasItem>("%Bg").Material = PreloadManager.Cache.GetMaterial(
                        "res://materials/ui/hover_tip_debuff.tres"
                    );
                }
                control.ResetSize();
                if (
                    _textHoverTipContainer.Size.Y + control.Size.Y + 5f
                    < NGame.Instance.GetViewportRect().Size.Y - 50f
                )
                {
                    _textHoverTipContainer.Size = new Vector2(
                        360f,
                        _textHoverTipContainer.Size.Y + control.Size.Y + 5f
                    );
                }
        ...
        if (alignment != HoverTipAlignment.None)
        {
            ...
            switch (alignment)
            {
                case HoverTipAlignment.Left:
                    ...
                    _cardHoverTipContainer.LayoutResizeAndReposition(
                        node.GlobalPosition + new Vector2(node.Size.X, 0f) * node.Scale,
                ...
                case HoverTipAlignment.Right:
                    ...
                    _textHoverTipContainer.GlobalPosition =
                        node.GlobalPosition + new Vector2(node.Size.X, 0f) * node.Scale;
                    break;
                case HoverTipAlignment.Center:
                    base.GlobalPosition = node.GlobalPosition + Vector2.Down * node.Size.Y * 1.5f;
                    _cardHoverTipContainer.GlobalPosition +=
                        Vector2.Down * _textHoverTipContainer.Size.Y;
                    _cardHoverTipContainer.LayoutResizeAndReposition(
                        _cardHoverTipContainer.GlobalPosition,
                        alignment
                    );
    ...
    public void SetAlignmentForRelic(NRelic relic)
    {
        ...
        _textHoverTipContainer.GlobalPosition =
            relic.GlobalPosition + Vector2.Down * (vector.Y + 10f);
        if (hoverTipAlignment == HoverTipAlignment.Left)
        {
            _textHoverTipContainer.Position +=
                Vector2.Left * (_textHoverTipContainer.Size.X - vector.X);
        }
        _cardHoverTipContainer.LayoutResizeAndReposition(
            _textHoverTipContainer.GlobalPosition + Vector2.Down * _textHoverTipContainer.Size.Y,
            hoverTipAlignment
        );
        if (hoverTipAlignment == HoverTipAlignment.Left)
        {
            _cardHoverTipContainer.GlobalPosition = new Vector2(
                _textHoverTipContainer.GlobalPosition.X,
                _cardHoverTipContainer.GlobalPosition.Y
            );
        }
        ...
        {
            _textHoverTipContainer.GlobalPosition =
                relic.GlobalPosition + Vector2.Up * _textHoverTipContainer.Size.Y;
        }
        CorrectVerticalOverflow();
        CorrectHorizontalOverflow();
        if (_textHoverTipContainer.GetRect().Intersects(_cardHoverTipContainer.GetRect()))
        {
            if (hoverTipAlignment == HoverTipAlignment.Left)
            {
                _cardHoverTipContainer.GlobalPosition =
                    _textHoverTipContainer.GlobalPosition
                    + _textHoverTipContainer.Size.X * Vector2.Right;
            }
            else
            {
                _cardHoverTipContainer.GlobalPosition =
                    _textHoverTipContainer.GlobalPosition
                    + _cardHoverTipContainer.Size.X * Vector2.Left;
            }
            CorrectVerticalOverflow();
        }
    }
    ...
    public void SetAlignmentForCardHolder(NCardHolder holder)
    {
        ...
        if (hoverTipAlignment == HoverTipAlignment.Left)
        {
            ...
            _textHoverTipContainer.Position +=
                Vector2.Left * _textHoverTipContainer.Size.X - new Vector2(10f, 0f);
            _textHoverTipContainer.ReverseFill = true;
            _cardHoverTipContainer.LayoutResizeAndReposition(
                hitbox.GlobalPosition + new Vector2(hitbox.Size.X, 0f) * hitbox.Scale,
                HoverTipAlignment.Right
            );
        }
        else
        {
            ...
            if (
                ...
                && (holder.CardModel.CurrentStarCost > 0 || holder.CardModel.HasStarCostX)
            )
            {
            ...
            _textHoverTipContainer.GlobalPosition =
                ...
                + new Vector2(hitbox.Size.X + 10f, 0f) * hitbox.Scale * holder.Scale;
        }
        CorrectVerticalOverflow();
        CorrectHorizontalOverflow();
        SetFollowOwner();
    ...
    private void CorrectVerticalOverflow()
    {
        ...
        {
            _textHoverTipContainer.GlobalPosition = new Vector2(
                _textHoverTipContainer.GlobalPosition.X,
                y - _textHoverTipContainer.Size.Y
            );
        }
        if (_cardHoverTipContainer.GlobalPosition.Y + _cardHoverTipContainer.Size.Y > y)
        {
            _cardHoverTipContainer.GlobalPosition = new Vector2(
                _cardHoverTipContainer.GlobalPosition.X,
                y - _cardHoverTipContainer.Size.Y
            );
        }
    }
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.CreateAndShowMapPointHistory,
                new PropertyInfo(
                    Variant.Type.Object,
                    "",
                    PropertyHint.None,
                ...
                new List<PropertyInfo>
                {
                    ...
                    new PropertyInfo(
                        ...
                        "",
                        PropertyUsageFlags.Default,
                        new StringName("MarginContainer"),
                        exported: false
                    ),
                },
                null
        ...
        list.Add(
            new MethodInfo(
                MethodName.SetAlignmentForCardHolder,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.CorrectVerticalOverflow,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.CorrectHorizontalOverflow,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.SetExtraFollowOffset,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NHoverTipSet>(
                CreateAndShowMapPointHistory(
                    VariantUtils.ConvertTo<Control>(in args[0]),
                    VariantUtils.ConvertTo<NMapPointHistoryHoverTip>(in args[1])
                )
            );
            return true;
        }
        ...
        if (method == MethodName.SetAlignment && args.Count == 2)
        {
            SetAlignment(
                VariantUtils.ConvertTo<Control>(in args[0]),
                VariantUtils.ConvertTo<HoverTipAlignment>(in args[1])
            );
            ret = default(godot_variant);
            return true;
        }
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._textHoverTipContainer,
                PropertyHint.None,
                "",
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._cardHoverTipContainer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Vector2,
                PropertyName.TextHoverTipDimensions,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Vector2,
                PropertyName.CardHoverTipDimensions,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._textHoverTipContainer,
            Variant.From(in _textHoverTipContainer)
        );
        info.AddProperty(
            PropertyName._cardHoverTipContainer,
            Variant.From(in _cardHoverTipContainer)
        );
