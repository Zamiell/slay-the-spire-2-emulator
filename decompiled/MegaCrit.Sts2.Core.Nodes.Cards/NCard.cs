...
public class NCard : Control, IPoolable
{
    ...
    private const string _portraitBlurMaterialPath =
        "res://scenes/cards/card_portrait_blur_material.tres";

    private const string _canvasGroupMaskMaterialPath =
        "res://scenes/cards/card_canvas_group_mask_material.tres";

    private const string _canvasGroupBlurMaterialPath =
        "res://scenes/cards/card_canvas_group_blur_material.tres";

    private const string _canvasGroupMaskBlurMaterialPath =
    ...
    private readonly LocString _unknownDescription = new LocString(
        "card_library",
        "UNKNOWN.description"
    );
    ...
    private readonly LocString _lockedDescription = new LocString(
        "card_library",
        "LOCKED.description"
    );
    ...
    public CardModel? Model
    {
        ...
        set
        {
            if (_model != value)
            {
                ...
                if (
                    _model != null
                    && (_model.RunState != null || _model.CombatState != null)
                    && LocalContext.IsMine(_model)
                )
                {
    ...
    public static IEnumerable<string> AssetPaths =>
        new global::_003C_003Ez__ReadOnlyArray<string>(
            new string[5]
            {
        ...
        if (model != null && IsInsideTree())
        {
            if (_subscribedEnchantment != null)
            {
                throw new InvalidOperationException(
                    $"Attempted to subscribe to enchantment {model}, but {this} is already subscribed to {_subscribedEnchantment}!"
                );
            }
    ...
    public static NCard? Create(
        CardModel card,
        ModelVisibility visibility = ModelVisibility.Visible
    )
    {
        if (TestMode.IsOn)
        {
    ...
    public static NCard? FindOnTable(CardModel card, PileType? overridePile = null)
    {
        ...
        return ((pile != null) ? new PileType?(pile.Type) : overridePile) switch
        {
            PileType.None => null,
            PileType.Draw => null,
            PileType.Hand => nCombatUi.Hand.GetCard(card)
                ?? nCombatUi.PlayQueue.GetCardNode(card)
                ?? nCombatUi.GetCardFromPlayContainer(card),
    ...
    public void UpdateVisuals(PileType pileType, CardPreviewMode previewMode)
    {
        ...
        string text = (
            (previewMode != CardPreviewMode.Upgrade)
                ? Model.GetDescriptionForPile(pileType, target)
        ...
        switch (Visibility)
        {
            ...
            case ModelVisibility.NotSeen:
                _descriptionLabel.SetTextAutoSize(
                    "[center][font_size=40]"
                        + _unknownDescription.GetFormattedText()
                        + "[/font_size][/center]"
                );
                break;
            case ModelVisibility.Locked:
                _descriptionLabel.SetTextAutoSize(
                    "[center][font_size=40]"
                        + _lockedDescription.GetFormattedText()
                        + "[/font_size][/center]"
                );
                break;
            default:
    ...
    private void UpdateEnergyCostVisuals(PileType pileType)
    {
        if (Visibility != ModelVisibility.Visible)
        {
            ...
            _energyLabel.AddThemeColorOverride(
                ThemeConstants.Label.FontOutlineColor,
                Model.Pool.EnergyOutlineColor
            );
            return;
        }
        ...
        if (
            ...
            && !Model.CanPlay(out UnplayableReason reason, out AbstractModel _)
        )
        {
    ...
    private void UpdateEnergyCostColor(PileType pileType)
    {
        ...
        {
            CardCostColor energyCostColor = CardCostHelper.GetEnergyCostColor(
                Model,
                Model.CombatState
            );
    ...
    private void UpdateStarCostVisuals(PileType pileType)
    {
        if (Visibility != ModelVisibility.Visible)
        {
            ...
            _starLabel.AddThemeColorOverride(
                ThemeConstants.Label.FontOutlineColor,
                Model.Pool.EnergyOutlineColor
            );
            return;
    ...
    )
    {
        return costColor switch
        {
            ...
            CardCostColor.InsufficientResources => pretendCardCanBePlayed
                ? defaultColor
                : StsColors.red,
    ...
    public void PlayRandomizeCostAnim()
    {
        ...
        RandomizeCostTween
            .TweenMethod(
                ...
                0,
                50,
                Rng.Chaotic.NextFloat(0.4f, 0.6f)
            )
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Sine);
        RandomizeCostTween.Connect(
    ...
    private void Reload()
    {
        ...
        if (Visibility != ModelVisibility.Visible)
        {
            ...
            {
                _portraitBlurMaterial = PreloadManager.Cache.GetMaterial(
                    "res://scenes/cards/card_portrait_blur_material.tres"
                );
            }
            if (flag)
            {
                ...
                {
                    _canvasGroupMaskBlurMaterial = PreloadManager.Cache.GetMaterial(
                        "res://scenes/cards/card_canvas_group_mask_blur_material.tres"
                    );
                }
            ...
            else
            {
                ...
                {
                    _canvasGroupBlurMaterial = PreloadManager.Cache.GetMaterial(
                        "res://scenes/cards/card_canvas_group_blur_material.tres"
                    );
                }
        ...
        else
        {
            if (flag)
            {
                ...
                {
                    _canvasGroupMaskMaterial = PreloadManager.Cache.GetMaterial(
                        "res://scenes/cards/card_canvas_group_mask_material.tres"
                    );
                }
    ...
    public async Task AnimMultiCardPlay()
    {
        if (GodotObject.IsInstanceValid(this))
        {
            ...
            PlayPileTween.Chain();
            PlayPileTween.TweenInterval(
                (SaveManager.Instance.PrefsSave.FastMode == FastModeType.Fast) ? 0.1 : 0.2
            );
            PlayPileTween.TweenCallback(
                Callable.From(
                    delegate
                    {
            ...
            PlayPileTween.Chain();
            PlayPileTween
                .TweenProperty(this, "modulate", Colors.White, 0.2)
                .SetEase(Tween.EaseType.Out)
                .SetTrans(Tween.TransitionType.Cubic);
            PlayPileTween
                .TweenProperty(this, "scale", scale, 0.25)
                .SetEase(Tween.EaseType.Out)
                .SetTrans(Tween.TransitionType.Cubic)
                .From(scale * 0.5f);
            PlayPileTween
                .TweenProperty(this, "position:y", y, 0.25)
                .SetEase(Tween.EaseType.Out)
    ...
    public void AnimCardToPlayPile()
    {
        ...
        PlayPileTween = CreateTween().SetParallel();
        PlayPileTween
            .TweenProperty(this, "position", targetPosition, 0.2)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Cubic);
        PlayPileTween
            .TweenProperty(this, "scale", Vector2.One * 0.8f, 0.2)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Cubic);
    }
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.UpdateEnchantmentVisuals,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnEnchantmentStatusChanged,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.SetEnchantmentStatus,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.UpdateEnergyCostVisuals,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.SetPretendCardCanBePlayed,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.SetForceUnpoweredPreview,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.UpdateEnergyCostColor,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.UpdateStarCostVisuals,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.UpdateStarCostColor,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.GetCostTextColorInHand,
                new PropertyInfo(
                    Variant.Type.Color,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.GetCostOutlineColorInHand,
                new PropertyInfo(
                    Variant.Type.Color,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.PlayRandomizeCostAnim,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.UpdateTypePlaqueSizeAndPosition,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.GetTitleLabelOutlineColor,
                new PropertyInfo(
                    Variant.Type.Color,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnAfflictionChanged,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnEnchantmentChanged,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.ActivateRewardScreenGlow,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    )
    {
        ...
        {
            UpdateVisuals(
                VariantUtils.ConvertTo<PileType>(in args[0]),
                VariantUtils.ConvertTo<CardPreviewMode>(in args[1])
            );
            ret = default(godot_variant);
            return true;
        }
        ...
        {
            ret = VariantUtils.CreateFrom<Color>(
                GetCostTextColorInHand(
                    VariantUtils.ConvertTo<CardCostColor>(in args[0]),
                    VariantUtils.ConvertTo<bool>(in args[1]),
                    VariantUtils.ConvertTo<Color>(in args[2])
                )
            );
            return true;
        }
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._descriptionLabel,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._ancientBorderGlassOverlay,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._portraitCanvasGroup,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._unplayableEnergyIcon,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._unplayableStarIcon,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._overlayContainer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._enchantmentVfxOverride,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._enchantmentLabel,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Vector2,
                PropertyName._defaultEnchantmentPosition,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName._pretendCardCanBePlayed,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName._forceUnpoweredPreview,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._portraitBlurMaterial,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._canvasGroupMaskBlurMaterial,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._canvasGroupBlurMaterial,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._canvasGroupMaskMaterial,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName.RandomizeCostTween,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName.EnchantmentVfxOverride,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._ancientBorderGlassOverlay,
            Variant.From(in _ancientBorderGlassOverlay)
        );
        ...
        info.AddProperty(
            PropertyName._unplayableEnergyIcon,
            Variant.From(in _unplayableEnergyIcon)
        );
        ...
        info.AddProperty(
            PropertyName._enchantmentVfxOverride,
            Variant.From(in _enchantmentVfxOverride)
        );
        ...
        info.AddProperty(
            PropertyName._defaultEnchantmentPosition,
            Variant.From(in _defaultEnchantmentPosition)
        );
        info.AddProperty(
            PropertyName._pretendCardCanBePlayed,
            Variant.From(in _pretendCardCanBePlayed)
        );
        info.AddProperty(
            PropertyName._forceUnpoweredPreview,
            Variant.From(in _forceUnpoweredPreview)
        );
        info.AddProperty(
            PropertyName._portraitBlurMaterial,
            Variant.From(in _portraitBlurMaterial)
        );
        info.AddProperty(
            PropertyName._canvasGroupMaskBlurMaterial,
            Variant.From(in _canvasGroupMaskBlurMaterial)
        );
        info.AddProperty(
            PropertyName._canvasGroupBlurMaterial,
            Variant.From(in _canvasGroupBlurMaterial)
        );
        info.AddProperty(
            PropertyName._canvasGroupMaskMaterial,
            Variant.From(in _canvasGroupMaskMaterial)
        );
