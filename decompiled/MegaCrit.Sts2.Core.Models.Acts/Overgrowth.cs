...
public sealed class Overgrowth : ActModel
{
    ...
    public override IEnumerable<EncounterModel> BossDiscoveryOrder =>
        new global::_003C_003Ez__ReadOnlyArray<EncounterModel>(
            new EncounterModel[3]
            {
    ...
    public override IEnumerable<AncientEventModel> AllAncients =>
        new global::_003C_003Ez__ReadOnlySingleElementList<AncientEventModel>(
    ...
    public override string[] BgMusicOptions =>
        new string[2] { "event:/music/act1_a1_v1", "event:/music/act1_a2_v2" };

    public override string[] MusicBankPaths =>
        new string[2] { "res://banks/desktop/act1_a1.bank", "res://banks/desktop/act1_a2.bank" };
    ...
    {
        return new global::_003C_003Ez__ReadOnlyArray<EncounterModel>(
            new EncounterModel[22]
            {
    ...
    protected override void ApplyActDiscoveryOrderModifications(UnlockState unlockState)
    {
        if (unlockState.NumberOfRuns == 0)
        {
            ...
            RoomSet.SwapToOrCreateAtIndex<EncounterModel, ShrinkerBeetleWeak>(
                _rooms.normalEncounters,
                2
            );
            RoomSet.SwapToOrCreateAtIndex<EncounterModel, InkletsNormal>(
                _rooms.normalEncounters,
                3
            );
            RoomSet.SwapToOrCreateAtIndex<EncounterModel, MawlerNormal>(_rooms.normalEncounters, 4);
            RoomSet.SwapToOrCreateAtIndex<EncounterModel, RubyRaidersNormal>(
                _rooms.normalEncounters,
                5
            );
            RoomSet.SwapToOrCreateAtIndex<EncounterModel, NibbitsNormal>(
                _rooms.normalEncounters,
                6
            );
            ...
            RoomSet.SwapToOrCreateAtIndex<EncounterModel, PhrogParasiteElite>(
                _rooms.eliteEncounters,
                1
            );
        }
    }
