...
public class NCeremonialBeastBgVfx : Node
{
    ...
    {
        Creature creature = combatState.Creatures.FirstOrDefault(
            (Creature c) => c.Monster is CeremonialBeast
        );
        if (creature == null)
        {
