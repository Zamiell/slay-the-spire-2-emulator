...
public class NSendFeedbackFlower : Control
{
    ...
    private const string _normalImage =
        "res://images/atlases/compressed.sprites/feedback/flower.tres";

    private const string _noddingImage =
        "res://images/atlases/compressed.sprites/feedback/flower_happy.tres";

    private const string _anticipationImage =
        "res://images/atlases/compressed.sprites/feedback/flower_anticipation.tres";
    ...
    public void SetState(State state)
    {
        switch (state)
        {
            case State.Nodding:
                ...
                _tween.TweenProperty(this, "rotation", Mathf.DegToRad(-8f), 0.5);
                _tween.SetLoops();
                Cartoon.Texture = PreloadManager.Cache.GetTexture2D(
                    "res://images/atlases/compressed.sprites/feedback/flower_happy.tres"
                );
                break;
    ...
    private void SetRandomPosition()
    {
        base.Position =
            _originalPosition
            + new Vector2(Rng.Chaotic.NextFloat(-3f, 3f), Rng.Chaotic.NextFloat(-3f, 3f));
    }
