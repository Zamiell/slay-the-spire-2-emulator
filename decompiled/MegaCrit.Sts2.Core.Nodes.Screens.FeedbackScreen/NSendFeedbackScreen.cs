...
public class NSendFeedbackScreen : Control, IScreenContext
{
    ...
    private static readonly string _scenePath = SceneHelper.GetScenePath(
        "screens/feedback_screen/feedback_screen"
    );
    ...
    private static readonly string _url =
        System.Environment.GetEnvironmentVariable("STS2_FEEDBACK_URL")
        ?? "https://feedback.sts2.megacrit.com/feedback";
    ...
    private readonly List<NSendFeedbackEmojiButton> _emojiButtons =
        new List<NSendFeedbackEmojiButton>();
    ...
    public static NSendFeedbackScreen? Create()
    {
        ...
        return PreloadManager
            ...
            .Instantiate<NSendFeedbackScreen>(PackedScene.GenEditState.Disabled);
    }
    ...
    public override void _Ready()
    {
        ...
        _successLabel.SetTextAutoSize(
            new LocString("settings_ui", "FEEDBACK_SEND_SUCCESS_LABEL").GetFormattedText()
        );
        _failedLabel.SetTextAutoSize(
            new LocString("settings_ui", "FEEDBACK_SEND_FAILED_LABEL").GetFormattedText()
        );
        _sendingLabel.SetTextAutoSize(
            new LocString("settings_ui", "FEEDBACK_SENDING_LABEL").GetFormattedText()
        );
        _returnToGameLabel.SetTextAutoSize(
            new LocString("settings_ui", "FEEDBACK_RUN_IN_BACKGROUND_LABEL").GetFormattedText()
        );
        _returnToGameHoverLabel.SetTextAutoSize(
            new LocString(
                "settings_ui",
                "FEEDBACK_RUN_IN_BACKGROUND_HOVER_LABEL"
            ).GetFormattedText()
        );
        ...
        foreach (Node child in GetNode("%EmojiButtonContainer").GetChildren())
        {
            if (child is NSendFeedbackEmojiButton nSendFeedbackEmojiButton)
            {
                ...
                nSendFeedbackEmojiButton.Connect(
                    NClickableControl.SignalName.Released,
                    Callable.From<NButton>(EmojiButtonSelected)
                );
            }
        }
        _sendButton.Connect(
            NClickableControl.SignalName.Released,
            Callable.From<NButton>(SendButtonSelected)
        );
        _sendButton.Connect(
            NClickableControl.SignalName.Focused,
            Callable.From<NClickableControl>(SendButtonFocused)
        );
        _sendButton.Connect(
            NClickableControl.SignalName.Unfocused,
            Callable.From<NClickableControl>(SendButtonUnfocused)
        );
        _returnToGameButton.Connect(
            NClickableControl.SignalName.Released,
            Callable.From<NButton>(ReturnToGameSelected)
        );
        _returnToGameButton.Connect(
            NClickableControl.SignalName.Focused,
            Callable.From<NClickableControl>(ReturnToGameFocused)
        );
        _returnToGameButton.Connect(
            NClickableControl.SignalName.Unfocused,
            Callable.From<NClickableControl>(ReturnToGameUnfocused)
        );
        _descriptionInput.Connect(
            TextEdit.SignalName.TextChanged,
            Callable.From(OnDescriptionChanged)
        );
    ...
    {
        _descriptionInput.PlaceholderText = new LocString(
            "settings_ui",
            "FEEDBACK_DESCRIPTION_PLACEHOLDER"
        ).GetFormattedText();
        _categoryLabel.SetTextAutoSize(
            new LocString("settings_ui", "FEEDBACK_CATEGORY_LABEL").GetFormattedText()
        );
        _emojiLabel.SetTextAutoSize(
            new LocString("settings_ui", "FEEDBACK_EMOJI_LABEL").GetFormattedText()
        );
        _sendLabel.SetTextAutoSize(
            new LocString("settings_ui", "FEEDBACK_SEND_BUTTON_LABEL").GetFormattedText()
        );
    ...
    private async Task SendFeedbackWrapper()
    {
        ...
        Log.Info(
            "Beginning asynchronous feedback send at " + Log.Timestamp + ": " + _descriptionText
        );
    ...
    )
    {
        ...
        try
        {
            using MultipartFormDataContent formContent = BuildMultipartContent(
                data,
                screenshotStream,
                logsMemoryStream
            );
            ...
            for (int attempt = 0; attempt < 3; attempt++)
            {
                try
                {
                    ...
                    if (statusCode >= 400 && statusCode < 500 && statusCode != 429)
                    {
                        ...
                        SentrySdk.CaptureMessage(
                            $"Feedback rejected: Response status code {response.StatusCode}"
                        );
                        return false;
                    }
                ...
                {
                    string text =
                        $"Feedback attempt {attempt + 1}/{3} network error: {ex}\n Inner messages: {ExceptionMessageWithInner(ex)}";
                    if (
                        ex is HttpRequestException
                        {
                            HttpRequestError: not HttpRequestError.NameResolutionError
                        }
                    )
                    {
    ...
    )
    {
        string content = JsonSerializer.Serialize(
            data,
            JsonSerializationUtility.GetTypeInfo<FeedbackData>()
        );
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnDescriptionChanged,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.EmojiButtonSelected,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.SendButtonUnfocused,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.ReturnToGameSelected,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.ReturnToGameFocused,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.ReturnToGameUnfocused,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._descriptionInput,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._returnToGameButton,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._returnToGameLabel,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._returnToGameHoverLabel,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._categoryDropdown,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._selectedEmoteButton,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                ...
                PropertyName._originalSuccessPosition,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Int,
                PropertyName._descriptionCaretLine,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Int,
                PropertyName._descriptionCaretColumn,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._returnToGameHoverLabel,
            Variant.From(in _returnToGameHoverLabel)
        );
        ...
        info.AddProperty(
            PropertyName._originalSuccessPosition,
            Variant.From(in _originalSuccessPosition)
        );
        ...
        info.AddProperty(
            PropertyName._descriptionCaretLine,
            Variant.From(in _descriptionCaretLine)
        );
        info.AddProperty(
            PropertyName._descriptionCaretColumn,
            Variant.From(in _descriptionCaretColumn)
        );
