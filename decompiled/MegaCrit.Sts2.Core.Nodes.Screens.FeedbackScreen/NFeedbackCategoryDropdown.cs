...
public class NFeedbackCategoryDropdown : NDropdown
{
    ...
    private void PopulateOptions()
    {
        ...
        {
            NFeedbackCategoryDropdownItem nFeedbackCategoryDropdownItem =
                _dropdownItemScene.Instantiate<NFeedbackCategoryDropdownItem>(
                    PackedScene.GenEditState.Disabled
                );
            node.AddChildSafely(nFeedbackCategoryDropdownItem);
            nFeedbackCategoryDropdownItem.Connect(
    ...
    {
        NFeedbackCategoryDropdownItem nFeedbackCategoryDropdownItem =
            (NFeedbackCategoryDropdownItem)item;
        if (nFeedbackCategoryDropdownItem.CategoryIndex != _currentCategoryIndex)
        {
            ...
            _currentOptionLabel.SetTextAutoSize(
                _categoryLoc[_currentCategoryIndex].GetFormattedText()
            );
        }
    }
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Int,
                PropertyName._currentCategoryIndex,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._currentCategoryIndex,
            Variant.From(in _currentCategoryIndex)
        );
    }
