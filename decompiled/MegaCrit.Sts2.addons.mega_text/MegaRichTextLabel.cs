...
public class MegaRichTextLabel : RichTextLabel
{
    ...
    public new class PropertyName : RichTextLabel.PropertyName
    {
        ...
        public static new readonly StringName Text = "Text";
    ...
    private static readonly AbstractMegaRichTextEffect[] _textEffects =
        new AbstractMegaRichTextEffect[13]
        {
            new RichTextAqua(),
            new RichTextBlue(),
            new RichTextFadeIn(),
    ...
    {
        get { return _isAutoSizeEnabled; }
        set
        {
            if (value && base.FitContent)
            {
                GD.PushWarning(
                    "Auto Size is not compatible with Fit Content, disabling Auto Size..."
                );
    ...
    {
        get { return _isHorizontallyBound; }
        set
        {
    ...
    private void AdjustFontSize()
    {
        ...
        try
        {
            ...
            float lineSpacing = GetThemeConstant(
                ThemeConstants.RichTextLabel.LineSpacing,
                "RichTextLabel"
            );
            Vector2 size = GetRect().Size;
            List<BbcodeObject> objs = MegaLabelHelper.ParseBbcode(Text);
            if (
                !MegaLabelHelper.IsTooBig(
                    _cachedParagraph,
                    objs,
                    themeFont,
                    MaxFontSize,
            ...
            if (
                _lastSetSize >= MinFontSize
                && _lastSetSize < MaxFontSize
                && !MegaLabelHelper.IsTooBig(
                    _cachedParagraph,
                    objs,
                    themeFont,
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.InstallEffectsIfNeeded,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    )
    {
        ...
        if (method == MethodName.HasEffect && args.Count == 1)
        {
            ret = VariantUtils.CreateFrom<bool>(
                HasEffect(VariantUtils.ConvertTo<AbstractMegaRichTextEffect>(in args[0]))
            );
            return true;
        }
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName._isAutoSizeEnabled,
                PropertyHint.None,
                "",
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName._isVerticallyBound,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName._isHorizontallyBound,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName._effectsInstalled,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                ...
                PropertyName._lastAdjustedSize,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName.IsVerticallyBound,
                PropertyHint.None,
                "",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName.IsHorizontallyBound,
                PropertyHint.None,
                "",
                PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable,
                exported: true
