...
public class NCustomRunLoadScreen : NSubmenu, ILoadRunLobbyListener
{
    ...
    private static readonly string _scenePath = SceneHelper.GetScenePath(
        "screens/custom_run/custom_run_load_screen"
    );
    ...
    public static IEnumerable<string> AssetPaths =>
        new global::_003C_003Ez__ReadOnlyArray<string>(
            new string[2] { _scenePath, "res://scenes/screens/custom_run/modifier_tickbox.tscn" }
        );
    ...
    public static NCustomRunLoadScreen? Create()
    {
        ...
        return PreloadManager
            ...
            .Instantiate<NCustomRunLoadScreen>(PackedScene.GenEditState.Disabled);
    }
    ...
    public override void _Ready()
    {
        ...
        _remotePlayerContainer = GetNode<NRemoteLoadLobbyPlayerContainer>(
            "LeftContainer/RemotePlayerLoadContainer"
        );
    ...
    public void InitializeAsHost(INetGameService gameService, SerializableRun run)
    {
        if (gameService.Type != NetGameType.Host)
        {
            throw new InvalidOperationException(
                $"Initialized custom run screen with NetService of type {gameService.Type} when hosting!"
            );
        }
    ...
    )
    {
        ...
        {
            throw new InvalidOperationException(
                $"Initialized character select screen with NetService of type {gameService.Type} when joining!"
            );
        }
    ...
    public override void OnSubmenuOpened()
    {
        ...
        _modifiersList.SyncModifierList(
            _lobby.Run.Modifiers.Select(ModifierModel.FromSerializable).ToList()
        );
    ...
    {
        Log.Info(
            "Loading a custom multiplayer run. Players: "
