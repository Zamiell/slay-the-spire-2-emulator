...
public class NMerchantFtue : NFtue
{
    ...
    public override void _Ready()
    {
        ...
        _sneakyHitbox.Connect(
            NClickableControl.SignalName.Released,
            Callable.From<NButton>(CloseFtueAndOpenRug)
        );
    ...
    public static NMerchantFtue? Create(NMerchantRoom merchantRoom)
    {
        ...
        NMerchantFtue nMerchantFtue = PreloadManager
            .Cache.GetScene(_scenePath)
            .Instantiate<NMerchantFtue>(PackedScene.GenEditState.Disabled);
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.CloseFtueAndOpenRug,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NMerchantFtue>(
                Create(VariantUtils.ConvertTo<NMerchantRoom>(in args[0]))
            );
            return true;
        }
