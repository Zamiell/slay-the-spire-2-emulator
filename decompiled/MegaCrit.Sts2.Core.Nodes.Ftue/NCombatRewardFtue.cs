...
public class NCombatRewardFtue : NFtue
{
    ...
    public static NCombatRewardFtue? Create(Control rewardsContainer)
    {
        ...
        NCombatRewardFtue nCombatRewardFtue = PreloadManager
            .Cache.GetScene(_scenePath)
            .Instantiate<NCombatRewardFtue>(PackedScene.GenEditState.Disabled);
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NCombatRewardFtue>(
