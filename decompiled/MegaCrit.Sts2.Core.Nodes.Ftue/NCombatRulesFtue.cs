...
public class NCombatRulesFtue : NFtue
{
    ...
    public override void _Ready()
    {
        ...
        _prevButton.Connect(
            ...
            Callable.From<NButton>(ToggleLeft)
        );
        _nextButton.Connect(
            NClickableControl.SignalName.Released,
            Callable.From<NButton>(ToggleRight)
        );
    ...
    public void Start()
    {
        ...
        _header.SetTextAutoSize(
            new LocString("ftues", "COMBAT_BASICS_FTUE_HEADER").GetFormattedText()
        );
        ...
        _pageTurnTween
            .TweenProperty(_image, "modulate:a", 1f, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Cubic)
            .From(0f);
        _pageTurnTween
            .TweenProperty(_bodyText, "modulate:a", 1f, 1.0)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Linear);
        _pageTurnTween
            .TweenProperty(_bodyText, "visible_ratio", 1f, 0.6)
            .SetEase(Tween.EaseType.Out)
    ...
    public static NCombatRulesFtue? Create()
    {
        ...
        return PreloadManager
            ...
            .Instantiate<NCombatRulesFtue>(PackedScene.GenEditState.Disabled);
    }
    ...
    private void ToggleLeft(NButton _)
    {
        ...
        switch (_currentPage)
        {
            case 1:
                _prevButton.Visible = false;
                _prevButton.Disable();
                _bodyText.SetTextAutoSize(
                    new LocString("ftues", "TUTORIAL_FTUE_BODY_1").GetFormattedText()
                );
                _image.Texture = _image1;
                break;
            case 2:
                _bodyText.SetTextAutoSize(
                    new LocString("ftues", "TUTORIAL_FTUE_BODY_2").GetFormattedText()
                );
        ...
        _pageTurnTween
            ...
            .From(0.5f);
        _pageTurnTween
            .TweenProperty(_image, "position", _imagePosition, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo)
            .From(_imagePosition - _imageAnimOffset);
        _pageTurnTween
            .TweenProperty(_bodyText, "position", _textPosition, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo)
            .From(_textPosition - _imageAnimOffset);
        _pageTurnTween
            .TweenProperty(_bodyText, "modulate:a", 1f, 0.6)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Linear)
            .From(0f);
        _pageTurnTween
    ...
    private void ToggleRight(NButton _)
    {
        ...
        switch (_currentPage)
        {
            ...
            case 3:
                _bodyText.SetTextAutoSize(
                    new LocString("ftues", "TUTORIAL_FTUE_BODY_3").GetFormattedText()
                );
