...
public class NRestSiteFtue : NFtue
{
    ...
    public static NRestSiteFtue? Create(Control restSiteOptionContainer)
    {
        ...
        NRestSiteFtue nRestSiteFtue = PreloadManager
            .Cache.GetScene(_scenePath)
            .Instantiate<NRestSiteFtue>(PackedScene.GenEditState.Disabled);
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NRestSiteFtue>(
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._restSiteOptionContainer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._restSiteOptionContainer,
            Variant.From(in _restSiteOptionContainer)
        );
    }
