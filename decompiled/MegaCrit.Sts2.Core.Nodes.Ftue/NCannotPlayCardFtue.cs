...
public class NCannotPlayCardFtue : NFtue
{
    ...
    public static NCannotPlayCardFtue? Create()
    {
        ...
        return PreloadManager
            ...
            .Instantiate<NCannotPlayCardFtue>(PackedScene.GenEditState.Disabled);
    }
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.CloseFtueAndEndTurn,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
