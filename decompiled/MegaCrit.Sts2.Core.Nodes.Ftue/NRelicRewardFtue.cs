...
public class NRelicRewardFtue : NFtue
{
    ...
    public override void _Ready()
    {
        ...
        _arrow.GlobalPosition =
            _relicReward.GlobalPosition
            + new Vector2(_relicReward.Size.X * 0.5f, _relicReward.Size.Y);
    ...
    public static NRelicRewardFtue? Create(Control relicReward)
    {
        ...
        NRelicRewardFtue nRelicRewardFtue = PreloadManager
            .Cache.GetScene(_scenePath)
            .Instantiate<NRelicRewardFtue>(PackedScene.GenEditState.Disabled);
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NRelicRewardFtue>(
