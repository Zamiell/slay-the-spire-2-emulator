...
public class NMapSelectFtue : NFtue
{
    ...
    {
        NMapSelectFtue nMapSelectFtue = PreloadManager
            .Cache.GetScene(_scenePath)
            .Instantiate<NMapSelectFtue>(PackedScene.GenEditState.Disabled);
    ...
    {
        await _confirmButton.AwaitSignal<NClickableControl>(
            NClickableControl.SignalName.Released,
            this
        );
    }
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NMapSelectFtue>(
