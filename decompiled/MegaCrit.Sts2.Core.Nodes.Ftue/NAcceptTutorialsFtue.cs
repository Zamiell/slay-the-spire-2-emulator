...
public class NAcceptTutorialsFtue : NFtue
{
    ...
    public override void _Ready()
    {
        ...
        _verticalPopup.SetText(
            new LocString("main_menu_ui", "ENABLE_TUTORIALS.title"),
            new LocString("main_menu_ui", "ENABLE_TUTORIALS.description")
        );
    ...
    )
    {
        ...
        NAcceptTutorialsFtue nAcceptTutorialsFtue = PreloadManager
            .Cache.GetScene(_scenePath)
            .Instantiate<NAcceptTutorialsFtue>(PackedScene.GenEditState.Disabled);
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._charSelectScreen,
                PropertyHint.None,
                "",
