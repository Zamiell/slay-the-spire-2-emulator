...
public class NPowerCardFtue : NFtue
{
    ...
    public static NPowerCardFtue? Create(Control card)
    {
        ...
        NPowerCardFtue nPowerCardFtue = PreloadManager
            .Cache.GetScene(_scenePath)
            .Instantiate<NPowerCardFtue>(PackedScene.GenEditState.Disabled);
    ...
    )
    {
        ...
        {
            ret = VariantUtils.CreateFrom<NPowerCardFtue>(
