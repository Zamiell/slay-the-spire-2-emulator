...
public sealed class FoulPotion : PotionModel
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars =>
        new global::_003C_003Ez__ReadOnlyArray<DynamicVar>(
            new DynamicVar[2] { new DamageVar(12m, ValueProp.Unpowered), new GoldVar(100) }
        );
    ...
    public override bool PassesCustomUsabilityCheck
    {
        get
        {
            ...
            if (
                base.Owner.RunState.CurrentRoom is EventRoom eventRoom
    ...
    protected override async Task OnUse(PlayerChoiceContext choiceContext, Creature? target)
    {
        ...
        else
        {
            ...
            if (
                localMutableEvent == null
                || !(localMutableEvent.Node is NFakeMerchant nFakeMerchant)
            )
            {
                return;
            }
