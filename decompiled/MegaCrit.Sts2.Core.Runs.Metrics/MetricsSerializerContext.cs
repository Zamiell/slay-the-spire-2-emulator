...
[JsonSourceGenerationOptions(
    ...
    Converters = new Type[] { typeof(ModelIdMetricsConverter) }
)]
...
internal class MetricsSerializerContext : JsonSerializerContext, IJsonTypeInfoResolver
{
    ...
    private static readonly JsonEncodedText PropName_achievement = JsonEncodedText.Encode(
        "achievement"
    );

    private static readonly JsonEncodedText PropName_totalAchievements = JsonEncodedText.Encode(
        "totalAchievements"
    );

    private static readonly JsonEncodedText PropName_totalPlaytime = JsonEncodedText.Encode(
        "totalPlaytime"
    );

    private static readonly JsonEncodedText PropName_totalRuns = JsonEncodedText.Encode(
        "totalRuns"
    );
    ...
    private static readonly JsonEncodedText PropName_character = JsonEncodedText.Encode(
        "character"
    );

    private static readonly JsonEncodedText PropName_numPlayers = JsonEncodedText.Encode(
        "numPlayers"
    );

    private static readonly JsonEncodedText PropName_team = JsonEncodedText.Encode("team");

    private static readonly JsonEncodedText PropName_buildType = JsonEncodedText.Encode(
        "buildType"
    );

    private static readonly JsonEncodedText PropName_ascension = JsonEncodedText.Encode(
        "ascension"
    );

    private static readonly JsonEncodedText PropName_totalWinRate = JsonEncodedText.Encode(
        "totalWinRate"
    );

    private static readonly JsonEncodedText PropName_numReloads = JsonEncodedText.Encode(
        "numReloads"
    );

    private static readonly JsonEncodedText PropName_runPlaytime = JsonEncodedText.Encode(
        "runPlaytime"
    );

    private static readonly JsonEncodedText PropName_floorReached = JsonEncodedText.Encode(
        "floorReached"
    );

    private static readonly JsonEncodedText PropName_killedByEncounter = JsonEncodedText.Encode(
        "killedByEncounter"
    );

    private static readonly JsonEncodedText PropName_cardChoices = JsonEncodedText.Encode(
        "cardChoices"
    );

    private static readonly JsonEncodedText PropName_campfireUpgrades = JsonEncodedText.Encode(
        "campfireUpgrades"
    );

    private static readonly JsonEncodedText PropName_eventChoices = JsonEncodedText.Encode(
        "eventChoices"
    );

    private static readonly JsonEncodedText PropName_ancientChoices = JsonEncodedText.Encode(
        "ancientChoices"
    );

    private static readonly JsonEncodedText PropName_relicBuys = JsonEncodedText.Encode(
        "relicBuys"
    );

    private static readonly JsonEncodedText PropName_potionBuys = JsonEncodedText.Encode(
        "potionBuys"
    );

    private static readonly JsonEncodedText PropName_colorlessBuys = JsonEncodedText.Encode(
        "colorlessBuys"
    );

    private static readonly JsonEncodedText PropName_potionDiscards = JsonEncodedText.Encode(
        "potionDiscards"
    );

    private static readonly JsonEncodedText PropName_encounters = JsonEncodedText.Encode(
        "encounters"
    );
    ...
    private static readonly JsonEncodedText PropName_systemRam = JsonEncodedText.Encode(
        "systemRam"
    );

    private static readonly JsonEncodedText PropName_language = JsonEncodedText.Encode("language");

    private static readonly JsonEncodedText PropName_combatSpeed = JsonEncodedText.Encode(
        "combatSpeed"
    );

    private static readonly JsonEncodedText PropName_screenshake = JsonEncodedText.Encode(
        "screenshake"
    );

    private static readonly JsonEncodedText PropName_runTimer = JsonEncodedText.Encode("runTimer");

    private static readonly JsonEncodedText PropName_phobiaMode = JsonEncodedText.Encode(
        "phobiaMode"
    );

    private static readonly JsonEncodedText PropName_cardIndices = JsonEncodedText.Encode(
        "cardIndices"
    );

    private static readonly JsonEncodedText PropName_displayCount = JsonEncodedText.Encode(
        "displayCount"
    );

    private static readonly JsonEncodedText PropName_displayResolution = JsonEncodedText.Encode(
        "displayResolution"
    );

    private static readonly JsonEncodedText PropName_fullscreen = JsonEncodedText.Encode(
        "fullscreen"
    );

    private static readonly JsonEncodedText PropName_aspectRatio = JsonEncodedText.Encode(
        "aspectRatio"
    );

    private static readonly JsonEncodedText PropName_resizeWindows = JsonEncodedText.Encode(
        "resizeWindows"
    );
    ...
    private static readonly JsonEncodedText PropName_totalEpochs = JsonEncodedText.Encode(
        "totalEpochs"
    );
    ...
    public JsonTypeInfo<AchievementMetric> AchievementMetric =>
        _AchievementMetric
        ?? (
            _AchievementMetric =
                (JsonTypeInfo<AchievementMetric>)base.Options.GetTypeInfo(typeof(AchievementMetric))
        );

    public JsonTypeInfo<ModelId> ModelId =>
        _ModelId ?? (_ModelId = (JsonTypeInfo<ModelId>)base.Options.GetTypeInfo(typeof(ModelId)));

    public JsonTypeInfo<ActWinMetric> ActWinMetric =>
        _ActWinMetric
        ?? (
            _ActWinMetric =
                (JsonTypeInfo<ActWinMetric>)base.Options.GetTypeInfo(typeof(ActWinMetric))
        );

    public JsonTypeInfo<AncientMetric> AncientMetric =>
        _AncientMetric
        ?? (
            _AncientMetric =
                (JsonTypeInfo<AncientMetric>)base.Options.GetTypeInfo(typeof(AncientMetric))
        );

    public JsonTypeInfo<CardChoiceMetric> CardChoiceMetric =>
        _CardChoiceMetric
        ?? (
            _CardChoiceMetric =
                (JsonTypeInfo<CardChoiceMetric>)base.Options.GetTypeInfo(typeof(CardChoiceMetric))
        );

    public JsonTypeInfo<EncounterMetric> EncounterMetric =>
        _EncounterMetric
        ?? (
            _EncounterMetric =
                (JsonTypeInfo<EncounterMetric>)base.Options.GetTypeInfo(typeof(EncounterMetric))
        );

    public JsonTypeInfo<EventChoiceMetric> EventChoiceMetric =>
        _EventChoiceMetric
        ?? (
            _EventChoiceMetric =
                (JsonTypeInfo<EventChoiceMetric>)base.Options.GetTypeInfo(typeof(EventChoiceMetric))
        );

    public JsonTypeInfo<RunMetrics> RunMetrics =>
        _RunMetrics
        ?? (_RunMetrics = (JsonTypeInfo<RunMetrics>)base.Options.GetTypeInfo(typeof(RunMetrics)));

    public JsonTypeInfo<SettingsDataMetric> SettingsDataMetric =>
        _SettingsDataMetric
        ?? (
            _SettingsDataMetric =
                (JsonTypeInfo<SettingsDataMetric>)
                    base.Options.GetTypeInfo(typeof(SettingsDataMetric))
        );
    ...
    public JsonTypeInfo<EpochMetric> EpochMetric =>
        _EpochMetric
        ?? (
            _EpochMetric = (JsonTypeInfo<EpochMetric>)base.Options.GetTypeInfo(typeof(EpochMetric))
        );

    public JsonTypeInfo<IEnumerable<ModelId>> IEnumerableModelId =>
        _IEnumerableModelId
        ?? (
            _IEnumerableModelId =
                (JsonTypeInfo<IEnumerable<ModelId>>)
                    base.Options.GetTypeInfo(typeof(IEnumerable<ModelId>))
        );
    ...
    public JsonTypeInfo<List<ActWinMetric>> ListActWinMetric =>
        _ListActWinMetric
        ?? (
            _ListActWinMetric =
                (JsonTypeInfo<List<ActWinMetric>>)
                    base.Options.GetTypeInfo(typeof(List<ActWinMetric>))
        );

    public JsonTypeInfo<List<AncientMetric>> ListAncientMetric =>
        _ListAncientMetric
        ?? (
            _ListAncientMetric =
                (JsonTypeInfo<List<AncientMetric>>)
                    base.Options.GetTypeInfo(typeof(List<AncientMetric>))
        );

    public JsonTypeInfo<List<CardChoiceMetric>> ListCardChoiceMetric =>
        _ListCardChoiceMetric
        ?? (
            _ListCardChoiceMetric =
                (JsonTypeInfo<List<CardChoiceMetric>>)
                    base.Options.GetTypeInfo(typeof(List<CardChoiceMetric>))
        );

    public JsonTypeInfo<List<EncounterMetric>> ListEncounterMetric =>
        _ListEncounterMetric
        ?? (
            _ListEncounterMetric =
                (JsonTypeInfo<List<EncounterMetric>>)
                    base.Options.GetTypeInfo(typeof(List<EncounterMetric>))
        );

    public JsonTypeInfo<List<EventChoiceMetric>> ListEventChoiceMetric =>
        _ListEventChoiceMetric
        ?? (
            _ListEventChoiceMetric =
                (JsonTypeInfo<List<EventChoiceMetric>>)
                    base.Options.GetTypeInfo(typeof(List<EventChoiceMetric>))
        );
    ...
    public static MetricsSerializerContext Default { get; } =
        new MetricsSerializerContext(new JsonSerializerOptions(s_defaultOptions));
    ...
    private JsonTypeInfo<AchievementMetric> Create_AchievementMetric(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<AchievementMetric> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<AchievementMetric> jsonObjectInfoValues =
                new JsonObjectInfoValues<AchievementMetric>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new AchievementMetric { BuildId = (string)args[0], Achievement = (string)args[1] };
            jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) =>
                AchievementMetricPropInit(options);
            jsonObjectInfoValues.ConstructorParameterMetadataInitializer =
                AchievementMetricCtorParamInit;
            jsonObjectInfoValues.ConstructorAttributeProviderFactory = () =>
                typeof(AchievementMetric).GetConstructor(
                    BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                    null,
                    Array.Empty<Type>(),
                    null
    ...
    private static JsonPropertyInfo[] AchievementMetricPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(AchievementMetric).GetProperty(
                "BuildId",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(string),
    ...
    private JsonTypeInfo<ActWinMetric> Create_ActWinMetric(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<ActWinMetric> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<ActWinMetric> objectInfo = new JsonObjectInfoValues<ActWinMetric>
            {
                ...
                ObjectWithParameterizedConstructorCreator = null,
                PropertyMetadataInitializer = (JsonSerializerContext _) =>
                    ActWinMetricPropInit(options),
                ConstructorParameterMetadataInitializer = null,
                ConstructorAttributeProviderFactory = () =>
                    typeof(ActWinMetric).GetConstructor(
                        BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                        null,
                        Array.Empty<Type>(),
                        null
    ...
    private JsonTypeInfo<AncientMetric> Create_AncientMetric(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<AncientMetric> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<AncientMetric> objectInfo = new JsonObjectInfoValues<AncientMetric>
            {
                ...
                ObjectWithParameterizedConstructorCreator = null,
                PropertyMetadataInitializer = (JsonSerializerContext _) =>
                    AncientMetricPropInit(options),
                ConstructorParameterMetadataInitializer = null,
                ConstructorAttributeProviderFactory = () =>
                    typeof(AncientMetric).GetConstructor(
                        BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                        null,
                        Array.Empty<Type>(),
                        null
    ...
    private static JsonPropertyInfo[] AncientMetricPropInit(JsonSerializerOptions options)
    {
        ...
        array[0].IsGetNullable = false;
        array[0].IsSetNullable = false;
        JsonPropertyInfoValues<List<string>> jsonPropertyInfoValues2 =
    ...
    private JsonTypeInfo<CardChoiceMetric> Create_CardChoiceMetric(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<CardChoiceMetric> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<CardChoiceMetric> objectInfo =
                new JsonObjectInfoValues<CardChoiceMetric>
                {
                    ObjectCreator = () => default(CardChoiceMetric),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        CardChoiceMetricPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(CardChoiceMetric).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] CardChoiceMetricPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.JsonPropertyName = null;
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(CardChoiceMetric).GetField(
                "picked",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic
            );
    ...
    private JsonTypeInfo<EncounterMetric> Create_EncounterMetric(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<EncounterMetric> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<EncounterMetric> objectInfo =
                new JsonObjectInfoValues<EncounterMetric>
                {
                    ObjectCreator = () => default(EncounterMetric),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        EncounterMetricPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(EncounterMetric).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] EncounterMetricPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.JsonPropertyName = null;
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(EncounterMetric).GetField(
                "id",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic
            );
        JsonPropertyInfoValues<string> propertyInfo = jsonPropertyInfoValues;
    ...
    private JsonTypeInfo<EventChoiceMetric> Create_EventChoiceMetric(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<EventChoiceMetric> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<EventChoiceMetric> objectInfo =
                new JsonObjectInfoValues<EventChoiceMetric>
                {
                    ObjectCreator = () => default(EventChoiceMetric),
                    ObjectWithParameterizedConstructorCreator = null,
                    PropertyMetadataInitializer = (JsonSerializerContext _) =>
                        EventChoiceMetricPropInit(options),
                    ConstructorParameterMetadataInitializer = null,
                    ConstructorAttributeProviderFactory = () =>
                        typeof(EventChoiceMetric).GetConstructor(
                            BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                            null,
                            Array.Empty<Type>(),
                            null
    ...
    private static JsonPropertyInfo[] EventChoiceMetricPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.JsonPropertyName = null;
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(EventChoiceMetric).GetField(
                "id",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic
            );
        JsonPropertyInfoValues<string> propertyInfo = jsonPropertyInfoValues;
    ...
    private JsonTypeInfo<RunMetrics> Create_RunMetrics(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<RunMetrics> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<RunMetrics> jsonObjectInfoValues =
                new JsonObjectInfoValues<RunMetrics>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new RunMetrics
                {
    ...
    private static JsonPropertyInfo[] RunMetricsPropInit(JsonSerializerOptions options)
    {
        ...
        JsonPropertyInfoValues<List<CardChoiceMetric>> jsonPropertyInfoValues7 =
            new JsonPropertyInfoValues<List<CardChoiceMetric>>();
        ...
        JsonPropertyInfoValues<List<string>> jsonPropertyInfoValues8 =
            new JsonPropertyInfoValues<List<string>>();
        ...
        JsonPropertyInfoValues<List<EventChoiceMetric>> jsonPropertyInfoValues9 =
            new JsonPropertyInfoValues<List<EventChoiceMetric>>();
        ...
        JsonPropertyInfoValues<List<AncientMetric>> jsonPropertyInfoValues10 =
            new JsonPropertyInfoValues<List<AncientMetric>>();
        ...
        JsonPropertyInfoValues<List<EncounterMetric>> jsonPropertyInfoValues11 =
            new JsonPropertyInfoValues<List<EncounterMetric>>();
        ...
        JsonPropertyInfoValues<List<ActWinMetric>> jsonPropertyInfoValues12 =
            new JsonPropertyInfoValues<List<ActWinMetric>>();
        ...
        JsonPropertyInfoValues<IEnumerable<ModelId>> jsonPropertyInfoValues13 =
            new JsonPropertyInfoValues<IEnumerable<ModelId>>();
    ...
    private JsonTypeInfo<SettingsDataMetric> Create_SettingsDataMetric(
    ...
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<SettingsDataMetric> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<SettingsDataMetric> jsonObjectInfoValues =
                new JsonObjectInfoValues<SettingsDataMetric>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new SettingsDataMetric
                {
                    BuildId = (string)args[0],
                    FastModeType = (FastModeType)args[1],
                };
            jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) =>
                SettingsDataMetricPropInit(options);
            jsonObjectInfoValues.ConstructorParameterMetadataInitializer =
                SettingsDataMetricCtorParamInit;
            jsonObjectInfoValues.ConstructorAttributeProviderFactory = () =>
                typeof(SettingsDataMetric).GetConstructor(
                    BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                    null,
                    Array.Empty<Type>(),
                    null
    ...
    private static JsonPropertyInfo[] SettingsDataMetricPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.JsonPropertyName = "buildId";
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(SettingsDataMetric).GetProperty(
                "BuildId",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(string),
        ...
        JsonPropertyInfoValues<FastModeType> jsonPropertyInfoValues3 =
        ...
        array[10] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo11);
        JsonPropertyInfoValues<Vector2I> jsonPropertyInfoValues5 =
        ...
        jsonPropertyInfoValues5.Getter = (object obj) =>
            ((SettingsDataMetric)obj).DisplayResolution;
        ...
        array[12] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo13);
        JsonPropertyInfoValues<AspectRatioSetting> jsonPropertyInfoValues6 =
        ...
        array[14] = JsonMetadataServices.CreatePropertyInfo(options, propertyInfo15);
        JsonPropertyInfoValues<VSyncType> jsonPropertyInfoValues7 =
    ...
    )
    {
        ...
        {
            JsonConverter converter = ExpandConverter(
                typeof(AspectRatioSetting),
                new JsonStringEnumConverter<AspectRatioSetting>(),
                options
            );
    ...
    private JsonTypeInfo<FastModeType> Create_FastModeType(JsonSerializerOptions options)
    {
        ...
        )
        {
            JsonConverter converter = ExpandConverter(
                typeof(FastModeType),
                new JsonStringEnumConverter<FastModeType>(),
                options
            );
    ...
    private JsonTypeInfo<VSyncType> Create_VSyncType(JsonSerializerOptions options)
    {
        ...
        )
        {
            JsonConverter converter = ExpandConverter(
                typeof(VSyncType),
                new JsonStringEnumConverter<VSyncType>(),
                options
            );
    ...
    private JsonTypeInfo<EpochMetric> Create_EpochMetric(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<EpochMetric> jsonTypeInfo
            )
        )
        {
            JsonObjectInfoValues<EpochMetric> jsonObjectInfoValues =
                new JsonObjectInfoValues<EpochMetric>();
            jsonObjectInfoValues.ObjectCreator = null;
            jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = (object[] args) =>
                new EpochMetric { BuildId = (string)args[0], Epoch = (string)args[1] };
            jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) =>
                EpochMetricPropInit(options);
            jsonObjectInfoValues.ConstructorParameterMetadataInitializer = EpochMetricCtorParamInit;
            jsonObjectInfoValues.ConstructorAttributeProviderFactory = () =>
                typeof(EpochMetric).GetConstructor(
                    BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                    null,
                    Array.Empty<Type>(),
                    null
    ...
    private static JsonPropertyInfo[] EpochMetricPropInit(JsonSerializerOptions options)
    {
        ...
        jsonPropertyInfoValues.JsonPropertyName = "buildId";
        jsonPropertyInfoValues.AttributeProviderFactory = () =>
            typeof(EpochMetric).GetProperty(
                "BuildId",
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                null,
                typeof(string),
    ...
    private JsonTypeInfo<IEnumerable<ModelId>> Create_IEnumerableModelId(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<IEnumerable<ModelId>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<IEnumerable<ModelId>> collectionInfo =
                new JsonCollectionInfoValues<IEnumerable<ModelId>>
                {
                    ObjectCreator = null,
    ...
    private void IEnumerableModelIdSerializeHandler(
        Utf8JsonWriter writer,
        IEnumerable<ModelId>? value
    )
    {
        if (value == null)
        {
    ...
    private JsonTypeInfo<List<ActWinMetric>> Create_ListActWinMetric(JsonSerializerOptions options)
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<ActWinMetric>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<ActWinMetric>> collectionInfo =
                new JsonCollectionInfoValues<List<ActWinMetric>>
                {
                    ObjectCreator = () => new List<ActWinMetric>(),
                    SerializeHandler = ListActWinMetricSerializeHandler,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<List<ActWinMetric>, ActWinMetric>(
                options,
                collectionInfo
            );
            jsonTypeInfo.NumberHandling = null;
    ...
    private JsonTypeInfo<List<AncientMetric>> Create_ListAncientMetric(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<AncientMetric>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<AncientMetric>> collectionInfo =
                new JsonCollectionInfoValues<List<AncientMetric>>
                {
                    ObjectCreator = () => new List<AncientMetric>(),
                    SerializeHandler = ListAncientMetricSerializeHandler,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<List<AncientMetric>, AncientMetric>(
                options,
                collectionInfo
            );
            jsonTypeInfo.NumberHandling = null;
    ...
    private void ListAncientMetricSerializeHandler(
        Utf8JsonWriter writer,
        List<AncientMetric>? value
    )
    {
        if (value == null)
        {
    ...
    private JsonTypeInfo<List<CardChoiceMetric>> Create_ListCardChoiceMetric(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<CardChoiceMetric>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<CardChoiceMetric>> collectionInfo =
                new JsonCollectionInfoValues<List<CardChoiceMetric>>
                {
    ...
    private JsonTypeInfo<List<EncounterMetric>> Create_ListEncounterMetric(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<EncounterMetric>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<EncounterMetric>> collectionInfo =
                new JsonCollectionInfoValues<List<EncounterMetric>>
                {
    ...
    private JsonTypeInfo<List<EventChoiceMetric>> Create_ListEventChoiceMetric(
        JsonSerializerOptions options
    )
    {
        if (
            !TryGetTypeInfoForRuntimeCustomConverter(
                options,
                out JsonTypeInfo<List<EventChoiceMetric>> jsonTypeInfo
            )
        )
        {
            JsonCollectionInfoValues<List<EventChoiceMetric>> collectionInfo =
                new JsonCollectionInfoValues<List<EventChoiceMetric>>
                {
                    ObjectCreator = () => new List<EventChoiceMetric>(),
                    SerializeHandler = ListEventChoiceMetricSerializeHandler,
                };
            jsonTypeInfo = JsonMetadataServices.CreateListInfo<
                List<EventChoiceMetric>,
                EventChoiceMetric
            >(options, collectionInfo);
            jsonTypeInfo.NumberHandling = null;
        }
