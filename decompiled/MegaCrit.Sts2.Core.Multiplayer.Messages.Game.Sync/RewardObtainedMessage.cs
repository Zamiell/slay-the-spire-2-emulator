...
public struct RewardObtainedMessage : INetMessage, IPacketSerializable, IRunLocationTargetedMessage
{
    ...
    public void Deserialize(PacketReader reader)
    {
        ...
        switch (rewardType)
        {
            ...
            case RewardType.Gold:
                ...
                break;
            case RewardType.Potion:
                potionModel = ModelDb.GetById<PotionModel>(
                    reader.ReadModelIdAssumingType<PotionModel>()
                );
                break;
            case RewardType.Relic:
    ...
    public override string ToString()
    {
        ...
        StringBuilder.AppendInterpolatedStringHandler handler =
            new StringBuilder.AppendInterpolatedStringHandler(29, 4, stringBuilder2);
