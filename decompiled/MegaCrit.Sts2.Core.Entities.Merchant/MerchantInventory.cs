...
public class MerchantInventory
{
    ...
    public IEnumerable<MerchantEntry> AllEntries
    {
        get
        {
            IEnumerable<MerchantEntry>[] obj = new IEnumerable<MerchantEntry>[4]
            {
                CardEntries,
                RelicEntries,
                PotionEntries,
            ...
            else
            {
                IEnumerable<MerchantEntry> enumerable =
                    new global::_003C_003Ez__ReadOnlySingleElementList<MerchantEntry>(
                        CardRemovalEntry
                    );
                enumerable2 = enumerable;
            }
    ...
    public IEnumerable<MerchantCardEntry> CardEntries =>
        CharacterCardEntries.Concat(ColorlessCardEntries);
    ...
    private void PopulateCharacterCardEntries()
    {
        ...
        List<CardModel> cardPool = Player
        ...
        {
            MerchantCardEntry merchantCardEntry = new MerchantCardEntry(
                Player,
                this,
                cardPool,
                _coloredCardTypes[i]
    ...
    {
        List<CardModel> cardPool = ModelDb
