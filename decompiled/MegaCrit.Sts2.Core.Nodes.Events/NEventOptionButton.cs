...
public class NEventOptionButton : NButton
{
    ...
    private static readonly string _voteIconPath = SceneHelper.GetScenePath(
        "ui/multiplayer_vote_icon"
    );
    ...
    private static string AncientScenePath =>
        SceneHelper.GetScenePath("events/ancient_event_option_button");

    public static IEnumerable<string> AssetPaths =>
        new global::_003C_003Ez__ReadOnlyArray<string>(
            new string[3] { ScenePath, AncientScenePath, _voteIconPath }
        );

    public static NEventOptionButton Create(EventModel eventModel, EventOption option, int index)
    {
        NEventOptionButton nEventOptionButton = (
            (eventModel is AncientEventModel)
                ? PreloadManager
                    .Cache.GetScene(AncientScenePath)
                    .Instantiate<NEventOptionButton>(PackedScene.GenEditState.Disabled)
                : PreloadManager
    ...
    public void AnimateIn()
    {
        if (GodotObject.IsInstanceValid(this))
        {
            ...
            _animInTween.Chain();
            _animInTween
                .TweenProperty(this, "position", base.Position, flag ? 0.25 : 0.5)
    ...
    protected override void OnRelease()
    {
        ...
        if (WillKillPlayer())
        {
            if (Event.Owner.RunState.Players.Count > 1)
            {
                ...
                {
                    LocString eventDeathPreventionLine = Event
                        .Owner
                        .Character
                        .EventDeathPreventionLine;
                    _deathPreventionVfx = NThoughtBubbleVfx.Create(
                        eventDeathPreventionLine.GetFormattedText(),
                        DialogueSide.Right,
                        null
                    );
    ...
    {
        ScreenRumbleInstance rumble = new ScreenRumbleInstance(
            20f,
            0.30000001192092896,
            10f,
            RumbleStyle.Rumble
    ...
    protected override void OnPress()
    {
        if (!Option.IsLocked)
        {
            ...
            _tween
                .TweenProperty(this, "scale", _pressScale, 0.5)
                .SetEase(Tween.EaseType.Out)
                .SetTrans(Tween.TransitionType.Expo);
            _tween
                .TweenMethod(Callable.From<float>(UpdateShaderParam), 1.2f, 0.9f, 0.5)
                .SetEase(Tween.EaseType.Out)
                .SetTrans(Tween.TransitionType.Expo);
            base.OnPress();
        }
    ...
    protected override void OnFocus()
    {
        if (!Option.IsLocked)
        {
            ...
            NHoverTipSet.CreateAndShow(
                this,
                Option.HoverTips,
                (Event.LayoutType != EventLayoutType.Combat)
    ...
    public async Task FlashConfirmation()
    {
        ...
        _flashTween
            .TweenProperty(_confirmFlash, "modulate:a", 0.8f, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _flashTween
            .Parallel()
            .TweenProperty(_confirmFlash, "scale", new Vector2(1.03f, 1.1f), 0.25)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _flashTween
            .TweenProperty(_confirmFlash, "scale", Vector2.One, 0.25)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
    ...
    public void GrayOut()
    {
        ...
        lightGray.A = 0.5f;
        flashTween
            .TweenProperty(this, property, lightGray, 0.3)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
    }
    ...
    private void PulseKillGlow()
    {
        ...
        _killGlowTween
            .TweenProperty(_killGlow, "modulate:a", 1f, 0.2)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.ShowPersistentKillGlow,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._playerVoteContainer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._deathPreventionVfx,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                ...
                PropertyName._deathPreventionVfxPosition,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._deathPreventionVfxPosition,
            Variant.From(in _deathPreventionVfxPosition)
        );
    }
