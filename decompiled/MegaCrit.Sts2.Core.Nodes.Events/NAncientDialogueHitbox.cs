...
public class NAncientDialogueHitbox : NButton
{
    ...
    public override void _Ready()
    {
        ...
        _loopTween
            .TweenProperty(_arrow, "position:x", _arrow.Position.X + 4f, 0.4)
            .SetEase(Tween.EaseType.InOut)
            .SetTrans(Tween.TransitionType.Sine);
        _loopTween
            .Chain()
            .TweenProperty(_arrow, "position:x", _arrow.Position.X - 4f, 0.6)
            .SetEase(Tween.EaseType.InOut)
            .SetTrans(Tween.TransitionType.Sine);
    ...
    protected override void OnRelease()
    {
        ...
        _tween
            .TweenProperty(_arrow, "scale", Vector2.One, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
    }
    ...
    protected override void OnPress()
    {
        ...
        _tween = CreateTween().SetParallel();
        _tween
            .TweenProperty(_label, "scale", Vector2.One * 0.9f, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _tween
            .TweenProperty(_arrow, "scale", Vector2.One * 0.9f, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _isAnimating = false;
    }
