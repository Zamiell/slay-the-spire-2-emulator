...
public class NAncientDialogueLine : NButton
{
    ...
    {
        NAncientDialogueLine nAncientDialogueLine = PreloadManager
            .Cache.GetScene("res://scenes/events/ancient_dialogue_line.tscn")
            .Instantiate<NAncientDialogueLine>(PackedScene.GenEditState.Disabled);
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.SetAncientAsSpeaker,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.SetCharacterAsSpeaker,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.SetSpeakerIconVisible,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.FadeInStaleDialogue,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.FadeOutStaleDialogue,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
