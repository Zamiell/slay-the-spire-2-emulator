...
public class NCombatEventLayout : NEventLayout
{
    ...
    public override void SetEvent(EventModel eventModel)
    {
        ...
        ICombatRoomVisuals visuals = eventModel.CreateCombatRoomVisuals(
            runState.Players,
            runState.Act
        );
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._combatRoomContainer,
                PropertyHint.None,
                "",
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName.EmbeddedCombatRoom,
            Variant.From<NCombatRoom>(EmbeddedCombatRoom)
        );
