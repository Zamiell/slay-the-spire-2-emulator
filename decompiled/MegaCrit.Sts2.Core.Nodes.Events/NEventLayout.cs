...
public class NEventLayout : Control
{
    ...
    private static readonly LocString _sharedEventLoc = new LocString(
        "events",
        "SHARED_EVENT_INFO"
    );
    ...
    public IEnumerable<NEventOptionButton> OptionButtons =>
        _optionsContainer.GetChildren().OfType<NEventOptionButton>();
        ...
        if (_currentPhobiaPortraitTex != null)
        {
            if (_portrait == null)
            {
                throw new InvalidOperationException(
                    "Trying to set a portrait in an event layout that doesn't have one."
                );
            }
    ...
    public void SetPortrait(Texture2D portrait, Texture2D? phobiaModePortrait = null)
    {
        ...
        _portrait.Texture = (
            (SaveManager.Instance.PrefsSave.PhobiaMode && _currentPhobiaPortraitTex != null)
                ? _currentPhobiaPortraitTex
                : _currentPortraitTex
        );
    }
    ...
    protected virtual void AnimateIn()
    {
        ...
        if (_description != null)
        {
            ...
            if (_title != null)
            {
                _descriptionTween.TweenProperty(
                    _title,
                    "modulate",
                    Colors.White,
                    flag ? 0.25 : 0.5
            ...
            _descriptionTween
                .TweenProperty(_description, "modulate", Colors.White, flag ? 0.5 : 1.0)
                .SetDelay(0.25);
            _descriptionTween
                .TweenProperty(_description, "visible_ratio", 1f, flag ? 0.5 : 1.0)
                .SetDelay(0.25)
                .From(0f)
            ...
            {
                _descriptionTween
                    .TweenProperty(_sharedEventLabel, "modulate", Colors.White, flag ? 0.25 : 0.5)
                    .SetDelay(0.25);
            }
        }
    }
    ...
    public void AddOptions(IEnumerable<EventOption> options)
    {
        if (_sharedEventLabel != null)
        {
            ...
            sharedEventLabel.Visible =
                eventModel != null
                && eventModel.IsShared
                && !eventModel.IsFinished
                && _event.Owner.RunState.Players.Count > 1;
        }
        foreach (EventOption option in options)
        {
            NEventOptionButton nEventOptionButton = NEventOptionButton.Create(
                _event,
                option,
                _optionsContainer.GetChildCount()
            );
        ...
        if (childCount != 0)
        {
            ...
            for (int i = 0; i < childCount; i++)
            {
                ...
                child.FocusNeighborTop = (
                    (i > 0) ? _optionsContainer.GetChild<Control>(i - 1).GetPath() : path2
                );
                child.FocusNeighborBottom = (
                    (i < childCount - 1)
                        ? _optionsContainer.GetChild<Control>(i + 1).GetPath()
                        : path
                );
            }
            AnimateButtonsIn();
    ...
    public async Task BeforeSharedOptionChosen(EventOption option)
    {
        ...
        EventSplitVoteAnimation eventSplitVoteAnimation = new EventSplitVoteAnimation(
            this,
            _event.Owner.RunState
        );
    ...
    public override void _Input(InputEvent inputEvent)
    {
        if (inputEvent.IsActionReleased(DebugHotkey.hideEventUi))
        {
            ...
            NGame.Instance.AddChildSafely(
                NFullscreenTextVfx.Create(_isDebugUiVisible ? "Hide Event UI" : "Show Event UI")
            );
        }
    }
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.AddVfxAnchoredToPortrait,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.RemoveNodesOnPortrait,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.DisableEventOptions,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    )
    {
        ...
        {
            SetPortrait(
                VariantUtils.ConvertTo<Texture2D>(in args[0]),
                VariantUtils.ConvertTo<Texture2D>(in args[1])
            );
            ret = default(godot_variant);
            return true;
        }
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._optionsContainer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._currentPortraitTex,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._currentPhobiaPortraitTex,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._sharedEventLabel,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._currentPhobiaPortraitTex,
            Variant.From(in _currentPhobiaPortraitTex)
        );
