...
public class NAncientEventLayout : NEventLayout
{
    public new class MethodName : NEventLayout.MethodName
    {
        ...
        public static new readonly StringName InitializeVisuals = "InitializeVisuals";

        public static new readonly StringName AnimateIn = "AnimateIn";
        ...
        public static new readonly StringName OnSetupComplete = "OnSetupComplete";

        public static new readonly StringName AnimateButtonsIn = "AnimateButtonsIn";
    ...
    public new class PropertyName : NEventLayout.PropertyName
    {
        ...
        public static new readonly StringName DefaultFocusedControl = "DefaultFocusedControl";
        ...
        public static readonly StringName _originalContentContainerHeight =
            "_originalContentContainerHeight";
    ...
    public override void _Ready()
    {
        ...
        _dialogueHitbox.Connect(
            NClickableControl.SignalName.Released,
            Callable.From<NClickableControl>(OnDialogueHitboxClicked)
        );
        ...
        _contentContainer.Size = new Vector2(
            _contentContainer.Size.X,
            _fakeNextButtonContainer.GlobalPosition.Y - _contentContainer.GlobalPosition.Y
        );
        UpdateHotkeyDisplay();
    ...
    public override void _ExitTree()
    {
        ...
        NInputManager.Instance.Disconnect(
            NInputManager.SignalName.InputRebound,
            Callable.From(UpdateHotkeyDisplay)
        );
    }
    ...
    protected override void InitializeVisuals()
    {
        ...
        if (ancientEvent != null && ancientEvent.Owner != null && ancientEvent.HealedAmount > 0)
        {
            TaskHelper.RunSafely(
                PlayHealVfxAfterFadeIn(_ancientEvent.Owner, _ancientEvent.HealedAmount)
            );
        }
        ...
        _ancientBgContainer.AddChildSafely(
            _ancientEvent
    ...
    public void SetDialogue(IReadOnlyList<AncientDialogueLine> lines)
    {
        ...
        {
            NAncientDialogueLine nAncientDialogueLine = NAncientDialogueLine.Create(
                line,
                _ancientEvent,
                _ancientEvent.Owner.Character
            );
            nAncientDialogueLine.Connect(
                NClickableControl.SignalName.Focused,
                Callable.From<NClickableControl>(OnDialogueLineFocused)
            );
            nAncientDialogueLine.Connect(
                NClickableControl.SignalName.Unfocused,
                Callable.From<NClickableControl>(OnDialogueLineUnfocused)
            );
    ...
    private void OnDialogueLineUnfocused(NClickableControl dialogueLine)
    {
        if (
            !_dialogueContainer
                .GetChild<NAncientDialogueLine>(_currentDialogueLine)
                .Equals(dialogueLine)
        )
        {
            for (int i = 0; i < _currentDialogueLine; i++)
    ...
    private void SetDialogueLineAndAnimate(int lineIndex)
    {
        ...
        NAncientDialogueLine childOrNull = _dialogueContainer.GetChildOrNull<NAncientDialogueLine>(
        ...
        _contentTween
            .TweenProperty(
                _content,
                "position",
                new Vector2(_content.Position.X, _contentContainer.Size.Y - num),
                1.0
            )
    ...
    {
        LocString locString = (
            (_dialogue.Count > _currentDialogueLine)
                ? _dialogue[_currentDialogueLine].NextButtonText
                : null
        );
        if (locString != null)
        {
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnDialogueLineFocused,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnDialogueLineUnfocused,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnDialogueHitboxClicked,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.SetDialogueLineAndAnimate,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.UpdateFakeNextButton,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.UpdateBannerVisibility,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Int,
                PropertyName._currentDialogueLine,
                PropertyHint.None,
                "",
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._ancientBgContainer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._ancientNameBanner,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._contentContainer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName._originalContentContainerHeight,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._dialogueContainer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._fakeNextButtonContainer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._fakeNextButtonControllerIcon,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._fakeNextButtonLabel,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName.IsDialogueOnLastLine,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._originalContentContainerHeight,
            Variant.From(in _originalContentContainerHeight)
        );
        ...
        info.AddProperty(
            PropertyName._fakeNextButtonContainer,
            Variant.From(in _fakeNextButtonContainer)
        );
        info.AddProperty(PropertyName._fakeNextButton, Variant.From(in _fakeNextButton));
        info.AddProperty(
            PropertyName._fakeNextButtonControllerIcon,
            Variant.From(in _fakeNextButtonControllerIcon)
        );
