...
public class NMerchantCard : NMerchantSlot
{
    public new class MethodName : NMerchantSlot.MethodName
    {
        ...
        public static new readonly StringName UpdateVisual = "UpdateVisual";

        public static readonly StringName OnInventoryOpened = "OnInventoryOpened";

        public static new readonly StringName OnPreview = "OnPreview";

        public static new readonly StringName CreateHoverTip = "CreateHoverTip";
    ...
    public new class PropertyName : NMerchantSlot.PropertyName
    {
        ...
        public static new readonly StringName Visual = "Visual";
        ...
        public static new readonly StringName _hoverTween = "_hoverTween";
    }
    ...
    protected void OnSuccessfulPurchase(PurchaseStatus _, MerchantEntry __)
    {
        ...
        NRun.Instance?.GlobalUi.TopBar.TrailContainer.AddChildSafely(
            NCardFlyVfx.Create(
                ...
                PileType.Deck,
                isAddingToPile: true,
                _cardNode.Model.Owner.Character.TrailPath
            )
        );
        _cardNode = null;
        UpdateVisual();
    ...
    {
        NHoverTipSet
            .CreateAndShow(this, _cardEntry.CreationResult.Card.HoverTips)
