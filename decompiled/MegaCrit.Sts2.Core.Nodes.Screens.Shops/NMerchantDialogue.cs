...
public class NMerchantDialogue : Node2D
{
    ...
    private void ShowRandom(IEnumerable<LocString> lines)
    {
        ...
        if (locString != null)
        {
            ...
            base.Position = new Vector2(
                Rng.Chaotic.NextFloat(_xRange.X, _xRange.Y),
                base.Position.Y
            );
            _tween?.Kill();
            ...
            _tween
                .TweenProperty(_dialogueBox, "position:y", 0f, 0.5)
                .From(-80f)
                .SetEase(Tween.EaseType.Out)
                .SetTrans(Tween.TransitionType.Back);
            _tween.Chain();
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.ShowOnInventoryOpen,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.ShowForPurchaseAttempt,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
