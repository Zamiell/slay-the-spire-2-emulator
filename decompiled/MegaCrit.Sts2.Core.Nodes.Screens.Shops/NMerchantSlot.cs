...
public abstract class NMerchantSlot : Control
{
    ...
    {
        add { backing_Hovered = (HoveredEventHandler)Delegate.Combine(backing_Hovered, value); }
        remove { backing_Hovered = (HoveredEventHandler)Delegate.Remove(backing_Hovered, value); }
    }
    ...
    private void OnUnfocus()
    {
        ...
        _hoverTween
            .TweenProperty(this, "scale", _smallScale, 0.5)
    ...
    protected void OnPurchaseFailed(PurchaseStatus status)
    {
        ...
        _purchaseFailedTween
            .TweenMethod(Callable.From<float>(WiggleAnimation), 0f, 2f, 0.4000000059604645)
            .SetEase(Tween.EaseType.Out)
    ...
    private void WiggleAnimation(float progress)
    {
        if (Visual is Node2D node2D)
        {
            ...
            position.X =
                _originalVisualPosition.Value
                + (float)Math.Sin(progress * (float)Math.PI * 2f) * 10f;
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.TriggerMerchantHandToPointHere,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnMerchantHandHovered,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnMerchantHandUnhovered,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._purchaseFailedTween,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName._ignoreMouseRelease,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void RestoreGodotObjectData(GodotSerializationInfo info)
    {
        ...
        if (
            info.TryGetSignalEventDelegate<UnhoveredEventHandler>(
                SignalName.Unhovered,
                out var value9
            )
        )
        {
