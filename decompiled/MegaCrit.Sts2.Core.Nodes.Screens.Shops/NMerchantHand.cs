...
public class NMerchantHand : Node
{
    ...
    public override void _Process(double delta)
    {
        ...
        _parent.GlobalPosition = _parent.GlobalPosition.Lerp(
            _targetPos + new Vector2(x, y) * 100f,
            (float)delta * 4f
        );
        _bone?.SetRotation(
            Mathf.Lerp(-10f, 10f, (_parent.Position.X - _rug.Size.X * 0.5f - 50f) * 0.01f)
        );
    }
