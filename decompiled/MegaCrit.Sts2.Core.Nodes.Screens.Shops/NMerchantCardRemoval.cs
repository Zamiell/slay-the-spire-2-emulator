...
public class NMerchantCardRemoval : NMerchantSlot
{
    ...
    private LocString Description =>
        new LocString("merchant_room", "MERCHANT.cardRemovalService.description");
        ...
        if (nHoverTipSet != null)
        {
            ...
            else
            {
                nHoverTipSet.GlobalPosition +=
                    Vector2.Right * base.Size.X * 0.5f * base.Scale
                    + Vector2.Up * base.Size.Y * 0.5f * base.Scale;
            }
        }
    }
