...
public class NRestSiteButton : NButton
{
    ...
    public RestSiteOption Option
    {
        ...
        {
            return _option
                ?? throw new InvalidOperationException("Option accessed before being set");
        }
        set
        {
            _option = value;
    ...
    private async Task AnimateIn()
    {
        ...
        tween
            .TweenProperty(this, "modulate", Colors.White, 0.5)
    ...
    {
        NRestSiteButton nRestSiteButton = PreloadManager
            .Cache.GetScene(_scenePath)
            .Instantiate<NRestSiteButton>(PackedScene.GenEditState.Disabled);
    ...
    private async Task SelectOption(RestSiteOption option)
    {
        ...
        if (num < 0)
        {
            throw new InvalidOperationException(
                $"Rest site option {option} was selected, but it was not in the list of rest site options!"
            );
        }
    ...
    protected override void OnPress()
    {
        if (!_isUnclickable)
        {
            ...
            _currentTween
                .TweenProperty(_visuals, "scale", Vector2.One * 0.9f, 1.0)
                .SetEase(Tween.EaseType.Out)
                .SetTrans(Tween.TransitionType.Expo);
            _currentTween
                .TweenProperty(_label, "position", _labelPosition, 1.0)
                .SetEase(Tween.EaseType.Out)
                .SetTrans(Tween.TransitionType.Expo);
            _currentTween
                .TweenProperty(_outline, "scale", Vector2.One * 0.9f, 1.0)
                .SetEase(Tween.EaseType.Out)
                .SetTrans(Tween.TransitionType.Expo);
            _currentTween
                .TweenMethod(Callable.From<float>(UpdateShaderParam), 1.2f, 1f, 1.0)
                .SetEase(Tween.EaseType.Out)
                .SetTrans(Tween.TransitionType.Expo);
        }
    }
    ...
    protected override void OnUnfocus()
    {
        ...
        _currentTween = CreateTween().SetParallel();
        _currentTween
            .TweenProperty(_visuals, "scale", Vector2.One, 1.0)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _currentTween
            .TweenProperty(_label, "position", _labelPosition, 1.0)
