...
public class NRestSiteCharacter : Node2D
{
    ...
    private static readonly string _multiplayerConfirmationScenePath = SceneHelper.GetScenePath(
        "rest_site/rest_site_multiplayer_confirmation"
    );
    ...
    {
        NRestSiteCharacter nRestSiteCharacter = PreloadManager
            .Cache.GetScene(player.Character.RestSiteAnimPath)
    ...
    public override void _Ready()
    {
        ...
        {
            MegaTrackEntry megaTrackEntry = new MegaSprite(childSpineNode)
                .GetAnimationState()
                .SetAnimation(animationName);
            megaTrackEntry?.SetTrackTime(
                megaTrackEntry.GetAnimationEnd() * Rng.Chaotic.NextFloat()
            );
        }
    ...
    private void RandomizeFire(ShaderMaterial mat)
    {
        ...
        mat.SetShaderParameter(
            _noise1Panning,
            mat.GetShaderParameter(_noise1Panning).AsVector2()
                + new Vector2(
        ...
        mat.SetShaderParameter(
            _noise2Panning,
            mat.GetShaderParameter(_noise2Panning).AsVector2()
                + new Vector2(
                    Rng.Chaotic.NextFloat(-0.1f, 0.1f),
                    Rng.Chaotic.NextFloat(-0.1f, 0.1f)
                )
    ...
    private void RefreshThoughtBubbleVfx()
    {
        ...
        if (_thoughtBubbleVfx == null)
        {
            ...
            bool flag2 = flag;
            _thoughtBubbleVfx = NThoughtBubbleVfx.Create(
                restSiteOption.Icon,
                (!flag2) ? DialogueSide.Left : DialogueSide.Right,
                null
            );
            ShaderMaterial shaderMaterial = (ShaderMaterial)
                _thoughtBubbleVfx.GetNode<TextureRect>("%Image").Material;
    ...
    public void ShowSelectedRestSiteOption(RestSiteOption option)
    {
        ...
        _selectedOptionConfirmation = PreloadManager
            .Cache.GetScene(_multiplayerConfirmationScenePath)
        ...
        _selectedOptionConfirmation.Position +=
            _multiplayerConfirmationOffset
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.RefreshThoughtBubbleVfx,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.GetRestSiteOptionAnchor,
                new PropertyInfo(
                    Variant.Type.Object,
                    "",
                    PropertyHint.None,
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._leftThoughtAnchor,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._rightThoughtAnchor,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._thoughtBubbleVfx,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._selectedOptionConfirmation,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._selectedOptionConfirmation,
            Variant.From(in _selectedOptionConfirmation)
        );
    }
