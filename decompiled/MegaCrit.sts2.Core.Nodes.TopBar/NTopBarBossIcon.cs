...
public class NTopBarBossIcon : NClickableControl
{
    ...
    private static readonly LocString _bossHoverTipTitle = new LocString(
        "static_hover_tips",
        "BOSS.title"
    );

    private static readonly LocString _bossHoverTipDescription = new LocString(
        "static_hover_tips",
        "BOSS.description"
    );

    private static readonly LocString _doubleBossHoverTipTitle = new LocString(
        "static_hover_tips",
        "DOUBLE_BOSS.title"
    );

    private static readonly LocString _doubleBossHoverTipDescription = new LocString(
        "static_hover_tips",
        "DOUBLE_BOSS.description"
    );
    ...
    private void OnRoomEntered()
    {
        if (_runState.CurrentRoom != null)
        {
            ...
            base.FocusMode = (FocusModeEnum)(
                (baseRoom.RoomType != RoomType.Boss || ShouldOnlyShowSecondBossIcon) ? 2 : 0
            );
    ...
    public void RefreshBossIcon()
    {
        EncounterModel encounterModel = (
            ShouldOnlyShowSecondBossIcon
                ? _runState.Act.SecondBossEncounter
                : _runState.Act.BossEncounter
        );
        string roomIconPath = ImageHelper.GetRoomIconPath(
            MapPointType.Boss,
            RoomType.Boss,
            encounterModel.Id
        );
        string roomIconOutlinePath = ImageHelper.GetRoomIconOutlinePath(
            MapPointType.Boss,
            RoomType.Boss,
            encounterModel.Id
        );
        ...
        if (secondBossEncounter != null && !ShouldOnlyShowSecondBossIcon)
        {
            if (_secondBossIcon == null)
            {
                PackedScene packedScene = GD.Load<PackedScene>(
                    "res://scenes/ui/top_bar/second_boss_icon.tscn"
                );
                _secondBossIcon = packedScene.Instantiate<TextureRect>(
            ...
            string roomIconPath2 = ImageHelper.GetRoomIconPath(
                MapPointType.Boss,
                RoomType.Boss,
                secondBossEncounter.Id
            );
            string roomIconOutlinePath2 = ImageHelper.GetRoomIconOutlinePath(
                MapPointType.Boss,
                RoomType.Boss,
                secondBossEncounter.Id
            );
            _secondBossIcon.Texture = PreloadManager.Cache.GetTexture2D(roomIconPath2);
            _secondBossIconOutline.Texture = PreloadManager.Cache.GetTexture2D(
                roomIconOutlinePath2
            );
    ...
    {
        if (
            _secondBossIcon?.Material is ShaderMaterial shaderMaterial
            && _secondBossIconOutline?.Material is ShaderMaterial shaderMaterial2
        )
        {
            ...
            Color color = (
                (currentMapPoint == bossMapPoint || currentMapPoint == secondBossMapPoint)
                    ? act.MapTraveledColor
                    : act.MapUntraveledColor
            );
    ...
    protected override void OnFocus()
    {
        ...
        {
            _bossHoverTipTitle.Add(
                "BossName",
                ShouldOnlyShowSecondBossIcon ? secondBossEncounter.Title : bossEncounter.Title
            );
            _bossHoverTipDescription.Add(
                "BossName",
                ShouldOnlyShowSecondBossIcon ? secondBossEncounter.Title : bossEncounter.Title
            );
        ...
        NHoverTipSet
            ...
            ?.SetGlobalPosition(_bossIcon.GlobalPosition + new Vector2(0f, base.Size.Y + 20f));
    }
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.RefreshSecondBossIconColor,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._secondBossIconOutline,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName.ShouldOnlyShowSecondBossIcon,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._secondBossIconOutline,
            Variant.From(in _secondBossIconOutline)
        );
    }
