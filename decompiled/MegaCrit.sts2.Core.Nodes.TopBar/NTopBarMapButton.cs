...
public class NTopBarMapButton : NTopBarButton
{
    ...
    public void StartOscillation()
    {
        ...
        _oscillateTween
            .TweenProperty(_icon, "rotation", -0.12f, 0.8)
    ...
    public void StopOscillation()
    {
        ...
        _oscillateTween = CreateTween();
        _oscillateTween
            .TweenProperty(_icon, "rotation", 0f, 0.5)
    ...
    protected override void OnFocus()
    {
        ...
        HoverTip hoverTip = new HoverTip(
            new LocString("static_hover_tips", "MAP.title"),
            new LocString("static_hover_tips", "MAP.description")
        );
