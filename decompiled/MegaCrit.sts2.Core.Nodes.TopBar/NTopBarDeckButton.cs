...
public class NTopBarDeckButton : NTopBarButton
{
    public new class MethodName : NTopBarButton.MethodName
    {
        ...
        public static new readonly StringName IsOpen = "IsOpen";
    ...
    protected override void OnFocus()
    {
        ...
        nHoverTipSet?.SetGlobalPosition(
            base.GlobalPosition + new Vector2(base.Size.X - nHoverTipSet.Size.X, base.Size.Y + 20f)
        );
    }
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName._rockBaseRotation,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
