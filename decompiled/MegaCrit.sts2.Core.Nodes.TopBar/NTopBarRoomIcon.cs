...
public class NTopBarRoomIcon : NClickableControl
{
        ...
        NHoverTipSet
            .CreateAndShow(
                hoverTip: new HoverTip(
                    new LocString("static_hover_tips", hoverTipPrefixForRoomType + ".title"),
                    new LocString("static_hover_tips", hoverTipPrefixForRoomType + ".description")
                ),
                owner: _roomIcon
            )
            ?.SetGlobalPosition(_roomIcon.GlobalPosition + new Vector2(0f, base.Size.Y + 20f));
    }
        ...
        if (_runState.CurrentRoom != null)
        {
            ...
            switch (currentMapPointType)
            {
                case MapPointType.Boss:
                    modelId = (
                        (_runState.CurrentMapPoint == _runState.Map.SecondBossMapPoint)
                            ? act.SecondBossEncounter.Id
                            : act.BossEncounter.Id
                    );
                    break;
            ...
            if (roomIconOutlinePath != null)
            {
                ...
                _roomIconOutline.Texture = PreloadManager.Cache.GetCompressedTexture2D(
                    roomIconOutlinePath
                );
            }
            else
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.DebugSetMapPointTypeOverride,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.DebugClearMapPointTypeOverride,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.GetHoverTipPrefixForRoomType,
                new PropertyInfo(
                    Variant.Type.String,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.GetHoverTipPrefixForUnknownRoomType,
                new PropertyInfo(
                    Variant.Type.String,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.GetCurrentMapPointType,
                new PropertyInfo(
                    Variant.Type.Int,
                    "",
                    PropertyHint.None,
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Int,
                PropertyName._debugMapPointTypeOverride,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._debugMapPointTypeOverride,
            Variant.From(in _debugMapPointTypeOverride)
        );
    }
