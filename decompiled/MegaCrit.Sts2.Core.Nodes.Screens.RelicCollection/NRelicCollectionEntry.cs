...
public class NRelicCollectionEntry : NButton
{
    ...
    public static readonly string scenePath = SceneHelper.GetScenePath(
        "screens/relic_collection/relic_collection_entry"
    );

    public static readonly string lockedIconPath = ImageHelper.GetImagePath(
        "packed/common_ui/locked_model.png"
    );
    ...
    private static LocString UnknownHoverTipTitle =>
        new LocString("main_menu_ui", "COMPENDIUM_RELIC_COLLECTION.unknown.title");

    private static LocString UnknownHoverTipDescription =>
        new LocString("main_menu_ui", "COMPENDIUM_RELIC_COLLECTION.unknown.description");

    private static HoverTip UnknownHoverTip =>
        new HoverTip(UnknownHoverTipTitle, UnknownHoverTipDescription);

    private static LocString LockedHoverTipTitle =>
        new LocString("main_menu_ui", "COMPENDIUM_RELIC_COLLECTION.locked.title");

    private static LocString LockedHoverTipDescription =>
        new LocString("main_menu_ui", "COMPENDIUM_RELIC_COLLECTION.locked.description");

    private static HoverTip LockedHoverTip =>
        new HoverTip(LockedHoverTipTitle, LockedHoverTipDescription);
    ...
    {
        NRelicCollectionEntry nRelicCollectionEntry = PreloadManager
            .Cache.GetScene(scenePath)
            .Instantiate<NRelicCollectionEntry>(PackedScene.GenEditState.Disabled);
    ...
    protected override void OnRelease()
    {
        ...
        _hoverTween
            .TweenProperty(_relicNode, "scale", Vector2.One, 1.0)
    ...
    protected override void OnFocus()
    {
        ...
        switch (modelVisibility)
        {
            ...
            case ModelVisibility.NotSeen:
                enumerable = new global::_003C_003Ez__ReadOnlySingleElementList<IHoverTip>(
                    UnknownHoverTip
                );
                break;
        ...
        NHoverTipSet
            .CreateAndShow(this, hoverTips, HoverTip.GetHoverTipAlignment(this))
            ?.SetFollowOwner();
    }
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName.ModelVisibility,
            Variant.From<ModelVisibility>(ModelVisibility)
        );
