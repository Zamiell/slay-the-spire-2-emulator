...
public class NSettingsScreen : NSubmenu
{
    ...
    public static string[] AssetPaths =>
        new string[2] { _scenePath, "res://images/ui/language_warning.png" };
    ...
    public event SettingsClosedEventHandler SettingsClosed
    {
        add
        {
            backing_SettingsClosed = (SettingsClosedEventHandler)
                Delegate.Combine(backing_SettingsClosed, value);
        }
        remove
        {
            backing_SettingsClosed = (SettingsClosedEventHandler)
                Delegate.Remove(backing_SettingsClosed, value);
        }
    }
    ...
    public event SettingsOpenedEventHandler SettingsOpened
    {
        add
        {
            backing_SettingsOpened = (SettingsOpenedEventHandler)
                Delegate.Combine(backing_SettingsOpened, value);
        }
        remove
        {
            backing_SettingsOpened = (SettingsOpenedEventHandler)
                Delegate.Remove(backing_SettingsOpened, value);
        }
    }
    ...
    public override void _Ready()
    {
        ...
        _settingsTabManager.Connect(
            NSettingsTabManager.SignalName.TabChanged,
            Callable.From(OnSettingsTabChanged)
        );
        _moddingScreenButton.Connect(
            NClickableControl.SignalName.Released,
            Callable.From<NButton>(OpenModdingScreen)
        );
        _feedbackScreenButton.Connect(
            NClickableControl.SignalName.Released,
            Callable.From((Action<NButton>)OpenFeedbackScreen)
        );
        ...
        {
            GetNode<Node>("%LanguageLine").GetNode<MegaRichTextLabel>("Label").Modulate =
                StsColors.gray;
    ...
    private void LocalizeLabels()
    {
        ...
        LocHelper(
            content.GetNode<Node>("LanguageLine"),
            new LocString("settings_ui", _isInRun ? "LANGUAGE_IN_RUN" : "LANGUAGE")
        );
        ...
        LocHelper(
            content.GetNode<Node>("Screenshake"),
            new LocString("settings_ui", "SCREENSHAKE")
        );
        LocHelper(
            content.GetNode<Node>("CommonTooltips"),
            new LocString("settings_ui", "COMMON_TOOLTIPS")
        );
        LocHelper(
            content.GetNode<Node>("ShowRunTimer"),
            new LocString("settings_ui", "SHOW_RUN_TIMER_HEADER")
        );
        LocHelper(
            content.GetNode<Node>("ShowHandCardCount"),
            new LocString("settings_ui", "SHOW_HAND_CARD_COUNT_HEADER")
        );
        LocHelper(
            content.GetNode<Node>("ShowMpDrawings"),
            new LocString("settings_ui", "SHOW_MP_DRAWINGS_HEADER")
        );
        LocHelper(
            content.GetNode<Node>("LongPressConfirmations"),
            new LocString("settings_ui", "LONG_PRESS_CONFIRMATION_HEADER")
        );
        LocHelper(
            content.GetNode<Node>("SkipIntroLogo"),
            new LocString("settings_ui", "SKIP_INTRO_LOGO_HEADER")
        );
        LocHelper(
            content.GetNode<Node>("LimitFpsInBackground"),
            new LocString("settings_ui", "LIMIT_FPS_IN_BACKGROUND_HEADER")
        );
        LocHelper(
            content.GetNode<Node>("UploadGameplayData"),
            new LocString("settings_ui", "UPLOAD_GAMEPLAY_DATA")
        );
        LocHelper(
            content.GetNode<Node>("TextEffects"),
            new LocString("settings_ui", "TEXT_EFFECTS")
        );
        LocHelper(
            content.GetNode<Node>("SendFeedback"),
            new LocString("settings_ui", "SEND_FEEDBACK")
        );
        LocHelper(
            content.GetNode<Node>("ResetTutorials"),
            new LocString("settings_ui", "TUTORIAL_RESET")
        );
        LocHelper(content.GetNode<Node>("Credits"), new LocString("settings_ui", "CREDITS"));
        LocHelper(
            content.GetNode<Node>("ResetGameplay"),
            new LocString("settings_ui", "RESET_DEFAULT")
        );
        ...
        LocHelper(
            content2.GetNode<Node>("DisplaySelection"),
            new LocString("settings_ui", "DISPLAY_SELECTION")
        );
        LocHelper(
            content2.GetNode<Node>("WindowedResolution"),
            new LocString("settings_ui", "RESOLUTION")
        );
        LocHelper(
            content2.GetNode<Node>("AspectRatio"),
            new LocString("settings_ui", "ASPECT_RATIO")
        );
        LocHelper(
            content2.GetNode<Node>("WindowResizing"),
            new LocString("settings_ui", "WINDOW_RESIZING")
        );
        ...
        LocHelper(
            content2.GetNode<Node>("ResetGraphics"),
            new LocString("settings_ui", "RESET_DEFAULT")
        );
        Node content3 = GetNode<NSettingsPanel>("%SoundSettings").Content;
        LocHelper(
            content3.GetNode<Node>("MasterVolume"),
            new LocString("settings_ui", "MASTER_VOLUME")
        );
        LocHelper(
            content3.GetNode<Node>("BgmVolume"),
            new LocString("settings_ui", "MUSIC_VOLUME")
        );
        LocHelper(content3.GetNode<Node>("SfxVolume"), new LocString("settings_ui", "SFX_VOLUME"));
        LocHelper(
            content3.GetNode<Node>("AmbienceVolume"),
            new LocString("settings_ui", "AMBIENCE_VOLUME")
        );
        LocHelper(
            content3.GetNode<Node>("MuteIfBackground"),
            new LocString("settings_ui", "BACKGROUND_MUTE")
        );
    }
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnSettingsTabChanged,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._settingsTabManager,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._feedbackScreenButton,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._moddingScreenButton,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._feedbackScreenButton,
            Variant.From(in _feedbackScreenButton)
        );
    ...
    protected override void RestoreGodotObjectData(GodotSerializationInfo info)
    {
        ...
        if (
            info.TryGetSignalEventDelegate<SettingsClosedEventHandler>(
                SignalName.SettingsClosed,
                out var value6
            )
        )
        {
        ...
        if (
            info.TryGetSignalEventDelegate<SettingsOpenedEventHandler>(
                SignalName.SettingsOpened,
                out var value7
            )
        )
        {
