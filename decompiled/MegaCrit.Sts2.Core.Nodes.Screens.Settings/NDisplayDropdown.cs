...
public class NDisplayDropdown : NSettingsDropdown
{
    ...
    private static readonly LocString _optionString = new LocString(
        "settings_ui",
        "DISPLAY_DROPDOWN_OPTION"
    );
    ...
    public override void _Ready()
    {
        ...
        {
            NDisplayDropdownItem nDisplayDropdownItem =
                _dropdownItemScene.Instantiate<NDisplayDropdownItem>(
                    PackedScene.GenEditState.Disabled
                );
            _dropdownItems.AddChildSafely(nDisplayDropdownItem);
            nDisplayDropdownItem.Connect(
    ...
    private void OnDropdownItemSelected(NDropdownItem nDropdownItem)
    {
        ...
        if (nDisplayDropdownItem.displayIndex != _currentDisplayIndex)
        {
            ...
            )
            {
                ...
                settingsSave.WindowSize = new Vector2I(
                    (int)((float)vector2I.X * 0.75f),
                    (int)((float)vector2I.Y * 0.75f)
                );
            }
            NResolutionDropdown.Instance.RefreshCurrentlySelectedResolution();
            NResolutionDropdown.Instance.PopulateDropdownItems();
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Int,
                PropertyName._currentDisplayIndex,
                PropertyHint.None,
                "",
