...
public class NWindowResizeTickbox : NSettingsTickbox, IResettableSettingNode
{
    public new class MethodName : NSettingsTickbox.MethodName
    {
        ...
        public static new readonly StringName OnTick = "OnTick";

        public static new readonly StringName OnUntick = "OnUntick";
    ...
    {
        public static new readonly StringName _settingsScreen = "_settingsScreen";
    }
