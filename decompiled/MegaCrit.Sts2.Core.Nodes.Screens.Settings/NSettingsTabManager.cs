...
public class NSettingsTabManager : Control
{
    ...
    private readonly Dictionary<NSettingsTab, NSettingsPanel> _tabs =
        new Dictionary<NSettingsTab, NSettingsPanel>();
    ...
    public event TabChangedEventHandler TabChanged
    {
        add
        {
            backing_TabChanged = (TabChangedEventHandler)
                Delegate.Combine(backing_TabChanged, value);
        }
        remove
        {
    ...
    private void SwitchTabTo(NSettingsTab selectedTab)
    {
        if (selectedTab != _currentTab)
        {
            ...
            _scrollbarTween
                .TweenProperty(_scrollContainer.Scrollbar, "modulate", Colors.White, 0.5)
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName.CurrentlyDisplayedPanel,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void RestoreGodotObjectData(GodotSerializationInfo info)
    {
        ...
        if (
            info.TryGetSignalEventDelegate<TabChangedEventHandler>(
                SignalName.TabChanged,
                out var value6
            )
        )
        {
