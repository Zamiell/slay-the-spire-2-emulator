...
public class NInputSettingsPanel : NSettingsPanel
{
    public new class MethodName : NSettingsPanel.MethodName
    {
        ...
        public static new readonly StringName OnVisibilityChange = "OnVisibilityChange";
    ...
    {
        public static new readonly StringName _minPadding = "_minPadding";
    ...
    public override void _Ready()
    {
        ...
        _commandHeader.Text = new LocString(
            "settings_ui",
            "INPUT_SETTINGS.COMMAND_HEADER"
        ).GetFormattedText();
        _keyboardHeader.Text = new LocString(
            "settings_ui",
            "INPUT_SETTINGS.KEYBOARD_HEADER"
        ).GetFormattedText();
        _controllerHeader.Text = new LocString(
            "settings_ui",
            "INPUT_SETTINGS.CONTROLLER_HEADER"
        ).GetFormattedText();
        _steamInputPrompt.Text = new LocString(
            "settings_ui",
            "INPUT_SETTINGS.STEAM_INPUT_DETECTED"
        ).GetFormattedText();
        IReadOnlyList<StringName> readOnlyList = NInputManager
            .remappableControllerInputs.Concat(NInputManager.remappableKeyboardInputs)
            .Distinct()
            .ToList();
        List<NInputSettingsEntry> list = base
            .Content.GetChildren()
    ...
    public override void _UnhandledKeyInput(InputEvent inputEvent)
    {
        if (
            _listeningEntry != null
            && NInputManager.remappableKeyboardInputs.Contains(_listeningEntry.InputName)
            && inputEvent is InputEventKey inputEventKey
        )
        {
            NInputManager.Instance.ModifyShortcutKey(
                _listeningEntry.InputName,
    ...
    public override void _Input(InputEvent inputEvent)
    {
        ...
        foreach (StringName stringName in allControllerInputs)
        {
            ...
            {
                if (
                    NInputManager.remappableControllerInputs.Contains(_listeningEntry.InputName)
                    && NControllerManager.Instance.ShouldAllowControllerRebinding
                )
                {
                    NInputManager.Instance.ModifyControllerButton(
                        _listeningEntry.InputName,
                        stringName
                    );
                }
    ...
    internal static new List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnViewportSizeChange,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.SetAsListeningEntry,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._resetToDefaultButton,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._controllerHeader,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._steamInputPrompt,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._resetToDefaultButton,
            Variant.From(in _resetToDefaultButton)
        );
