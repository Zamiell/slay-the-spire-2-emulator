...
public class NResetGraphicsButton : NSettingsButton
{
    ...
    public override void _Ready()
    {
        ...
        GetNode<MegaLabel>("Label")
            .SetTextAutoSize(
                new LocString("settings_ui", "RESET_SETTINGS_BUTTON").GetFormattedText()
            );
    }
    ...
    private async Task ResetSettingsAfterConfirmation()
    {
        ...
        if (
            !(
                await nGenericPopup.WaitForConfirmation(
                    new LocString("settings_ui", "RESET_GRAPHICS_CONFIRMATION.body"),
                    new LocString("settings_ui", "RESET_CONFIRMATION.header"),
        ...
        foreach (
            IResettableSettingNode item in ancestorOfType.GetChildrenRecursive<IResettableSettingNode>()
        )
        {
