...
public class NLanguageButton : NButton
{
    ...
    public void Init(string languageIsoCode)
    {
        ...
        _label.SetTextAutoSize(
            new LocString(
                "settings_ui",
                "LANGUAGE_" + languageIsoCode.ToUpperInvariant()
            ).GetRawText()
        );
        _flag.Texture = ResourceLoader.Load<Texture2D>(
            "res://images/ui/settings_screen/flag_" + languageIsoCode + ".png",
            null,
    ...
    protected override void OnRelease()
    {
        ...
        _tween
            .TweenProperty(_image, "self_modulate", new Color("26373d"), 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _tween.TweenProperty(_image, "modulate", Colors.White, 0.05);
        _tween
            .TweenProperty(_image, "scale", Vector2.One, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
        _tween
            .TweenProperty(_label, "modulate", StsColors.cream, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
    }
    ...
    protected override void OnPress()
    {
        ...
        _tween
            .TweenProperty(_image, "scale", Vector2.One * 0.95f, 0.5)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo);
    }
