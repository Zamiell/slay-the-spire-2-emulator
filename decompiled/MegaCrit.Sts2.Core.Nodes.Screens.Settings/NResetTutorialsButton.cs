...
public class NResetTutorialsButton : NSettingsButton
{
    ...
    {
        public static new readonly StringName _image = "_image";

        public static new readonly StringName _label = "_label";
    }

    public new class SignalName : NSettingsButton.SignalName { }

    private readonly LocString _header = new LocString(
        "settings_ui",
        "TUTORIAL_RESET_POPUP_HEADER"
    );

    private readonly LocString _description = new LocString(
        "settings_ui",
        "TUTORIAL_RESET_POPUP_DESCRIPTION"
    );
    ...
    public override void _Ready()
    {
        ...
        _label.SetTextAutoSize(
            new LocString("settings_ui", "TUTORIAL_RESET_BUTTON_LABEL").GetFormattedText()
        );
