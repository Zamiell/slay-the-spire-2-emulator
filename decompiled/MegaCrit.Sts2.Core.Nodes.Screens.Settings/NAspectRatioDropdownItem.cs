        ...
        switch (aspectRatioSetting)
        {
            case AspectRatioSetting.Auto:
                _label.SetTextAutoSize(
                    new LocString("settings_ui", "ASPECT_RATIO_AUTO").GetFormattedText()
                );
                break;
            case AspectRatioSetting.FourByThree:
                _label.SetTextAutoSize(
                    new LocString("settings_ui", "ASPECT_RATIO_FOUR_BY_THREE").GetFormattedText()
                );
                break;
            case AspectRatioSetting.SixteenByTen:
                _label.SetTextAutoSize(
                    new LocString("settings_ui", "ASPECT_RATIO_SIXTEEN_BY_TEN").GetFormattedText()
                );
                break;
            case AspectRatioSetting.SixteenByNine:
                _label.SetTextAutoSize(
                    new LocString("settings_ui", "ASPECT_RATIO_SIXTEEN_BY_NINE").GetFormattedText()
                );
                break;
            ...
            default:
                throw new ArgumentOutOfRangeException(
                    $"Invalid Aspect Ratio: {aspectRatioSetting}"
                );
        }
    }
