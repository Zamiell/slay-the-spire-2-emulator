...
public class RichTextThinkyDots : AbstractMegaRichTextEffect
{
    ...
    {
        public static new readonly StringName _ProcessCustomFX = "_ProcessCustomFX";
    }

    public new class PropertyName : AbstractMegaRichTextEffect.PropertyName
    {
        public static new readonly StringName Bbcode = "Bbcode";
    ...
    public override bool _ProcessCustomFX(CharFXTransform charFx)
    {
        ...
        float val = (float)(
            charFx.ElapsedTime * 1.0 - (double)((float)charFx.RelativeIndex * 0.1f)
        );
        val = Math.Max(val, 0f);
        float num = val % 4.4f;
        ...
        charFx.Visible =
            !env.ContainsKey(RichTextUtil.visibleKey) || (bool)env[RichTextUtil.visibleKey];
        return true;
    }
            ...
            new MethodInfo(
                ...
                new List<PropertyInfo>
                {
                    new PropertyInfo(
                        ...
                        "",
                        PropertyUsageFlags.Default,
                        new StringName("CharFXTransform"),
                        exported: false
                    ),
                },
                null
    ...
    )
    {
        if (method == MethodName._ProcessCustomFX && args.Count == 1)
        {
            ret = VariantUtils.CreateFrom<bool>(
                _ProcessCustomFX(VariantUtils.ConvertTo<CharFXTransform>(in args[0]))
            );
            return true;
        }
