...
public abstract class Reward
{
    ...
    {
        return new SerializableReward { RewardType = RewardType };
    }
        ...
        switch (save.RewardType)
        {
            ...
            case RewardType.SpecialCard:
            {
                ...
                if (save.CustomDescriptionEncounterSourceId != ModelId.none)
                {
                    specialCardReward.SetCustomDescriptionEncounterSource(
                        save.CustomDescriptionEncounterSourceId
                    );
                }
            ...
            case RewardType.Relic:
                if (save.PredeterminedModelId != ModelId.none)
                {
                    return new RelicReward(
                        ModelDb.GetById<RelicModel>(save.PredeterminedModelId).ToMutable(),
                        player
                    );
                }
            ...
            default:
                throw new NotImplementedException(
                    "Serializing these types of rewards hasn't been implemented yet"
                );
        }
    }
}
