...
public class SpecialCardReward : Reward
{
    ...
    private static string RewardIcon =>
        ImageHelper.GetImagePath("ui/reward_screen/reward_icon_special_card.png");
    ...
    public override LocString Description
    {
        get
        {
            ...
            {
                locString = ModelDb
                    .GetById<EncounterModel>(_customDescriptionEncounterSourceId)
    ...
    protected override IEnumerable<IHoverTip> ExtraHoverTips =>
        new global::_003C_003Ez__ReadOnlySingleElementList<IHoverTip>(
            HoverTipFactory.FromCard(_card)
        );
    ...
    public override void OnSkipped()
    {
        if (!_wasTaken)
        {
            base.Player.RunState.CurrentMapPointHistoryEntry.GetEntry(base.Player.NetId)
                .CardChoices.Add(new CardChoiceHistoryEntry(_card, wasPicked: false));
        }
    }
