...
public class AtlasResourceLoader : ResourceFormatLoader
{
    ...
    {
        public static new readonly StringName _GetRecognizedExtensions = "_GetRecognizedExtensions";

        public static new readonly StringName _HandlesType = "_HandlesType";

        public static new readonly StringName _GetResourceType = "_GetResourceType";

        public static new readonly StringName _RecognizePath = "_RecognizePath";

        public static new readonly StringName _Exists = "_Exists";

        public static new readonly StringName _Load = "_Load";

        public static new readonly StringName _GetDependencies = "_GetDependencies";
    ...
    )
    {
        ...
        {
            Log.Warn(
                $"AtlasResourceLoader: Missing sprite '{text2}' in {text} (requested: {path})"
            );
        }
    ...
    private static Texture2D? LoadFallback(string atlasName, string spriteName)
    {
        ...
        Log.Debug(
            $"AtlasResourceLoader: Using fallback for {atlasName}/{spriteName}: {fallbackPath}"
        );
    ...
    {
        string text = (
            (!(atlasName == "card_atlas"))
                ? "res://images/powers/missing_power.png"
                : "res://images/packed/card_portraits/beta.png"
        );
        string path = text;
        if (ResourceLoader.Exists(path))
        {
            Texture2D texture2D = ResourceLoader.Load<Texture2D>(
                path,
                null,
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName._GetRecognizedExtensions,
                new PropertyInfo(
        ...
        list.Add(
            new MethodInfo(
                ...
                new PropertyInfo(
                    ...
                    PropertyHint.None,
                    "",
                    PropertyUsageFlags.Default | PropertyUsageFlags.NilIsVariant,
                    exported: false
                ),
                MethodFlags.Normal,
                new List<PropertyInfo>
        ...
        list.Add(
            new MethodInfo(
                MethodName.GetRelicFallbackPath,
                new PropertyInfo(
                    Variant.Type.String,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.GetPowerFallbackPath,
                new PropertyInfo(
                    Variant.Type.String,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.GetCardFallbackPath,
                new PropertyInfo(
                    Variant.Type.String,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.GetPotionFallbackPath,
                new PropertyInfo(
                    Variant.Type.String,
                    "",
                    PropertyHint.None,
    ...
    )
    {
        ...
        if (method == MethodName._HandlesType && args.Count == 1)
        {
            ret = VariantUtils.CreateFrom<bool>(
                _HandlesType(VariantUtils.ConvertTo<StringName>(in args[0]))
            );
            return true;
        }
        if (method == MethodName._GetResourceType && args.Count == 1)
        {
            ret = VariantUtils.CreateFrom<string>(
                _GetResourceType(VariantUtils.ConvertTo<string>(in args[0]))
            );
            return true;
        }
        ...
        {
            ret = VariantUtils.CreateFrom<bool>(
                _Exists(VariantUtils.ConvertTo<string>(in args[0]))
            );
            return true;
        }
        if (method == MethodName._Load && args.Count == 4)
        {
            ret = VariantUtils.CreateFrom<Variant>(
                _Load(
                    VariantUtils.ConvertTo<string>(in args[0]),
                    VariantUtils.ConvertTo<string>(in args[1]),
                    VariantUtils.ConvertTo<bool>(in args[2]),
                    VariantUtils.ConvertTo<int>(in args[3])
                )
            );
            return true;
        }
        ...
        {
            ret = VariantUtils.CreateFrom<bool>(
                IsSpritePath(VariantUtils.ConvertTo<string>(in args[0]))
            );
            return true;
        }
        ...
        {
            ret = VariantUtils.CreateFrom<string>(
                GetRelicFallbackPath(VariantUtils.ConvertTo<string>(in args[0]))
            );
            return true;
        }
        ...
        {
            ret = VariantUtils.CreateFrom<string>(
                GetPowerFallbackPath(VariantUtils.ConvertTo<string>(in args[0]))
            );
            return true;
        }
        ...
        {
            ret = VariantUtils.CreateFrom<string>(
                GetCardFallbackPath(VariantUtils.ConvertTo<string>(in args[0]))
            );
            return true;
        }
        ...
        {
            ret = VariantUtils.CreateFrom<string>(
                GetPotionFallbackPath(VariantUtils.ConvertTo<string>(in args[0]))
            );
            return true;
        }
        ...
        {
            ret = VariantUtils.CreateFrom<Variant>(
                GetMissingTexture(VariantUtils.ConvertTo<string>(in args[0]))
            );
            return true;
        }
