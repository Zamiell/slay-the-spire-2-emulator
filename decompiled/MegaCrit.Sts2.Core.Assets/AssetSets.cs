...
public static class AssetSets
{
    ...
    static AssetSets()
    {
        ...
        CommonAssets = new HashSet<string>(
            new IEnumerable<string>[93]
            {
                ...
                .Concat(CardMaterialPaths)
        );
        MainMenuSet = new HashSet<string>(
            new IEnumerable<string>[23]
            {
                ...
                ModelDb.AllCharacters.SelectMany(
                    (CharacterModel character) => character.AssetPathsCharacterSelect
                ),
            }.SelectMany((IEnumerable<string> s) => s)
        );
        RunSet = null;
