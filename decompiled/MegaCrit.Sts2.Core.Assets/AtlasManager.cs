...
public static class AtlasManager
{
    ...
    private static readonly ConcurrentDictionary<string, AtlasData> _atlases =
        new ConcurrentDictionary<string, AtlasData>();

    private static readonly ConcurrentDictionary<string, AtlasTexture> _spriteCache =
        new ConcurrentDictionary<string, AtlasTexture>();
