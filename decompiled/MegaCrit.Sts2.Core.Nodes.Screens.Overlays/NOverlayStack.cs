...
public class NOverlayStack : Control
{
    ...
    {
        add { backing_Changed = (ChangedEventHandler)Delegate.Combine(backing_Changed, value); }
        remove { backing_Changed = (ChangedEventHandler)Delegate.Remove(backing_Changed, value); }
    }
    ...
    public void ShowOverlays()
    {
        ...
        {
            _backstop.Modulate = (
                overlayScreen.UseSharedBackstop ? Colors.White : Colors.Transparent
            );
            overlayScreen.AfterOverlayShown();
        }
    }
    ...
    public void ShowBackstop()
    {
        ...
        if (overlayScreen == null || overlayScreen.UseSharedBackstop)
        {
            ...
            _backstopFade
                .TweenProperty(_backstop, "modulate:a", 1f, 0.5)
    ...
    public void HideBackstop()
    {
        ...
        if (overlayScreen == null || overlayScreen.UseSharedBackstop)
        {
            ...
            if (ScreenCount <= 1)
            {
                _backstopFade = CreateTween();
                _backstopFade
                    .TweenProperty(_backstop, "modulate:a", 0f, 0.5)
                    .SetEase(Tween.EaseType.Out)
                    .SetTrans(Tween.TransitionType.Cubic);
            }
            else
