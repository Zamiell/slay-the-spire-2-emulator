...
public class NParticleCounter : Control
{
    ...
    private static readonly StringName _toggleParticleCounter = new StringName(
        "toggle_particle_counter"
    );
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName._secondsSinceLastUpdate,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._secondsSinceLastUpdate,
            Variant.From(in _secondsSinceLastUpdate)
        );
