...
public class NUnlockRelicsScreen : NUnlockScreen
{
    ...
    private static readonly string _scenePath = SceneHelper.GetScenePath(
        "timeline_screen/unlock_relics_screen"
    );
    ...
    public static NUnlockRelicsScreen Create()
    {
        return PreloadManager
            ...
            .Instantiate<NUnlockRelicsScreen>(PackedScene.GenEditState.Disabled);
    }
    ...
    public override void _Ready()
    {
        ...
        _banner.label.SetTextAutoSize(
            new LocString("timeline", "UNLOCK_RELICS_BANNER").GetRawText()
        );
        _banner.AnimateIn();
        ...
        foreach (RelicModel relic in _relics)
        {
            ...
            _relicTween
                .TweenProperty(
                    nRelicBasicHolder,
                    "position",
                    vector + Vector2.Right * 350f * num,
                    0.5
                )
                .SetEase(Tween.EaseType.Out)
                .SetTrans(Tween.TransitionType.Expo);
            _relicTween
                .TweenProperty(nRelicBasicHolder, "modulate", Colors.White, 1.0)
                .SetEase(Tween.EaseType.Out)
