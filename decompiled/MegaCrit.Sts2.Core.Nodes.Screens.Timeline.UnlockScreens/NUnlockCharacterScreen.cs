...
public class NUnlockCharacterScreen : NUnlockScreen
{
    ...
    {
        NUnlockCharacterScreen nUnlockCharacterScreen = PreloadManager
            .Cache.GetScene(_scenePath)
            .Instantiate<NUnlockCharacterScreen>(PackedScene.GenEditState.Disabled);
