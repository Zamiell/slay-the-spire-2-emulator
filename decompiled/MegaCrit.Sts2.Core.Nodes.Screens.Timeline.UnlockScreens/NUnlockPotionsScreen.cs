...
public class NUnlockPotionsScreen : NUnlockScreen
{
    ...
    private static readonly string _scenePath = SceneHelper.GetScenePath(
        "timeline_screen/unlock_potions_screen"
    );
    ...
    public static NUnlockPotionsScreen Create()
    {
        return PreloadManager
            ...
            .Instantiate<NUnlockPotionsScreen>(PackedScene.GenEditState.Disabled);
    }
    ...
    public override void _Ready()
    {
        ...
        _banner.label.SetTextAutoSize(
            new LocString("timeline", "UNLOCK_POTIONS_BANNER").GetRawText()
        );
        _banner.AnimateIn();
        ...
        foreach (PotionModel potion in _potions)
        {
            ...
            _potionTween
                .TweenProperty(
                    nPotionHolder,
                    "position",
                    base.Position + Vector2.Right * 350f * num,
                    0.5
                )
                .SetEase(Tween.EaseType.Out)
                .SetTrans(Tween.TransitionType.Expo);
            _potionTween
                .TweenProperty(nPotionHolder, "modulate", Colors.White, 1.0)
                .SetEase(Tween.EaseType.Out)
