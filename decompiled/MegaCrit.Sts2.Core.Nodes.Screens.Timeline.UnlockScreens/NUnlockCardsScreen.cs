...
public class NUnlockCardsScreen : NUnlockScreen
{
    public new class MethodName : NUnlockScreen.MethodName
    {
        ...
        public static new readonly StringName Open = "Open";

        public static new readonly StringName OnScreenPreClose = "OnScreenPreClose";

        public static new readonly StringName OnScreenClose = "OnScreenClose";
    ...
    private static readonly string _scenePath = SceneHelper.GetScenePath(
        "timeline_screen/unlock_cards_screen"
    );
    ...
    public static NUnlockCardsScreen Create()
    {
        return PreloadManager
            ...
            .Instantiate<NUnlockCardsScreen>(PackedScene.GenEditState.Disabled);
    }
    ...
    public override void _Ready()
    {
        ...
        _banner.label.SetTextAutoSize(
            new LocString("timeline", "UNLOCK_CARDS_BANNER").GetRawText()
        );
        _banner.AnimateIn();
        _cardRow = GetNode<Control>("%CardRow");
        LocString locString = new LocString("timeline", "UNLOCK_CARDS");
        GetNode<MegaRichTextLabel>("%ExplanationText").Text =
            "[center]" + locString.GetFormattedText() + "[/center]";
    }
        ...
        foreach (CardModel card in _cards)
        {
            ...
            _cardTween
                .TweenProperty(
                    nGridCardHolder,
                    "position",
                    nGridCardHolder.Position + vector + Vector2.Right * 350f * num,
                    0.5
                )
