...
public class NCombatBackground : Control
{
    ...
    public static NCombatBackground Create(BackgroundAssets bg)
    {
        ...
        NCombatBackground nCombatBackground = PreloadManager
            .Cache.GetScene(backgroundScenePath)
    ...
    private void AddLayer(string layerName, string layerPath)
    {
        ...
        if (nodeOrNull == null)
        {
            throw new InvalidOperationException(
                "Layer node='" + layerName + "' not found in combat background scene."
            );
        }
        Control control = PreloadManager
            .Cache.GetScene(layerPath)
