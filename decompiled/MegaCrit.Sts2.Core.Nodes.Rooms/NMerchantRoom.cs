...
public class NMerchantRoom : Control, IScreenContext, IRoomWithProceedButton
{
    ...
    public static NMerchantRoom? Create(MerchantRoom room, IReadOnlyList<Player> players)
    {
        ...
        NMerchantRoom nMerchantRoom = PreloadManager
    ...
    public override void _Ready()
    {
        ...
        _proceedButton.Connect(
            ...
            Callable.From<NButton>(HideScreen)
        );
        ...
        MerchantButton.Connect(
            NMerchantButton.SignalName.MerchantOpened,
            Callable.From<NMerchantButton>(OnMerchantOpened)
        );
    ...
    public override void _EnterTree()
    {
        ...
        NMapScreen.Instance.Connect(
            NMapScreen.SignalName.Opened,
            Callable.From(ToggleMerchantTrack)
        );
        NMapScreen.Instance.Connect(
            NMapScreen.SignalName.Closed,
            Callable.From(ToggleMerchantTrack)
        );
    }
    ...
    public override void _ExitTree()
    {
        ...
        ActiveScreenContext.Instance.Updated -= OnActiveScreenUpdated;
        NMapScreen.Instance.Disconnect(
            NMapScreen.SignalName.Opened,
            Callable.From(ToggleMerchantTrack)
        );
        NMapScreen.Instance.Disconnect(
    ...
    private void AfterRoomIsLoaded()
    {
        ...
        for (int i = 0; i < num; i++)
        {
            ...
            for (int j = 0; j < num; j++)
            {
                ...
                NMerchantCharacter nMerchantCharacter = PreloadManager
                    .Cache.GetScene(_players[num3].Character.MerchantAnimPath)
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.ToggleMerchantTrack,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName.MerchantButton,
            Variant.From<NMerchantButton>(MerchantButton)
        );
