...
public class NRestSiteRoom : Control, IScreenContext, IRoomWithProceedButton
{
    ...
    public static NRestSiteRoom? Create(RestSiteRoom room, IRunState runState)
    {
        ...
        NRestSiteRoom nRestSiteRoom = PreloadManager
            .Cache.GetScene("res://scenes/rooms/rest_site_room.tscn")
            .Instantiate<NRestSiteRoom>(PackedScene.GenEditState.Disabled);
    ...
    public override void _Ready()
    {
        ...
        _proceedButton.Connect(
            ...
            Callable.From<NButton>(OnProceedButtonReleased)
        );
        ...
        {
            NRestSiteCharacter nRestSiteCharacter = NRestSiteCharacter.Create(
                _runState.Players[i],
                i
            );
        ...
        RunManager.Instance.RestSiteSynchronizer.PlayerHoverChanged +=
            OnPlayerChangedHoveredRestSiteOption;
        RunManager.Instance.RestSiteSynchronizer.BeforePlayerOptionChosen +=
            OnBeforePlayerSelectedRestSiteOption;
        RunManager.Instance.RestSiteSynchronizer.AfterPlayerOptionChosen +=
    ...
    public void AnimateDescriptionDown()
    {
        ...
        _descriptionPositionTween
            .TweenProperty(Description, "position:y", 885f, 0.800000011920929)
    ...
    public void AnimateDescriptionUp()
    {
        ...
        _descriptionPositionTween = CreateTween();
        _descriptionPositionTween
            .TweenProperty(Description, "position:y", _originalDescriptionYPos, 0.800000011920929)
            .SetTrans(Tween.TransitionType.Expo)
            .SetEase(Tween.EaseType.Out);
    }
    ...
    private void UpdateRestSiteOptions()
    {
        ...
        foreach (RestSiteOption option in Options)
        {
            ...
            nRestSiteButton.Connect(
                NClickableControl.SignalName.Focused,
                Callable.From<NRestSiteButton>(RestSiteButtonHovered)
            );
            nRestSiteButton.Connect(
                NClickableControl.SignalName.Unfocused,
                Callable.From<NRestSiteButton>(RestSiteButtonUnhovered)
            );
        ...
        for (int i = 0; i < list.Count; i++)
        {
            ...
            nRestSiteButton2.FocusNeighborRight = (
                (i < list.Count - 1) ? list[i + 1].GetPath() : list[0].GetPath()
            );
    ...
    private void OnPlayerChangedHoveredRestSiteOption(ulong playerId)
    {
        ...
        {
            NRestSiteCharacter nRestSiteCharacter = Characters.First(
                (NRestSiteCharacter c) => c.Player.NetId == playerId
            );
            int? hoveredOptionIndex =
                RunManager.Instance.RestSiteSynchronizer.GetHoveredOptionIndex(playerId);
            RestSiteOption option = (
                (!hoveredOptionIndex.HasValue)
                    ? null
                    : RunManager.Instance.RestSiteSynchronizer.GetOptionsForPlayer(playerId)[
    ...
    private async Task AfterSelectingOptionAsync(RestSiteOption option)
    {
        ...
        global::_003C_003Ey__InlineArray2<Task> buffer =
            default(global::_003C_003Ey__InlineArray2<Task>);
        global::_003CPrivateImplementationDetails_003E.InlineArrayElementRef<
            global::_003C_003Ey__InlineArray2<Task>,
            Task
        >(ref buffer, 0) = task;
        global::_003CPrivateImplementationDetails_003E.InlineArrayElementRef<
            global::_003C_003Ey__InlineArray2<Task>,
    ...
    public void FadeOutOptionDescription()
    {
        ...
        _descriptionTween
            .TweenProperty(Description, "modulate:a", 0f, 1.0)
            .SetEase(Tween.EaseType.Out)
            .SetTrans(Tween.TransitionType.Expo)
            .From(1f);
    }
        ...
        if (inputEvent.IsActionReleased(DebugHotkey.hideRestSite))
        {
            ...
            NGame.Instance.AddChildSafely(
                NFullscreenTextVfx.Create(
                    _isDebugUiVisible ? "Hide RestSite UI" : "Show RestSite UI"
                )
            );
        }
    }
    ...
    {
        if (
            RunManager.Instance.RestSiteSynchronizer.GetLocalOptions().Count > 0
            || !_restSiteLighting.Visible
        )
        {
            return;
        }
    ...
    private async Task ShowChoices(CancellationToken ct)
    {
        ...
        _choicesTween
            .TweenProperty(_choicesScreen, "modulate:a", 1f, 0.5)
            .SetEase(Tween.EaseType.Out)
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.AnimateDescriptionDown,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.AnimateDescriptionUp,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.UpdateRestSiteOptions,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.RestSiteButtonHovered,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.RestSiteButtonUnhovered,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnPlayerChangedHoveredRestSiteOption,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnProceedButtonReleased,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.FadeOutOptionDescription,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.ExtinguishFireIfAble,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._choicesContainer,
                PropertyHint.None,
                "",
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._restSiteLighting,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._descriptionTween,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._descriptionPositionTween,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Float,
                PropertyName._originalDescriptionYPos,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._descriptionPositionTween,
            Variant.From(in _descriptionPositionTween)
        );
        info.AddProperty(PropertyName._choicesTween, Variant.From(in _choicesTween));
        info.AddProperty(
            PropertyName._originalDescriptionYPos,
            Variant.From(in _originalDescriptionYPos)
        );
