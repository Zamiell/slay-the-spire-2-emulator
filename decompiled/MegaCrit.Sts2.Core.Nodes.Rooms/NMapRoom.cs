...
public class NMapRoom : Control, IScreenContext
{
    ...
    public static NMapRoom? Create(ActModel act, int actIndex)
    {
        ...
        NMapRoom nMapRoom = PreloadManager
            .Cache.GetScene("res://scenes/rooms/map_room.tscn")
            .Instantiate<NMapRoom>(PackedScene.GenEditState.Disabled);
        nMapRoom._act = act;
    ...
    public override void _Ready()
    {
        ...
        NCapstoneContainer.Instance.Connect(
            NCapstoneContainer.SignalName.CapstoneClosed,
            Callable.From(ReopenMap)
        );
    ...
    {
        NCapstoneContainer.Instance.Disconnect(
            NCapstoneContainer.SignalName.CapstoneClosed,
            Callable.From(ReopenMap)
        );
