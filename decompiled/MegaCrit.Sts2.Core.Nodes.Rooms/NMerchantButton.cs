...
public class NMerchantButton : NButton
{
    ...
    public new class MethodName : NButton.MethodName
    {
        ...
        public static new readonly StringName RefreshFocus = "RefreshFocus";
    }
    ...
    public event MerchantOpenedEventHandler MerchantOpened
    {
        add
        {
            backing_MerchantOpened = (MerchantOpenedEventHandler)
                Delegate.Combine(backing_MerchantOpened, value);
        }
        remove
        {
            backing_MerchantOpened = (MerchantOpenedEventHandler)
                Delegate.Remove(backing_MerchantOpened, value);
        }
    }
    ...
    {
        NSpeechBubbleVfx nSpeechBubbleVfx = NSpeechBubbleVfx.Create(
            line.GetFormattedText(),
            DialogueSide.Right,
            base.GlobalPosition + base.Size.X * Vector2.Left,
            duration,
            VfxColor.Blue
        );
    ...
    internal static new List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._merchantSelectionReticle,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName.IsLocalPlayerDead,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._merchantSelectionReticle,
            Variant.From(in _merchantSelectionReticle)
        );
        info.AddProperty(
            PropertyName._focusedWhileTargeting,
    ...
    protected override void RestoreGodotObjectData(GodotSerializationInfo info)
    {
        ...
        if (
            info.TryGetSignalEventDelegate<MerchantOpenedEventHandler>(
                SignalName.MerchantOpened,
                out var value4
            )
        )
        {
