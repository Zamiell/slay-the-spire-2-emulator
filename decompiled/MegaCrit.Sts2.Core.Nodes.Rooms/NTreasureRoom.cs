...
public class NTreasureRoom : Control, IScreenContext, IRoomWithProceedButton
{
    ...
    public static NTreasureRoom? Create(TreasureRoom room, IRunState runState)
    {
        ...
        NTreasureRoom nTreasureRoom = PreloadManager
            .Cache.GetScene(_scenePath)
            .Instantiate<NTreasureRoom>(PackedScene.GenEditState.Disabled);
    ...
    public override void _Ready()
    {
        ...
        if (_runState.Players.Count == 1)
        {
            _banner.label.SetTextAutoSize(
                new LocString("gameplay_ui", "TREASURE_BANNER").GetRawText()
            );
        }
        else
        {
            _banner.label.SetTextAutoSize(
                new LocString("gameplay_ui", "CHOOSE_SHARED_RELIC_HEADER").GetRawText()
            );
        }
        ...
        _chestButton.Connect(
            NClickableControl.SignalName.Released,
            Callable.From<NButton>(OnChestButtonReleased)
        );
    }
    ...
    private async Task RelicFtueCheck()
    {
        if (!SaveManager.Instance.SeenFtue("obtain_relic_ftue"))
        {
            ...
            Control relicReward = (
                (!_relicCollection.SingleplayerRelicHolder.Visible)
                    ? ((Control)_relicCollection)
                    : ((Control)_relicCollection.SingleplayerRelicHolder)
            );
    ...
    internal static List<MethodInfo> GetGodotMethodList()
    {
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnChestButtonReleased,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
        ...
        list.Add(
            new MethodInfo(
                MethodName.OnActiveScreenChanged,
                new PropertyInfo(
                    Variant.Type.Nil,
                    "",
                    PropertyHint.None,
    ...
    internal static List<PropertyInfo> GetGodotPropertyList()
    {
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Object,
                PropertyName._skipVoteContainer,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName._isRelicCollectionOpen,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
        ...
        list.Add(
            new PropertyInfo(
                Variant.Type.Bool,
                PropertyName._hasChestBeenOpened,
                PropertyHint.None,
                "",
                PropertyUsageFlags.ScriptVariable,
                exported: false
    ...
    protected override void SaveGodotObjectData(GodotSerializationInfo info)
    {
        ...
        info.AddProperty(
            PropertyName._isRelicCollectionOpen,
            Variant.From(in _isRelicCollectionOpen)
        );
