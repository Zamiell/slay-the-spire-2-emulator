...
public class CreatureAnimator
{
    ...
    public CreatureAnimator(AnimState initialState, MegaSprite spineController)
    {
        ...
        _spineController.ConnectAnimationStarted(
            Callable.From<GodotObject, GodotObject, GodotObject>(OnAnimationStarted)
        );
        _spineController.ConnectAnimationCompleted(
            Callable.From<GodotObject, GodotObject, GodotObject>(OnAnimationCompleted)
        );
        _spineController.ConnectAnimationInterrupted(
            Callable.From<GodotObject, GodotObject, GodotObject>(OnAnimationInterrupted)
        );
