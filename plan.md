...
- Current curated trace mismatch summary: DRUM_1 step 46 (floor 3→4 map topology); TRACE_CARDS_1 step 79 (map topology + gold diff at floor 5); RARITY_1 step 32 (max_hp diff from MORPHIC_GROVE event not selected); INSTANT_5 step 43 (floor 3 Slimes combat ends at different step due to hand ordering / enemy HP differences); INSTANT_9 step 23 (emulator completes floor 2 combat faster, first significant mismatch at step 88); INSTANT_10 step 19 (HP diff from combat timing).
