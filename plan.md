...
- Current curated trace mismatch status: DRUM_1 step 49 (floor 4 event behavior), TRACE_CARDS_1 step 46 (floor 5 encounter type - map layout mismatch causes wrong row assignment → wrong encounter), RARITY_1 step 27 (map layout wrong), INSTANT_5 step 43 (multi-enemy targeting - architectural), INSTANT_9 step 23 (multi-enemy targeting - architectural). Remaining RNG gaps: elite/boss encounter selection still uses numpy; map path generation produces wrong layouts for RARITY_1 and TRACE_CARDS_1.
