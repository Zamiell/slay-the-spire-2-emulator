...
- Current curated trace mismatch summary: DRUM_1 step 46 (floor 3→4 map topology); TRACE_CARDS_1 step 79 (map topology + gold diff at floor 5); RARITY_1 step 32 (max_hp diff from MORPHIC_GROVE event not selected); INSTANT_5 step 43 (floor 3 Slimes combat timing — emulator draws different cards due to shuffle RNG mismatch); INSTANT_9 step 88 (Vine Shambler combat not completing — emulator deals cards in different order, HP 17 vs 14); INSTANT_10 step 19 (HP diff from combat timing).
